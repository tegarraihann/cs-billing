...
/**
 * Usage:
 *   php scripts/move-so-2602044014-lolo-bca-to-mandiri.php           # dry-run
 *   php scripts/move-so-2602044014-lolo-bca-to-mandiri.php --apply   # eksekusi pindah bank
 */
$argvValues = $argv ?? ($_SERVER['argv'] ?? []);
$apply = in_array('--apply', $argvValues, true) || getenv('MOVE_TX_APPLY') === '1';

$targetSoSuffix = '2602044014';
$targetVendorName = 'INTERNAL DIVISION';
$targetDescriptionKeyword = 'LOLO';
$targetAmount = 749250.00;
$fromBankName = 'BCA';
$toBankName = 'Mandiri';
$dryRun = !$apply;
$systemUserId = 1;
