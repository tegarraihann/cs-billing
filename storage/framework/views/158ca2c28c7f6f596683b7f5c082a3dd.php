...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Eshaka Wijaya Logistics. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\OfficeManagement\resources\views\errors\login-not-available.blade.php ENDPATH**/ ?>