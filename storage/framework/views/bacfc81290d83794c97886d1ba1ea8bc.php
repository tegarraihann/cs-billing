...
<head>
    <meta charset="utf-8">
    <title>NOTA - <?php echo e($invoice->invoice_number); ?></title>
    <style>
        @page {
            size: A4;
            margin: 20mm 15mm;
...
<body>
    <div class="container">
        <!-- Watermark -->
        <div class="watermark"><?php echo e($invoice->status === 'draft' ? 'ORIGINAL' : 'ORIGINAL'); ?></div>
        ...
        <div class="nota-number">
            No. <?php echo e($invoice->invoice_number); ?>

        </div>

        <div class="nota-subtitle">
            <strong>Kami mendebit anda untuk pengiriman<br></strong>
            <?php echo e(strtoupper($invoice->vessel ?? $invoice->salesOrder->vessel ?? 'VESSEL NAME')); ?>

            <?php echo e(strtoupper($invoice->salesOrder->pol ?? 'ORIGIN')); ?> to
            <?php echo e(strtoupper($invoice->salesOrder->pod ?? 'DESTINATION')); ?>
            ...
            <table>
                <tr>
                    ...
                    <td class="detail-value">
                        <?php echo e(strtoupper($invoice->customer->company_name ?? $invoice->salesOrder->customer ?? 'PT LOGISTICS NUSANTARA SEJAHTERA')); ?>
                ...
                <tr>
                    ...
                    <td class="detail-colon">:</td>
                    <td class="detail-value"><?php echo e($invoice->awb_bl_no ?? $invoice->salesOrder->bl_awb ?? '-'); ?></td>
                </tr>
                <tr>
                    <td class="detail-label">Nota Tambahan</td>
                    <td class="detail-colon">:</td>
                    <td class="detail-value"><?php echo e($invoice->remarks ?? '-'); ?></td>
                </tr>
            </table>
        </div>
            ...
            <tbody>
                ...
                <?php if($items && $items->count() > 0): ?>
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr>
                            <td><?php echo e(strtoupper($item->description ?? $item->item_description ?? 'SERVICE')); ?></td>
                            <td><?php echo e($item->quantity ?? $item->qty ?? 1); ?></td>
                            <td class="currency">RP
                                <?php echo e(number_format($item->unit_price ?? $item->rate ?? $item->price ?? 0, 2, ',', '.')); ?></td>
                            <td class="currency">RP <?php echo e(number_format($itemAmount, 2, ',', '.')); ?></td>
                        </tr>
        ...
        <div class="note-total-section">
            <div class="note-total-info">
                <div class="note-left">
                    <strong>NOTE :</strong> <?php echo e($invoice->notes ?? $invoice->remarks ?? $invoice->description ?? '-'); ?>

                </div>
                <div class="total-right">
                    <div class="amount-large">
                        TOTAL &nbsp;&nbsp;&nbsp;&nbsp; RP <?php echo e(number_format($totalAmount, 2, ',', '.')); ?>
        ...
        <div class="footer-section">
                ...
                <div class="footer-left">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div style="text-align: left; flex: 1;">
                            Payable (PREPAID) at : <?php echo e(strtoupper($invoice->salesOrder->pol ?? 'JAKARTA')); ?> - CY(FIOST)/PORT<br>
            ...
            <div class="copy-label">
                <?php echo e($invoice->status === 'draft' ? 'ASLI (ORIGINAL)' : 'ASLI (ORIGINAL)'); ?>
...
<?php /**PATH C:\laragon\www\OfficeManagement\resources\views\invoices\reimbursement-nota-pdf.blade.php ENDPATH**/ ?>