...
<head>
    <meta charset="utf-8">
    <title>Preview - <?php echo e($invoice->invoice_number); ?></title>
    <style>
        body {
...
<body>
    <div class="preview-actions">
        <a href="<?php echo e(route('admin-keuangan.invoices.pdf', $invoice)); ?>" class="btn btn-success" target="_blank">Download Invoice</a>
        <button onclick="printInvoice()" class="btn btn-primary">Print Invoice</button>
        <a href="<?php echo e(route('admin-keuangan.invoices.show', $invoice)); ?>" class="btn">Back to Invoice</a>
    </div>
    ...
    <script>
        function printInvoice() {
            ...
            iframe.src = '<?php echo e(route("admin-keuangan.invoices.print", $invoice)); ?>';
            ...
            iframe.onload = function() {
                setTimeout(function() {
                    try {
                        ...
                        window.open('<?php echo e(route("admin-keuangan.invoices.pdf", $invoice)); ?>', '_blank');
                        document.body.removeChild(iframe);
                    }
                }, 500);
            };
    ...
    <div class="preview-header">
        <h3>Invoice Preview - <?php echo e($invoice->invoice_number); ?></h3>
    ...
    <div class="preview-container">
        <div class="container">
            ...
            <!-- Top Header Line -->
            <div class="top-line">
                <div class="customer-code">CUSTOMER CODE :<?php echo e($invoice->customer->customer_code ?? '-'); ?></div>
            ...
            <div class="shipment-section">
                <div class="shipment-left">
                    ...
                    <div class="shipment-row">
                        <span class="field-label">No. OF PKGS</span> :<?php echo e($invoice->no_of_packages ? $invoice->no_of_packages . ' BAG' : '2760 BAG'); ?>
                    ...
                    <?php if($invoice->container_no ?? $invoice->salesOrder->container_no ?? null): ?>
                    ...
                    <div class="shipment-row">
                        ...
                        <?php if($invoice->container_no): ?>
                            <?php
                                ...
                                $containers = is_array($containerNo) ? $containerNo : explode("\n", str_replace(',', "\n", $containerNo));
                            ?>
                            <?php $__currentLoopData = $containers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $container): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(trim($container)): ?>
                                    <?php echo e($index > 0 ? '<br>' : ''); ?>-[<?php echo e(trim($container)); ?>]
                                <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            -[MSKU2934199]
...
<?php /**PATH C:\laragon\www\OfficeManagement\resources\views\invoices\preview.blade.php ENDPATH**/ ?>