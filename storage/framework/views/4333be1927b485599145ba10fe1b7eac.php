...
<body>
    ...
    <div class="container" data-status="<?php echo e($invoice->status === 'draft' ? 'PREVIEW' : 'ORIGINAL'); ?>">
        ...
        <div class="shipment-section">
            <table class="shipment-table">
                ...
                <tr>
                    ...
                    <td class="ship-colon">:</td>
                    <td class="ship-value">
                        <?php echo e(strtoupper($invoice->consignee ?? $invoice->customer->company_name ?? $invoice->salesOrder->customer ?? 'PT CITRA PERDANA PUTRA')); ?>
                ...
                <tr>
                    ...
                    <td class="ship-colon">:</td>
                    <td class="ship-value"><?php echo e($invoice->party_lcl ?? '-'); ?></td>
                    <td colspan="3"></td>
                </tr>
                <tr>
        ...
        <table class="items-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $entriesCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="desc-col"><?php echo e(strtoupper($item['description'] ?? 'SERVICE')); ?></td>
                        <td class="qty-col"><?php echo e(number_format($item['quantity'] ?? 1, 2)); ?></td>
                        <td class="unit-col"><?php echo e(strtoupper($item['unit'] ?? 'UNIT')); ?></td>
                        <td class="rate-col"><?php echo e(number_format($item['rate'] ?? 0, 2)); ?></td>
                        <td class="cur-col"><?php echo e($item['currency'] ?? $entriesCurrency); ?></td>
        ...
        <table class="bank-totals-table">
            <tr>
                ...
                <td class="total-value-col total-bold">
                    <?php echo e(number_format($entriesSubtotal, 2)); ?>
            ...
            <tr>
                ...
                <?php if($invoice->hasDownPayment() && $downPayment > 0): ?>
                    <td class="total-label-col" style="color: #0000">DOWN PAYMENT (-)</td>
                    <td class="total-value-col" style="color: #0000"><?php echo e(number_format($downPayment, 2)); ?></td>
                <?php else: ?>
                    <td class="total-label-col"></td>
                    <td class="total-value-col"></td>
                <?php endif; ?>
            ...
            <tr>
                ...
                <td class="total-value-col total-bold">
                    <?php echo e(number_format($entriesTotal, 2)); ?>
...
<?php /**PATH C:\laragon\www\OfficeManagement\resources\views/invoices/pdf.blade.php ENDPATH**/ ?>