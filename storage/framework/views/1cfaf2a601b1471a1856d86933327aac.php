...
<body>
    ...
    <div class="header">
        ...
        <div class="period-info"><?php echo e($cutoffDate->translatedFormat('d F Y')); ?> TRANSACTION PERIOD</div>
    </div>
    ...
    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sectionKey => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="section">
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $group['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                <td>
                                    <div><?php echo e($row['account_name']); ?></div>
                                    <div style="font-size: 8px; color: #666;"><?php echo e($row['account_code']); ?></div>
                                </td>
            ...
            <table>
                <tr class="total-row">
                    <td>Total <?php echo e($section['title']); ?></td>
                    <td class="amount"><?php echo e($formatCurrency($section['total'])); ?></td>
                </tr>
            </table>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="summary-box">
        ...
        <div class="summary-item">
            ...
            <span><?php echo e($formatCurrency($balanceCheck['assets_total'] ?? 0)); ?></span>
        </div>
        <div class="summary-item">
            <span>Total Liabilities</span>
            <span><?php echo e($formatCurrency($sections['liabilities']['total'] ?? 0)); ?></span>
        </div>
        <div class="summary-item">
            <span>Total Equity</span>
            <span><?php echo e($formatCurrency($sections['equity']['total'] ?? 0)); ?></span>
        </div>
        <div class="summary-item">
            <span><strong>Total Liabilities & Equity</strong></span>
            <span><?php echo e($formatCurrency($balanceCheck['liabilities_equity_total'] ?? 0)); ?></span>
        </div>
        ...
        <div class="summary-item" style="margin-top: 10px;">
            ...
            ?>
            <span class="<?php echo e($differenceClass); ?>"><?php echo e($formatCurrency($difference)); ?></span>
        </div>
    ...
    <div class="footer">
        <div><strong>&copy; <?php echo e(now()->year); ?> <?php echo e(strtoupper($companyName)); ?></strong></div>
        <div>Laporan ini dihasilkan secara otomatis oleh sistem.</div>
        <div>Dicetak pada <?php echo e($generatedAt->format('d/m/Y H:i')); ?></div>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\OfficeManagement\resources\views\admin\admin-keuangan\financial-position\pdf.blade.php ENDPATH**/ ?>