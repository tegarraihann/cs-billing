...
<body>
    ...
    <div class="header">
        ...
        <div class="document-info">
            ...
            <div class="document-details">
                ...
                Date: {{ $salesOrder->created_at ? $salesOrder->created_at->locale('en')->isoFormat('DD MMMM YYYY') : date('d F Y') }}<br>
    ...
    <div class="print-info" style="line-height: 1.5;">
        Printed on: {{ \Carbon\Carbon::now()->locale('en')->isoFormat('DD MMMM YYYY HH:mm') }}<br>
                ...
                <div style="width: 48%; display: table-cell; vertical-align: top; padding-right: 2%;">
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 8px; font-weight: bold; padding: 1px 0; text-align: center; vertical-align: top;">:</td>
                            <td style="font-size: 8px; padding: 1px 0; vertical-align: top;">{{ $salesOrder->eta ? \Carbon\Carbon::parse($salesOrder->eta)->locale('en')->isoFormat('DD MMMM YYYY') : '-' }}</td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="width: 48%; display: table-cell; vertical-align: top; padding-left: 2%;">
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 8px; font-weight: bold; padding: 1px 0; text-align: center; vertical-align: top;">:</td>
                            <td style="font-size: 8px; padding: 1px 0; vertical-align: top;">{{ $salesOrder->sppb_date ? \Carbon\Carbon::parse($salesOrder->sppb_date)->locale('en')->isoFormat('DD MMMM YYYY') : '-' }}</td>
                        </tr>
                        <tr>
                ...
                <div style="margin-bottom: 15px;">
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td style="width: 2%; font-size: 8px; font-weight: bold; padding: 1px 0; text-align: center; vertical-align: top;">:</td>
                            <td style="width: 165%; font-size: 8px; padding: 1px 0; vertical-align: top;">{{ $salesOrder->invoice_date ? \Carbon\Carbon::parse($salesOrder->invoice_date)->locale('en')->isoFormat('DD MMMM YYYY') : '-' }}</td>
                        </tr>
                        <tr>
                ...
                <div style="margin-bottom: 15px;">
                    <table style="width: 100%; border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="font-size: 8px; padding: 1px 0; text-align: left; vertical-align: top; white-space: pre-wrap; word-wrap: break-word; word-break: break-word; max-width: 300px;">{{ $salesOrder->note ?: 'No additional notes' }}</td>
                            {{-- <td style="width: 51%; font-size: 8px; vertical-align: top; padding: 0px 0; white-space: pre-wrap; text-align: justify;">
                                {{ $salesOrder->note ?: 'No additional notes' }}
                            </td> --}}
                        </tr>
                    </table>
                </div>
    ...
    <!-- Footer -->
    <div class="footer">
        Shipping Order No: {{ $salesOrder->order_number }} | PT. Eshaka Wijaya Logistics | Page 1 of 1<br>
        Printed on: {{ $generatedAt->format('d/m/Y H:i:s') }} | This document was generated automatically by the system
    </div>
</body>
</html>
