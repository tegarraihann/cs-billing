<template>
  <div class="text-center">
    <h3
      class="text-2xl font-bold text-gray-800 mb-12 flex items-center justify-center gap-3"
    >
    ...
    <div class="relative max-w-4xl mx-auto">
          ...
          >
            ...
            <div class="flex flex-col md:flex-row bg-white h-96 md:h-80 group">
              ...
              >
                ...
                >
                  <div
                    class="absolute inset-0 bg-gradient-to-br from-sage-900/20 via-transparent to-sage-900/40 group-hover:from-sage-900/10 transition-all duration-500"
                  ></div>
                </div>
                ...
                <div class="absolute top-6 left-6">
                  <div
                    class="w-16 h-16 bg-white/90 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:bg-sage-600 transition-all duration-500 shadow-lg"
                  >
                    <component
                ...
                <div class="absolute bottom-4 right-4">
                  <div
                    class="w-10 h-10 bg-sage-600/90 backdrop-blur-sm rounded-full flex items-center justify-center text-white font-bold text-sm"
                  >
              ...
              >
                <div class="mb-4">
                  <span
                    class="inline-flex items-center px-3 py-1 bg-sage-100 text-sage-700 text-sm font-medium rounded-full mb-3"
                  >
                    Support Service
                  </span>
                </div>
                ...
                <h4
                  class="text-xl md:text-2xl font-bold text-gray-900 group-hover:text-sage-700 transition-colors duration-300 mb-4 leading-tight"
                >
                  {{ service.title }}
                </h4>

                <p
                  class="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300 mb-6"
                >
                  {{ service.description }}
                </p>
      ...
      >
        ...
        >
          <ChevronLeftIcon
            class="w-6 h-6 text-sage-600 group-hover:text-white group-disabled:text-gray-400 transition-colors duration-300"
          />
        </button>
        ...
        <button
          ...
          class="group w-12 h-12 bg-sage-100 hover:bg-sage-600 disabled:bg-gray-100 disabled:cursor-not-allowed rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl disabled:shadow-none"
          :class="
            currentSlide >= totalSlides - 1 ? 'opacity-50' : 'hover:scale-110'
          "
        >
          <ChevronRightIcon
            class="w-6 h-6 text-sage-600 group-hover:text-white group-disabled:text-gray-400 transition-colors duration-300"
