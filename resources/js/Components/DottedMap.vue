<template>
  <section id="services" class="py-20 bg-white relative overflow-hidden">
    ...
    ></div>
    <div
      class="absolute bottom-0 left-0 w-80 h-80 bg-sage-200/20 rounded-full blur-3xl"
    ></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="relative">
        ...
        <div class="overflow-hidden rounded-2xl">
          ...
          >
            ...
            >
              <div
                class="relative h-96 md:h-[500px] group cursor-pointer"
              ...
              >
                ...
                <div class="absolute top-6 left-6">
                  <div
                    class="inline-flex items-center px-3 py-1 bg-sage-600/90 text-white rounded-full text-sm font-medium"
                  >
                    <img
                ...
                <div class="absolute bottom-0 left-0 right-0 p-8">
                  <div class="max-w-4xl">
                    <h3
                      class="text-3xl md:text-4xl font-bold text-white mb-4 font-montserrat"
                    >
                      {{ service.title }}
                    </h3>
                    ...
                    >
                      <div
                        class="grid grid-cols-1 md:grid-cols-2 gap-2 max-w-2xl"
                      >
                        <div
                        ...
                        >
                          <svg
                            class="w-4 h-4 mr-2 text-sage-400 flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
      ...
      <div class="mt-20 lg:mt-24">
        <div class="relative bg-sage-600 rounded-2xl overflow-hidden">
          ...
          <!-- Content Grid -->
          <div
            class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 p-8 lg:p-12"
          >
            <!-- Left Content -->
            <div class="text-white">
              ...
              <p class="text-lg text-sage-100 mb-8 font-jost leading-relaxed">
                Get a free consultation with our expert team. We provide the
                best solutions for export-import, trucking, and other logistics
                services.
              </p>
            </div>
          ...
          <div class="relative z-10 border-t border-sage-500/30 p-8 lg:p-12">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                <div
                  class="text-2xl lg:text-3xl font-bold text-white mb-1 font-montserrat"
                >
                  {{ stat.value }}
                </div>
...
.bg-sage-100\/30 {
  background-color: rgb(240 242 239 / 0.3);
}
.bg-sage-200\/20 {
  background-color: rgb(225 230 221 / 0.2);
}
.bg-sage-600\/90 {
  background-color: rgb(123 161 105 / 0.9);
}
