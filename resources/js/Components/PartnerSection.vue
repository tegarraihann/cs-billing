    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          Dipercaya oleh perusahaan-perusahaan besar di Indonesia dan
          mancanegara
        </p>
      </div>
      ...
      <div class="bg-white rounded-3xl p-12 shadow-xl">
        <div class="text-center mb-12">
          <h3 class="text-3xl font-bold text-gray-900 mb-4">Testimoni Klien</h3>
      ...
      <div class="text-center mt-16">
        ...
        <p class="text-gray-600 mb-8 max-w-2xl mx-auto">
          Dapatkan solusi logistik terpercaya untuk mendukung pertumbuhan bisnis
          Anda
        </p>
        <button
