...
<<<<<<< HEAD
  <section id="services" class="py-20 bg-white relative overflow-hidden">
    ...
    <div
      class="absolute top-0 right-0 w-96 h-96 bg-sage-100/30 rounded-full blur-3xl"
    ></div>
    <div
      class="absolute bottom-0 left-0 w-80 h-80 bg-sage-100/20 rounded-full blur-3xl"
    ></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-base text-gray-600 max-w-2xl mx-auto font-jost">
                    With over 20 years of experience, we provide high-quality logistics services with international
                    standards.
                </p>
            </div>
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-2 mb-8 bg-black/20 rounded-lg p-4 backdrop-blur-none rounded-xl">
                            ...
                            <div v-for="feature in exportImportFeatures" :key="feature" class="flex items-start">
                                ...
                                <span class="text-white text-sm font-jost font-medium drop-shadow-sm">{{ feature
                                    }}</span>
                            </div>
                        </div>
...
>>>>>>> 3ed81757a753494b3ed79badfc150ee47f2c643f
        ...
        <p class="text-base text-gray-600 max-w-2xl mx-auto font-jost">
          With over 20 years of experience, we provide high-quality logistics
      ...
      <div class="grid lg:grid-cols-2 gap-8 mb-20">
        ...
        >
          ...
          <div class="relative z-10">
            <div class="flex items-center mb-6">
              ...
              <div
                class="bg-sage-600 text-white px-3 py-1 rounded-full text-xs font-medium"
              >
                Featured
              </div>
            </div>
            ...
            <p class="text-white mb-6 leading-relaxed font-jost drop-shadow-md">
              We specialize in export and import services with comprehensive
              customs clearance, door-to-door delivery, and real-time tracking.
            </p>

            <div
              class="space-y-2 mb-8 bg-black/8 rounded-lg p-4 backdrop-blur-sm"
            >
              <div
                v-for="feature in exportImportFeatures"
                :key="feature"
              ...
              >
                ...
                <span
                  class="text-white text-sm font-jost font-medium drop-shadow-sm"
                  >{{ feature }}</span
                >
              </div>
            </div>
        ...
        <div class="space-y-6">
          ...
          >
            ...
            <div
              class="relative flex items-start bg-black/8 rounded-lg p-4 backdrop-blur-sm"
            >
              <div
                class="w-10 h-10 rounded-lg flex items-center justify-center mr-4 hover:scale-105 transition-transform duration-200"
                :class="service.iconBg"
              >
                <div v-html="service.icon" class="w-5 h-5 text-white"></div>
              </div>
            ...
            >
              ...
              >
                ...
                >
                  <!-- Image Section (Left) -->
                  <div
                    class="w-full md:w-1/2 h-48 md:h-full relative overflow-hidden"
                  >
                    <div
                      class="absolute inset-0 bg-cover bg-center transition-transform duration-300 group-hover:scale-105"
                      :style="`background-image: url('${addon.backgroundImage}');`"
                  ...
                  <div
                    class="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-center"
                  >
                    <h4
      ...
      <div class="mt-20 lg:mt-24 relative">
        ...
        >
          ...
          <!-- Decorative Elements -->
          <div
            class="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-full blur-xl z-5"
          ></div>
          <div
            class="absolute bottom-0 left-0 w-20 h-20 bg-white/5 rounded-full blur-lg z-5"
          ></div>
          ...
          >
            ...
            <div class="flex-shrink-0">
              ...
              >
                <svg
                  class="w-5 h-5 mr-2 text-sage-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div class="relative z-20 mt-6 lg:mt-8 pt-6 border-t border-white/20">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div v-for="stat in globalStats" :key="stat.label">
                <div
                  class="text-lg md:text-xl font-bold text-white mb-1 font-montserrat"
                >
                  {{ stat.value }}
                </div>
                <div
                  class="text-sage-200 text-xs md:text-sm font-medium font-jost"
                >
                  {{ stat.label }}
                </div>
              </div>
...
<<<<<<< HEAD
  {
    ...
    description:
      "Ground shipping throughout Indonesia with a well-maintained fleet and real-time tracking.",
...
<<<<<<< HEAD
  ...
  },
  {
    title: "Cold Chain",
    description:
      "Sistem rantai dingin untuk menjaga kualitas produk yang memerlukan suhu terkontrol",
  ...
  },
  {
    ...
    description:
      "Koordinasi pengiriman multimoda dengan jaringan global untuk efisiensi maksimal",
