<template>
  <nav
    class="fixed w-full bg-white/90 backdrop-blur-md shadow-lg border-b border-pale-sage/30 z-50 transition-all duration-300"
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        <!-- Logo -->
        <div
          class="flex items-center cursor-pointer hover:scale-105 transition-transform duration-300"
    ...
    <div
      ...
      class="md:hidden bg-white border-t border-pale-sage"
    >
