      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        >
          ...
          <div class="p-6 space-y-4">
            <div>
              <label class="block text-sm font-medium text-sage-700"
                >Nama Lengkap</label
              >
      ...
      >
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <a
              :href="`mailto:${customer.email}?subject=Inquiry%20Follow-up`"
