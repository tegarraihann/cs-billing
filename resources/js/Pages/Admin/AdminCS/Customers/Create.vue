        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-sage-200 bg-sage-50">
                    <h3 class="text-lg font-semibold text-sage-800">Form Tambah Pelanggan</h3>
                    <p class="text-sm text-sage-600 mt-1">Lengkapi informasi pelanggan dengan benar</p>
                </div>
                ...
                <div class="p-6">
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Telepon -->
                            <div>
                                <label for="phone" class="block text-sm font-medium text-sage-700 mb-2">
                            ...
                            <!-- Perusahaan -->
                            <div>
                                <label for="company" class="block text-sm font-medium text-sage-700 mb-2">
                                    Nama Perusahaan
                                </label>
                            ...
                            <!-- Sumber Inquiry -->
                            <div>
                                <label for="inquiry_source" class="block text-sm font-medium text-sage-700 mb-2">
                                    Sumber Inquiry <span class="text-red-500">*</span>
                                </label>
                                <select v-model="form.inquiry_source" id="inquiry_source" required
                                    class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors">
                                ...
                                <div v-if="form.errors.inquiry_source" class="mt-2 text-sm text-red-600">
                            ...
                            <!-- Status -->
                            <div>
                                <label for="status" class="block text-sm font-medium text-sage-700 mb-2">
                        ...
                        <!-- Alamat -->
                        <div>
                            <label for="address" class="block text-sm font-medium text-sage-700 mb-2">
                                Alamat
                            </label>
                        ...
                        <!-- Catatan -->
                        <div>
                            <label for="notes" class="block text-sm font-medium text-sage-700 mb-2">
                                Catatan
                            </label>
                            <textarea v-model="form.notes" id="notes" rows="4"
