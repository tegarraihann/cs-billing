                    ...
                    <div v-show="sections.basic" class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <div v-if="form.errors.ref_no" class="mt-2 text-sm text-red-600">{{ form.errors.ref_no
                                    }}</div>
                            </div>
                            <div>
                                ...
                                <input v-model="form.so_date" type="date"
                                    class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                <div v-if="form.errors.so_date" class="mt-2 text-sm text-red-600">{{ form.errors.so_date
                                    }}</div>
                            </div>
                        </div>
                        <div>
                            ...
                            <input v-model="form.customer" type="text" required
                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                            <div v-if="form.errors.customer" class="mt-2 text-sm text-red-600">{{ form.errors.customer
                                }}</div>
                        </div>
                        <div>
                    ...
                    <div v-show="sections.shipping" class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.sppb_date" type="date"
                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                            <div v-if="form.errors.sppb_date" class="mt-2 text-sm text-red-600">{{ form.errors.sppb_date
                                }}</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input v-model="form.party_lcl" type="text"
                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                            <div v-if="form.errors.party_lcl" class="mt-2 text-sm text-red-600">{{ form.errors.party_lcl
                                }}</div>
                        </div>
                        <div>
                    ...
                    <div v-show="sections.pricing" class="p-6 space-y-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div v-for="(item, index) in form.vendor_breakdown" :key="index"
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        <label class="block text-xs font-medium text-sage-700 mb-1">Deskripsi Service /
                                            Jenis Biaya</label>
                                ...
                                <div class="grid grid-cols-3 gap-3 p-3 bg-blue-50 rounded-lg">
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium text-green-700 mb-1">Selling Amount
                                            (Revenue)</label>
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-300 grid grid-cols-3 gap-4 text-center">
                                ...
                                <div class="p-3 rounded-lg" :class="totalRevenue >= 0 ? 'bg-purple-100' : 'bg-red-100'">
                                    <p class="text-xs font-medium"
                                        :class="totalRevenue >= 0 ? 'text-purple-700' : 'text-red-700'">Net Profit</p>
                        ...
                        <div class="bg-blue-50 rounded-lg p-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-orange-700">{{ formatCurrency(totalOtherCosts)
                                        }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span>Total Reimbursement:</span>
                                    <span class="font-medium text-purple-700">{{ formatCurrency(totalReimbursement)
                                        }}</span>
                                </div>
                                <div class="flex justify-between border-t border-blue-200 pt-2 mt-1">
                                    <span class="text-sm font-medium text-gray-700">Total Pengeluaran
                                        Keseluruhan:</span>
                                    <span class="text-sm font-bold text-red-800">{{ formatCurrency(totalBuying +
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <select v-model="cost.category"
                                                ...
                                                <option v-for="category in operationalCostCategories" :key="category.id"
                                                    :value="category.name" :title="category.description">
                                                    {{ category.name }}
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-span-3">
                                            <label class="block text-xs font-medium text-orange-700 mb-1">Vendor /
                                                Penerima</label>
                        ...
                        <div class="bg-purple-50 rounded-lg p-4">
                                ...
                                <div v-for="(item, index) in reimbursementItems" :key="index"
                                    ...
                                    <div class="grid grid-cols-12 gap-3 mb-2">
                                        ...
                                        <div class="col-span-2">
                                            ...
                                            <input v-model="item.amount" type="number" step="0.01" placeholder="0.00"
                                                class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" />
                                        </div>
                                        <div class="col-span-2">
                                            <label
                            ...
                            <div v-else class="text-center py-4 text-purple-600">
                                ...
                                <p class="text-xs text-purple-500">Klik tombol "Tambah Reimbursement" untuk menambahkan
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea v-model="form.note" rows="3" placeholder="Catatan tambahan untuk sales order ini"
                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none"></textarea>
                    ...
                    <div v-show="sections.goods" class="p-6 space-y-4">
                        <div>
                            ...
                            <textarea v-model="form.commodity" rows="3"
                                ...
                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none"></textarea>
                            <div v-if="form.errors.commodity" class="mt-2 text-sm text-red-600">{{ form.errors.commodity
                                }}</div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="grid grid-cols-2 gap-3">
