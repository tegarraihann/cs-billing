<template>
    <AdminKeuanganLayout title="Detail Piutang">
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">{{ formatDate(receivable.invoice.invoice_date) }}</p>
                        </div>
                        <div class="text-right">
                            <p class="font-medium text-gray-900">Rp {{ formatNumber(receivable.invoice.total) }}</p>
                            <span
                                :class="getInvoiceStatusClass(receivable.invoice.status)"
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3">
                    ...
                    <div class="mb-4 bg-gray-50 p-3 rounded-md">
                        ...
                        <p class="text-sm text-gray-600">Outstanding: Rp {{ formatNumber(receivable.outstanding_amount) }}</p>
                    </div>
                    <form @submit.prevent="recordPayment">
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                type="number"
                                step="0.01"
                                :max="receivable.outstanding_amount"
                                required
