        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
          <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <a href="/admin-keuangan/invoices/payment-history" class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-500">
                <div class="flex-shrink-0">
                  <CreditCard class="h-6 w-6 text-blue-600" />
                </div>
                <div class="flex-1 min-w-0">
                  <span class="absolute inset-0" aria-hidden="true"></span>
                  <p class="text-sm font-medium text-gray-900">Payment Monitoring</p>
                  <p class="text-sm text-gray-500 truncate">Monitor payment status</p>
                </div>
              </a>
