<template>
  <AdminKeuanganLayout>
    <Head title="Edit Petty Cash Category" />

    <div class="py-6">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
          <Link
            :href="route('admin-keuangan.petty-cash-categories.index')"
            class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4"
          >
            <ArrowLeft class="w-4 h-4 mr-2" />
            Back to Petty Cash Categories
          </Link>
          <h1 class="text-2xl font-bold text-gray-900">Edit Category</h1>
          <p class="mt-1 text-sm text-gray-600">Update petty cash category details.</p>
        </div>
