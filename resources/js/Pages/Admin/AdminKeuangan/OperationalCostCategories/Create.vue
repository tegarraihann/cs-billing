    ...
    <div class="py-6">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
          ...
          <h1 class="text-2xl font-bold text-gray-900">Add Operational Cost Category</h1>
          <p class="mt-1 text-sm text-gray-600">Create a new category for operational expenses</p>
        </div>
