      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
          <div class="px-4 py-5 sm:p-6">
            ...
            <div v-if="serviceTypes?.links && serviceTypes.links.length > 3" class="mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
              <div class="flex items-center justify-between">
                <div class="text-sm text-gray-700">
                  Showing {{ serviceTypes?.from ?? 0 }} to {{ serviceTypes?.to ?? 0 }} of {{ serviceTypes?.total ?? 0 }} service types
                </div>
                <div class="flex space-x-1">
                  <template v-for="link in serviceTypes?.links || []" :key="link.label">
                    <button
                      v-if="link.url"
...
const currentIndexQuery = computed(() => {
  ...
  const currentPage = props.serviceTypes?.current_page;
