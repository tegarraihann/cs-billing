                                                ...
                                                <table class="min-w-full divide-y divide-gray-200">
                                                    <thead class="bg-indigo-50">
                                                        <tr>
                                                            ...
                                                            <th class="px-6 py-3 text-left text-xs font-medium text-indigo-700 uppercase tracking-wider">Invoice</th>
                                                            <th class="px-6 py-3 text-right text-xs font-medium text-indigo-700 uppercase tracking-wider">Amount</th>
                                                    ...
                                                    <tfoot class="bg-indigo-50">
                                                        <tr>
                                                            <td class="px-6 py-3 text-sm font-semibold text-indigo-800 uppercase">Total</td>
                                                            <td colspan="2"></td>
                                                            <td class="px-6 py-3 text-right text-sm font-mono font-semibold text-indigo-900">
                                                                {{ formatCurrency(salesOrder.additional_buying_total || 0) }}
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                    </tfoot>
                                    ...
                                    <div
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-900">{{ salesOrder.qty || '-' }} {{ salesOrder.package_unit_label || salesOrder.package_unit }}</p>
                                            </div>
                                            <div>
