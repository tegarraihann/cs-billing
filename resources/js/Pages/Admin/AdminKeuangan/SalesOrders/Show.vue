<template>
    <AdminKeuanganLayout>
        <div class="py-6">
                                ...
                                <div v-for="voucher in salesOrder.vouchers" :key="voucher.id"
                                    ...
                                    <div class="flex justify-between items-start mb-3">
                                        ...
                                        <div class="text-right">
                                            <p class="font-semibold text-gray-900">{{ formatCurrency(voucher.amount) }}
                                            </p>
                                            <span
                                    ...
                                    <div v-if="voucher.status === 'released'" class="mt-3 flex space-x-2">
                                        <button @click="approveVoucher(voucher)"
                                        ...
                                        <button @click="showVoucherRejectModalFn(voucher)"
                                    ...
                                    <div v-if="voucher.status === 'released' || voucher.status === 'approved'"
            ...
            <div v-if="showVoucherRejectModal && selectedVoucher"
                class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div class="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                    ...
                    <p class="text-gray-600 mb-4">Berikan alasan penolakan:</p>
                    <textarea v-model="voucherRejectionReason"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                        rows="4" placeholder="Masukkan alasan penolakan voucher..."></textarea>
                    <div class="flex justify-end space-x-3 mt-4">
                        <button @click="closeVoucherRejectModal"
                            class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 transition-colors">
                            Batal
                        </button>
                        <button @click="rejectVoucher" :disabled="!voucherRejectionReason.trim()"
                            class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                            Tolak Voucher
                        </button>
                    </div>
