  ...
  <div class="min-h-screen bg-sage-50">
    ...
    >
      ...
      <nav class="p-4 space-y-2 flex-1 overflow-y-auto">
        ...
        <Link
          ...
          :class="{ 'bg-sage-100 text-sage-800': route().current('masteradmin.dashboard') }"
        >
        ...
        <div class="space-y-1">
          <button
            ...
            class="flex items-center justify-between w-full p-3 rounded-lg text-sage-700 hover:bg-sage-100 hover:text-sage-800 transition-all duration-200 group"
          >
            <div class="flex items-center space-x-3">
              <svg class="w-5 h-5 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <svg
              ...
              :class="{ 'rotate-180': usersMenuOpen }"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div v-show="usersMenuOpen" class="ml-8 space-y-1">
            <Link :href="route('masteradmin.users.index')" class="flex items-center space-x-2 p-2 rounded-lg text-sage-600 hover:bg-sage-50 hover:text-sage-700 transition-colors">
              <span class="text-sm">All Users</span>
            </Link>
            <Link :href="route('masteradmin.users.create')" class="flex items-center space-x-2 p-2 rounded-lg text-sage-600 hover:bg-sage-50 hover:text-sage-700 transition-colors">
      ...
      <div class="p-4 border-t border-sage-200 bg-sage-50">
        <div class="flex items-center space-x-3 p-3 rounded-lg hover:bg-sage-100 transition-colors cursor-pointer">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-sm font-medium text-sage-700 truncate">{{ $page.props.auth.user?.name }}</p>
            <p class="text-xs text-sage-500 truncate">{{ $page.props.auth.user?.email }}</p>
          </div>
        </div>
      </div>
    </aside>
    ...
    <main class="lg:ml-64 pt-16 min-h-screen">
      <div class="p-4 sm:p-6 lg:p-8">
        <!-- Welcome Section -->
        <div class="bg-gradient-to-r from-sage-600 to-sage-700 rounded-xl shadow-lg p-6 mb-8 text-white">
          <h2 class="text-2xl font-bold mb-2">Welcome back, {{ $page.props.auth.user?.name }}!</h2>
          <p class="text-sage-100">You have full system administrative privileges.</p>
        </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">99%</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">2.1GB</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Main Content -->
        <div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200">
          <h3 class="text-xl font-bold text-sage-800 mb-4">System Overview</h3>
          <p class="text-sage-600 mb-6">
            As Master Administrator, you have complete control over the system. Manage users, configure settings, and monitor system performance.
          </p>

          <!-- Quick Actions -->
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link :href="route('masteradmin.users.index')" class="p-6 border border-sage-200 rounded-lg hover:bg-sage-50 transition-colors group">
              <div class="flex items-center space-x-4">
                <div class="p-3 bg-sage-100 rounded-lg group-hover:bg-blue-200 transition-colors">
                ...
                <div>
                  ...
                  <p class="text-sm text-sage-600">View and manage all user accounts</p>
                </div>
              </div>
            </Link>

            <Link :href="route('masteradmin.users.create')" class="p-6 border border-sage-200 rounded-lg hover:bg-sage-50 transition-colors group">
              <div class="flex items-center space-x-4">
                <div class="p-3 bg-sage-100 rounded-lg group-hover:bg-green-200 transition-colors">
                  <svg class="w-6 h-6 text-sage-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p class="text-sm text-sage-600">Create new user accounts for the system</p>
                </div>
              </div>
            </Link>
          </div>
...
.to-sage-700 { --tw-gradient-to: #7BA169; }
