            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-sage-200">
                    <div class="px-6 py-4 border-b border-sage-200">
                        <h2 class="text-xl font-semibold text-sage-800">Edit Employee</h2>
                    ...
                    <form @submit.prevent="submitForm" class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.nama" class="text-red-500 text-xs mt-1">{{ errors.nama[0]
                                        }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.tempat_lahir" class="text-red-500 text-xs mt-1">{{
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.tanggal_lahir" class="text-red-500 text-xs mt-1">{{
                                        errors.tanggal_lahir[0] }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.jenis_kelamin" class="text-red-500 text-xs mt-1">{{
                                        errors.jenis_kelamin[0] }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.agama" class="text-red-500 text-xs mt-1">{{ errors.agama[0]
                                        }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input v-model="form.suku_bangsa" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.suku_bangsa }" />
                                    <span v-if="errors.suku_bangsa" class="text-red-500 text-xs mt-1">{{
                                        errors.suku_bangsa[0]
                                        }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.kewarganegaraan" class="text-red-500 text-xs mt-1">{{
                                        errors.kewarganegaraan[0] }}</span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.email" class="text-red-500 text-xs mt-1">{{ errors.email[0]
                                        }}</span>
                                </div>
                            </div>
                            ...
                            <div class="mt-6">
                                ...
                                <textarea v-model="form.alamat_ktp" rows="3"
                                    class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                    :class="{ 'border-red-500': errors.alamat_ktp }"></textarea>
                                <span v-if="errors.alamat_ktp" class="text-red-500 text-xs mt-1">{{ errors.alamat_ktp[0]
                                    }}</span>
                            </div>

                            <!-- Address Details (same as Create) -->
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">RT <span
                                            class="text-red-500">*</span></label>
                                    <input v-model="form.rt_ktp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.rt_ktp }" />
                                    <span v-if="errors.rt_ktp" class="text-red-500 text-xs mt-1">{{ errors.rt_ktp[0]
                                        }}</span>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">RW <span
                                            class="text-red-500">*</span></label>
                                    <input v-model="form.rw_ktp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.rw_ktp }" />
                                    <span v-if="errors.rw_ktp" class="text-red-500 text-xs mt-1">{{ errors.rw_ktp[0]
                                        }}</span>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">Kelurahan <span
                                            class="text-red-500">*</span></label>
                                    <input v-model="form.kelurahan_ktp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.kelurahan_ktp }" />
                                    <span v-if="errors.kelurahan_ktp" class="text-red-500 text-xs mt-1">{{
                                        errors.kelurahan_ktp[0] }}</span>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">Kecamatan <span
                                            class="text-red-500">*</span></label>
                                    <input v-model="form.kecamatan_ktp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.kecamatan_ktp }" />
                                    <span v-if="errors.kecamatan_ktp" class="text-red-500 text-xs mt-1">{{
                                        errors.kecamatan_ktp[0] }}</span>
                                </div>
                            </div>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">Kota <span
                                            class="text-red-500">*</span></label>
                                    <input v-model="form.kota_ktp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.kota_ktp }" />
                                    <span v-if="errors.kota_ktp" class="text-red-500 text-xs mt-1">{{ errors.kota_ktp[0]
                                        }}</span>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">Provinsi <span
                                            class="text-red-500">*</span></label>
                                    <input v-model="form.provinsi_ktp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.provinsi_ktp }" />
                                    <span v-if="errors.provinsi_ktp" class="text-red-500 text-xs mt-1">{{
                                        errors.provinsi_ktp[0]
                                        }}</span>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                                <div>
                                    ...
                                    <input v-model="form.nomor_telp_rumah" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">
                                    ...
                                    <input v-model="form.nomor_hp" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"
                                        :class="{ 'border-red-500': errors.nomor_hp }" />
                                    <span v-if="errors.nomor_hp" class="text-red-500 text-xs mt-1">{{ errors.nomor_hp[0]
                                        }}</span>
                                </div>
                                <div>
                        ...
                        <!-- Section 2: Data Orang Tua (same as Create) -->
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold text-sage-800 mb-4 pb-2 border-b border-sage-200">
                            ...
                            <!-- Alamat Orang Tua -->
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-sage-700 mb-2">Alamat Rumah Orang
                                    Tua</label>
                                <textarea v-model="form.alamat_orang_tua" rows="3"
                                    class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"></textarea>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input v-model="form.kota_orang_tua" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">Provinsi</label>
                                    <input v-model="form.provinsi_orang_tua" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input v-model="form.nomor_telp_orang_tua" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-sage-700 mb-2">Nomor HP</label>
                                    <input v-model="form.nomor_hp_orang_tua" type="text"
                                        class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <span v-if="errors.status" class="text-red-500 text-xs mt-1">{{ errors.status[0]
                                        }}</span>
                                </div>
                            </div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input v-model="form.family_members.ayah.nama_keluarga" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Tempat Lahir</label>
                                            <input v-model="form.family_members.ayah.tempat_lahir_keluarga" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Tanggal Lahir</label>
                                            <input v-model="form.family_members.ayah.tanggal_lahir_keluarga" type="date"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Pendidikan Terakhir</label>
                                            <input v-model="form.family_members.ayah.pendidikan_terakhir" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Pekerjaan</label>
                                            <input v-model="form.family_members.ayah.pekerjaan" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input v-model="form.family_members.ibu.nama_keluarga" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Tempat Lahir</label>
                                            <input v-model="form.family_members.ibu.tempat_lahir_keluarga" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Tanggal Lahir</label>
                                            <input v-model="form.family_members.ibu.tanggal_lahir_keluarga" type="date"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Pendidikan Terakhir</label>
                                            <input v-model="form.family_members.ibu.pendidikan_terakhir" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-sage-700 mb-2">Pekerjaan</label>
                                            <input v-model="form.family_members.ibu.pekerjaan" type="text"
                                                class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                <div v-for="(work, index) in form.work_experiences" :key="index"
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                <div class="flex items-center">
                                    <input v-model="form.document_status.surat_lamaran" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Surat Lamaran</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.cv" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">CV</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.akte_kelahiran" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Akte Kelahiran</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.kartu_keluarga" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Kartu Keluarga</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.surat_pengalaman_kerja" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Surat Pengalaman Kerja</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.ktp_sim" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">KTP/SIM</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.skck" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">SKCK</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.pas_foto" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Pas Foto</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.ijazah" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Ijazah</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.surat_sehat" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
                                    <label class="text-sm">Surat Sehat</label>
                                </div>
                                <div class="flex items-center">
                                    <input v-model="form.document_status.npwp" type="checkbox"
                                        class="mr-2 w-4 h-4 text-sage-600 border-gray-300 rounded focus:ring-sage-500" />
...
const submitForm = async () => {
    ...
    try {
        const response = await fetch(`/master-admin/employees/${props.employee.id}`, {
            method: 'PUT',
            headers: {
