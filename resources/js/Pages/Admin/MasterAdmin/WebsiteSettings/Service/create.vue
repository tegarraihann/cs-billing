      ...
      <div class="px-4 sm:px-6 lg:ml-64 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex-1 lg:flex-none">
            <h1 class="text-lg sm:text-xl font-semibold text-sage-800">Tambah Service</h1>
          </div>
      ...
      <div class="p-4 sm:p-6 lg:p-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ml-1 text-sage-500 md:ml-2">Tambah Service</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200">
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 class="text-2xl font-bold text-sage-800 mb-2">Tambah Service Baru</h2>
              <p class="text-sage-600">Buat layanan baru untuk ditampilkan di website</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden">
          <div class="px-6 py-4 border-b border-sage-200">
            ...
            <p class="text-sm text-sage-600 mt-1">Lengkapi detail service baru</p>
          </div>
