                    ...
                    <div v-for="service in services" :key="service.id" class="p-6 hover:bg-sage-50 transition-colors">
                        <div class="flex justify-between items-start">
                            <div class="flex space-x-4 flex-1">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center text-xs text-gray-500 space-x-4">
                                        ...
                                        <span v-if="service.updated_at !== service.created_at">Diperbarui: {{
                                            formatDate(service.updated_at) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center space-x-2 ml-4">
                                <a :href="getEditRoute(service.id)"
                                ...
                                <button @click="toggleServiceStatus(service)" class="p-2 rounded transition-colors"
                                    :class="service.is_active
                                            ? 'text-orange-600 hover:text-orange-800'
                                            : 'text-green-600 hover:text-green-800'
                                        " :title="service.is_active ? 'Nonaktifkan' : 'Aktifkan'">
                                    <svg v-if="service.is_active" class="w-4 h-4" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button @click="confirmDelete(service)"
                                    class="text-red-600 hover:text-red-800 p-2 rounded transition-colors" title="Hapus">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
