                        ...
                        <!-- <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div v-if="settings?.company_logo" class="relative">
                                    <img :src="`/storage/${settings.company_logo}`" alt="Company Logo"
                                        class="w-32 h-20 object-contain rounded border" />
                                </div>
                                <div>
                                    <input type="file" @change="handleFileUpload($event, 'company_logo')"
                                        accept="image/*"
                                        class="block text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-sage-50 file:text-sage-700 hover:file:bg-sage-100" />
                                    <p class="text-xs text-gray-500 mt-1">
                                        Maksimal 5MB (JPEG, PNG, JPG, GIF, SVG)
                                    </p>
                                </div>
                            </div>
                        </div> -->
