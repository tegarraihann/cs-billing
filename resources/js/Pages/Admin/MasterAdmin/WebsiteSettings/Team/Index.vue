                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        <div v-for="member in teamMembers" :key="member.id"
                            ...
                            <div class="mx-auto w-24 h-24 rounded-full overflow-hidden bg-gray-200 mb-4">
                                <img v-if="member.photo_path" :src="`/storage/${member.photo_path}`" :alt="member.name"
                            ...
                            <div class="flex justify-center space-x-2">
                                ...
                                <button @click="toggleMemberStatus(member)" class="p-2 rounded transition-colors"
                                    :class="member.is_active
                                        ? 'text-orange-600 hover:text-orange-800'
                                        : 'text-green-600 hover:text-green-800'
                                        " :title="member.is_active ? 'Nonaktifkan' : 'Aktifkan'">
                                    <svg v-if="member.is_active" class="w-4 h-4" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
