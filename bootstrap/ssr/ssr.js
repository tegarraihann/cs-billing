...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-zRelIFZo.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-L7fzx6Ph.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-DRi5UVTK.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-BUSE5Enx.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-BOn41g0a.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-giyvWrLQ.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-B_iHtVgR.js"), "./Pages/HomePage.vue": () => import("./assets/HomePage-CPx9gnyw.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-DP2r3h5l.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-JErP_Yl2.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-62Fx1gq2.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-BlqLV5MH.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-DMaBece4.js"), "./Pages/masteradmin/FooterSection.vue": () => import("./assets/FooterSection-CxTVLidt.js"), "./Pages/masteradmin/Herosection.vue": () => import("./assets/Herosection-CHjcZnnp.js"), "./Pages/masteradmin/Sidebar.vue": () => import("./assets/Sidebar-BeHCjdq8.js") })
    ),
