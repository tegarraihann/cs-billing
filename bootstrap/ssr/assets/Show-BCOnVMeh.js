...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const revenuesOther = computed(() => {
      var _a, _b;
      return ((_b = (_a = props.reportData) == null ? void 0 : _a.revenues) == null ? void 0 : _b.other) ?? [];
    });
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="py-6" data-v-1e593df4${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-1e593df4${_scopeId}><div class="mb-6" data-v-1e593df4${_scopeId}>`);
            ...
            _push2(`<div class="flex justify-between items-start" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(__props.period.period_name)}</h1><p class="mt-1 text-sm text-gray-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatDate(__props.period.start_date))} - ${ssrInterpolate(formatDate(__props.period.end_date))} <span class="mx-2" data-v-1e593df4${_scopeId}>•</span><span class="${ssrRenderClass([getStatusBadge(__props.period.status), "inline-flex px-2 py-1 text-xs font-semibold rounded-full"])}" data-v-1e593df4${_scopeId}>${ssrInterpolate(getStatusText(__props.period.status))}</span></p></div><div class="flex space-x-3" data-v-1e593df4${_scopeId}><button${ssrIncludeBooleanAttr(isExporting.value) ? " disabled" : ""} class="${ssrRenderClass([
            ...
            if (__props.period.status !== "closed") {
              _push2(`<button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-500" data-v-1e593df4${_scopeId}>`);
            ...
            if (__props.period.status !== "closed") {
              _push2(`<button${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} class="inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-700 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition ease-in-out duration-150" data-v-1e593df4${_scopeId}>`);
              _push2(ssrRenderComponent(unref(CheckCircle), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` Tutup Periode </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8" data-v-1e593df4${_scopeId}><!--[-->`);
            ssrRenderList(summaryCards.value, (card) => {
              _push2(`<div class="rounded-lg border border-gray-200 bg-white shadow-sm p-4" data-v-1e593df4${_scopeId}><div class="text-xs font-semibold text-gray-500 uppercase tracking-wide" data-v-1e593df4${_scopeId}>${ssrInterpolate(card.title)}</div><div class="${ssrRenderClass([card.tone, "mt-2 text-lg font-bold"])}" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(card.value))}</div>`);
              if (card.subtitle) {
                _push2(`<div class="text-xs text-gray-500 mt-1" data-v-1e593df4${_scopeId}>${ssrInterpolate(card.subtitle)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-8" data-v-1e593df4${_scopeId}><div class="lg:col-span-2 space-y-8" data-v-1e593df4${_scopeId}><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-1e593df4${_scopeId}><div class="px-4 py-5 sm:px-6 border-b border-gray-200" data-v-1e593df4${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-1e593df4${_scopeId}>PENDAPATAN</h3></div><div class="px-4 py-5 sm:p-6" data-v-1e593df4${_scopeId}><div class="space-y-4" data-v-1e593df4${_scopeId}>`);
            if (revenuesMain.value.length > 0) {
              _push2(`<div data-v-1e593df4${_scopeId}><h4 class="text-sm font-medium text-gray-700 mb-2" data-v-1e593df4${_scopeId}>Pendapatan Utama</h4><div class="space-y-2" data-v-1e593df4${_scopeId}><!--[-->`);
              ssrRenderList(revenuesMain.value, (entry) => {
                _push2(`<div class="flex justify-between items-center py-2 border-b border-gray-100" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.account.account_name)}</div><div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.description)}</div></div><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (revenuesOther.value.length > 0) {
              _push2(`<div data-v-1e593df4${_scopeId}><h4 class="text-sm font-medium text-gray-700 mb-3" data-v-1e593df4${_scopeId}>Pendapatan Lain-lain</h4>`);
              if (__props.reportData.revenues.other_income_breakdown.bunga_mandiri.total > 0) {
                _push2(`<div class="mb-4" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center py-2 bg-blue-50 px-3 rounded" data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-blue-900" data-v-1e593df4${_scopeId}>Pendapatan Lain-lain (Bunga Bank Mandiri)</div><div class="text-sm font-semibold text-blue-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.other_income_breakdown.bunga_mandiri.total))}</div></div><div class="ml-4 mt-2 space-y-1" data-v-1e593df4${_scopeId}><!--[-->`);
                ssrRenderList(__props.reportData.revenues.other_income_breakdown.bunga_mandiri.entries, (entry) => {
                  _push2(`<div class="flex justify-between items-center py-1 text-xs" data-v-1e593df4${_scopeId}><div class="text-gray-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.description)}</div><div class="text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              if (__props.reportData.revenues.other_income_breakdown.bunga_bca.total > 0) {
                _push2(`<div class="mb-4" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center py-2 bg-green-50 px-3 rounded" data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-green-900" data-v-1e593df4${_scopeId}>Pendapatan Lain-lain (Bunga Bank BCA)</div><div class="text-sm font-semibold text-green-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.other_income_breakdown.bunga_bca.total))}</div></div><div class="ml-4 mt-2 space-y-1" data-v-1e593df4${_scopeId}><!--[-->`);
              ...
              if (__props.reportData.revenues.other_income_breakdown.lainnya.total > 0) {
                _push2(`<div class="mb-4" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center py-2 bg-purple-50 px-3 rounded" data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-purple-900" data-v-1e593df4${_scopeId}>Pendapatan Lain-lain (Lainnya)</div><div class="text-sm font-semibold text-purple-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.other_income_breakdown.lainnya.total))}</div></div><div class="ml-4 mt-2 space-y-1" data-v-1e593df4${_scopeId}><!--[-->`);
            ...
            _push2(`<div class="pt-4 border-t border-gray-200" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><div class="text-base font-semibold text-gray-900" data-v-1e593df4${_scopeId}>TOTAL PENDAPATAN</div><div class="text-base font-semibold text-green-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.total))}</div></div></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-1e593df4${_scopeId}><div class="px-4 py-5 sm:px-6 border-b border-gray-200" data-v-1e593df4${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-1e593df4${_scopeId}>BEBAN</h3></div><div class="px-4 py-5 sm:p-6" data-v-1e593df4${_scopeId}><div class="space-y-6" data-v-1e593df4${_scopeId}>`);
            if (__props.reportData.expenses.salary.length > 0) {
              _push2(`<div data-v-1e593df4${_scopeId}><h4 class="text-sm font-medium text-gray-700 mb-2" data-v-1e593df4${_scopeId}>Beban Gaji Karyawan</h4><div class="space-y-2" data-v-1e593df4${_scopeId}><!--[-->`);
              ssrRenderList(__props.reportData.expenses.salary, (entry) => {
                _push2(`<div class="flex justify-between items-center py-2 border-b border-gray-100" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.description)}</div><div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatDate(entry.transaction_date))}</div></div><div class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (operationalCategories.value.length > 0) {
              _push2(`<div class="space-y-3" data-v-1e593df4${_scopeId}><div class="flex items-center justify-between" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>Beban Operasional</div><div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(operationalCategories.value.length)} kategori · ${ssrInterpolate(formatCurrency(operationalExpensesTotal.value))}</div></div><button type="button" class="text-sm text-gray-500 hover:text-gray-700 flex items-center" data-v-1e593df4${_scopeId}>${ssrInterpolate(showOperationalDetails.value ? "Tutup" : "Detail")} `);
              ...
              if (showOperationalDetails.value) {
                _push2(`<div class="space-y-3" data-v-1e593df4${_scopeId}><!--[-->`);
                ssrRenderList(operationalCategories.value, (category) => {
                  _push2(`<div class="border border-gray-200 rounded-lg" data-v-1e593df4${_scopeId}><div class="px-4 py-3 bg-gray-50 flex justify-between items-center" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(category.category_name || "Kategori Lainnya")}</div><div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(category.entries.length)} transaksi </div></div><div class="text-sm font-semibold text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(category.total))}</div></div><div class="divide-y divide-gray-100" data-v-1e593df4${_scopeId}><!--[-->`);
                  ssrRenderList(category.entries, (entry) => {
                    _push2(`<div class="flex justify-between items-center px-4 py-3 bg-white" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.description)}</div>`);
                    if (entry.transaction_date) {
                      _push2(`<div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatDate(entry.transaction_date))}</div>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    _push2(`</div><div class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
                  });
                  _push2(`<!--]--></div></div>`);
                });
                _push2(`<!--]--></div>`);
            ...
            if (adminExpenses.value.length > 0) {
              _push2(`<div data-v-1e593df4${_scopeId}><h4 class="text-sm font-medium text-gray-700 mb-2" data-v-1e593df4${_scopeId}>Beban Administrasi</h4><div class="space-y-2" data-v-1e593df4${_scopeId}><!--[-->`);
              ssrRenderList(adminExpenses.value, (entry) => {
                _push2(`<div class="flex justify-between items-center py-2 border-b border-gray-100" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.account.account_name)}</div><div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.description)}</div></div><div class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (otherExpenses.value.length > 0) {
              _push2(`<div data-v-1e593df4${_scopeId}><h4 class="text-sm font-medium text-gray-700 mb-2" data-v-1e593df4${_scopeId}>Beban Lainnya</h4><div class="space-y-2" data-v-1e593df4${_scopeId}><!--[-->`);
              ssrRenderList(otherExpenses.value, (entry) => {
                _push2(`<div class="flex justify-between items-center py-2 border-b border-gray-100" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.account.account_name)}</div><div class="text-xs text-gray-500" data-v-1e593df4${_scopeId}>${ssrInterpolate(entry.description)}</div></div><div class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
              });
              _push2(`<!--]--></div></div>`);
            } else {
            ...
            _push2(`<div class="pt-4 border-t border-gray-200" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><div class="text-base font-semibold text-gray-900" data-v-1e593df4${_scopeId}>TOTAL BEBAN</div><div class="text-base font-semibold text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.expenses.total))}</div></div></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-1e593df4${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center py-4 border-t-2 border-gray-300" data-v-1e593df4${_scopeId}><div class="text-xl font-bold text-gray-900" data-v-1e593df4${_scopeId}>LABA (RUGI) BERSIH</div><div class="${ssrRenderClass(__props.reportData.net_profit >= 0 ? "text-xl font-bold text-green-600" : "text-xl font-bold text-red-600")}" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.net_profit))}</div></div></div></div></div><div class="space-y-6" data-v-1e593df4${_scopeId}><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-1e593df4${_scopeId}><div class="px-4 py-5 sm:px-6 border-b border-gray-200" data-v-1e593df4${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-1e593df4${_scopeId}>Ringkasan</h3></div><div class="px-4 py-5 sm:p-6 space-y-4" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-sm text-gray-500" data-v-1e593df4${_scopeId}>Periode</span><span class="text-sm font-medium text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(__props.period.period_type)}</span></div><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-sm text-gray-500" data-v-1e593df4${_scopeId}>Total Pendapatan</span><span class="text-sm font-medium text-green-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.period.total_revenue))}</span></div><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-sm text-gray-500" data-v-1e593df4${_scopeId}>Beban Gaji</span><span class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(((_a = __props.reportData.summary) == null ? void 0 : _a.total_salary_expense) || 0))}</span></div><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-sm text-gray-500" data-v-1e593df4${_scopeId}>Beban Operasional</span><span class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(((_b = __props.reportData.summary) == null ? void 0 : _b.total_operational_expense) || 0))}</span></div><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-sm text-gray-500" data-v-1e593df4${_scopeId}>Beban Admin</span><span class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(((_c = __props.reportData.summary) == null ? void 0 : _c.total_admin_expense) || 0))}</span></div><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-sm text-gray-500" data-v-1e593df4${_scopeId}>Beban Lainnya</span><span class="text-sm font-medium text-red-600" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(((_d = __props.reportData.summary) == null ? void 0 : _d.total_other_expense) || 0))}</span></div><div class="border-t border-gray-200 pt-4" data-v-1e593df4${_scopeId}><div class="flex justify-between items-center" data-v-1e593df4${_scopeId}><span class="text-base font-semibold text-gray-900" data-v-1e593df4${_scopeId}>Laba Bersih</span><span class="${ssrRenderClass(__props.period.net_profit >= 0 ? "text-base font-semibold text-green-600" : "text-base font-semibold text-red-600")}" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatCurrency(__props.period.net_profit))}</span></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-1e593df4${_scopeId}><div class="px-4 py-5 sm:px-6 border-b border-gray-200" data-v-1e593df4${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-1e593df4${_scopeId}>Informasi</h3></div><div class="px-4 py-5 sm:p-6 space-y-3" data-v-1e593df4${_scopeId}><div data-v-1e593df4${_scopeId}><dt class="text-sm font-medium text-gray-500" data-v-1e593df4${_scopeId}>Dibuat oleh</dt><dd class="mt-1 text-sm text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(__props.period.creator.name)}</dd></div><div data-v-1e593df4${_scopeId}><dt class="text-sm font-medium text-gray-500" data-v-1e593df4${_scopeId}>Tanggal dibuat</dt><dd class="mt-1 text-sm text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatDateTime(__props.period.created_at))}</dd></div>`);
            if (__props.period.approved_by) {
              _push2(`<div data-v-1e593df4${_scopeId}><dt class="text-sm font-medium text-gray-500" data-v-1e593df4${_scopeId}>Disetujui oleh</dt><dd class="mt-1 text-sm text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(__props.period.approver.name)}</dd></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.period.approved_at) {
              _push2(`<div data-v-1e593df4${_scopeId}><dt class="text-sm font-medium text-gray-500" data-v-1e593df4${_scopeId}>Tanggal disetujui</dt><dd class="mt-1 text-sm text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(formatDateTime(__props.period.approved_at))}</dd></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.period.notes) {
              _push2(`<div data-v-1e593df4${_scopeId}><dt class="text-sm font-medium text-gray-500" data-v-1e593df4${_scopeId}>Catatan</dt><dd class="mt-1 text-sm text-gray-900" data-v-1e593df4${_scopeId}>${ssrInterpolate(__props.period.notes)}</dd></div>`);
            } else {
              _push2(`<!---->`);
            }
                      ...
                      createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg" }, [
                        ...
                        createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                          createVNode("div", { class: "space-y-4" }, [
                            revenuesMain.value.length > 0 ? (openBlock(), createBlock("div", { key: 0 }, [
                              createVNode("h4", { class: "text-sm font-medium text-gray-700 mb-2" }, "Pendapatan Utama"),
                              createVNode("div", { class: "space-y-2" }, [
                                (openBlock(true), createBlock(Fragment, null, renderList(revenuesMain.value, (entry) => {
                                  return openBlock(), createBlock("div", {
                                    key: entry.id,
                            ...
                            revenuesOther.value.length > 0 ? (openBlock(), createBlock("div", { key: 1 }, [
                      ...
                      createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg" }, [
                        ...
                        createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                          createVNode("div", { class: "space-y-6" }, [
                            ...
                            adminExpenses.value.length > 0 ? (openBlock(), createBlock("div", { key: 2 }, [
                              createVNode("h4", { class: "text-sm font-medium text-gray-700 mb-2" }, "Beban Administrasi"),
                              createVNode("div", { class: "space-y-2" }, [
                                (openBlock(true), createBlock(Fragment, null, renderList(adminExpenses.value, (entry) => {
                                  return openBlock(), createBlock("div", {
                                    key: entry.id,
                                    class: "flex justify-between items-center py-2 border-b border-gray-100"
                                  }, [
                            ...
                            otherExpenses.value.length > 0 ? (openBlock(), createBlock("div", { key: 3 }, [
                              createVNode("h4", { class: "text-sm font-medium text-gray-700 mb-2" }, "Beban Lainnya"),
                              createVNode("div", { class: "space-y-2" }, [
                                (openBlock(true), createBlock(Fragment, null, renderList(otherExpenses.value, (entry) => {
                                  return openBlock(), createBlock("div", {
                                    key: entry.id,
                                    class: "flex justify-between items-center py-2 border-b border-gray-100"
                                  }, [
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e593df4"]]);
export {
  Show as default
};
