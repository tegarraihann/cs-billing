    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Edit Income Statement Period" }, null, _parent2, _scopeId));
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="mb-6"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.profit-loss.show", { profitLoss: __props.period.id, ...__props.returnQuery }),
            ...
            _push2(`</div><div${_scopeId}><label for="period_type" class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Period Type </label><select id="period_type" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 bg-gray-50 text-gray-500 cursor-not-allowed" disabled${_scopeId}><option value="monthly"${ssrIncludeBooleanAttr(Array.isArray(__props.period.period_type) ? ssrLooseContain(__props.period.period_type, "monthly") : ssrLooseEqual(__props.period.period_type, "monthly")) ? " selected" : ""}${_scopeId}>Monthly</option><option value="quarterly"${ssrIncludeBooleanAttr(Array.isArray(__props.period.period_type) ? ssrLooseContain(__props.period.period_type, "quarterly") : ssrLooseEqual(__props.period.period_type, "quarterly")) ? " selected" : ""}${_scopeId}>Quarterly</option><option value="yearly"${ssrIncludeBooleanAttr(Array.isArray(__props.period.period_type) ? ssrLooseContain(__props.period.period_type, "yearly") : ssrLooseEqual(__props.period.period_type, "yearly")) ? " selected" : ""}${_scopeId}>Yearly</option></select><p class="mt-1 text-sm text-gray-500"${_scopeId}> The period type cannot be changed after creation. </p></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}><div${_scopeId}><label for="start_date" class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Start Date <span class="text-red-500"${_scopeId}>*</span></label><input id="start_date"${ssrRenderAttr("value", unref(form).start_date)} type="date" class="${ssrRenderClass([{ "border-red-300 focus:border-red-500 focus:ring-red-500": __props.errors.start_date }, "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm"])}"${_scopeId}>`);
            ...
            _push2(`</div></div><div${_scopeId}><label for="notes" class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Notes </label><textarea id="notes" rows="3" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm" placeholder="Additional notes for this period..."${_scopeId}>${ssrInterpolate(unref(form).notes)}</textarea></div><div class="bg-blue-50 border border-blue-200 rounded-md p-4"${_scopeId}><h3 class="text-sm font-medium text-blue-900 mb-2"${_scopeId}>Period Information</h3><div class="text-sm text-blue-700 space-y-1"${_scopeId}><p${_scopeId}><strong${_scopeId}>Period Code:</strong> ${ssrInterpolate(__props.period.period_code)}</p><p${_scopeId}><strong${_scopeId}>Status:</strong><span class="${ssrRenderClass([{
              "bg-yellow-100 text-yellow-800": __props.period.status === "draft",
              "bg-green-100 text-green-800": __props.period.status === "closed"
            }, "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}"${_scopeId}>${ssrInterpolate(__props.period.status === "draft" ? "Draft" : "Closed")}</span></p><p${_scopeId}><strong${_scopeId}>Created:</strong> ${ssrInterpolate(formatDate(__props.period.created_at))}</p>`);
            if (__props.period.approved_at) {
              _push2(`<p${_scopeId}><strong${_scopeId}>Approved:</strong> ${ssrInterpolate(formatDate(__props.period.approved_at))}</p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Saving..." : "Save Changes")}</button></div></form></div></div><div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-md p-4"${_scopeId}><div class="flex"${_scopeId}><div class="flex-shrink-0"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(AlertTriangle), { class: "h-5 w-5 text-yellow-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-3"${_scopeId}><h3 class="text-sm font-medium text-yellow-800"${_scopeId}>Warning</h3><div class="mt-2 text-sm text-yellow-700"${_scopeId}><ul class="list-disc list-inside space-y-1"${_scopeId}><li${_scopeId}>Changing the period dates affects the data imported automatically.</li><li${_scopeId}>After saving, you may need to regenerate entries to refresh the automatic data.</li><li${_scopeId}>Closed periods cannot be edited.</li></ul></div></div></div></div></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Edit Income Statement Period" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Edit Income Statement Period"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Update period " + toDisplayString(__props.period.period_name), 1)
                  ]),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "grid grid-cols-1 gap-6" }, [
                          ...
                          createVNode("div", null, [
                            ...
                            createVNode("p", { class: "mt-1 text-sm text-gray-500" }, " The period type cannot be changed after creation. ")
                          ]),
                          ...
                          createVNode("div", { class: "bg-blue-50 border border-blue-200 rounded-md p-4" }, [
                            createVNode("h3", { class: "text-sm font-medium text-blue-900 mb-2" }, "Period Information"),
                            createVNode("div", { class: "text-sm text-blue-700 space-y-1" }, [
                              createVNode("p", null, [
                                createVNode("strong", null, "Period Code:"),
                              ...
                              createVNode("p", null, [
                                ...
                                }, toDisplayString(__props.period.status === "draft" ? "Draft" : "Closed"), 3)
                              ]),
                              createVNode("p", null, [
                      ...
                      createVNode("div", { class: "ml-3" }, [
                        ...
                        createVNode("div", { class: "mt-2 text-sm text-yellow-700" }, [
                          createVNode("ul", { class: "list-disc list-inside space-y-1" }, [
                            createVNode("li", null, "Changing the period dates affects the data imported automatically."),
                            createVNode("li", null, "After saving, you may need to regenerate entries to refresh the automatic data."),
                            createVNode("li", null, "Closed periods cannot be edited.")
                          ])
                        ])
                      ])
                    ])
