import { ref, reactive, onMounted, onBeforeUnmount, computed, watch, withCtx, unref, createVNode, createBlock, createCommentVNode, toDisplayString, createTextVNode, openBlock, Fragment, renderList, withModifiers, withDirectives, vModelSelect, vModelText, useSSRContext } from "vue";
                                    ...
                                    isActionMenuOpen(component.id) ? (openBlock(), createBlock("div", {
                                      ...
                                      createVNode("div", { class: "py-1" }, [
                                        ...
                                        createVNode("button", {
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed",
                                          disabled: !canPostPph23Receivable.value || postingPph23.value || Math.abs(pph23Rate.value - 0.5) > 0.01,
                                          onClick: ($event) => handleAction(() => postPph23Receivable(0.5), !canPostPph23Receivable.value || postingPph23.value || Math.abs(pph23Rate.value - 0.5) > 0.01)
                                        }, " Post VAT Receivable PPh23 0.5% ", 8, ["disabled", "onClick"]),
                                        createVNode("button", {
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed",
                                          disabled: !canPostPph23Receivable.value || postingPph23.value || Math.abs(pph23Rate.value - 2) > 0.01,
                                          onClick: ($event) => handleAction(() => postPph23Receivable(2), !canPostPph23Receivable.value || postingPph23.value || Math.abs(pph23Rate.value - 2) > 0.01)
