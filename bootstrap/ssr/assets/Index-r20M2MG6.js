...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentOpeningPaginationQuery = computed(() => {
      var _a, _b;
      return {
        source: "opening-receivables",
        main_page: ((_a = props.receivablesMain) == null ? void 0 : _a.current_page) || 1,
        reim_page: ((_b = props.receivablesReimbursement) == null ? void 0 : _b.current_page) || 1
      };
    });
    ...
    const buildReceivableDetailUrl = (receivableId) => {
      return buildUrlWithQuery(
        `/admin-keuangan/account-receivables/${receivableId}`,
            ...
            ssrRenderList(sections.value, (section) => {
              ...
              if (section.data && section.data.data && section.data.data.length) {
                ...
                ssrRenderList(section.data.data, (receivable) => {
                  ...
                  _push2(ssrRenderComponent(unref(Link), {
                    href: buildReceivableDetailUrl(receivable.id),
