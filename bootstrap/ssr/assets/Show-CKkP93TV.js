      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (canPostVat.value) {
              _push2(`<button class="inline-flex items-center justify-center px-4 py-2 min-w-[170px] bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-amber-700 focus:bg-amber-700 active:bg-amber-900 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition ease-in-out duration-150"${ssrIncludeBooleanAttr(postingVat11.value) ? " disabled" : ""}${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileText), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(postingVat11.value ? "Posting..." : "Post VAT Payable 11%")}</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (canPostVat.value) {
              _push2(`<button class="inline-flex items-center justify-center px-4 py-2 min-w-[170px] bg-orange-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-orange-700 focus:bg-orange-700 active:bg-orange-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150"${ssrIncludeBooleanAttr(postingVat11_1.value) ? " disabled" : ""}${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileText), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(postingVat11_1.value ? "Posting..." : "Post VAT Payable 1.1%")}</button>`);
            } else {
              _push2(`<!---->`);
            }
                  ...
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    ...
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      ...
                      canPostVat.value ? (openBlock(), createBlock("button", {
                        ...
                        disabled: postingVat11.value
                      }, [
                        createVNode(unref(FileText), { class: "w-4 h-4 mr-2" }),
                        createTextVNode(" " + toDisplayString(postingVat11.value ? "Posting..." : "Post VAT Payable 11%"), 1)
                      ...
                      canPostVat.value ? (openBlock(), createBlock("button", {
                        ...
                        disabled: postingVat11_1.value
                      }, [
                        createVNode(unref(FileText), { class: "w-4 h-4 mr-2" }),
                        createTextVNode(" " + toDisplayString(postingVat11_1.value ? "Posting..." : "Post VAT Payable 1.1%"), 1)
                      ], 8, ["disabled"])) : createCommentVNode("", true),
                      createVNode("button", {
