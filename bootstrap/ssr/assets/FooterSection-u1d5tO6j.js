...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-b931c2e9><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-b931c2e9><div class="text-center mb-16 lg:mb-24" data-v-b931c2e9><div class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm border border-white/30 text-white rounded-full text-sm font-semibold mb-6" data-v-b931c2e9><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b931c2e9><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" data-v-b931c2e9></path></svg> Contact Our Professional Team </div><h2 id="contact-heading" class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 font-inter" data-v-b931c2e9> Let&#39;s Discuss Your Needs </h2><p class="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed font-jost" data-v-b931c2e9> Our team of experts is ready to help provide the best logistics solutions for your business with 24/7 service. </p></div><div class="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-start" data-v-b931c2e9><div class="bg-white/10 backdrop-blur-md rounded-3xl p-8 md:p-10 lg:p-12 shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300" data-v-b931c2e9><h3 class="text-xl md:text-2xl font-bold text-white mb-4 md:mb-6 lg:mb-8 font-inter" id="contact-form-heading" data-v-b931c2e9> Send Your Message </h3><form class="space-y-4 md:space-y-6" aria-labelledby="contact-form-heading" novalidate data-v-b931c2e9><div class="grid md:grid-cols-2 gap-4 md:gap-6" data-v-b931c2e9><div data-v-b931c2e9><label for="contact-name" class="block text-xs md:text-sm font-semibold text-white/90 mb-2 md:mb-3 font-jost" data-v-b931c2e9>Full Name *</label><input id="contact-name"${ssrRenderAttr("value", form.name)} type="text" required class="${ssrRenderClass([
      ...
      ])}" placeholder="Enter full name"${ssrRenderAttr("aria-invalid", !!formErrors.name)}${ssrRenderAttr("aria-describedby", formErrors.name ? "name-error" : void 0)} data-v-b931c2e9>`);
      if (formErrors.name) {
        _push(`<p id="name-error" class="text-red-300 text-xs mt-1 font-jost" role="alert" data-v-b931c2e9>${ssrInterpolate(formErrors.name)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div data-v-b931c2e9><label for="contact-email" class="block text-xs md:text-sm font-semibold text-white/90 mb-2 md:mb-3 font-jost" data-v-b931c2e9>Email *</label><input id="contact-email"${ssrRenderAttr("value", form.email)} type="email" required class="${ssrRenderClass([
        "w-full px-3 md:px-4 py-3 md:py-4 bg-white/20 border rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 backdrop-blur-sm text-sm",
      ...
      if (formErrors.email) {
        _push(`<p id="email-error" class="text-red-300 text-xs mt-1 font-jost" role="alert" data-v-b931c2e9>${ssrInterpolate(formErrors.email)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="grid md:grid-cols-2 gap-4 md:gap-6" data-v-b931c2e9><div data-v-b931c2e9><label for="contact-phone" class="block text-xs md:text-sm font-semibold text-white/90 mb-2 md:mb-3 font-jost" data-v-b931c2e9>Mobile Phone *</label><input id="contact-phone"${ssrRenderAttr("value", form.phone)} type="tel" required class="${ssrRenderClass([
        "w-full px-3 md:px-4 py-3 md:py-4 bg-white/20 border rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 backdrop-blur-sm text-sm",
      ...
      if (formErrors.phone) {
        _push(`<p id="phone-error" class="text-red-300 text-xs mt-1 font-jost" role="alert" data-v-b931c2e9>${ssrInterpolate(formErrors.phone)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div data-v-b931c2e9><label for="contact-service" class="block text-xs md:text-sm font-semibold text-white/90 mb-2 md:mb-3 font-jost" data-v-b931c2e9>Services</label><select id="contact-service" class="w-full px-4 py-4 bg-white/20 border border-white/30 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-all duration-300 backdrop-blur-sm text-sm" aria-label="Select a service" data-v-b931c2e9><option value="" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "") : ssrLooseEqual(form.service, "")) ? " selected" : ""}>Choose Service</option><option value="export-import" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "export-import") : ssrLooseEqual(form.service, "export-import")) ? " selected" : ""}> Export/Import </option><option value="trucking" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "trucking") : ssrLooseEqual(form.service, "trucking")) ? " selected" : ""}> Trucking Inland </option><option value="money-transfer" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "money-transfer") : ssrLooseEqual(form.service, "money-transfer")) ? " selected" : ""}> Transfer Uang </option><option value="insurance" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "insurance") : ssrLooseEqual(form.service, "insurance")) ? " selected" : ""}> Asuransi Barang </option><option value="warehousing" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "warehousing") : ssrLooseEqual(form.service, "warehousing")) ? " selected" : ""}> Warehousing </option><option value="consulting" class="text-gray-900" data-v-b931c2e9${ssrIncludeBooleanAttr(Array.isArray(form.service) ? ssrLooseContain(form.service, "consulting") : ssrLooseEqual(form.service, "consulting")) ? " selected" : ""}> Consulting </option></select></div></div><div data-v-b931c2e9><label for="contact-message" class="block text-xs md:text-sm font-semibold text-white/90 mb-2 md:mb-3 font-jost" data-v-b931c2e9>Your Message *</label><textarea id="contact-message" required rows="5" class="${ssrRenderClass([
      ...
      )} data-v-b931c2e9>${ssrInterpolate(form.message)}</textarea>`);
      if (formErrors.message) {
        _push(`<p id="message-error" class="text-red-300 text-xs mt-1 font-jost" role="alert" data-v-b931c2e9>${ssrInterpolate(formErrors.message)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (submitStatus.value === "success") {
        _push(`<div class="mb-4 p-3 bg-green-500/20 border border-green-400/30 rounded-xl text-green-300 text-sm font-jost flex items-center" data-v-b931c2e9><svg class="w-5 h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b931c2e9><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" data-v-b931c2e9></path></svg> Your message has been sent successfully! Our team will contact you soon. </div>`);
      } else {
        _push(`<!---->`);
      }
      if (submitStatus.value === "error") {
        _push(`<div class="mb-4 p-3 bg-red-500/20 border border-red-400/30 rounded-xl text-red-300 text-sm font-jost flex items-center" data-v-b931c2e9><svg class="w-5 h-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b931c2e9><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-b931c2e9></path></svg> An error occurred. Please try again. </div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (!isSubmitting.value) {
        _push(`<span data-v-b931c2e9>Send Message</span>`);
      } else {
        _push(`<span class="flex items-center justify-center" data-v-b931c2e9><svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-sage-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" data-v-b931c2e9><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1" data-v-b931c2e9></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-b931c2e9></path></svg> Sending... </span>`);
      }
      _push(`</button></form></div><div class="space-y-6 md:space-y-8" role="complementary" aria-labelledby="contact-info-heading" data-v-b931c2e9><div class="grid gap-6" data-v-b931c2e9><h3 id="contact-info-heading" class="sr-only" data-v-b931c2e9> Contact Information </h3><!--[-->`);
      ssrRenderList(offices, (office) => {
        _push(`<div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300" data-v-b931c2e9><h4 class="text-base md:text-lg font-bold text-white mb-3 md:mb-4 font-inter" data-v-b931c2e9>${ssrInterpolate(office.name)}</h4><div class="space-y-2 md:space-y-3" data-v-b931c2e9><div class="flex items-start" data-v-b931c2e9><svg class="w-4 h-4 md:w-5 md:h-5 text-white/80 mt-0.5 mr-2 md:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b931c2e9><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" data-v-b931c2e9></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" data-v-b931c2e9></path></svg><span class="text-white/90 text-xs md:text-sm leading-relaxed font-jost" data-v-b931c2e9>${ssrInterpolate(office.address)}</span></div><div class="flex items-center" data-v-b931c2e9><svg class="w-4 h-4 md:w-5 md:h-5 text-white/80 mr-2 md:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b931c2e9><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" data-v-b931c2e9></path></svg><span class="text-white font-medium text-xs md:text-sm font-jost" data-v-b931c2e9>${ssrInterpolate(office.phone)}</span></div><div class="flex items-center" data-v-b931c2e9><svg class="w-4 h-4 md:w-5 md:h-5 text-white/80 mr-2 md:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b931c2e9><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" data-v-b931c2e9></path></svg><span class="text-white font-medium text-xs md:text-sm break-all font-jost" data-v-b931c2e9>${ssrInterpolate(office.email)}</span></div></div></div>`);
      });
      _push(`<!--]--></div><div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-6 border border-white/20" role="complementary" aria-labelledby="why-choose-us-heading" data-v-b931c2e9><h4 id="why-choose-us-heading" class="text-lg md:text-xl font-bold text-white mb-4 md:mb-6 font-inter" data-v-b931c2e9> Why Choose Us? </h4><div class="space-y-3 md:space-y-4" data-v-b931c2e9><!--[-->`);
      ssrRenderList(whyChooseUs, (reason) => {
        _push(`<div class="flex items-start group" data-v-b931c2e9><div class="w-2 h-2 bg-white rounded-full mt-2 mr-3 md:mr-4 group-hover:scale-125 transition-transform duration-300 flex-shrink-0" data-v-b931c2e9></div><div data-v-b931c2e9><h5 class="font-semibold text-white text-xs md:text-sm mb-1 font-jost" data-v-b931c2e9>${ssrInterpolate(reason.title)}</h5><p class="text-white/80 text-xs leading-relaxed font-jost" data-v-b931c2e9>${ssrInterpolate(reason.description)}</p></div></div>`);
      });
...
const ContactSection = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b931c2e9"]]);
const _sfc_main = {
