import { watch, mergeProps, useSSRContext, reactive, ref, computed, onMounted, onBeforeUnmount, withCtx, unref, createBlock, createCommentVNode, openBlock, createVNode, withDirectives, Fragment, renderList, toDisplayString, vModelSelect, vModelText, Teleport, Transition, createTextVNode, nextTick } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderClass, ssrRenderComponent, ssrRenderStyle, ssrRenderTeleport } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const summarizeComponents = (components) => {
      ...
      const labels = components.map((component) => componentDisplayName(component)).filter(Boolean);
      if (labels.length <= 2) {
        return labels.join(", ");
      }
    ...
    const resolveVendorName = (component = null) => {
      var _a, _b, _c;
      if (component == null ? void 0 : component.recipient_name) {
        return component.recipient_name;
      }
      if ((_b = (_a = selectedPayable.value) == null ? void 0 : _a.vendor) == null ? void 0 : _b.nama_vendor) {
        return selectedPayable.value.vendor.nama_vendor;
      }
      if ((_c = selectedPayable.value) == null ? void 0 : _c.vendor_name) {
    ...
    const availableComponents = computed(() => {
      var _a;
      return ((_a = selectedPayable.value) == null ? void 0 : _a.components) || [];
    });
    ...
    const updateReimbursementContext = async (component) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          paymentForm.reimbursement_items = items.filter((item) => item.status !== "paid").map((item) => item.id);
        } else {
          reimbursementItems.value = [];
          paymentForm.reimbursement_items = [];
        }
    ...
    const tableRows = computed(() => {
      ...
      return data.map((payable) => {
        var _a2;
        const vendorName = ((_a2 = payable.vendor) == null ? void 0 : _a2.nama_vendor) || payable.vendor_name;
        ...
        const serviceDescription = singleComponent ? singleComponent.description || payable.service_description || "" : payable.service_description || "";
        return {
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-6" data-v-10ea5fd4${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-10ea5fd4${_scopeId}><div class="flex justify-between items-center mb-6" data-v-10ea5fd4${_scopeId}><div data-v-10ea5fd4${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-10ea5fd4${_scopeId}>Manajemen Hutang</h1><p class="mt-1 text-sm text-gray-600" data-v-10ea5fd4${_scopeId}>Kelola hutang dan pembayaran vendor</p></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6" data-v-10ea5fd4${_scopeId}><div class="bg-white overflow-hidden shadow rounded-lg" data-v-10ea5fd4${_scopeId}><div class="p-5" data-v-10ea5fd4${_scopeId}><div class="flex items-center" data-v-10ea5fd4${_scopeId}><div class="flex-shrink-0" data-v-10ea5fd4${_scopeId}>`);
            _push2(ssrRenderComponent(unref(CreditCard), { class: "h-6 w-6 text-red-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-10ea5fd4${_scopeId}><dl data-v-10ea5fd4${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-10ea5fd4${_scopeId}>Total Outstanding</dt><dd class="text-lg font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(formatCurrency(__props.summary.total_outstanding))}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg" data-v-10ea5fd4${_scopeId}><div class="p-5" data-v-10ea5fd4${_scopeId}><div class="flex items-center" data-v-10ea5fd4${_scopeId}><div class="flex-shrink-0" data-v-10ea5fd4${_scopeId}>`);
            _push2(ssrRenderComponent(unref(AlertTriangle), { class: "h-6 w-6 text-orange-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-10ea5fd4${_scopeId}><dl data-v-10ea5fd4${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-10ea5fd4${_scopeId}>Total Overdue</dt><dd class="text-lg font-medium text-orange-600" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(formatCurrency(__props.summary.total_overdue))}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg" data-v-10ea5fd4${_scopeId}><div class="p-5" data-v-10ea5fd4${_scopeId}><div class="flex items-center" data-v-10ea5fd4${_scopeId}><div class="flex-shrink-0" data-v-10ea5fd4${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Users), { class: "h-6 w-6 text-yellow-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-10ea5fd4${_scopeId}><dl data-v-10ea5fd4${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-10ea5fd4${_scopeId}>Jumlah Overdue</dt><dd class="text-lg font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(__props.summary.count_overdue)}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg" data-v-10ea5fd4${_scopeId}><div class="p-5" data-v-10ea5fd4${_scopeId}><div class="flex items-center" data-v-10ea5fd4${_scopeId}><div class="flex-shrink-0" data-v-10ea5fd4${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Building2), { class: "h-6 w-6 text-blue-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-10ea5fd4${_scopeId}><dl data-v-10ea5fd4${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-10ea5fd4${_scopeId}>Unpaid Active</dt><dd class="text-lg font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(__props.summary.count_unpaid)}</dd></dl></div></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-10ea5fd4${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-10ea5fd4${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-10ea5fd4${_scopeId}>Filter Data</h3><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4" data-v-10ea5fd4${_scopeId}><div data-v-10ea5fd4${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-10ea5fd4${_scopeId}>Search</label><input${ssrRenderAttr("value", searchForm.search)} type="text" placeholder="Cari vendor atau service..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-10ea5fd4${_scopeId}></div><div data-v-10ea5fd4${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-10ea5fd4${_scopeId}>Status</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-10ea5fd4${_scopeId}><option value="" data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "") : ssrLooseEqual(searchForm.status, "")) ? " selected" : ""}${_scopeId}>Semua Status</option><option value="unpaid" data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "unpaid") : ssrLooseEqual(searchForm.status, "unpaid")) ? " selected" : ""}${_scopeId}>Unpaid</option><option value="partial" data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "partial") : ssrLooseEqual(searchForm.status, "partial")) ? " selected" : ""}${_scopeId}>Partial</option><option value="paid" data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "paid") : ssrLooseEqual(searchForm.status, "paid")) ? " selected" : ""}${_scopeId}>Paid</option></select></div><div data-v-10ea5fd4${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-10ea5fd4${_scopeId}>Vendor</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-10ea5fd4${_scopeId}><option value="" data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(searchForm.vendor_id) ? ssrLooseContain(searchForm.vendor_id, "") : ssrLooseEqual(searchForm.vendor_id, "")) ? " selected" : ""}${_scopeId}>Semua Vendor</option><!--[-->`);
            ssrRenderList(__props.vendors, (vendor) => {
              _push2(`<option${ssrRenderAttr("value", vendor.id)} data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(searchForm.vendor_id) ? ssrLooseContain(searchForm.vendor_id, vendor.id) : ssrLooseEqual(searchForm.vendor_id, vendor.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendor.nama_vendor)}</option>`);
            });
            _push2(`<!--]--></select></div><div data-v-10ea5fd4${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-10ea5fd4${_scopeId}>Dari Tanggal</label><input${ssrRenderAttr("value", searchForm.date_from)} type="date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-10ea5fd4${_scopeId}></div><div data-v-10ea5fd4${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-10ea5fd4${_scopeId}>Sampai Tanggal</label><input${ssrRenderAttr("value", searchForm.date_to)} type="date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-10ea5fd4${_scopeId}></div></div></div></div>`);
            if (vendorSummaryRows.value.length > 0) {
              _push2(`<div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-10ea5fd4${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-10ea5fd4${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-10ea5fd4${_scopeId}>Ringkasan per Vendor</h3><div class="overflow-x-auto" style="${ssrRenderStyle({ "overflow-x": "auto" })}" data-v-10ea5fd4${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-10ea5fd4${_scopeId}><thead class="bg-gray-50" data-v-10ea5fd4${_scopeId}><tr data-v-10ea5fd4${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}>Vendor</th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}>Total Amount</th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}>Total Paid</th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}>Total Outstanding</th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}>Jumlah Invoice</th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}>Overdue</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-10ea5fd4${_scopeId}><!--[-->`);
              ssrRenderList(vendorSummaryRows.value, (vendor) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-10ea5fd4${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-10ea5fd4${_scopeId}><div class="inline-flex items-center space-x-1 text-sm font-medium text-gray-900 cursor-pointer select-none" data-vendor-popover-trigger="true"${ssrRenderAttr("data-vendor-popover-trigger-key", vendor.key)} tabindex="0" data-v-10ea5fd4${_scopeId}><span data-v-10ea5fd4${_scopeId}>${ssrInterpolate(vendor.vendor_name)}</span><svg class="w-4 h-4 text-sage-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10ea5fd4${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M12 18a6 6 0 100-12 6 6 0 000 12z" data-v-10ea5fd4${_scopeId}></path></svg></div></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-10ea5fd4${_scopeId}> Rp ${ssrInterpolate(formatNumber(vendor.total_amount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-green-600" data-v-10ea5fd4${_scopeId}> Rp ${ssrInterpolate(formatNumber(vendor.total_paid))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" data-v-10ea5fd4${_scopeId}><span class="${ssrRenderClass(vendor.total_outstanding > 0 ? "text-red-600" : "text-green-600")}" data-v-10ea5fd4${_scopeId}> Rp ${ssrInterpolate(formatNumber(vendor.total_outstanding))}</span></td><td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(vendor.count_invoices)}</td><td class="px-6 py-4 whitespace-nowrap text-center text-sm" data-v-10ea5fd4${_scopeId}>`);
                if (vendor.count_overdue > 0) {
                  _push2(`<span class="text-red-600 font-medium" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(vendor.count_overdue)}</span>`);
                } else {
                  _push2(`<span class="text-gray-400" data-v-10ea5fd4${_scopeId}>0</span>`);
                }
                _push2(`</td></tr>`);
              });
              ...
              ssrRenderTeleport(_push2, (_push3) => {
                if (activeVendorPopover.value) {
                  _push3(`<div class="absolute z-50 w-72 rounded-lg border border-sage-200 bg-white shadow-xl p-4" style="${ssrRenderStyle({ top: popoverPosition.top + "px", left: popoverPosition.left + "px", transform: "translateX(-50%)" })}" data-v-10ea5fd4${_scopeId}><div class="flex items-start justify-between" data-v-10ea5fd4${_scopeId}><div data-v-10ea5fd4${_scopeId}><h4 class="text-sm font-semibold text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(activeVendorPopover.value.vendor_name)}</h4><p class="text-xs text-gray-500" data-v-10ea5fd4${_scopeId}> Summary for outstanding payables </p></div><span class="${ssrRenderClass([activeVendorPopover.value.total_outstanding > 0 ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700", "px-2 py-0.5 text-xs font-medium rounded-full"])}" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(activeVendorPopover.value.total_outstanding > 0 ? "Outstanding" : "Cleared")}</span></div><div class="mt-3 space-y-2 text-sm" data-v-10ea5fd4${_scopeId}><div class="flex justify-between" data-v-10ea5fd4${_scopeId}><span class="text-gray-600" data-v-10ea5fd4${_scopeId}>Total Amount</span><span class="font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(formatCurrency(activeVendorPopover.value.total_amount))}</span></div><div class="flex justify-between" data-v-10ea5fd4${_scopeId}><span class="text-gray-600" data-v-10ea5fd4${_scopeId}>Total Paid</span><span class="font-medium text-green-600" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(formatCurrency(activeVendorPopover.value.total_paid))}</span></div><div class="flex justify-between" data-v-10ea5fd4${_scopeId}><span class="text-gray-600" data-v-10ea5fd4${_scopeId}>Outstanding</span><span class="${ssrRenderClass(activeVendorPopover.value.total_outstanding > 0 ? "font-medium text-red-600" : "font-medium text-green-600")}" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(formatCurrency(activeVendorPopover.value.total_outstanding))}</span></div><div class="flex justify-between" data-v-10ea5fd4${_scopeId}><span class="text-gray-600" data-v-10ea5fd4${_scopeId}>Invoices</span><span class="font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(activeVendorPopover.value.count_invoices)}</span></div><div class="flex justify-between" data-v-10ea5fd4${_scopeId}><span class="text-gray-600" data-v-10ea5fd4${_scopeId}>Overdue</span><span class="${ssrRenderClass(activeVendorPopover.value.count_overdue > 0 ? "font-medium text-red-600" : "font-medium text-gray-500")}" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(activeVendorPopover.value.count_overdue)}</span></div></div><div class="mt-4" data-v-10ea5fd4${_scopeId}><button type="button" class="w-full inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-sage-600 hover:bg-sage-700 rounded-md transition" data-v-10ea5fd4${_scopeId}> View Details </button></div></div>`);
                } else {
                  _push3(`<!---->`);
                }
              }, "body", false, _parent2);
              _push2(`<div class="bg-white rounded-lg shadow-sm overflow-hidden" data-v-10ea5fd4${_scopeId}><div class="overflow-x-auto" data-v-10ea5fd4${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-10ea5fd4${_scopeId}><thead class="bg-gray-50" data-v-10ea5fd4${_scopeId}><tr data-v-10ea5fd4${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Vendor </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Service </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Invoice/SO </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Amount </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Paid </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Outstanding </th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Status </th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-10ea5fd4${_scopeId}> Actions </th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-10ea5fd4${_scopeId}><!--[-->`);
              ssrRenderList(tableRows.value, (row) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-10ea5fd4${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-10ea5fd4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(row.vendorName)}</div><div class="text-sm text-gray-500" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(row.vendorInvoiceDate ? formatDate(row.vendorInvoiceDate) : "-")}</div></td><td class="px-6 py-4" data-v-10ea5fd4${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(row.serviceLabel)}</div>`);
                if (row.componentSummary) {
                  _push2(`<div class="text-sm text-gray-600" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(row.componentSummary)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (row.serviceDescription) {
                  _push2(`<div class="text-sm text-gray-600" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(row.serviceDescription)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (row.serviceRemarks) {
                  _push2(`<div class="text-sm text-gray-500" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(row.serviceRemarks.substring(0, 50))}${ssrInterpolate(row.serviceRemarks.length > 50 ? "..." : "")}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</td><td class="px-6 py-4 whitespace-nowrap" data-v-10ea5fd4${_scopeId}><div class="text-sm text-gray-900" data-v-10ea5fd4${_scopeId}>`);
                if (row.invoiceNumber) {
                  _push2(`<div data-v-10ea5fd4${_scopeId}> Invoice: ${ssrInterpolate(row.invoiceNumber)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (row.salesOrder) {
                  _push2(`<div data-v-10ea5fd4${_scopeId}> SO: ${ssrInterpolate(row.salesOrder.order_number)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-10ea5fd4${_scopeId}> Rp ${ssrInterpolate(formatNumber(row.amount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-10ea5fd4${_scopeId}> Rp ${ssrInterpolate(formatNumber(row.paidAmount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-10ea5fd4${_scopeId}> Rp ${ssrInterpolate(formatNumber(row.outstanding))}</td><td class="px-6 py-4 whitespace-nowrap text-center" data-v-10ea5fd4${_scopeId}><span class="${ssrRenderClass([getStatusClass(row.status), "inline-flex px-2 py-1 text-xs font-semibold rounded-full"])}" data-v-10ea5fd4${_scopeId}>${ssrInterpolate(getStatusText(row.status))} `);
                if (row.daysOverdue > 0) {
                  _push2(`<span class="ml-1" data-v-10ea5fd4${_scopeId}> (${ssrInterpolate(row.daysOverdue)} hari) </span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</span></td><td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium" data-v-10ea5fd4${_scopeId}><div class="flex items-center justify-center space-x-2" data-v-10ea5fd4${_scopeId}><button class="text-blue-600 hover:text-blue-900" title="Lihat Detail" data-v-10ea5fd4${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10ea5fd4${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-10ea5fd4${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-10ea5fd4${_scopeId}></path></svg></button>`);
                if (row.status !== "paid") {
                  _push2(`<button class="text-green-600 hover:text-green-900" title="Mark Payment" data-v-10ea5fd4${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10ea5fd4${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" data-v-10ea5fd4${_scopeId}></path></svg></button>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div><div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6" data-v-10ea5fd4${_scopeId}><div class="flex items-center justify-between" data-v-10ea5fd4${_scopeId}><div class="text-sm text-gray-700" data-v-10ea5fd4${_scopeId}> Showing ${ssrInterpolate(__props.payables.from || 0)} to ${ssrInterpolate(__props.payables.to || 0)} of ${ssrInterpolate(__props.payables.total || 0)} results </div><div class="flex space-x-1" data-v-10ea5fd4${_scopeId}><!--[-->`);
              ssrRenderList(__props.payables.links, (link) => {
                ...
                if (link.url) {
                  ...
                  ])}" data-v-10ea5fd4${_scopeId}>${link.label ?? ""}</button>`);
                } else {
                  _push2(`<span class="px-3 py-2 text-sm text-gray-400" data-v-10ea5fd4${_scopeId}>${link.label ?? ""}</span>`);
                }
                _push2(`<!--]-->`);
              });
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              "max-amount": selectedComponent.value ? Number(selectedComponent.value.outstanding_amount || 0) : selectedPayable.value ? Number(selectedPayable.value.outstanding_amount || 0) : 0,
              title: "Mark Payment",
              ...
              summary: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="mb-4 bg-gray-50 p-3 rounded-md" data-v-10ea5fd4${_scopeId2}><p class="text-sm text-gray-600" data-v-10ea5fd4${_scopeId2}>Vendor: ${ssrInterpolate(modalVendorName.value)}</p><p class="text-sm text-gray-600" data-v-10ea5fd4${_scopeId2}>Komponen: ${ssrInterpolate(modalServiceLabel.value)}</p><p class="text-sm text-gray-600" data-v-10ea5fd4${_scopeId2}>Outstanding: Rp ${ssrInterpolate(formatNumber(modalOutstanding.value))}</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "mb-4 bg-gray-50 p-3 rounded-md" }, [
                      createVNode("p", { class: "text-sm text-gray-600" }, "Vendor: " + toDisplayString(modalVendorName.value), 1),
                      createVNode("p", { class: "text-sm text-gray-600" }, "Komponen: " + toDisplayString(modalServiceLabel.value), 1),
                      createVNode("p", { class: "text-sm text-gray-600" }, "Outstanding: Rp " + toDisplayString(formatNumber(modalOutstanding.value)), 1)
                    ])
                  ];
                }
              }),
              "before-fields": withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (availableComponents.value.length > 1) {
                    _push3(`<div class="mb-4" data-v-10ea5fd4${_scopeId2}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-10ea5fd4${_scopeId2}>Komponen Pembayaran *</label><select required class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-10ea5fd4${_scopeId2}><option value="" data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(paymentForm.component_id) ? ssrLooseContain(paymentForm.component_id, "") : ssrLooseEqual(paymentForm.component_id, "")) ? " selected" : ""}${_scopeId2}>Pilih komponen</option><!--[-->`);
                    ssrRenderList(availableComponents.value, (component) => {
                      _push3(`<option${ssrRenderAttr("value", component.id)} data-v-10ea5fd4${ssrIncludeBooleanAttr(Array.isArray(paymentForm.component_id) ? ssrLooseContain(paymentForm.component_id, component.id) : ssrLooseEqual(paymentForm.component_id, component.id)) ? " selected" : ""}${_scopeId2}>${ssrInterpolate(componentDisplayName(component))} - Outstanding Rp ${ssrInterpolate(formatNumber(component.outstanding_amount || component.amount || 0))}</option>`);
                    });
                    _push3(`<!--]--></select><p class="text-xs text-gray-500 mt-1" data-v-10ea5fd4${_scopeId2}> Pilih komponen hutang yang ingin ditandai lunas. </p></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    availableComponents.value.length > 1 ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "mb-4"
                    }, [
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(availableComponents.value, (component) => {
                          return openBlock(), createBlock("option", {
                            key: component.id,
                            value: component.id
                          }, toDisplayString(componentDisplayName(component)) + " - Outstanding Rp " + toDisplayString(formatNumber(component.outstanding_amount || component.amount || 0)), 9, ["value"]);
                        }), 128))
                      ], 8, ["onUpdate:modelValue"]), [
                        [vModelSelect, paymentForm.component_id]
                      ]),
                      createVNode("p", { class: "text-xs text-gray-500 mt-1" }, " Pilih komponen hutang yang ingin ditandai lunas. ")
                          ...
                          createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(tableRows.value, (row) => {
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                  createVNode("div", { class: "text-sm font-medium text-gray-900" }, toDisplayString(row.vendorName), 1),
                                ...
                                createVNode("td", { class: "px-6 py-4" }, [
                                  createVNode("div", { class: "text-sm font-medium text-gray-900" }, toDisplayString(row.serviceLabel), 1),
                                  row.componentSummary ? (openBlock(), createBlock("div", {
                                    key: 0,
                                    class: "text-sm text-gray-600"
                                  }, toDisplayString(row.componentSummary), 1)) : createCommentVNode("", true),
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                  createVNode("div", { class: "text-sm text-gray-900" }, [
                                    row.invoiceNumber ? (openBlock(), createBlock("div", { key: 0 }, " Invoice: " + toDisplayString(row.invoiceNumber), 1)) : createCommentVNode("", true),
                                    row.salesOrder ? (openBlock(), createBlock("div", { key: 1 }, " SO: " + toDisplayString(row.salesOrder.order_number), 1)) : createCommentVNode("", true)
                                  ])
                                ]),
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-center" }, [
                                  createVNode("span", {
                                    ...
                                    row.daysOverdue > 0 ? (openBlock(), createBlock("span", {
                                      key: 0,
                                      class: "ml-1"
                                    }, " (" + toDisplayString(row.daysOverdue) + " hari) ", 1)) : createCommentVNode("", true)
                                  ], 2)
                                ]),
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-center text-sm font-medium" }, [
                                  createVNode("div", { class: "flex items-center justify-center space-x-2" }, [
                                    ...
                                    row.status !== "paid" ? (openBlock(), createBlock("button", {
                                      key: 0,
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10ea5fd4"]]);
export {
  Index as default
};
