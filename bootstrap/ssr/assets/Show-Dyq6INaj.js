import { ref, reactive, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, withModifiers, withDirectives, vModelText, vModelSelect, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (__props.payable.status !== "paid") {
              _push2(`<button class="bg-green-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-green-700"${_scopeId}> Mark Payment </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button class="bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700"${_scopeId}> Edit Details </button></div></div></div><div class="bg-white rounded-lg shadow-sm p-6 mb-6"${_scopeId}><h2 class="text-lg font-semibold text-gray-900 mb-4"${_scopeId}>Informasi Vendor</h2><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}><div${_scopeId}><div class="space-y-3"${_scopeId}><div${_scopeId}><label class="text-sm font-medium text-gray-500"${_scopeId}>Vendor Name</label><p class="text-sm text-gray-900"${_scopeId}>${ssrInterpolate(((_a = __props.payable.vendor) == null ? void 0 : _a.nama_vendor) || __props.payable.vendor_name)}</p></div>`);
            if ((_b = __props.payable.vendor) == null ? void 0 : _b.alamat) {
            ...
            if ((_c = __props.payable.vendor) == null ? void 0 : _c.pic_name) {
            ...
            if ((_d = __props.payable.vendor) == null ? void 0 : _d.pic_phone) {
            ...
            return [
              createVNode("div", { class: "max-w-4xl mx-auto" }, [
                createVNode("div", { class: "bg-white rounded-lg shadow-sm p-6 mb-6" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-4" }, [
                    ...
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      ...
                      }, " Mark Payment ")) : createCommentVNode("", true),
                      createVNode("button", {
                ...
                createVNode("div", { class: "bg-white rounded-lg shadow-sm p-6 mb-6" }, [
                  createVNode("h2", { class: "text-lg font-semibold text-gray-900 mb-4" }, "Informasi Vendor"),
                  createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                    createVNode("div", null, [
                      createVNode("div", { class: "space-y-3" }, [
                        createVNode("div", null, [
                          createVNode("label", { class: "text-sm font-medium text-gray-500" }, "Vendor Name"),
                          createVNode("p", { class: "text-sm text-gray-900" }, toDisplayString(((_f = __props.payable.vendor) == null ? void 0 : _f.nama_vendor) || __props.payable.vendor_name), 1)
                        ]),
                        ((_g = __props.payable.vendor) == null ? void 0 : _g.alamat) ? (openBlock(), createBlock("div", { key: 0 }, [
                    ...
                    createVNode("div", null, [
                      createVNode("div", { class: "space-y-3" }, [
                        ((_h = __props.payable.vendor) == null ? void 0 : _h.pic_name) ? (openBlock(), createBlock("div", { key: 0 }, [
                        ...
                        ((_i = __props.payable.vendor) == null ? void 0 : _i.pic_phone) ? (openBlock(), createBlock("div", { key: 1 }, [
                ...
                createVNode("div", { class: "relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" }, [
                  createVNode("div", { class: "mt-3" }, [
                    ...
                    createVNode("div", { class: "mb-4 bg-gray-50 p-3 rounded-md" }, [
                      createVNode("p", { class: "text-sm text-gray-600" }, "Vendor: " + toDisplayString(((_j = __props.payable.vendor) == null ? void 0 : _j.nama_vendor) || __props.payable.vendor_name), 1),
