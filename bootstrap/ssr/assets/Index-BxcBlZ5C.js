    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Pengeluaran Lain-lain" }, null, _parent2, _scopeId));
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="flex justify-between items-center mb-6"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Pengeluaran Lain-lain</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Kelola pengeluaran tanpa SO non petty cash</p></div><div class="flex items-center space-x-3"${_scopeId}><button class="inline-flex items-center px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` Tambah Pengeluaran `);
                } else {
                  return [
                    createVNode(unref(Plus), { class: "w-4 h-4 mr-2" }),
                    createTextVNode(" Tambah Pengeluaran ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(`</div><div class="ml-5 w-0 flex-1"${_scopeId}><dl${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate"${_scopeId}>Approved</dt><dd class="text-lg font-medium text-gray-900"${_scopeId}>${ssrInterpolate(((_d = __props.stats) == null ? void 0 : _d.approved_count) || 0)}</dd></dl></div></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6"${_scopeId}><div class="px-4 py-5 sm:p-6"${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4"${_scopeId}>Filter Pengeluaran</h3><div class="grid grid-cols-1 md:grid-cols-4 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Periode (Bulan-Tahun)</label><input${ssrRenderAttr("value", formFilters.period)} type="month" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Kategori</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(formFilters.category) ? ssrLooseContain(formFilters.category, "") : ssrLooseEqual(formFilters.category, "")) ? " selected" : ""}${_scopeId}>Semua Kategori</option><option value="Salary Staff"${ssrIncludeBooleanAttr(Array.isArray(formFilters.category) ? ssrLooseContain(formFilters.category, "Salary Staff") : ssrLooseEqual(formFilters.category, "Salary Staff")) ? " selected" : ""}${_scopeId}>Gaji Staff</option><option value="Bank Admin"${ssrIncludeBooleanAttr(Array.isArray(formFilters.category) ? ssrLooseContain(formFilters.category, "Bank Admin") : ssrLooseEqual(formFilters.category, "Bank Admin")) ? " selected" : ""}${_scopeId}>Biaya Admin Bank</option><option value="Reimbursements"${ssrIncludeBooleanAttr(Array.isArray(formFilters.category) ? ssrLooseContain(formFilters.category, "Reimbursements") : ssrLooseEqual(formFilters.category, "Reimbursements")) ? " selected" : ""}${_scopeId}>Reimbursements</option><option value="Office Expenses"${ssrIncludeBooleanAttr(Array.isArray(formFilters.category) ? ssrLooseContain(formFilters.category, "Office Expenses") : ssrLooseEqual(formFilters.category, "Office Expenses")) ? " selected" : ""}${_scopeId}>Biaya Kantor</option><option value="Other"${ssrIncludeBooleanAttr(Array.isArray(formFilters.category) ? ssrLooseContain(formFilters.category, "Other") : ssrLooseEqual(formFilters.category, "Other")) ? " selected" : ""}${_scopeId}>Lainnya</option></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Status</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(formFilters.status) ? ssrLooseContain(formFilters.status, "") : ssrLooseEqual(formFilters.status, "")) ? " selected" : ""}${_scopeId}>Semua Status</option><option value="draft"${ssrIncludeBooleanAttr(Array.isArray(formFilters.status) ? ssrLooseContain(formFilters.status, "draft") : ssrLooseEqual(formFilters.status, "draft")) ? " selected" : ""}${_scopeId}>Draft</option><option value="approved"${ssrIncludeBooleanAttr(Array.isArray(formFilters.status) ? ssrLooseContain(formFilters.status, "approved") : ssrLooseEqual(formFilters.status, "approved")) ? " selected" : ""}${_scopeId}>Approved</option></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Tanggal</label><input${ssrRenderAttr("value", formFilters.expense_date)} type="date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}></div></div><div class="flex justify-end space-x-3 mt-4"${_scopeId}><button class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"${_scopeId}> Clear </button><button class="px-4 py-2 text-sm font-medium text-white bg-sage-600 rounded-md hover:bg-sage-700 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2"${_scopeId}> Filter </button></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md"${_scopeId}><div class="px-4 py-5 sm:px-6"${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900"${_scopeId}>Daftar Pengeluaran</h3></div><div class="overflow-x-auto"${_scopeId}><table class="min-w-full divide-y divide-gray-200"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Tanggal</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Kategori</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Periode</th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Total</th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Items</th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Status</th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Aksi</th></tr></thead><tbody class="bg-white divide-y divide-gray-200"${_scopeId}><!--[-->`);
            ...
            if (!((_f = __props.expenses) == null ? void 0 : _f.data) || __props.expenses.data.length === 0) {
              ...
              _push2(`<h3 class="text-lg font-medium text-gray-900 mb-2"${_scopeId}>Belum ada pengeluaran</h3><p class="text-sm text-gray-500 mb-4"${_scopeId}>Mulai dengan menambahkan pengeluaran pertama</p>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: unref(route)("admin-keuangan.general-expenses.create"),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(Plus), { class: "w-4 h-4 mr-2" }, null, _parent3, _scopeId2));
                    _push3(` Tambah Pengeluaran Pertama `);
                  } else {
                    return [
                      createVNode(unref(Plus), { class: "w-4 h-4 mr-2" }),
                      createTextVNode(" Tambah Pengeluaran Pertama ")
                    ];
                  }
                }),
                _: 1
            ...
            if (((_g = __props.expenses) == null ? void 0 : _g.links) && __props.expenses.links.length > 3) {
              ...
              _push2(`</div><div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between"${_scopeId}><div${_scopeId}><p class="text-sm text-gray-700"${_scopeId}> Menampilkan <span class="font-medium"${_scopeId}>${ssrInterpolate(((_h = __props.expenses) == null ? void 0 : _h.from) ?? 0)}</span> sampai <span class="font-medium"${_scopeId}>${ssrInterpolate(((_i = __props.expenses) == null ? void 0 : _i.to) ?? 0)}</span> dari <span class="font-medium"${_scopeId}>${ssrInterpolate(((_j = __props.expenses) == null ? void 0 : _j.total) ?? 0)}</span> pengeluaran </p></div><div${_scopeId}><nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination"${_scopeId}><!--[-->`);
            ...
            if (showDeleteModal.value) {
              _push2(`<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50"${_scopeId}><div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white"${_scopeId}><div class="mt-3 text-center"${_scopeId}><h3 class="text-lg font-medium text-gray-900 mb-4"${_scopeId}>Konfirmasi Hapus</h3><div class="mt-2 px-7 py-3"${_scopeId}><p class="text-sm text-gray-500"${_scopeId}> Apakah Anda yakin ingin menghapus pengeluaran kategori &quot;${ssrInterpolate((_l = selectedExpense.value) == null ? void 0 : _l.category)}&quot;? Tindakan ini tidak dapat dibatalkan. </p></div><div class="flex justify-center space-x-3 mt-4"${_scopeId}><button class="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"${_scopeId}> Batal </button><button class="px-4 py-2 bg-red-600 text-white rounded-md text-sm font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"${_scopeId}> Hapus </button></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createVNode(unref(Head), { title: "Pengeluaran Lain-lain" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Pengeluaran Lain-lain"),
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Kelola pengeluaran tanpa SO non petty cash")
                    ]),
                    ...
                    createVNode("div", { class: "bg-white overflow-hidden shadow rounded-lg" }, [
                      createVNode("div", { class: "p-5" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("div", { class: "ml-5 w-0 flex-1" }, [
                            createVNode("dl", null, [
                              createVNode("dt", { class: "text-sm font-medium text-gray-500 truncate" }, "Total Tahun Ini"),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900 mb-4" }, "Filter Pengeluaran"),
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-4 gap-4" }, [
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Periode (Bulan-Tahun)"),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:px-6" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900" }, "Daftar Pengeluaran")
                    ]),
                      ...
                      createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                        createVNode("thead", { class: "bg-gray-50" }, [
                          createVNode("tr", null, [
                            ...
                            createVNode("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Periode"),
                          ...
                          !((_r = __props.expenses) == null ? void 0 : _r.data) || __props.expenses.data.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                            createVNode("td", {
                              ...
                              createVNode("div", { class: "flex flex-col items-center" }, [
                                ...
                                createVNode("h3", { class: "text-lg font-medium text-gray-900 mb-2" }, "Belum ada pengeluaran"),
                                createVNode("p", { class: "text-sm text-gray-500 mb-4" }, "Mulai dengan menambahkan pengeluaran pertama"),
                                createVNode(unref(Link), {
                                  href: unref(route)("admin-keuangan.general-expenses.create"),
                                  class: "inline-flex items-center px-4 py-2 bg-sage-600 text-white text-sm font-medium rounded-md hover:bg-sage-700"
                                }, {
                ...
                createVNode("div", { class: "relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" }, [
                  createVNode("div", { class: "mt-3 text-center" }, [
                    ...
                    createVNode("div", { class: "mt-2 px-7 py-3" }, [
                      createVNode("p", { class: "text-sm text-gray-500" }, ' Apakah Anda yakin ingin menghapus pengeluaran kategori "' + toDisplayString((_x = selectedExpense.value) == null ? void 0 : _x.category) + '"? Tindakan ini tidak dapat dibatalkan. ', 1)
                    ]),
