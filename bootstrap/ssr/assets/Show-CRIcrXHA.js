  ...
  setup(__props) {
    ...
    const summaryCards = computed(() => {
      ...
      return [
        ...
        { title: "Laba/Rugi Bersih", value: ((_o = props.reportData) == null ? void 0 : _o.net_profit) || 0, tone: ((_p = props.reportData) == null ? void 0 : _p.net_profit) >= 0 ? "text-green-700" : "text-red-700" },
    ...
    const SummaryRow = defineComponent({
      ...
      setup(props2) {
        return () => h("div", { class: "flex items-center justify-between border border-gray-100 rounded px-3 py-2 bg-gray-50" }, [
          h("div", { class: "text-sm font-semibold text-gray-800" }, props2.title || "Kategori"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (operationalGrouped.value.length) {
                    _push3(`<div class="space-y-2"${_scopeId2}><div class="text-xs font-semibold text-gray-600 uppercase tracking-wide"${_scopeId2}>Beban Operasional</div><div class="space-y-1"${_scopeId2}><!--[-->`);
