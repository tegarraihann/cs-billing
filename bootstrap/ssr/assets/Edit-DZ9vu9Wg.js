    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-6" data-v-b3c124e9${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-b3c124e9${_scopeId}><div class="bg-white shadow rounded-lg mb-6" data-v-b3c124e9${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-b3c124e9${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-b3c124e9${_scopeId}><div class="flex items-center" data-v-b3c124e9${_scopeId}><div class="w-12 h-12 bg-sage-800 rounded-full flex items-center justify-center mr-4" data-v-b3c124e9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Edit$1), { class: "w-6 h-6 text-white" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-b3c124e9${_scopeId}><h1 class="text-2xl font-semibold text-gray-900" data-v-b3c124e9${_scopeId}>Edit Vendor: ${ssrInterpolate(__props.vendor.nama_vendor)}</h1><p class="mt-1 text-sm text-gray-600" data-v-b3c124e9${_scopeId}>Update vendor information</p></div></div><div class="mt-4 sm:mt-0 flex space-x-3" data-v-b3c124e9${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-b3c124e9${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-b3c124e9${_scopeId}><h3 class="text-lg font-medium text-sage-800" data-v-b3c124e9${_scopeId}>Edit Vendor Form</h3><p class="mt-1 text-sm text-gray-600" data-v-b3c124e9${_scopeId}>Update vendor information accurately</p></div><div class="p-6" data-v-b3c124e9${_scopeId}><form class="space-y-6" data-v-b3c124e9${_scopeId}><div data-v-b3c124e9${_scopeId}><label for="nama_vendor" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Vendor Name <span class="text-red-500" data-v-b3c124e9${_scopeId}>*</span></label><input id="nama_vendor"${ssrRenderAttr("value", unref(form).nama_vendor)} type="text" placeholder="Enter vendor name" class="${ssrRenderClass([{ "border-red-500": __props.errors.nama_vendor }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.nama_vendor) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.nama_vendor)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="pic" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> PIC (Person in Charge) </label><input id="pic"${ssrRenderAttr("value", unref(form).pic)} type="text" placeholder="Enter PIC name" class="${ssrRenderClass([{ "border-red-500": __props.errors.pic }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.pic) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.pic)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="no_hp" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Phone Number </label><input id="no_hp"${ssrRenderAttr("value", unref(form).no_hp)} type="text" placeholder="Enter phone number" class="${ssrRenderClass([{ "border-red-500": __props.errors.no_hp }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.no_hp) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.no_hp)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="email" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Email </label><input id="email"${ssrRenderAttr("value", unref(form).email)} type="email" placeholder="Enter email address" class="${ssrRenderClass([{ "border-red-500": __props.errors.email }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.email) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.email)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="no_kantor" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Office Phone </label><input id="no_kantor"${ssrRenderAttr("value", unref(form).no_kantor)} type="text" placeholder="Enter office phone number" class="${ssrRenderClass([{ "border-red-500": __props.errors.no_kantor }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.no_kantor) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.no_kantor)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="nomor_rekening" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Bank Account Number <span class="text-red-500" data-v-b3c124e9${_scopeId}>*</span></label><input id="nomor_rekening"${ssrRenderAttr("value", unref(form).nomor_rekening)} type="text" placeholder="Enter bank account number" class="${ssrRenderClass([{ "border-red-500": __props.errors.nomor_rekening }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.nomor_rekening) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.nomor_rekening)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="nama_rekening" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Account Holder Name <span class="text-red-500" data-v-b3c124e9${_scopeId}>*</span></label><input id="nama_rekening"${ssrRenderAttr("value", unref(form).nama_rekening)} type="text" placeholder="Enter account holder name" class="${ssrRenderClass([{ "border-red-500": __props.errors.nama_rekening }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.nama_rekening) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.nama_rekening)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="nib" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Business Identification Number (NIB) </label><input id="nib"${ssrRenderAttr("value", unref(form).nib)} type="text" placeholder="Enter business identification number" class="${ssrRenderClass([{ "border-red-500": __props.errors.nib }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500"])}" data-v-b3c124e9${_scopeId}>`);
            if (__props.errors.nib) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.nib)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="photo" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Vendor Photo </label>`);
            if (__props.vendor.photo_path) {
              _push2(`<div class="mb-3" data-v-b3c124e9${_scopeId}><p class="text-sm text-gray-600 mb-2" data-v-b3c124e9${_scopeId}>Current photo:</p><img${ssrRenderAttr("src", `/storage/${__props.vendor.photo_path}`)} alt="Vendor Photo" class="w-20 h-20 object-cover rounded-lg border border-gray-200" data-v-b3c124e9${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<input type="file" id="photo" accept="image/*" class="${ssrRenderClass([{ "border-red-500": __props.errors.photo }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-sage-100 file:text-sage-700 hover:file:bg-sage-200"])}" data-v-b3c124e9${_scopeId}><p class="mt-1 text-xs text-gray-500" data-v-b3c124e9${_scopeId}> Supported formats: JPG, PNG, GIF. Max 2MB. Leave empty if you do not want to replace the photo. </p>`);
            if (__props.errors.photo) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.photo)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b3c124e9${_scopeId}><label for="legal_document" class="block text-sm font-medium text-sage-700 mb-2" data-v-b3c124e9${_scopeId}> Legal Document </label>`);
            if (__props.vendor.legal_document_path) {
              _push2(`<div class="mb-3" data-v-b3c124e9${_scopeId}><p class="text-sm text-gray-600 mb-2" data-v-b3c124e9${_scopeId}>Current document:</p><a${ssrRenderAttr("href", `/storage/${__props.vendor.legal_document_path}`)} target="_blank" class="inline-flex items-center px-3 py-2 text-sm bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200" data-v-b3c124e9${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b3c124e9${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" data-v-b3c124e9${_scopeId}></path></svg> View Document </a></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<input type="file" id="legal_document" accept=".pdf" class="${ssrRenderClass([{ "border-red-500": __props.errors.legal_document }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-sage-100 file:text-sage-700 hover:file:bg-sage-200"])}" data-v-b3c124e9${_scopeId}><p class="mt-1 text-xs text-gray-500" data-v-b3c124e9${_scopeId}> Supported format: PDF. Max 10MB. Leave empty if you do not want to replace the document. </p>`);
            if (__props.errors.legal_document) {
              _push2(`<div class="mt-1 text-sm text-red-600" data-v-b3c124e9${_scopeId}>${ssrInterpolate(__props.errors.legal_document)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex justify-end space-x-3 pt-4 border-t border-gray-200" data-v-b3c124e9${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.vendors.show", __props.vendor.id),
              class: "inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            }, {
...
const Edit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b3c124e9"]]);
export {
  Edit as default
};
