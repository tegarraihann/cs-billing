      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="mb-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Bank ${ssrInterpolate(__props.bank.bank_name)} History</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}> Riwayat opening balance dan transaksi bank ${ssrInterpolate(__props.bank.bank_name)}</p></div><div class="flex space-x-3"${_scopeId}>`);
            ...
            if (__props.balances && __props.balances.data && __props.balances.data.length > 0) {
              ...
              _push2(`<h3 class="mt-2 text-sm font-medium text-gray-900"${_scopeId}>No opening balances found</h3><p class="mt-1 text-sm text-gray-500"${_scopeId}> Opening balances akan muncul setelah diinput. </p></div>`);
            }
                  ...
                  createVNode("div", { class: "mb-6" }, [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", null, [
                        ...
                        createVNode("p", { class: "mt-1 text-sm text-gray-600" }, " Riwayat opening balance dan transaksi bank " + toDisplayString(__props.bank.bank_name), 1)
                      ]),
                    ...
                    createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg" }, [
                      createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                        ...
                        __props.balances && __props.balances.data && __props.balances.data.length > 0 ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("p", { class: "mt-1 text-sm text-gray-500" }, " Opening balances akan muncul setelah diinput. ")
                        ]))
                      ])
                    ]),
                    createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg" }, [
