    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Other Income Details" }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.other-incomes.index", __props.returnQuery),
            ...
            _push2(`<div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Other Income Details</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Full income information</p></div></div><div class="flex space-x-2"${_scopeId}>`);
            if (!__props.otherIncome.posted_to_profit_loss) {
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("admin-keuangan.other-incomes.edit", {
                  otherIncome: __props.otherIncome.id,
                  ...__props.returnQuery
                }),
            ...
            if (__props.otherIncome.notes) {
              ...
              _push2(` Notes </dt><dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"${_scopeId}>${ssrInterpolate(__props.otherIncome.notes)}</dd></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.otherIncome.receipt_file) {
              ...
              _push2(` Income Receipt </dt><dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"${_scopeId}><a${ssrRenderAttr("href", `/storage/${__props.otherIncome.receipt_file}`)} target="_blank" class="inline-flex items-center text-sage-600 hover:text-sage-800"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileText), { class: "w-4 h-4 mr-1" }, null, _parent2, _scopeId));
              _push2(` View File </a></dd></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</dl></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6"${_scopeId}><div class="px-4 py-5 sm:px-6 bg-gray-50"${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900"${_scopeId}>Audit Information</h3></div><div class="border-t border-gray-200"${_scopeId}><dl${_scopeId}><div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"${_scopeId}><dt class="text-sm font-medium text-gray-500"${_scopeId}>Created By</dt><dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"${_scopeId}>${ssrInterpolate(((_b = __props.otherIncome.creator) == null ? void 0 : _b.name) || "-")} <span class="text-gray-500 ml-2"${_scopeId}>${ssrInterpolate(formatDateTime(__props.otherIncome.created_at))}</span></dd></div>`);
            if (__props.otherIncome.posted_to_profit_loss) {
              _push2(`<div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6"${_scopeId}><dt class="text-sm font-medium text-gray-500"${_scopeId}>Posted to Profit &amp; Loss By</dt><dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2"${_scopeId}>${ssrInterpolate(((_c = __props.otherIncome.approver) == null ? void 0 : _c.name) || "-")} <span class="text-gray-500 ml-2"${_scopeId}>${ssrInterpolate(formatDateTime(__props.otherIncome.posted_at))}</span></dd></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</dl></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg mb-6"${_scopeId}><div class="px-4 py-5 sm:px-6 flex items-center justify-between"${_scopeId}><div${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900"${_scopeId}>Receivable Payments</h3><p class="mt-1 text-sm text-gray-500"${_scopeId}>Record cash receipts for this income.</p></div>`);
            if (!canRecordPayment.value) {
              _push2(`<span class="text-xs text-gray-500"${_scopeId}>Receivable is settled</span>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            if ((_d = __props.otherIncome.payments) == null ? void 0 : _d.length) {
              _push2(`<div class="overflow-x-auto"${_scopeId}><table class="min-w-full divide-y divide-gray-200"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Date</th><th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Method</th><th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Amount</th><th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Adjustment</th><th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Notes</th></tr></thead><tbody class="bg-white divide-y divide-gray-200"${_scopeId}><!--[-->`);
              ...
              _push2(`<div class="text-sm text-gray-500"${_scopeId}>No payments recorded yet.</div>`);
            }
            if (canRecordPayment.value) {
              _push2(`<form class="space-y-4 border-t border-gray-200 pt-4"${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Payment Date</label><input${ssrRenderAttr("value", unref(paymentForm).payment_date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm" required${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Payment Method</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm" required${_scopeId}><option value="bank"${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).payment_method) ? ssrLooseContain(unref(paymentForm).payment_method, "bank") : ssrLooseEqual(unref(paymentForm).payment_method, "bank")) ? " selected" : ""}${_scopeId}>Bank Transfer</option><option value="petty_cash"${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).payment_method) ? ssrLooseContain(unref(paymentForm).payment_method, "petty_cash") : ssrLooseEqual(unref(paymentForm).payment_method, "petty_cash")) ? " selected" : ""}${_scopeId}>Petty Cash</option></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Payment Amount</label><input${ssrRenderAttr("value", unref(paymentForm).amount)} type="number" step="0.01" min="0.01" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm" required${_scopeId}></div></div>`);
              if (unref(paymentForm).payment_method === "bank") {
                _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Bank Account</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm" required${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).bank_account_id) ? ssrLooseContain(unref(paymentForm).bank_account_id, "") : ssrLooseEqual(unref(paymentForm).bank_account_id, "")) ? " selected" : ""}${_scopeId}>Select Bank Account</option><!--[-->`);
              ...
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Adjustment</label><div class="flex space-x-2"${_scopeId}><input${ssrRenderAttr("value", unref(paymentForm).adjustment_amount)} type="number" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm"${_scopeId}><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).adjustment_type) ? ssrLooseContain(unref(paymentForm).adjustment_type, "") : ssrLooseEqual(unref(paymentForm).adjustment_type, "")) ? " selected" : ""}${_scopeId}>-</option><option value="tax_expense"${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).adjustment_type) ? ssrLooseContain(unref(paymentForm).adjustment_type, "tax_expense") : ssrLooseEqual(unref(paymentForm).adjustment_type, "tax_expense")) ? " selected" : ""}${_scopeId}>Tax Expense</option><option value="other_expense"${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).adjustment_type) ? ssrLooseContain(unref(paymentForm).adjustment_type, "other_expense") : ssrLooseEqual(unref(paymentForm).adjustment_type, "other_expense")) ? " selected" : ""}${_scopeId}>Other Expense</option></select></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Notes</label><textarea rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500 text-sm"${_scopeId}>${ssrInterpolate(unref(paymentForm).notes)}</textarea></div></div><div class="flex justify-end"${_scopeId}><button type="submit" class="inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-700 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition disabled:opacity-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(isPaymentDisabled.value) ? " disabled" : ""}${_scopeId}> Record Payment </button></div></form>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg"${_scopeId}><div class="px-4 py-5 sm:px-6"${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4"${_scopeId}>Actions</h3><div class="flex flex-wrap gap-3"${_scopeId}>`);
            if (!__props.otherIncome.posted_to_profit_loss) {
              ...
              _push2(ssrRenderComponent(unref(CheckCircle), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` Post to Profit &amp; Loss </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.otherIncome.posted_to_profit_loss) {
              ...
              _push2(` Unpost from Profit &amp; Loss </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (!__props.otherIncome.posted_to_profit_loss) {
            ...
            return [
              createVNode(unref(Head), { title: "Other Income Details" }),
                ...
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                    ...
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", { class: "flex items-center space-x-4" }, [
                        ...
                        createVNode("div", null, [
                          createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Other Income Details"),
                          createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Full income information")
                        ])
                      ]),
                  ...
                  createVNode("div", { class: "mb-6" }, [
                    createVNode("span", {
                      ...
                      createTextVNode(" " + toDisplayString(__props.otherIncome.posted_to_profit_loss ? "Posted to Profit & Loss" : "Pending"), 1)
                    ], 2)
                  ]),
                  createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6" }, [
                    ...
                    createVNode("div", { class: "bg-white border border-sage-200 rounded-lg p-4" }, [
                      createVNode("p", { class: "text-xs text-gray-500 uppercase tracking-wider" }, "Receivable Status"),
                      createVNode("span", {
                    ...
                    createVNode("div", { class: "bg-white border border-sage-200 rounded-lg p-4" }, [
                      createVNode("p", { class: "text-xs text-gray-500 uppercase tracking-wider" }, "Due Date"),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:px-6 bg-sage-50" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900" }, "Income Information")
                    ]),
                    createVNode("div", { class: "border-t border-gray-200" }, [
                      createVNode("dl", null, [
                        ...
                        createVNode("div", { class: "bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" }, [
                          createVNode("dt", { class: "text-sm font-medium text-gray-500" }, "Reference Number"),
                        ...
                        createVNode("div", { class: "bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" }, [
                          createVNode("dt", { class: "text-sm font-medium text-gray-500" }, "Current Outstanding"),
                        ...
                        __props.otherIncome.receipt_file ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("dt", { class: "text-sm font-medium text-gray-500 flex items-center" }, [
                            ...
                            createTextVNode(" Income Receipt ")
                          ]),
                          createVNode("dd", { class: "mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2" }, [
                            createVNode("a", {
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:px-6 bg-gray-50" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900" }, "Audit Information")
                    ]),
                    createVNode("div", { class: "border-t border-gray-200" }, [
                      createVNode("dl", null, [
                        createVNode("div", { class: "bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6" }, [
                        ...
                        __props.otherIncome.posted_to_profit_loss ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("dt", { class: "text-sm font-medium text-gray-500" }, "Posted to Profit & Loss By"),
                          createVNode("dd", { class: "mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2" }, [
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:px-6 flex items-center justify-between" }, [
                      createVNode("div", null, [
                        createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900" }, "Receivable Payments"),
                        createVNode("p", { class: "mt-1 text-sm text-gray-500" }, "Record cash receipts for this income.")
                      ]),
                      !canRecordPayment.value ? (openBlock(), createBlock("span", {
                        key: 0,
                        class: "text-xs text-gray-500"
                      }, "Receivable is settled")) : createCommentVNode("", true)
                    ]),
                    createVNode("div", { class: "border-t border-gray-200" }, [
                      createVNode("div", { class: "p-4 space-y-6" }, [
                        ((_h = __props.otherIncome.payments) == null ? void 0 : _h.length) ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                            createVNode("thead", { class: "bg-gray-50" }, [
                              createVNode("tr", null, [
                                createVNode("th", { class: "px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Date"),
                                createVNode("th", { class: "px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Method"),
                                createVNode("th", { class: "px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Amount"),
                                createVNode("th", { class: "px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Adjustment"),
                                createVNode("th", { class: "px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Notes")
                              ])
                            ]),
                        ...
                        canRecordPayment.value ? (openBlock(), createBlock("form", {
                          ...
                          createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-4" }, [
                            ...
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Payment Amount"),
                              withDirectives(createVNode("input", {
                            ...
                            createVNode("div", null, [
                              ...
                              createVNode("div", { class: "flex space-x-2" }, [
                                ...
                                withDirectives(createVNode("select", {
                                  ...
                                  createVNode("option", { value: "tax_expense" }, "Tax Expense"),
                                  createVNode("option", { value: "other_expense" }, "Other Expense")
                                ], 8, ["onUpdate:modelValue"]), [
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-lg" }, [
                    createVNode("div", { class: "px-4 py-5 sm:px-6" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900 mb-4" }, "Actions"),
                      createVNode("div", { class: "flex flex-wrap gap-3" }, [
                        ...
                        __props.otherIncome.posted_to_profit_loss ? (openBlock(), createBlock("button", {
                          ...
                          createTextVNode(" Unpost from Profit & Loss ")
                        ])) : createCommentVNode("", true),
                        !__props.otherIncome.posted_to_profit_loss ? (openBlock(), createBlock("button", {
                          key: 2,
