...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const componentVatRateMatches = (component, rate) => {
      const sourceRate = Number((component == null ? void 0 : component.vat_source_rate) ?? 0);
    ...
    const canPostVatReceivableFor = (component, rate = null) => {
      const eligible = (component == null ? void 0 : component.can_post_vat_receivable) === true;
      if (!eligible) {
        return false;
      }
      if (rate === null) {
                                    ...
                                    isVatMenuOpen(component.id) ? (openBlock(), createBlock("div", {
                                      ...
                                      createVNode("div", { class: "py-1" }, [
                                        ...
                                        createVNode("button", {
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed",
                                          disabled: isPostingVat.value || !canPostVatReceivableFor(component, 11),
                                          onClick: ($event) => canPostVatReceivableFor(component, 11) && handleVatAction(postVatReceivable11, component)
                                        }, " Post VAT Receivable 11% ", 8, ["disabled", "onClick"]),
                                        createVNode("button", {
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed",
                                          disabled: isPostingVat.value || !canPostVatReceivableFor(component, 1.1),
                                          onClick: ($event) => canPostVatReceivableFor(component, 1.1) && handleVatAction(postVatReceivable11_1, component)
