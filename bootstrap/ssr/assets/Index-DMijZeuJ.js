      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_a2 = __props.shipmentTypes) == null ? void 0 : _a2.data) && __props.shipmentTypes.data.length > 0) {
            ...
            _push2(ssrRenderComponent(AlertDialog, {
              ...
              message: `Are you sure you want to delete shipment type '${(_b2 = deleteModal.shipmentType) == null ? void 0 : _b2.name}'?`,
              "confirm-text": "Delete",
              "cancel-text": "Cancel",
            ...
            return [
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      ...
                      ((_c = __props.shipmentTypes) == null ? void 0 : _c.data) && __props.shipmentTypes.data.length > 0 ? (openBlock(), createBlock("div", {
                        key: 1,
                        class: "mt-6"
                      }, [
              ...
              createVNode(AlertDialog, {
                show: deleteModal.show,
                title: "Confirm Deletion",
                message: `Are you sure you want to delete shipment type '${(_d = deleteModal.shipmentType) == null ? void 0 : _d.name}'?`,
                "confirm-text": "Delete",
                "cancel-text": "Cancel",
                onConfirm: deleteShipmentType,
                onCancel: ($event) => deleteModal.show = false
