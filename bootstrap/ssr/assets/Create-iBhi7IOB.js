    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Add Service Type" }, null, _parent2, _scopeId));
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Saving..." : "Save Service Type")}</button></div></form></div></div></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Add Service Type" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Add New Service Type"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Add a new service/fee type for vendor items.")
                  ]),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", null, [
                          createVNode("label", {
                            ...
                            createTextVNode(" Service Type Code "),
                        ...
                        createVNode("div", { class: "mt-8 flex justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            createTextVNode(" " + toDisplayString(processing.value ? "Saving..." : "Save Service Type"), 1)
                          ], 8, ["disabled"])
                        ])
                      ], 32)
                    ])
