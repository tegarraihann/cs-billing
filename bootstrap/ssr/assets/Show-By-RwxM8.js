        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (__props.reportData.revenues.other.length > 0) {
              _push2(`<div${_scopeId}><h4 class="text-sm font-medium text-gray-700 mb-3"${_scopeId}>Pendapatan Lain-lain</h4>`);
              if (__props.reportData.revenues.other_income_breakdown.bunga_mandiri.total > 0) {
                _push2(`<div class="mb-4"${_scopeId}><div class="flex justify-between items-center py-2 bg-blue-50 px-3 rounded"${_scopeId}><div class="text-sm font-medium text-blue-900"${_scopeId}>Pendapatan Lain-lain (Bunga Bank Mandiri)</div><div class="text-sm font-semibold text-blue-900"${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.other_income_breakdown.bunga_mandiri.total))}</div></div><div class="ml-4 mt-2 space-y-1"${_scopeId}><!--[-->`);
                ssrRenderList(__props.reportData.revenues.other_income_breakdown.bunga_mandiri.entries, (entry) => {
                  _push2(`<div class="flex justify-between items-center py-1 text-xs"${_scopeId}><div class="text-gray-600"${_scopeId}>${ssrInterpolate(entry.description)}</div><div class="text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
                });
                _push2(`<!--]--></div></div>`);
              } else {
                _push2(`<!---->`);
              ...
              if (__props.reportData.revenues.other_income_breakdown.bunga_bca.total > 0) {
                _push2(`<div class="mb-4"${_scopeId}><div class="flex justify-between items-center py-2 bg-green-50 px-3 rounded"${_scopeId}><div class="text-sm font-medium text-green-900"${_scopeId}>Pendapatan Lain-lain (Bunga Bank BCA)</div><div class="text-sm font-semibold text-green-900"${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.other_income_breakdown.bunga_bca.total))}</div></div><div class="ml-4 mt-2 space-y-1"${_scopeId}><!--[-->`);
              ...
              if (__props.reportData.revenues.other_income_breakdown.lainnya.total > 0) {
                _push2(`<div class="mb-4"${_scopeId}><div class="flex justify-between items-center py-2 bg-purple-50 px-3 rounded"${_scopeId}><div class="text-sm font-medium text-purple-900"${_scopeId}>Pendapatan Lain-lain (Lainnya)</div><div class="text-sm font-semibold text-purple-900"${_scopeId}>${ssrInterpolate(formatCurrency(__props.reportData.revenues.other_income_breakdown.lainnya.total))}</div></div><div class="ml-4 mt-2 space-y-1"${_scopeId}><!--[-->`);
