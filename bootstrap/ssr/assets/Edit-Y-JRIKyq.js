import { withCtx, unref, createVNode, createTextVNode, toDisplayString, withModifiers, withDirectives, createBlock, createCommentVNode, vModelText, openBlock, vModelCheckbox, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Edit Satuan Package" }, null, _parent2, _scopeId));
            ...
            return [
              createVNode(unref(Head), { title: "Edit Satuan Package" }),
                ...
                createVNode("div", { class: "max-w-2xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    createVNode("div", { class: "flex items-center space-x-3 mb-2" }, [
                      ...
                      createVNode("h1", { class: "text-2xl font-bold text-sage-800" }, "Edit Satuan Package")
                    ]),
                    createVNode("p", { class: "text-sm text-sage-600" }, ' Edit informasi satuan packaging "' + toDisplayString(__props.packageUnit.name) + '" ', 1)
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/AdminKeuangan/MasterPackageUnits/Edit.vue");
