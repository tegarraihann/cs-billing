    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="py-6" data-v-d1c14847${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-d1c14847${_scopeId}><div class="bg-white shadow rounded-lg mb-6" data-v-d1c14847${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-d1c14847${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-d1c14847${_scopeId}><div class="flex items-center" data-v-d1c14847${_scopeId}><div class="w-12 h-12 bg-sage-800 rounded-full flex items-center justify-center mr-4" data-v-d1c14847${_scopeId}>`);
            _push2(ssrRenderComponent(unref(FileText), { class: "w-6 h-6 text-white" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-d1c14847${_scopeId}><h1 class="text-2xl font-semibold text-gray-900" data-v-d1c14847${_scopeId}>Shipping Order: ${ssrInterpolate(__props.salesOrder.order_number)}</h1><p class="mt-1 text-sm text-gray-600" data-v-d1c14847${_scopeId}>Review dan kelola shipping order dari CS</p></div></div><div class="mt-4 sm:mt-0 flex space-x-3" data-v-d1c14847${_scopeId}>`);
            if (__props.salesOrder.status === "released") {
              _push2(`<button class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" data-v-d1c14847${_scopeId}>`);
            ...
            if (__props.salesOrder.status === "released") {
              _push2(`<button class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" data-v-d1c14847${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-6" data-v-d1c14847${_scopeId}><div class="lg:col-span-2 space-y-6" data-v-d1c14847${_scopeId}><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-d1c14847${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-d1c14847${_scopeId}><h3 class="text-lg font-medium text-gray-900" data-v-d1c14847${_scopeId}>Informasi shiping Order</h3></div><div class="p-6" data-v-d1c14847${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8" data-v-d1c14847${_scopeId}><div class="space-y-3" data-v-d1c14847${_scopeId}><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>ORDER NUMB:</span><span class="font-semibold" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.order_number)}</span></p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>REF NO:</span> ${ssrInterpolate(__props.salesOrder.ref_no || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>DATE:</span> ${ssrInterpolate(__props.salesOrder.so_date ? formatDate(__props.salesOrder.so_date) : "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>CUSTOMER:</span> ${ssrInterpolate(__props.salesOrder.customer)}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>SHIPPER:</span> ${ssrInterpolate(__props.salesOrder.shipper || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>BL/AWB:</span> ${ssrInterpolate(__props.salesOrder.bl_awb || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>LINER:</span> ${ssrInterpolate(__props.salesOrder.liner || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>VESSEL:</span> ${ssrInterpolate(__props.salesOrder.vessel || "-")}</p></div><div class="space-y-3" data-v-d1c14847${_scopeId}><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>ETA:</span> ${ssrInterpolate(__props.salesOrder.eta ? formatDate(__props.salesOrder.eta) : "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>ETD:</span> ${ssrInterpolate(__props.salesOrder.etd ? formatDate(__props.salesOrder.etd) : "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>AJU:</span> ${ssrInterpolate(__props.salesOrder.aju || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>SPPB DATE:</span> ${ssrInterpolate(__props.salesOrder.sppb_date ? formatDate(__props.salesOrder.sppb_date) : "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>SHIPMENT TYPE:</span> ${ssrInterpolate(__props.salesOrder.shipment_type || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>POL/POD:</span> ${ssrInterpolate([__props.salesOrder.pol, __props.salesOrder.pod].filter(Boolean).join(" / ") || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>GUDANG/UTC:</span> ${ssrInterpolate(__props.salesOrder.gudang_utc || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>PARTY/LCL:</span> ${ssrInterpolate(__props.salesOrder.party_lcl || "-")}</p><p class="text-gray-900" data-v-d1c14847${_scopeId}><span class="font-semibold text-gray-700" data-v-d1c14847${_scopeId}>PREPARED BY:</span> ${ssrInterpolate(__props.salesOrder.prepared_by || "-")}</p></div></div><div class="border-t border-gray-200 pt-6 mb-6" data-v-d1c14847${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-d1c14847${_scopeId}>EXCHANGE RATE</label><p class="text-gray-900 font-mono" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.exchange_rate ? formatNumber(__props.salesOrder.exchange_rate) : "-")}</p></div></div></div><div class="border-t border-gray-200 pt-6" data-v-d1c14847${_scopeId}><h4 class="text-md font-semibold text-gray-800 mb-4" data-v-d1c14847${_scopeId}>Detail Informasi</h4><div class="overflow-x-auto mb-6" data-v-d1c14847${_scopeId}><table class="min-w-full" data-v-d1c14847${_scopeId}><thead data-v-d1c14847${_scopeId}><tr class="bg-sage-50" data-v-d1c14847${_scopeId}><th class="px-6 py-4 text-left text-sm font-bold text-sage-800 uppercase tracking-wide" data-v-d1c14847${_scopeId}> JENIS BIAYA</th><th class="px-6 py-4 text-center text-sm font-bold text-sage-800 uppercase tracking-wide" data-v-d1c14847${_scopeId}> BUYING</th><th class="px-6 py-4 text-center text-sm font-bold text-sage-800 uppercase tracking-wide" data-v-d1c14847${_scopeId}> SELLING</th><th class="px-6 py-4 text-center text-sm font-bold text-sage-800 uppercase tracking-wide" data-v-d1c14847${_scopeId}> REVENUE</th><th class="px-6 py-4 text-left text-sm font-bold text-sage-800 uppercase tracking-wide" data-v-d1c14847${_scopeId}> REMARKS</th></tr></thead><tbody data-v-d1c14847${_scopeId}>`);
            if (__props.salesOrder.vendor_breakdown && __props.salesOrder.vendor_breakdown.length > 0) {
              ...
              ssrRenderList(__props.salesOrder.vendor_breakdown, (item, index) => {
                _push2(`<tr class="hover:bg-sage-50 transition-colors" data-v-d1c14847${_scopeId}><td class="px-6 py-4 text-sm text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(item.description || "Service Type")}</td><td class="px-6 py-4 text-center text-sm font-mono text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(item.buying_amount || 0))}</td><td class="px-6 py-4 text-center text-sm font-mono text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(item.selling_amount || 0))}</td><td class="${ssrRenderClass([getVendorProfit(item) >= 0 ? "text-sage-700" : "text-red-600", "px-6 py-4 text-center text-sm font-mono"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(getVendorProfit(item)))}</td><td class="px-6 py-4 text-sm text-gray-600" data-v-d1c14847${_scopeId}>${ssrInterpolate(item.remarks || "-")}</td></tr>`);
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<tr data-v-d1c14847${_scopeId}><td colspan="5" class="px-6 py-12 text-center text-gray-500" data-v-d1c14847${_scopeId}><div class="flex flex-col items-center" data-v-d1c14847${_scopeId}><div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4" data-v-d1c14847${_scopeId}><svg class="w-8 h-8 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-d1c14847${_scopeId}></path></svg></div><h3 class="text-lg font-medium text-gray-900 mb-2" data-v-d1c14847${_scopeId}>Tidak ada data breakdown</h3><p class="text-sm text-gray-500 max-w-sm" data-v-d1c14847${_scopeId}>Belum ada informasi vendor breakdown. Data akan muncul setelah informasi pricing diisi.</p></div></td></tr>`);
            }
            if (__props.salesOrder.vendor_breakdown && __props.salesOrder.vendor_breakdown.length > 0) {
              _push2(`<tr class="bg-sage-50 border-t border-gray-200" data-v-d1c14847${_scopeId}><td class="px-6 py-4 text-sm font-semibold text-sage-800 uppercase" data-v-d1c14847${_scopeId}> TOTAL </td><td class="px-6 py-4 text-center text-sm font-mono font-semibold text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</td><td class="px-6 py-4 text-center text-sm font-mono font-semibold text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</td><td class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-sage-700" : "text-red-600", "px-6 py-4 text-center text-sm font-mono font-semibold"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</td><td class="px-6 py-4 text-center text-gray-400" data-v-d1c14847${_scopeId}> - </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div>`);
            if (__props.salesOrder.remarks) {
              _push2(`<div class="mb-6" data-v-d1c14847${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-d1c14847${_scopeId}>Catatan (Remarks)</h5><div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4" data-v-d1c14847${_scopeId}><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.remarks)}</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.note) {
              _push2(`<div class="mb-6" data-v-d1c14847${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-d1c14847${_scopeId}>Catatan Tambahan (Note) </h5><div class="bg-blue-50 border border-blue-200 rounded-lg p-4" data-v-d1c14847${_scopeId}><p class="text-gray-900 whitespace-pre-wrap" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.note)}</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.other_costs && __props.salesOrder.other_costs.length > 0) {
              _push2(`<div class="mb-6" data-v-d1c14847${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-d1c14847${_scopeId}>Biaya Beban Lain (Operational)</h5><div class="bg-white border border-gray-200 rounded-lg overflow-hidden" data-v-d1c14847${_scopeId}><div class="overflow-x-auto" data-v-d1c14847${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-d1c14847${_scopeId}><thead class="bg-red-50" data-v-d1c14847${_scopeId}><tr data-v-d1c14847${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-red-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Description</th><th class="px-6 py-3 text-right text-xs font-medium text-red-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Amount</th><th class="px-6 py-3 text-left text-xs font-medium text-red-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Category</th><th class="px-6 py-3 text-left text-xs font-medium text-red-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Notes</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-d1c14847${_scopeId}><!--[-->`);
              ssrRenderList(__props.salesOrder.other_costs, (cost, index) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-d1c14847${_scopeId}><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(cost.description || "-")}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-mono text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(cost.amount || 0))}</td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600" data-v-d1c14847${_scopeId}>${ssrInterpolate(cost.category || "-")}</td><td class="px-6 py-4 text-sm text-gray-600" data-v-d1c14847${_scopeId}>${ssrInterpolate(cost.notes || "-")}</td></tr>`);
              });
              _push2(`<!--]--></tbody><tfoot class="bg-red-50" data-v-d1c14847${_scopeId}><tr data-v-d1c14847${_scopeId}><td class="px-6 py-3 text-sm font-semibold text-red-800 uppercase" data-v-d1c14847${_scopeId}>Total</td><td class="px-6 py-3 text-right text-sm font-mono font-semibold text-red-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(__props.salesOrder.other_costs.reduce((total, cost) => total + (parseFloat(cost.amount) || 0), 0)))}</td><td colspan="2" class="px-6 py-3" data-v-d1c14847${_scopeId}></td></tr></tfoot></table></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.reimbursement_items && __props.salesOrder.reimbursement_items.length > 0) {
              _push2(`<div class="mb-6" data-v-d1c14847${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-d1c14847${_scopeId}>Items Reimbursement</h5><div class="bg-white border border-gray-200 rounded-lg overflow-hidden" data-v-d1c14847${_scopeId}><div class="overflow-x-auto" data-v-d1c14847${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-d1c14847${_scopeId}><thead class="bg-orange-50" data-v-d1c14847${_scopeId}><tr data-v-d1c14847${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Description</th><th class="px-6 py-3 text-right text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Amount</th><th class="px-6 py-3 text-center text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Status</th><th class="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-d1c14847${_scopeId}>Notes</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-d1c14847${_scopeId}><!--[-->`);
              ssrRenderList(__props.salesOrder.reimbursement_items, (item, index) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-d1c14847${_scopeId}><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(item.description || "-")}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-mono text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(item.amount || 0))}</td><td class="px-6 py-4 whitespace-nowrap text-center" data-v-d1c14847${_scopeId}><span class="${ssrRenderClass([getReimbursementStatusColor(item.status), "inline-flex px-2 py-1 text-xs font-semibold rounded-full"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(getReimbursementStatusText(item.status))}</span></td><td class="px-6 py-4 text-sm text-gray-600" data-v-d1c14847${_scopeId}>${ssrInterpolate(item.notes || "-")}</td></tr>`);
              });
              _push2(`<!--]--></tbody><tfoot class="bg-orange-50" data-v-d1c14847${_scopeId}><tr data-v-d1c14847${_scopeId}><td class="px-6 py-3 text-sm font-semibold text-orange-800 uppercase" data-v-d1c14847${_scopeId}>Total</td><td class="px-6 py-3 text-right text-sm font-mono font-semibold text-orange-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(__props.salesOrder.reimbursement_items.reduce((total, item) => total + (parseFloat(item.amount) || 0), 0)))}</td><td colspan="2" class="px-6 py-3" data-v-d1c14847${_scopeId}></td></tr></tfoot></table></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 pt-6 border-t border-gray-200" data-v-d1c14847${_scopeId}><div class="space-y-3" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>COMMODITY/URAIAN BARANG</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.commodity || "-")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>QTY</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.qty || "-")} ${ssrInterpolate(__props.salesOrder.package_unit_label || __props.salesOrder.package_unit)}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>NET WEIGHT (KG)</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.net_weight ? formatWeight(__props.salesOrder.net_weight) : "-")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>GROSS WEIGHT (KG)</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.gross_weight ? formatWeight(__props.salesOrder.gross_weight) : "-")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>MEAS (M³)</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.measurement ? formatMeasurement(__props.salesOrder.measurement) : "-")}</p></div></div><div class="space-y-3" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>CONTAINER NO</label>`);
            if (Array.isArray(__props.salesOrder.container_no) && __props.salesOrder.container_no.length) {
              _push2(`<div class="space-y-2" data-v-d1c14847${_scopeId}><div class="flex flex-wrap gap-2" data-v-d1c14847${_scopeId}><!--[-->`);
              ssrRenderList(__props.salesOrder.container_no, (container, index) => {
                _push2(`<span class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-sm font-medium" data-v-d1c14847${_scopeId}>${ssrInterpolate(container)}</span>`);
              });
              _push2(`<!--]--></div><p class="text-xs text-gray-500" data-v-d1c14847${_scopeId}> Total: ${ssrInterpolate(__props.salesOrder.container_no.length)} container </p></div>`);
            } else if (__props.salesOrder.container_no) {
              _push2(`<p class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 text-blue-800 text-sm font-medium" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.container_no)}</p>`);
            } else {
              _push2(`<p class="text-gray-500" data-v-d1c14847${_scopeId}>-</p>`);
            }
            _push2(`</div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>INVOICE NUMB</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.invoice_number || "-")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>INVOICE DATE</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.invoice_date ? formatDate(__props.salesOrder.invoice_date) : "-")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>T.O.P</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.top || "-")}</p></div></div></div></div></div></div>`);
            if ((__props.salesOrder.status === "released" || __props.salesOrder.status === "approved") && __props.salesOrder.released_at) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-d1c14847${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-d1c14847${_scopeId}><div class="flex justify-between items-center" data-v-d1c14847${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-d1c14847${_scopeId}>Invoice Management</h3><button class="inline-flex items-center px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors" data-v-d1c14847${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-d1c14847${_scopeId}></path></svg> Buat Invoice </button></div></div><div class="p-6" data-v-d1c14847${_scopeId}>`);
              if (__props.salesOrder.invoices && __props.salesOrder.invoices.filter((inv) => inv.invoice_type === "main").length > 0) {
                _push2(`<div data-v-d1c14847${_scopeId}><h4 class="text-md font-semibold text-gray-800 mb-4" data-v-d1c14847${_scopeId}>Main Invoices</h4><!--[-->`);
                ssrRenderList(__props.salesOrder.invoices.filter((inv) => inv.invoice_type === "main"), (invoice) => {
                  _push2(`<div class="border border-gray-200 rounded-lg p-4 mb-4 last:mb-0" data-v-d1c14847${_scopeId}><div class="flex justify-between items-start mb-3" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><h5 class="font-semibold text-gray-900 flex items-center" data-v-d1c14847${_scopeId}><span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium mr-2 bg-blue-100 text-blue-800" data-v-d1c14847${_scopeId}> Main </span> ${ssrInterpolate(invoice.invoice_number)}</h5><p class="text-sm text-gray-600" data-v-d1c14847${_scopeId}>${ssrInterpolate(invoice.description || "MainInvoice")}</p></div><div class="text-right" data-v-d1c14847${_scopeId}><p class="font-semibold text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(invoice.total_amount || 0))}</p><span class="${ssrRenderClass([getInvoiceStatusColor(invoice.status), "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(getInvoiceStatusLabel(invoice.status))}</span></div></div><div class="grid grid-cols-2 gap-4 text-sm" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><span class="text-gray-500" data-v-d1c14847${_scopeId}>Date:</span><span class="ml-1 text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatDate(invoice.invoice_date))}</span></div><div data-v-d1c14847${_scopeId}><span class="text-gray-500" data-v-d1c14847${_scopeId}>Customer:</span><span class="ml-1 text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(invoice.customer_name || __props.salesOrder.customer)}</span></div></div><div class="mt-3 flex space-x-2" data-v-d1c14847${_scopeId}><a${ssrRenderAttr("href", _ctx.route("admin-keuangan.invoices.print", invoice.id))} target="_blank" class="inline-flex items-center px-3 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition-colors" data-v-d1c14847${_scopeId}><svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" data-v-d1c14847${_scopeId}></path></svg> Download PDF </a>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(`<svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-d1c14847${_scopeId2}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-d1c14847${_scopeId2}></path></svg> View `);
                      } else {
                        return [
              ...
              if (__props.salesOrder.invoices && __props.salesOrder.invoices.filter((inv) => inv.invoice_type === "reimbursement").length > 0) {
                _push2(`<div class="mt-6" data-v-d1c14847${_scopeId}><h4 class="text-md font-semibold text-gray-800 mb-4" data-v-d1c14847${_scopeId}>Reimbursement Invoices</h4><!--[-->`);
                ssrRenderList(__props.salesOrder.invoices.filter((inv) => inv.invoice_type === "reimbursement"), (invoice) => {
                  _push2(`<div class="border border-gray-200 rounded-lg p-4 mb-4 last:mb-0" data-v-d1c14847${_scopeId}><div class="flex justify-between items-start mb-3" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><h5 class="font-semibold text-gray-900 flex items-center" data-v-d1c14847${_scopeId}><span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium mr-2 bg-orange-100 text-orange-800" data-v-d1c14847${_scopeId}> Reimbursement </span> ${ssrInterpolate(invoice.invoice_number)}</h5><p class="text-sm text-gray-600" data-v-d1c14847${_scopeId}>${ssrInterpolate(invoice.description || "Reimbursement Invoice")}</p></div><div class="text-right" data-v-d1c14847${_scopeId}><p class="font-semibold text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatCurrency(invoice.total_amount || 0))}</p><span class="${ssrRenderClass([getInvoiceStatusColor(invoice.status), "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(getInvoiceStatusLabel(invoice.status))}</span></div></div><div class="grid grid-cols-2 gap-4 text-sm" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><span class="text-gray-500" data-v-d1c14847${_scopeId}>Date:</span><span class="ml-1 text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatDate(invoice.invoice_date))}</span></div><div data-v-d1c14847${_scopeId}><span class="text-gray-500" data-v-d1c14847${_scopeId}>Customer:</span><span class="ml-1 text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(invoice.customer_name || __props.salesOrder.customer)}</span></div></div><div class="mt-3 flex space-x-2" data-v-d1c14847${_scopeId}><a${ssrRenderAttr("href", _ctx.route("admin-keuangan.invoices.print", invoice.id))} target="_blank" class="inline-flex items-center px-3 py-1 bg-orange-600 text-white text-sm rounded hover:bg-orange-700 transition-colors" data-v-d1c14847${_scopeId}><svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" data-v-d1c14847${_scopeId}></path></svg> Download PDF -R </a>`);
                  _push2(ssrRenderComponent(unref(Link), {
                    href: _ctx.route("admin-keuangan.invoices.show", invoice.id),
                    class: "inline-flex items-center px-3 py-1 bg-gray-600 text-white text-sm rounded hover:bg-gray-700 transition-colors"
                  }, {
              ...
              if (!__props.salesOrder.invoices || __props.salesOrder.invoices.length === 0) {
                _push2(`<div class="text-center py-8" data-v-d1c14847${_scopeId}><div class="flex flex-col items-center" data-v-d1c14847${_scopeId}><div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4" data-v-d1c14847${_scopeId}><svg class="w-8 h-8 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-d1c14847${_scopeId}></path></svg></div><h3 class="text-lg font-medium text-gray-900 mb-2" data-v-d1c14847${_scopeId}>Belum ada invoice</h3><p class="text-sm text-gray-500 max-w-sm" data-v-d1c14847${_scopeId}>Belum ada invoice yang dibuat untuk shipping order ini. Klik tombol &quot;Buat Invoice&quot; untuk memulai.</p></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            _push2(`</div><div class="space-y-6" data-v-d1c14847${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-d1c14847${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-d1c14847${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-d1c14847${_scopeId}>Status</h3></div><div class="p-6" data-v-d1c14847${_scopeId}><span class="${ssrRenderClass([getStatusColor(__props.salesOrder.status), "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium w-full justify-center"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(getStatusLabel(__props.salesOrder.status || "released"))}</span></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-d1c14847${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-d1c14847${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-d1c14847${_scopeId}>Informasi Rilis</h3></div><div class="p-6 space-y-4" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>Dirilis Oleh</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(((_a = __props.salesOrder.released_by) == null ? void 0 : _a.name) || "Unknown")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>Tanggal Rilis</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.released_at))}</p></div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-d1c14847${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-d1c14847${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-d1c14847${_scopeId}>System Information</h3></div><div class="p-6 space-y-4" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>Created By</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(((_b = __props.salesOrder.creator) == null ? void 0 : _b.name) || "Unknown")}</p></div><div data-v-d1c14847${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d1c14847${_scopeId}>Created At</label><p class="text-gray-900" data-v-d1c14847${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.created_at))}</p></div></div></div></div></div></div>`);
            if (showApprovalModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-d1c14847${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-d1c14847${_scopeId}><div class="flex items-center mb-4" data-v-d1c14847${_scopeId}><div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center mr-3" data-v-d1c14847${_scopeId}><svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" data-v-d1c14847${_scopeId}></path></svg></div><h3 class="text-lg font-semibold text-gray-900" data-v-d1c14847${_scopeId}>Konfirmasi Persetujuan</h3></div><div class="mb-6 space-y-3" data-v-d1c14847${_scopeId}><p class="text-gray-600" data-v-d1c14847${_scopeId}>Apakah Anda yakin ingin menyetujui shipping order ini?</p><div class="bg-gray-50 p-3 rounded-lg space-y-2" data-v-d1c14847${_scopeId}><div class="flex justify-between text-sm" data-v-d1c14847${_scopeId}><span class="font-medium" data-v-d1c14847${_scopeId}>Order Number:</span><span data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.order_number)}</span></div><div class="flex justify-between text-sm" data-v-d1c14847${_scopeId}><span class="font-medium" data-v-d1c14847${_scopeId}>Customer:</span><span data-v-d1c14847${_scopeId}>${ssrInterpolate(__props.salesOrder.customer)}</span></div><div class="flex justify-between text-sm" data-v-d1c14847${_scopeId}><span class="font-medium" data-v-d1c14847${_scopeId}>Status Saat Ini:</span><span class="${ssrRenderClass([getStatusColor(__props.salesOrder.status), "inline-flex items-center px-2 py-1 rounded text-xs font-medium"])}" data-v-d1c14847${_scopeId}>${ssrInterpolate(getStatusLabel(__props.salesOrder.status))}</span></div></div>`);
              if (debugInfo.value) {
                _push2(`<div class="bg-yellow-50 border border-yellow-200 p-3 rounded-lg" data-v-d1c14847${_scopeId}><div class="text-sm font-medium text-yellow-800 mb-1" data-v-d1c14847${_scopeId}>Debug Info:</div><div class="text-xs text-yellow-700" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}>Status: ${ssrInterpolate(__props.salesOrder.status)}</div><div data-v-d1c14847${_scopeId}>Released At: ${ssrInterpolate(__props.salesOrder.released_at || "NULL")}</div><div data-v-d1c14847${_scopeId}>Released By: ${ssrInterpolate(((_c = __props.salesOrder.released_by) == null ? void 0 : _c.name) || "NULL")}</div></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="flex justify-end space-x-3" data-v-d1c14847${_scopeId}><button class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors" data-v-d1c14847${_scopeId}> Batal </button><button class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors" data-v-d1c14847${_scopeId}> Ya, Setujui </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showRejectModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-d1c14847${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-d1c14847${_scopeId}><h3 class="text-lg font-semibold mb-4" data-v-d1c14847${_scopeId}>Tolak Shipping Order</h3><p class="text-gray-600 mb-4" data-v-d1c14847${_scopeId}>Berikan alasan penolakan:</p><textarea class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent" rows="4" placeholder="Masukkan alasan penolakan..." data-v-d1c14847${_scopeId}>${ssrInterpolate(rejectionReason.value)}</textarea><div class="flex justify-end space-x-3 mt-4" data-v-d1c14847${_scopeId}><button class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 transition-colors" data-v-d1c14847${_scopeId}> Batal </button><button${ssrIncludeBooleanAttr(!rejectionReason.value.trim()) ? " disabled" : ""} class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" data-v-d1c14847${_scopeId}> Tolak </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showInvoiceCreateModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-d1c14847${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-d1c14847${_scopeId}><div class="flex items-center mb-4" data-v-d1c14847${_scopeId}><div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3" data-v-d1c14847${_scopeId}><svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d1c14847${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-d1c14847${_scopeId}></path></svg></div><h3 class="text-lg font-semibold text-gray-900" data-v-d1c14847${_scopeId}>Pilih Tipe Invoice</h3></div><div class="mb-6" data-v-d1c14847${_scopeId}><p class="text-gray-600 mb-4" data-v-d1c14847${_scopeId}>Pilih tipe invoice yang ingin dibuat untuk shipping order ini:</p><div class="space-y-3" data-v-d1c14847${_scopeId}><label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer" data-v-d1c14847${_scopeId}><input type="radio" name="invoice_type" value="main"${ssrIncludeBooleanAttr(ssrLooseEqual(selectedInvoiceType.value, "main")) ? " checked" : ""} class="mr-3" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><div class="font-medium text-gray-900" data-v-d1c14847${_scopeId}>Main Invoice</div><div class="text-sm text-gray-600" data-v-d1c14847${_scopeId}>Invoice utama untuk tagihan customer</div></div></label><label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer" data-v-d1c14847${_scopeId}><input type="radio" name="invoice_type" value="reimbursement"${ssrIncludeBooleanAttr(ssrLooseEqual(selectedInvoiceType.value, "reimbursement")) ? " checked" : ""} class="mr-3" data-v-d1c14847${_scopeId}><div data-v-d1c14847${_scopeId}><div class="font-medium text-gray-900" data-v-d1c14847${_scopeId}>Reimbursement Invoice</div><div class="text-sm text-gray-600" data-v-d1c14847${_scopeId}>Invoice untuk penggantian biaya pihak ketiga </div></div></label></div></div><div class="flex justify-end space-x-3" data-v-d1c14847${_scopeId}><button class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors" data-v-d1c14847${_scopeId}> Batal </button><button${ssrIncludeBooleanAttr(!selectedInvoiceType.value) ? " disabled" : ""} class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" data-v-d1c14847${_scopeId}> Lanjutkan </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d1c14847"]]);
export {
  Show as default
};
