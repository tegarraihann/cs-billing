import { ref, watch, computed, withCtx, unref, createVNode, resolveDynamicComponent, createBlock, createCommentVNode, openBlock, toDisplayString, withModifiers, withDirectives, Fragment, renderList, vModelSelect, vModelText, createTextVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderVNode } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const selectedYear = ref(((_b = props.filters) == null ? void 0 : _b.year) || "");
    ...
    const balanceCheck = computed(() => {
      ...
      return {
        assets_total: Number(((_b2 = (_a2 = props.statement) == null ? void 0 : _a2.balance_check) == null ? void 0 : _b2.assets_total) || 0),
    ...
    const liabilitiesTotal = computed(() => {
      var _a2, _b2, _c;
      return Number(((_c = (_b2 = (_a2 = props.statement) == null ? void 0 : _a2.sections) == null ? void 0 : _b2.liabilities) == null ? void 0 : _c.total) || 0);
    });
    computed(() => {
      var _a2, _b2, _c;
      return Number(((_c = (_b2 = (_a2 = props.statement) == null ? void 0 : _a2.sections) == null ? void 0 : _b2.equity) == null ? void 0 : _c.total) || 0);
    });
    ...
    const refreshData = () => {
      ...
      router.get(
        ...
        { date: selectedDate.value, year: selectedYear.value || void 0 },
        {
          preserveState: true,
          replace: true,
          onFinish: () => {
    ...
    const exportPdf = () => {
      ...
      const url = route("admin-keuangan.financial-position.pdf", {
        ...
        year: selectedYear.value || void 0
      });
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6"${_scopeId}><div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Statement of Financial Position</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}> Summary of assets, liabilities, and equity as of the selected cut-off date. </p>`);
            if (__props.statement.generated_at) {
              _push2(`<p class="mt-1 text-xs text-gray-400"${_scopeId}> Last updated: ${ssrInterpolate(formatDateTime(__props.statement.generated_at))}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><form class="bg-white border border-sage-200 rounded-lg p-4 shadow-sm w-full sm:w-auto"${_scopeId}><div class="flex flex-col sm:flex-row sm:items-end gap-4"${_scopeId}>`);
            if (__props.closedYears.length) {
              _push2(`<div${_scopeId}><label for="closing-year" class="block text-sm font-medium text-gray-700"${_scopeId}> Closed Year </label><div class="mt-1 relative"${_scopeId}><select id="closing-year" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring focus:ring-sage-200 focus:ring-opacity-50 text-sm"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(selectedYear.value) ? ssrLooseContain(selectedYear.value, "") : ssrLooseEqual(selectedYear.value, "")) ? " selected" : ""}${_scopeId}>Custom Date</option><!--[-->`);
              ssrRenderList(__props.closedYears, (year) => {
                _push2(`<option${ssrRenderAttr("value", year)}${ssrIncludeBooleanAttr(Array.isArray(selectedYear.value) ? ssrLooseContain(selectedYear.value, year) : ssrLooseEqual(selectedYear.value, year)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(year)}</option>`);
              });
              _push2(`<!--]--></select></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div${_scopeId}><label for="cutoff-date" class="block text-sm font-medium text-gray-700"${_scopeId}> Cut-off Date </label><div class="mt-1 relative"${_scopeId}><input id="cutoff-date" type="date"${ssrRenderAttr("value", selectedDate.value)} class="block w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring focus:ring-sage-200 focus:ring-opacity-50 text-sm"${_scopeId}>`);
            ...
            _push2(` Download PDF </button></div></div><p class="mt-2 text-xs text-gray-400"${_scopeId}> Changes will automatically reload the report. </p></form></div><div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"${_scopeId}><div class="bg-white border border-sage-200 rounded-lg shadow-sm p-5 flex items-center"${_scopeId}><div class="p-3 bg-sage-100 rounded-lg"${_scopeId}>`);
            ...
            _push2(`</div><div class="ml-4"${_scopeId}><p class="text-sm text-gray-500"${_scopeId}>Equity (Info)</p><p class="text-lg font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(equityTotalDisplay.value)}</p></div></div><div class="${ssrRenderClass([isBalanced.value ? "border-emerald-200" : "border-amber-200", "bg-white border rounded-lg shadow-sm p-5 flex items-center"])}"${_scopeId}><div class="${ssrRenderClass([isBalanced.value ? "bg-emerald-100" : "bg-amber-100", "p-3 rounded-lg"])}"${_scopeId}>`);
            ...
            if (!isBalanced.value) {
              ...
              _push2(`<div${_scopeId}> There is a difference between total assets and total liabilities + equity. Review manual adjustments or ensure all modules are posted correctly. </div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`<div${_scopeId}> The <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-blue-100 text-blue-800 text-xs font-medium"${_scopeId}>Auto</span> label indicates balances calculated automatically from related modules. If manual adjustments are needed, create entries in <span class="font-medium"${_scopeId}>Financial Position Adjustments</span>. Manual entries are labeled <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 text-xs font-medium"${_scopeId}>Manual</span>. </div></div><div class="space-y-6"${_scopeId}><!--[-->`);
            ssrRenderList(visibleSections.value, (section, sectionKey) => {
              ...
              ssrRenderList(section.groups, (group) => {
                _push2(`<div class="space-y-3"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide"${_scopeId}>${ssrInterpolate(group.title)}</h3>`);
                if (sectionKey !== "equity") {
                  _push2(`<span class="text-sm font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(group.total))}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="bg-white border border-gray-100 rounded-lg overflow-hidden"${_scopeId}><table class="min-w-full divide-y divide-gray-100"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th scope="col" class="px-4 py-2 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider"${_scopeId}> Account </th><th scope="col" class="px-4 py-2 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider"${_scopeId}> Balance </th><th scope="col" class="px-4 py-2 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider"${_scopeId}> Source </th></tr></thead><tbody class="bg-white divide-y divide-gray-100"${_scopeId}><!--[-->`);
                ...
                _push2(`<!--]--></tbody>`);
                if (sectionKey !== "equity") {
                  _push2(`<tfoot${_scopeId}><tr class="bg-gray-50"${_scopeId}><td class="px-4 py-3 text-sm font-semibold text-gray-700"${_scopeId}> Total ${ssrInterpolate(group.title)}</td><td class="px-4 py-3 text-right text-sm font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(group.total))}</td><td${_scopeId}></td></tr></tfoot>`);
                } else {
                  _push2(`<!---->`);
                }
              ...
              _push2(`<!--]--></div>`);
              if (sectionKey !== "equity") {
                _push2(`<div class="px-6 py-4 border-t border-sage-200 bg-sage-50 flex items-center justify-between"${_scopeId}><span class="text-sm font-semibold text-sage-800"${_scopeId}> Total ${ssrInterpolate(section.title)}</span><span class="text-base font-bold text-sage-900"${_scopeId}>${ssrInterpolate(formatCurrency(section.total))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6" }, [
                  createVNode("div", { class: "flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between" }, [
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, " Summary of assets, liabilities, and equity as of the selected cut-off date. "),
                      __props.statement.generated_at ? (openBlock(), createBlock("p", {
                        key: 0,
                        class: "mt-1 text-xs text-gray-400"
                      }, " Last updated: " + toDisplayString(formatDateTime(__props.statement.generated_at)), 1)) : createCommentVNode("", true)
                    ]),
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "flex flex-col sm:flex-row sm:items-end gap-4" }, [
                        __props.closedYears.length ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("label", {
                            for: "closing-year",
                          ...
                          createVNode("div", { class: "mt-1 relative" }, [
                            withDirectives(createVNode("select", {
                              ...
                              createVNode("option", { value: "" }, "Custom Date"),
                              (openBlock(true), createBlock(Fragment, null, renderList(__props.closedYears, (year) => {
                      ...
                      createVNode("p", { class: "mt-2 text-xs text-gray-400" }, " Changes will automatically reload the report. ")
                    ], 32)
                  ]),
                  createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4" }, [
                    ...
                    createVNode("div", { class: "bg-white border border-sage-200 rounded-lg shadow-sm p-5 flex items-center" }, [
                      ...
                      createVNode("div", { class: "ml-4" }, [
                        createVNode("p", { class: "text-sm text-gray-500" }, "Equity (Info)"),
                        createVNode("p", { class: "text-lg font-semibold text-gray-900" }, toDisplayString(equityTotalDisplay.value), 1)
                      ])
                    ]),
                    createVNode("div", {
                  ...
                  !isBalanced.value ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", null, " There is a difference between total assets and total liabilities + equity. Review manual adjustments or ensure all modules are posted correctly. ")
                  ])) : createCommentVNode("", true),
                  createVNode("div", { class: "rounded-lg border border-sage-200 bg-white px-4 py-3 text-sm text-gray-600 flex items-start gap-3" }, [
                    ...
                    createVNode("div", null, [
                      ...
                      createTextVNode(" label indicates balances calculated automatically from related modules. If manual adjustments are needed, create entries in "),
                      createVNode("span", { class: "font-medium" }, "Financial Position Adjustments"),
                      createTextVNode(". Manual entries are labeled "),
                  ...
                  createVNode("div", { class: "space-y-6" }, [
                    (openBlock(true), createBlock(Fragment, null, renderList(visibleSections.value, (section, sectionKey) => {
                      return openBlock(), createBlock("div", {
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(section.groups, (group) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "flex items-center justify-between" }, [
                                ...
                                sectionKey !== "equity" ? (openBlock(), createBlock("span", {
                                  key: 0,
                                  class: "text-sm font-semibold text-gray-900"
                                }, toDisplayString(formatCurrency(group.total)), 1)) : createCommentVNode("", true)
                              ]),
                              createVNode("div", { class: "bg-white border border-gray-100 rounded-lg overflow-hidden" }, [
                                createVNode("table", { class: "min-w-full divide-y divide-gray-100" }, [
                                  ...
                                  sectionKey !== "equity" ? (openBlock(), createBlock("tfoot", { key: 0 }, [
                        ...
                        sectionKey !== "equity" ? (openBlock(), createBlock("div", {
                          key: 0,
                          class: "px-6 py-4 border-t border-sage-200 bg-sage-50 flex items-center justify-between"
                        }, [
