import { computed, ref, reactive, watch, withCtx, unref, createVNode, createBlock, createCommentVNode, toDisplayString, openBlock, Fragment, renderList, withDirectives, vModelSelect, vModelText, withModifiers, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.transactions.data.length === 0) {
              _push2(`<tr${_scopeId}><td colspan="5" class="px-6 py-8 text-center text-sm text-gray-500"${_scopeId}> Belum ada transaksi supplies. </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
                ...
                createVNode("div", { class: "bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4" }, [
                  ...
                  createVNode("div", { class: "px-6 py-4 border-t border-sage-100 flex justify-end gap-3" }, [
                    ...
                    createVNode("button", {
                      type: "button",
                      class: "inline-flex items-center px-4 py-2 bg-sage-600 text-white rounded-md text-sm font-semibold hover:bg-sage-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-500",
                      disabled: unref(topupForm).processing,
                      onClick: submitTopup
                ...
                createVNode("div", { class: "bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4" }, [
                  ...
                  createVNode("div", { class: "px-6 py-4 border-t border-sage-100 flex justify-end gap-3" }, [
                    ...
                    createVNode("button", {
                      type: "button",
                      class: "inline-flex items-center px-4 py-2 bg-sage-600 text-white rounded-md text-sm font-semibold hover:bg-sage-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-500",
                      disabled: unref(usageForm).processing,
                      onClick: submitUsage
                    }, " Simpan ", 8, ["disabled"])
                  ])
                ])
