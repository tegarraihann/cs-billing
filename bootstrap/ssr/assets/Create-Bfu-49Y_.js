import { ref, computed, watch, withCtx, unref, createVNode, createTextVNode, withModifiers, withDirectives, createBlock, openBlock, Fragment, renderList, toDisplayString, vModelSelect, createCommentVNode, vModelText, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Add Employee Salary" }, null, _parent2, _scopeId));
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Saving..." : "Save Salary")}</button></div></form></div></div><div class="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4"${_scopeId}><div class="flex"${_scopeId}><div class="flex-shrink-0"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Info), { class: "h-5 w-5 text-blue-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-3"${_scopeId}><h3 class="text-sm font-medium text-blue-800"${_scopeId}>Information</h3><div class="mt-2 text-sm text-blue-700"${_scopeId}><ul class="list-disc list-inside space-y-1"${_scopeId}><li${_scopeId}>New salaries start in &quot;Draft&quot; status.</li><li${_scopeId}>After approval, the salary is automatically posted to the profit &amp; loss report.</li><li${_scopeId}>Make sure the period matches the salary month to be paid.</li></ul></div></div></div></div></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Add Employee Salary" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Add Employee Salary"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Enter a new employee salary record.")
                  ]),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "mt-8 flex justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            createTextVNode(" " + toDisplayString(processing.value ? "Saving..." : "Save Salary"), 1)
                          ], 8, ["disabled"])
                        ])
                      ], 32)
                    ])
                  ...
                  createVNode("div", { class: "mt-6 bg-blue-50 border border-blue-200 rounded-md p-4" }, [
                    createVNode("div", { class: "flex" }, [
                      ...
                      createVNode("div", { class: "ml-3" }, [
                        createVNode("h3", { class: "text-sm font-medium text-blue-800" }, "Information"),
                        createVNode("div", { class: "mt-2 text-sm text-blue-700" }, [
                          createVNode("ul", { class: "list-disc list-inside space-y-1" }, [
                            createVNode("li", null, 'New salaries start in "Draft" status.'),
                            createVNode("li", null, "After approval, the salary is automatically posted to the profit & loss report."),
                            createVNode("li", null, "Make sure the period matches the salary month to be paid.")
                          ])
                        ])
                      ])
                    ])
