    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminCSLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b2;
          if (_push2) {
            _push2(`<div class="py-6" data-v-7715f236${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-7715f236${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6" data-v-7715f236${_scopeId}><div data-v-7715f236${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-7715f236${_scopeId}>Manajemen Shipping Order</h1><p class="mt-1 text-sm text-gray-600" data-v-7715f236${_scopeId}>Kelola dokumen Shipping Order dan penawaran harga</p></div><div class="mt-4 sm:mt-0 flex space-x-2" data-v-7715f236${_scopeId}>`);
            ...
            _push2(`</div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-7715f236${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-7715f236${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-7715f236${_scopeId}>Filter Data</h3><div class="grid grid-cols-1 md:grid-cols-4 gap-4" data-v-7715f236${_scopeId}><div class="md:col-span-2" data-v-7715f236${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-7715f236${_scopeId}>Cari Data</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Cari SO Number, Customer, Consignee..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-7715f236${_scopeId}></div><div data-v-7715f236${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-7715f236${_scopeId}>Status</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-7715f236${_scopeId}><option value="" data-v-7715f236${ssrIncludeBooleanAttr(Array.isArray(form.status) ? ssrLooseContain(form.status, "") : ssrLooseEqual(form.status, "")) ? " selected" : ""}${_scopeId}>Semua Status</option><option value="draft" data-v-7715f236${ssrIncludeBooleanAttr(Array.isArray(form.status) ? ssrLooseContain(form.status, "draft") : ssrLooseEqual(form.status, "draft")) ? " selected" : ""}${_scopeId}>Draft</option><option value="sent" data-v-7715f236${ssrIncludeBooleanAttr(Array.isArray(form.status) ? ssrLooseContain(form.status, "sent") : ssrLooseEqual(form.status, "sent")) ? " selected" : ""}${_scopeId}>Terkirim</option><option value="confirmed" data-v-7715f236${ssrIncludeBooleanAttr(Array.isArray(form.status) ? ssrLooseContain(form.status, "confirmed") : ssrLooseEqual(form.status, "confirmed")) ? " selected" : ""}${_scopeId}>Dikonfirmasi</option><option value="cancelled" data-v-7715f236${ssrIncludeBooleanAttr(Array.isArray(form.status) ? ssrLooseContain(form.status, "cancelled") : ssrLooseEqual(form.status, "cancelled")) ? " selected" : ""}${_scopeId}>Dibatalkan</option></select></div><div class="flex items-end" data-v-7715f236${_scopeId}><button class="w-full px-4 py-2 bg-sage-800 text-white rounded-md transition-colors hover:bg-sage-900" data-v-7715f236${_scopeId}> Cari </button></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md" data-v-7715f236${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-7715f236${_scopeId}><div class="sm:flex sm:items-center sm:justify-between mb-4" data-v-7715f236${_scopeId}><div data-v-7715f236${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-7715f236${_scopeId}>Daftar Shipping Order</h3><p class="mt-1 text-sm text-gray-600" data-v-7715f236${_scopeId}>Total: ${ssrInterpolate(((_a2 = __props.salesOrders) == null ? void 0 : _a2.total) || 0)} data</p></div></div><div class="overflow-x-auto" data-v-7715f236${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-7715f236${_scopeId}><thead class="bg-gray-50" data-v-7715f236${_scopeId}><tr data-v-7715f236${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Order Number </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Customer </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Shipper </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Shipment Type </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Commodity </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> QTY </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Container No </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Status </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-7715f236${_scopeId}> Aksi </th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-7715f236${_scopeId}><!--[-->`);
            ssrRenderList(__props.salesOrders.data, (salesOrder) => {
              _push2(`<tr class="hover:bg-gray-50 transition-colors" data-v-7715f236${_scopeId}><td class="px-6 py-4 text-sm font-medium text-gray-900" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.order_number || salesOrder.so_number)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-7715f236${_scopeId}><div data-v-7715f236${_scopeId}><div class="font-medium" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.customer || salesOrder.customer_name)}</div>`);
              if (salesOrder.customer_code) {
                _push2(`<div class="text-gray-500" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.customer_code)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td><td class="px-6 py-4 text-sm text-gray-900" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.shipper || salesOrder.consignee_shipper || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-7715f236${_scopeId}><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.shipment_type || "-")}</span></td><td class="px-6 py-4 text-sm text-gray-900" data-v-7715f236${_scopeId}><div class="max-w-32 truncate"${ssrRenderAttr("title", salesOrder.commodity)} data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.commodity || salesOrder.goods || "-")}</div></td><td class="px-6 py-4 text-sm text-gray-900" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.qty || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-7715f236${_scopeId}>`);
              if (salesOrder.container_no && Array.isArray(salesOrder.container_no)) {
                _push2(`<div class="space-y-1" data-v-7715f236${_scopeId}><!--[-->`);
                ssrRenderList(salesOrder.container_no.slice(0, 2), (container, index) => {
                  _push2(`<span class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full mr-1" data-v-7715f236${_scopeId}>${ssrInterpolate(container)}</span>`);
                });
                _push2(`<!--]-->`);
                if (salesOrder.container_no.length > 2) {
                  _push2(`<div class="text-xs text-gray-500" data-v-7715f236${_scopeId}> +${ssrInterpolate(salesOrder.container_no.length - 2)} lainnya </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              } else if (salesOrder.container_no) {
                _push2(`<span class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full" data-v-7715f236${_scopeId}>${ssrInterpolate(salesOrder.container_no)}</span>`);
              } else {
                _push2(`<span class="text-gray-500" data-v-7715f236${_scopeId}>-</span>`);
              }
              _push2(`</td><td class="px-6 py-4 text-sm" data-v-7715f236${_scopeId}><span class="${ssrRenderClass([getStatusColor(salesOrder.status), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-7715f236${_scopeId}>${ssrInterpolate(getStatusLabel(salesOrder.status))}</span></td><td class="px-6 py-4 text-sm font-medium" data-v-7715f236${_scopeId}><div class="flex items-center space-x-2" data-v-7715f236${_scopeId}><button${ssrIncludeBooleanAttr(!salesOrder.cs_can_release) ? " disabled" : ""} class="${ssrRenderClass([!salesOrder.cs_can_release ? "text-gray-400 bg-gray-100 cursor-not-allowed" : "text-sage-600 hover:text-sage-900 hover:bg-sage-100", "inline-flex items-center justify-center w-8 h-8 rounded-full transition-colors"])}"${ssrRenderAttr("title", !salesOrder.cs_can_release ? salesOrder.is_finance_created ? "Dibuat oleh finance" : "Sudah Diproses" : "Rilis Shipping Order")} data-v-7715f236${_scopeId}>`);
              ...
              if (salesOrder.cs_can_edit) {
                ...
                _push2(`<span class="inline-flex items-center justify-center w-8 h-8 text-gray-400 bg-gray-100 rounded-full cursor-not-allowed"${ssrRenderAttr("title", salesOrder.is_finance_created ? "Dibuat oleh finance" : "Tidak dapat diedit (Shipping Order sudah diproses)")} data-v-7715f236${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Pencil), { class: "w-4 h-4" }, null, _parent2, _scopeId));
                _push2(`</span>`);
              }
              if (salesOrder.cs_can_delete) {
                _push2(`<button class="inline-flex items-center justify-center w-8 h-8 text-red-600 hover:text-red-900 hover:bg-red-100 rounded-full transition-colors" title="Hapus" data-v-7715f236${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent2, _scopeId));
                _push2(`</button>`);
              } else {
                _push2(`<span class="inline-flex items-center justify-center w-8 h-8 text-gray-400 bg-gray-100 rounded-full cursor-not-allowed"${ssrRenderAttr("title", salesOrder.is_finance_created ? "Dibuat oleh finance" : "Tidak dapat dihapus (Shipping Order sudah diproses)")} data-v-7715f236${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent2, _scopeId));
                _push2(`</span>`);
              }
              _push2(`</div></td></tr>`);
            ...
            if (!__props.salesOrders.data || __props.salesOrders.data.length === 0) {
              _push2(`<tr data-v-7715f236${_scopeId}><td colspan="9" class="px-6 py-8 text-center text-gray-500" data-v-7715f236${_scopeId}><div class="flex flex-col items-center" data-v-7715f236${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileText), { class: "w-12 h-12 text-gray-300 mb-4" }, null, _parent2, _scopeId));
              _push2(`<p class="text-lg font-medium mb-2" data-v-7715f236${_scopeId}>Tidak ada data</p><p class="text-sm text-gray-400" data-v-7715f236${_scopeId}> Belum ada Shipping Order yang tersedia </p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div>`);
            if (__props.salesOrders.last_page > 1) {
              _push2(`<div class="px-4 py-4 border-t border-gray-200" data-v-7715f236${_scopeId}>`);
                                ...
                                createVNode("td", { class: "px-6 py-4 text-sm font-medium" }, [
                                  createVNode("div", { class: "flex items-center space-x-2" }, [
                                    createVNode("button", {
                                      ...
                                      title: !salesOrder.cs_can_release ? salesOrder.is_finance_created ? "Dibuat oleh finance" : "Sudah Diproses" : "Rilis Shipping Order"
                                    }, [
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7715f236"]]);
export {
  Index as default
};
