import { ref, computed, watch, onMounted, withCtx, unref, createBlock, openBlock, createVNode, createTextVNode, createCommentVNode, toDisplayString, withModifiers, withDirectives, vModelText, Fragment, renderList, vModelSelect, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Edit General Expense" }, null, _parent2, _scopeId));
            ...
            _push2(`<h1 class="text-2xl font-bold text-sage-800"${_scopeId}>Edit General Expense</h1></div><div class="flex justify-between items-center"${_scopeId}><p class="text-sm text-sage-600"${_scopeId}>Edit non-SO, non-petty cash expense</p><div class="flex items-center space-x-2"${_scopeId}><span class="${ssrRenderClass([getStatusClass(__props.generalExpense.status), "px-2 py-1 rounded-full text-xs font-medium"])}"${_scopeId}>${ssrInterpolate(getStatusLabel(__props.generalExpense.status))}</span><span class="text-xs text-sage-500"${_scopeId}>ID: ${ssrInterpolate(__props.generalExpense.id)}</span></div></div></div>`);
            if (__props.generalExpense.status === "approved") {
              _push2(`<div class="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg"${_scopeId}><div class="flex items-center"${_scopeId}><svg class="w-5 h-5 text-yellow-400 mr-3" fill="currentColor" viewBox="0 0 20 20"${_scopeId}><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"${_scopeId}></path></svg><div${_scopeId}><h4 class="text-sm font-medium text-yellow-800"${_scopeId}>Expense Already Approved</h4><p class="text-sm text-yellow-700 mt-1"${_scopeId}> This expense has already been approved. Any changes will reset the status to Draft. </p></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Category <span class="text-red-500"${_scopeId}>*</span></label><select class="${ssrRenderClass([{ "border-red-300": errors.value.category }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}"${ssrIncludeBooleanAttr(categoryOptions.value.length === 0) ? " disabled" : ""}${_scopeId}><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).category) ? ssrLooseContain(unref(form).category, "") : ssrLooseEqual(unref(form).category, "")) ? " selected" : ""}${_scopeId}>Select Category</option><!--[-->`);
            ...
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Expense Account (P&amp;L) <span class="text-red-500"${_scopeId}>*</span></label><select class="${ssrRenderClass([{ "border-red-300": errors.value.pl_account_id }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).pl_account_id) ? ssrLooseContain(unref(form).pl_account_id, "") : ssrLooseEqual(unref(form).pl_account_id, "")) ? " selected" : ""}${_scopeId}>Select Account</option><!--[-->`);
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(route)("admin-keuangan.general-expenses.show", {
            ...
            if (processing.value) {
              ...
              _push2(`<span${_scopeId}>Update Expense</span>`);
            }
            _push2(`</button></div></form></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Edit General Expense" }),
              createVNode("div", { class: "p-6 max-w-6xl mx-auto" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("div", { class: "flex items-center space-x-4 mb-2" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-sage-800" }, "Edit General Expense")
                  ]),
                  createVNode("div", { class: "flex justify-between items-center" }, [
                    createVNode("p", { class: "text-sm text-sage-600" }, "Edit non-SO, non-petty cash expense"),
                ...
                __props.generalExpense.status === "approved" ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "flex items-center" }, [
                    ...
                    createVNode("div", null, [
                      createVNode("h4", { class: "text-sm font-medium text-yellow-800" }, "Expense Already Approved"),
                      createVNode("p", { class: "text-sm text-yellow-700 mt-1" }, " This expense has already been approved. Any changes will reset the status to Draft. ")
                    ])
                  ])
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", null, [
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        class: ["w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm", { "border-red-300": errors.value.pl_account_id }]
                      }, [
                    ...
                    createVNode("div", { class: "flex justify-end space-x-3 pt-4 border-t border-sage-200" }, [
                      ...
                      createVNode("button", {
                        ...
                        processing.value ? (openBlock(), createBlock("span", { key: 0 }, "Saving...")) : (openBlock(), createBlock("span", { key: 1 }, "Update Expense"))
                      ], 8, ["disabled"])
                    ])
                  ], 32)
                ])
