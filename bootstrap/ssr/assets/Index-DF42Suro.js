...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const sourceBadgeClass = (row) => {
      var _a2;
      const isManual = !!((_a2 = row.details) == null ? void 0 : _a2.manual_override);
      return isManual ? "bg-amber-100 text-amber-800" : row.source === "auto" ? "bg-blue-100 text-blue-800" : "bg-gray-100 text-gray-800";
    };
    const sourceLabel = (row) => {
      var _a2;
      if ((_a2 = row.details) == null ? void 0 : _a2.manual_override) {
        return "Manual";
      }
                                      ...
                                      return openBlock(), createBlock("tr", {
                                        ...
                                        createVNode("td", { class: "px-4 py-3" }, [
                                          createVNode("div", { class: "flex items-center justify-end gap-2" }, [
                                            ...
                                            }, toDisplayString(formatDate(row.details.manual_override.effective_date)), 1)) : createCommentVNode("", true)
                                          ])
                                        ])
                                      ]);
                                    }), 128))
