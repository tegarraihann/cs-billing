...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const profitRows = computed(() => {
      var _a;
      return ((_a = props.profitData) == null ? void 0 : _a.data) || [];
    });
    ...
    const currentIndexQuery = computed(() => {
      ...
      const currentPage = (_a = props.profitData) == null ? void 0 : _a.current_page;
                  ...
                  createVNode("div", { class: "bg-white rounded-lg shadow-sm overflow-hidden" }, [
                    createVNode("div", { class: "overflow-x-auto" }, [
                      createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                        ...
                        createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(profitRows.value, (item) => {
                            var _a2;
                            return openBlock(), createBlock("tr", {
                              ...
                              createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                createVNode("div", { class: "text-sm font-medium text-gray-900" }, toDisplayString(((_a2 = item.sales_order.customer) == null ? void 0 : _a2.company_name) || item.sales_order.customer), 1)
                              ]),
                          ...
                          profitRows.value.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                            createVNode("td", {
                              colspan: "9",
                    ...
                    createVNode("div", { class: "bg-white px-4 py-3 border-t border-gray-200 sm:px-6" }, [
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(((_e = __props.profitData) == null ? void 0 : _e.from) || 0) + " to " + toDisplayString(((_f = __props.profitData) == null ? void 0 : _f.to) || 0) + " of " + toDisplayString(((_g = __props.profitData) == null ? void 0 : _g.total) || 0) + " results ", 1),
                        createVNode("div", { class: "flex space-x-1" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(((_h = __props.profitData) == null ? void 0 : _h.links) || [], (link) => {
