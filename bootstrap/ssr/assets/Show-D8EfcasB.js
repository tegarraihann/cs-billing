...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const displayPaymentNotes = computed(() => {
      var _a;
      return ((_a = props.receivable) == null ? void 0 : _a.notes) || "";
    });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (displayPaymentNotes.value) {
              _push2(`<div class="bg-white rounded-lg shadow-sm p-6 mb-6"${_scopeId}><h2 class="text-lg font-semibold text-gray-900 mb-4"${_scopeId}>Payment Information</h2><div${_scopeId}><label class="text-sm font-medium text-gray-500"${_scopeId}>Payment Notes</label><p class="text-sm text-gray-700 whitespace-pre-line"${_scopeId}>${ssrInterpolate(displayPaymentNotes.value)}</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
