    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminCSLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-6" data-v-0e704a75${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-0e704a75${_scopeId}><div class="bg-white shadow rounded-lg mb-6" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-0e704a75${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-0e704a75${_scopeId}><div class="flex items-center" data-v-0e704a75${_scopeId}><div class="w-12 h-12 bg-sage-800 rounded-full flex items-center justify-center mr-4" data-v-0e704a75${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Pen), { class: "w-6 h-6 text-white" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-0e704a75${_scopeId}><h1 class="text-2xl font-semibold text-gray-900" data-v-0e704a75${_scopeId}>Edit Shipping: ${ssrInterpolate(__props.salesOrder.order_number)}</h1><p class="mt-1 text-sm text-gray-600" data-v-0e704a75${_scopeId}>Perbarui informasi shipping order untuk pelanggan </p></div></div><div class="mt-4 sm:mt-0 flex gap-3" data-v-0e704a75${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><form class="space-y-6" data-v-0e704a75${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Informasi Dasar</h3>`);
            ...
            _push2(`</div><div style="${ssrRenderStyle(sections.value.basic ? null : { display: "none" })}" class="p-6 space-y-4" data-v-0e704a75${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>ORDER NUMB <span class="text-red-500" data-v-0e704a75${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).order_number)} type="text" required readonly placeholder="EWILOG2509001001" class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.order_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.order_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>REF NO</label><input${ssrRenderAttr("value", unref(form).ref_no)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.ref_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.ref_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>DATE</label><input${ssrRenderAttr("value", unref(form).so_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.so_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.so_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>CUSTOMER <span class="text-red-500" data-v-0e704a75${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).customer)} type="text" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.customer) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.customer)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>SHIPPER</label><input${ssrRenderAttr("value", unref(form).shipper)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.shipper) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.shipper)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Informasi Pengiriman</h3>`);
            _push2(ssrRenderComponent(unref(ChevronDown), {
              class: [{ "rotate-180": !sections.value.shipping }, "w-5 h-5 text-sage-600 transition-transform duration-200"]
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(sections.value.shipping ? null : { display: "none" })}" class="p-6 space-y-4" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>BL/AWB</label><input${ssrRenderAttr("value", unref(form).bl_awb)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.bl_awb) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.bl_awb)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>LINER</label><input${ssrRenderAttr("value", unref(form).liner)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.liner) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.liner)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>VESSEL</label><input${ssrRenderAttr("value", unref(form).vessel)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.vessel) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.vessel)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>ETA</label><input${ssrRenderAttr("value", unref(form).eta)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.eta) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.eta)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>ETD</label><input${ssrRenderAttr("value", unref(form).etd)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.etd) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.etd)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>AJU</label><input${ssrRenderAttr("value", unref(form).aju)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.aju) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.aju)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>SPPB DATE</label><input${ssrRenderAttr("value", unref(form).sppb_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.sppb_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.sppb_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>SHIPMENT TYPE</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}><option value="" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, "") : ssrLooseEqual(unref(form).shipment_type, "")) ? " selected" : ""}${_scopeId}>Pilih Shipment Type</option><!--[-->`);
            ssrRenderList(__props.shipmentTypes, (shipmentType) => {
              _push2(`<option${ssrRenderAttr("value", shipmentType.code)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, shipmentType.code) : ssrLooseEqual(unref(form).shipment_type, shipmentType.code)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(shipmentType.name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (unref(form).errors.shipment_type) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.shipment_type)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>POL</label><input${ssrRenderAttr("value", unref(form).pol)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.pol) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.pol)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>POD</label><input${ssrRenderAttr("value", unref(form).pod)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.pod) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.pod)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>GUDANG/UTC</label><input${ssrRenderAttr("value", unref(form).gudang_utc)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.gudang_utc) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.gudang_utc)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>PARTY/LCL</label><input${ssrRenderAttr("value", unref(form).party_lcl)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.party_lcl) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.party_lcl)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>EXCHANGE RATE</label><input${ssrRenderAttr("value", unref(form).exchange_rate)} type="number" step="0.0001" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.exchange_rate) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.exchange_rate)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Informasi Pricing</h3>`);
            _push2(ssrRenderComponent(unref(ChevronDown), {
              class: [{ "rotate-180": !sections.value.pricing }, "w-5 h-5 text-sage-600 transition-transform duration-200"]
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(sections.value.pricing ? null : { display: "none" })}" class="p-6 space-y-6" data-v-0e704a75${_scopeId}><div class="bg-gray-50 rounded-lg p-4" data-v-0e704a75${_scopeId}><div class="flex justify-between items-center mb-4" data-v-0e704a75${_scopeId}><h4 class="text-md font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Rincian Vendor (Buying &amp; Selling) </h4><button type="button" class="inline-flex items-center text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-0e704a75${_scopeId}>`);
            ...
            ssrRenderList(unref(form).vendor_breakdown, (item, index) => {
              _push2(`<div class="border border-sage-200 rounded-lg p-4 mb-4 space-y-4" data-v-0e704a75${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-0e704a75${_scopeId}><div class="col-span-11" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>Nama Vendor</label><select class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}><option value="" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, "") : ssrLooseEqual(item.vendor_id, "")) ? " selected" : ""}${_scopeId}>Pilih vendor...</option><!--[-->`);
              ssrRenderList(__props.vendors, (vendorOption) => {
                _push2(`<option${ssrRenderAttr("value", vendorOption.id)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, vendorOption.id) : ssrLooseEqual(item.vendor_id, vendorOption.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendorOption.nama_vendor)}</option>`);
              });
              _push2(`<!--]--></select></div><div class="col-span-1" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-transparent mb-1" data-v-0e704a75${_scopeId}>Del</label><button type="button" class="w-full h-10 inline-flex items-center justify-center text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors" data-v-0e704a75${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent2, _scopeId));
              _push2(`</button></div></div><div class="grid grid-cols-2 gap-3" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>Deskripsi Service / Jenis Biaya</label><select class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}><option value="" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "") : ssrLooseEqual(item.description, "")) ? " selected" : ""}${_scopeId}>Pilih Jenis Biaya</option><!--[-->`);
              ssrRenderList(serviceTypeOptions.value, (option) => {
                _push2(`<option${ssrRenderAttr("value", option.value)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, option.value) : ssrLooseEqual(item.description, option.value)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(option.label)}</option>`);
              });
              _push2(`<!--]-->`);
              if (item.description && !isKnownServiceType(item.description)) {
                _push2(`<option${ssrRenderAttr("value", item.description)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, item.description) : ssrLooseEqual(item.description, item.description)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(item.description)}</option>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</select></div><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>RCVD INV</label><input${ssrRenderAttr("value", item.rcvd_inv)} type="text" placeholder="Nomor invoice yang diterima" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}></div></div><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>Remarks (Individual)</label><input${ssrRenderAttr("value", item.remarks)} type="text" placeholder="Catatan khusus untuk item ini" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}></div><div class="grid grid-cols-3 gap-3 p-3 bg-blue-50 rounded-lg" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-blue-700 mb-1" data-v-0e704a75${_scopeId}>Buying Amount (Cost)</label><input${ssrRenderAttr("value", item.buying_amount)} type="text" placeholder="0" class="w-full px-3 py-2 border border-blue-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500" data-v-0e704a75${_scopeId}></div><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-green-700 mb-1" data-v-0e704a75${_scopeId}>Selling Amount (Revenue)</label><input${ssrRenderAttr("value", item.selling_amount)} type="text" placeholder="0" class="w-full px-3 py-2 border border-green-300 rounded focus:ring-2 focus:ring-green-500 focus:border-green-500" data-v-0e704a75${_scopeId}></div><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-0e704a75${_scopeId}>Profit</label><p class="${ssrRenderClass([getProfit(item) >= 0 ? "text-green-600" : "text-red-600", "px-3 py-2 bg-white border border-purple-300 rounded text-sm font-semibold"])}" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(getProfit(item)))}</p></div></div>`);
              if (item.vendor_id) {
                _push2(`<div class="grid grid-cols-3 gap-3 p-3 bg-sage-50 rounded-lg" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>Nama Vendor</label><p class="text-sm text-gray-900" data-v-0e704a75${_scopeId}>${ssrInterpolate(item.nama_vendor || "-")}</p></div><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>Nomor Rekening</label><p class="text-sm text-gray-900 font-mono" data-v-0e704a75${_scopeId}>${ssrInterpolate(item.no_rekening || "-")}</p></div><div data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-0e704a75${_scopeId}>Nama Rekening</label><p class="text-sm text-gray-900" data-v-0e704a75${_scopeId}>${ssrInterpolate(item.nama_rekening || "-")}</p></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--><div class="mt-4 pt-4 border-t border-gray-300 grid grid-cols-3 gap-4 text-center" data-v-0e704a75${_scopeId}><div class="p-3 bg-blue-100 rounded-lg" data-v-0e704a75${_scopeId}><p class="text-xs font-medium text-blue-700" data-v-0e704a75${_scopeId}>Total Buying</p><p class="text-lg font-bold text-blue-800" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</p></div><div class="p-3 bg-green-100 rounded-lg" data-v-0e704a75${_scopeId}><p class="text-xs font-medium text-green-700" data-v-0e704a75${_scopeId}>Total Selling</p><p class="text-lg font-bold text-green-800" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</p></div><div class="${ssrRenderClass([totalRevenue.value >= 0 ? "bg-purple-100" : "bg-red-100", "p-3 rounded-lg"])}" data-v-0e704a75${_scopeId}><p class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-purple-700" : "text-red-700", "text-xs font-medium"])}" data-v-0e704a75${_scopeId}>Total Profit </p><p class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-purple-800" : "text-red-800", "text-lg font-bold"])}" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</p></div></div></div><div class="bg-blue-50 rounded-lg p-4" data-v-0e704a75${_scopeId}><h4 class="text-md font-semibold text-blue-800 mb-3" data-v-0e704a75${_scopeId}>Ringkasan Revenue</h4><div class="space-y-2" data-v-0e704a75${_scopeId}><div class="flex justify-between" data-v-0e704a75${_scopeId}><span data-v-0e704a75${_scopeId}>Total Pemasukan (Selling):</span><span class="font-medium" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</span></div><div class="flex justify-between" data-v-0e704a75${_scopeId}><span data-v-0e704a75${_scopeId}>Total Pengeluaran (Buying):</span><span class="font-medium" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</span></div><div class="flex justify-between items-center pt-2 border-t border-blue-300 font-bold text-lg" data-v-0e704a75${_scopeId}><span data-v-0e704a75${_scopeId}>Profit (Revenue):</span><span class="${ssrRenderClass(totalRevenue.value >= 0 ? "text-green-600" : "text-red-600")}" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</span></div></div></div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>REMARKS</label><textarea rows="3" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).remarks)}</textarea>`);
            if (unref(form).errors.remarks) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.remarks)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>NOTE</label><textarea rows="3" placeholder="Catatan tambahan untuk Shipping Order ini" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).note)}</textarea>`);
            if (unref(form).errors.note) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.note)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Informasi Barang</h3>`);
            _push2(ssrRenderComponent(unref(ChevronDown), {
              class: [{ "rotate-180": !sections.value.goods }, "w-5 h-5 text-sage-600 transition-transform duration-200"]
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(sections.value.goods ? null : { display: "none" })}" class="p-6 space-y-4" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>COMMODITY/URAIAN BARANG</label><textarea rows="3" placeholder="Masukkan uraian barang/commodity yang detail" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).commodity)}</textarea>`);
            if (unref(form).errors.commodity) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.commodity)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-0e704a75${_scopeId}><div class="grid grid-cols-2 gap-3" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>QTY</label><input${ssrRenderAttr("value", unref(form).qty)} type="number" min="0" placeholder="Masukkan quantity" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.qty) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.qty)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>Package Unit</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}><option${ssrRenderAttr("value", null)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(unref(form).package_unit) ? ssrLooseContain(unref(form).package_unit, null) : ssrLooseEqual(unref(form).package_unit, null)) ? " selected" : ""}${_scopeId}>Select Unit</option><!--[-->`);
            ssrRenderList(packageUnits.value, (unit) => {
              _push2(`<option${ssrRenderAttr("value", unit.code)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(unref(form).package_unit) ? ssrLooseContain(unref(form).package_unit, unit.code) : ssrLooseEqual(unref(form).package_unit, unit.code)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(unit.name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (unref(form).errors.package_unit) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.package_unit)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>NET WEIGHT (KG)</label><input${ssrRenderAttr("value", unref(form).net_weight)} type="number" step="0.01" min="0" placeholder="Masukkan berat netto dalam kg" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.net_weight) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.net_weight)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>GROSS WEIGHT (KG)</label><input${ssrRenderAttr("value", unref(form).gross_weight)} type="number" step="0.01" min="0" placeholder="Masukkan berat kotor dalam kg" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.gross_weight) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.gross_weight)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>MEAS (M³)</label><input${ssrRenderAttr("value", unref(form).measurement)} type="number" step="0.001" min="0" placeholder="Masukkan volume dalam m³" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.measurement) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.measurement)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-0e704a75${_scopeId}><div class="flex justify-between items-center mb-2" data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700" data-v-0e704a75${_scopeId}>CONTAINER NO</label><button type="button" class="inline-flex items-center text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-0e704a75${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Plus), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            _push2(` Tambah Container </button></div><!--[-->`);
            ssrRenderList(unref(form).container_no, (container, index) => {
              _push2(`<div class="flex gap-2 mb-2" data-v-0e704a75${_scopeId}><input${ssrRenderAttr("value", unref(form).container_no[index])} type="text" placeholder="Masukkan nomor container (misal: TCLU1234567)" class="flex-1 px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
              if (unref(form).container_no.length > 1) {
                _push2(`<button type="button" class="px-3 py-2 inline-flex items-center justify-center text-red-600 hover:text-red-800 hover:bg-red-100 rounded-lg transition-colors" data-v-0e704a75${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent2, _scopeId));
                _push2(`</button>`);
              } else {
                _push2(`<!---->`);
            ...
            if (unref(form).errors.container_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.container_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Informasi Invoice</h3>`);
            _push2(ssrRenderComponent(unref(ChevronDown), {
              class: [{ "rotate-180": !sections.value.invoice }, "w-5 h-5 text-sage-600 transition-transform duration-200"]
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(sections.value.invoice ? null : { display: "none" })}" class="p-6 space-y-4" data-v-0e704a75${_scopeId}><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>INVOICE NUMB</label><input${ssrRenderAttr("value", unref(form).invoice_number)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.invoice_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>INVOICE DATE</label><input${ssrRenderAttr("value", unref(form).invoice_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.invoice_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0e704a75${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0e704a75${_scopeId}>T.O.P</label><input${ssrRenderAttr("value", unref(form).top)} type="text" placeholder="e.g., NET 30" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0e704a75${_scopeId}>`);
            if (unref(form).errors.top) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-0e704a75${_scopeId}>${ssrInterpolate(unref(form).errors.top)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Biaya Beban Lain (Operational)</h3>`);
            _push2(ssrRenderComponent(unref(ChevronDown), {
              class: [{ "rotate-180": !sections.value.other_costs }, "w-5 h-5 text-sage-600 transition-transform duration-200"]
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(sections.value.other_costs ? null : { display: "none" })}" class="p-6" data-v-0e704a75${_scopeId}><div class="bg-orange-50 rounded-lg p-4" data-v-0e704a75${_scopeId}><div class="flex justify-between items-center mb-4" data-v-0e704a75${_scopeId}><h4 class="text-md font-semibold text-orange-800" data-v-0e704a75${_scopeId}>Biaya Beban Lain (Operational) </h4><button type="button" class="inline-flex items-center text-sm bg-orange-600 text-white px-3 py-1 rounded hover:bg-orange-700 transition-colors" data-v-0e704a75${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Plus), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            _push2(` Tambah Biaya </button></div>`);
            if (unref(form).other_costs && unref(form).other_costs.length > 0) {
              _push2(`<div class="space-y-3" data-v-0e704a75${_scopeId}><!--[-->`);
              ssrRenderList(unref(form).other_costs, (cost, index) => {
                _push2(`<div class="border border-orange-200 rounded-lg p-3 bg-white" data-v-0e704a75${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-0e704a75${_scopeId}><div class="col-span-4" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-0e704a75${_scopeId}>Deskripsi Biaya</label><input${ssrRenderAttr("value", cost.description)} type="text" placeholder="Contoh: Biaya handling, dokumen, dll" class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-0e704a75${_scopeId}></div><div class="col-span-2" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-0e704a75${_scopeId}>Jumlah Biaya</label><input${ssrRenderAttr("value", cost.amount)} type="text" placeholder="0 (contoh: 2.500 atau 2500)" class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-0e704a75${_scopeId}></div><div class="col-span-2" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-0e704a75${_scopeId}>Kategori</label><select class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-0e704a75${_scopeId}><option value="" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(cost.category_id) ? ssrLooseContain(cost.category_id, "") : ssrLooseEqual(cost.category_id, "")) ? " selected" : ""}${_scopeId}>Pilih kategori</option><!--[-->`);
                ssrRenderList(operationalCostCategories.value, (category) => {
                  _push2(`<option${ssrRenderAttr("value", category.id)}${ssrRenderAttr("title", category.description)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(cost.category_id) ? ssrLooseContain(cost.category_id, category.id) : ssrLooseEqual(cost.category_id, category.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(category.name)}</option>`);
                });
                _push2(`<!--]--></select></div><div class="col-span-3" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-0e704a75${_scopeId}>Vendor / Penerima</label><select class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-0e704a75${_scopeId}><option value="" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(cost.vendor_id) ? ssrLooseContain(cost.vendor_id, "") : ssrLooseEqual(cost.vendor_id, "")) ? " selected" : ""}${_scopeId}>-- Belum Ditentukan --</option><option value="internal" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(cost.vendor_id) ? ssrLooseContain(cost.vendor_id, "internal") : ssrLooseEqual(cost.vendor_id, "internal")) ? " selected" : ""}${_scopeId}>-- Internal (Divisi Operational) --</option><!--[-->`);
                ssrRenderList(__props.vendors, (vendor) => {
                  _push2(`<option${ssrRenderAttr("value", vendor.id)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(cost.vendor_id) ? ssrLooseContain(cost.vendor_id, vendor.id) : ssrLooseEqual(cost.vendor_id, vendor.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendor.nama_vendor)}</option>`);
                });
                _push2(`<!--]--></select><p class="text-xs text-orange-600 mt-1" data-v-0e704a75${_scopeId}>Pilih vendor jika sudah tahu akan dibayar ke siapa</p></div><div class="col-span-1 flex items-end" data-v-0e704a75${_scopeId}><button type="button" class="w-full px-2 py-1 inline-flex items-center justify-center text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors"${ssrIncludeBooleanAttr(unref(form).other_costs.length <= 1) ? " disabled" : ""} data-v-0e704a75${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent2, _scopeId));
                _push2(`</button></div></div></div>`);
              });
              _push2(`<!--]--><div class="pt-3 border-t border-orange-300" data-v-0e704a75${_scopeId}><div class="flex justify-between items-center" data-v-0e704a75${_scopeId}><span class="text-sm font-medium text-orange-700" data-v-0e704a75${_scopeId}>Total Biaya Beban Lain:</span><span class="text-lg font-bold text-orange-800" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalOtherCosts.value))}</span></div></div><div class="flex justify-center mt-6 pt-4 border-t border-orange-200" data-v-0e704a75${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors" data-v-0e704a75${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Plus), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` Tambah Biaya Lagi </button></div></div>`);
            } else {
              _push2(`<div class="text-center py-4 text-orange-600" data-v-0e704a75${_scopeId}><p class="text-sm" data-v-0e704a75${_scopeId}>Belum ada biaya beban lain</p><p class="text-xs text-orange-500" data-v-0e704a75${_scopeId}>Klik tombol &quot;Tambah Biaya&quot; untuk menambahkan</p></div>`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0e704a75${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-0e704a75${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0e704a75${_scopeId}>Items Reimbursement</h3>`);
            _push2(ssrRenderComponent(unref(ChevronDown), {
              class: [{ "rotate-180": !sections.value.reimbursement }, "w-5 h-5 text-sage-600 transition-transform duration-200"]
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(sections.value.reimbursement ? null : { display: "none" })}" class="p-6" data-v-0e704a75${_scopeId}><div class="bg-purple-50 rounded-lg p-4" data-v-0e704a75${_scopeId}><div class="flex justify-between items-center mb-4" data-v-0e704a75${_scopeId}><h4 class="text-md font-semibold text-purple-800" data-v-0e704a75${_scopeId}>Items Reimbursement</h4><button type="button" class="inline-flex items-center text-sm bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-700 transition-colors" data-v-0e704a75${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Plus), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            ...
            if (reimbursementItems.value && reimbursementItems.value.length > 0) {
              ...
              ssrRenderList(reimbursementItems.value, (item, index) => {
                _push2(`<div class="border border-purple-200 rounded-lg p-3 bg-white" data-v-0e704a75${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-0e704a75${_scopeId}><div class="col-span-4" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-0e704a75${_scopeId}>Deskripsi</label><input${ssrRenderAttr("value", item.description)} type="text" placeholder="Contoh: Transport ke pelabuhan" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-0e704a75${_scopeId}></div><div class="col-span-2" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-0e704a75${_scopeId}>Jumlah</label><input${ssrRenderAttr("value", item.amount)} type="number" step="0.01" placeholder="0.00" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-0e704a75${_scopeId}></div><div class="col-span-2" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-0e704a75${_scopeId}>Kategori</label><select class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500"${ssrIncludeBooleanAttr(reimbursementCategoryOptions.value.length === 0) ? " disabled" : ""} data-v-0e704a75${_scopeId}><option value="" disabled data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "") : ssrLooseEqual(item.category, "")) ? " selected" : ""}${_scopeId}>Pilih Kategori</option><!--[-->`);
                ssrRenderList(reimbursementCategoryOptions.value, (category) => {
                  _push2(`<option${ssrRenderAttr("value", category.value)}${ssrRenderAttr("title", category.description)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, category.value) : ssrLooseEqual(item.category, category.value)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(category.label)}</option>`);
                });
                _push2(`<!--]--></select>`);
                if (reimbursementCategoryOptions.value.length === 0) {
                  _push2(`<p class="text-xs text-purple-600 mt-1" data-v-0e704a75${_scopeId}> Kategori belum tersedia. Tambahkan master Operational Cost Categories terlebih dahulu. </p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="col-span-3" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-0e704a75${_scopeId}>Vendor / Penerima</label><select class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-0e704a75${_scopeId}><option value="" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, "") : ssrLooseEqual(item.vendor_id, "")) ? " selected" : ""}${_scopeId}>-- Belum Ditentukan --</option><option value="internal" data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, "internal") : ssrLooseEqual(item.vendor_id, "internal")) ? " selected" : ""}${_scopeId}>-- Internal (Divisi Operational) --</option><!--[-->`);
                ssrRenderList(__props.vendors, (vendor) => {
                  _push2(`<option${ssrRenderAttr("value", vendor.id)} data-v-0e704a75${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, vendor.id) : ssrLooseEqual(item.vendor_id, vendor.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendor.nama_vendor)}</option>`);
                });
                _push2(`<!--]--></select><p class="text-xs text-purple-600 mt-1" data-v-0e704a75${_scopeId}>Pilih vendor jika sudah tahu akan dibayar ke siapa</p></div><div class="col-span-1 flex items-end" data-v-0e704a75${_scopeId}><button type="button" class="w-full px-2 py-1 inline-flex items-center justify-center text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors" data-v-0e704a75${_scopeId}>`);
                _push2(ssrRenderComponent(unref(Trash2), { class: "w-4 h-4" }, null, _parent2, _scopeId));
                _push2(`</button></div></div><div class="grid grid-cols-12 gap-3 mt-3" data-v-0e704a75${_scopeId}><div class="col-span-12" data-v-0e704a75${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-0e704a75${_scopeId}>Catatan</label><input${ssrRenderAttr("value", item.notes)} type="text" placeholder="Catatan tambahan (opsional)" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-0e704a75${_scopeId}></div></div></div>`);
              });
              _push2(`<!--]--><div class="pt-3 border-t border-purple-300" data-v-0e704a75${_scopeId}><div class="flex justify-between items-center" data-v-0e704a75${_scopeId}><span class="text-sm font-medium text-purple-700" data-v-0e704a75${_scopeId}>Total Reimbursement:</span><span class="text-lg font-bold text-purple-800" data-v-0e704a75${_scopeId}>${ssrInterpolate(formatCurrency(totalReimbursement.value))}</span></div></div><div class="flex justify-center mt-6 pt-4 border-t border-purple-200" data-v-0e704a75${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors" data-v-0e704a75${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Plus), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` Tambah Reimbursement Lagi </button></div></div>`);
            } else {
              _push2(`<div class="text-center py-4 text-purple-600" data-v-0e704a75${_scopeId}><p class="text-sm" data-v-0e704a75${_scopeId}>Belum ada item reimbursement</p><p class="text-xs text-purple-500" data-v-0e704a75${_scopeId}>Klik tombol &quot;Tambah Reimbursement&quot; untuk menambahkan</p></div>`);
            }
            _push2(`</div></div></div><div class="flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-3 pt-6" data-v-0e704a75${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-cs.sales-orders.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="inline-flex items-center justify-center px-6 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" data-v-0e704a75${_scopeId}>`);
            ...
            if (unref(form).processing) {
              _push2(`<span data-v-0e704a75${_scopeId}>Menyimpan...</span>`);
            } else {
              _push2(`<span data-v-0e704a75${_scopeId}>Update Shipping Order</span>`);
            }
...
const Edit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0e704a75"]]);
export {
  Edit as default
};
