    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Shipment Profit Details" }, null, _parent2, _scopeId));
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="flex justify-between items-center mb-6"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Shipment Profit Details</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Profit analysis details for Sales Order ${ssrInterpolate(__props.salesOrder.order_number)}</p></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.profit-reports.index", __props.returnQuery || {}),
              class: "inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"${_scopeId2}></path></svg> Back `);
                } else {
                  return [
            ...
            _push2(`</div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6"${_scopeId}><div class="px-4 py-5 sm:p-6"${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-6"${_scopeId}><div${_scopeId}><h3 class="text-lg font-medium text-gray-900 mb-3"${_scopeId}>Sales Order Information</h3><dl class="space-y-2"${_scopeId}><div${_scopeId}><dt class="text-sm font-medium text-gray-500"${_scopeId}>Order Number</dt><dd class="text-sm text-gray-900"${_scopeId}>${ssrInterpolate(__props.salesOrder.order_number)}</dd></div><div${_scopeId}><dt class="text-sm font-medium text-gray-500"${_scopeId}>Customer</dt><dd class="text-sm text-gray-900"${_scopeId}>${ssrInterpolate(((_a = __props.salesOrder.customer) == null ? void 0 : _a.company_name) || __props.salesOrder.customer)}</dd></div><div${_scopeId}><dt class="text-sm font-medium text-gray-500"${_scopeId}>Created Date</dt><dd class="text-sm text-gray-900"${_scopeId}>${ssrInterpolate(formatDate(__props.salesOrder.created_at))}</dd></div><div${_scopeId}><dt class="text-sm font-medium text-gray-500"${_scopeId}>Status</dt><dd class="text-sm"${_scopeId}><span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800"${_scopeId}>${ssrInterpolate(__props.salesOrder.status)}</span></dd></div></dl></div><div${_scopeId}><h3 class="text-lg font-medium text-gray-900 mb-3"${_scopeId}>Total Selling</h3><div class="text-3xl font-bold text-green-600"${_scopeId}> Rp ${ssrInterpolate(formatNumber(__props.salesOrder.total_selling))}</div></div><div${_scopeId}><h3 class="text-lg font-medium text-gray-900 mb-3"${_scopeId}>Status Profit</h3><span class="${ssrRenderClass([getProfitStatusClass(__props.profitAnalysis.profit_status), "inline-flex px-3 py-2 text-sm font-semibold rounded-lg"])}"${_scopeId}>${ssrInterpolate(getProfitStatusText(__props.profitAnalysis.profit_status))}</span></div></div></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6"${_scopeId}><div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200"${_scopeId}><div class="text-sm font-medium text-gray-500 mb-1"${_scopeId}>Revenue</div><div class="text-lg font-bold text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(__props.profitAnalysis.revenue))}</div></div><div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200"${_scopeId}><div class="text-sm font-medium text-gray-500 mb-1"${_scopeId}>Operational Costs</div><div class="text-lg font-bold text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(__props.profitAnalysis.operational_costs))}</div></div><div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200"${_scopeId}><div class="text-sm font-medium text-gray-500 mb-1"${_scopeId}>Tax Expense</div><div class="text-lg font-bold text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(__props.profitAnalysis.tax_expense))}</div></div><div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200"${_scopeId}><div class="text-sm font-medium text-gray-500 mb-1"${_scopeId}>Net Profit</div><div class="${ssrRenderClass([__props.profitAnalysis.profit >= 0 ? "text-green-600" : "text-red-600", "text-lg font-bold"])}"${_scopeId}> Rp ${ssrInterpolate(formatNumber(__props.profitAnalysis.profit))}</div></div><div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200"${_scopeId}><div class="text-sm font-medium text-gray-500 mb-1"${_scopeId}>Profit Margin</div><div class="text-lg font-bold text-gray-900"${_scopeId}>${ssrInterpolate(formatPercentage(__props.profitAnalysis.profit_margin))}% </div></div></div><div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6"${_scopeId}><div class="px-6 py-4 border-b border-gray-200 bg-blue-50"${_scopeId}><h3 class="text-lg font-semibold text-blue-800"${_scopeId}>Revenue Breakdown</h3></div><div class="overflow-x-auto"${_scopeId}><table class="min-w-full divide-y divide-gray-200"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Invoice Number </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Total </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Paid Amount </th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Status </th></tr></thead><tbody class="bg-white divide-y divide-gray-200"${_scopeId}><!--[-->`);
            ...
            if (__props.costBreakdown.length === 0) {
              _push2(`<tr${_scopeId}><td colspan="5" class="px-6 py-4 text-center text-gray-500"${_scopeId}> No vendor cost data </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode(unref(Head), { title: "Shipment Profit Details" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Shipment Profit Details"),
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Profit analysis details for Sales Order " + toDisplayString(__props.salesOrder.order_number), 1)
                    ]),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-6" }, [
                        createVNode("div", null, [
                          createVNode("h3", { class: "text-lg font-medium text-gray-900 mb-3" }, "Sales Order Information"),
                          createVNode("dl", { class: "space-y-2" }, [
                            ...
                            createVNode("div", null, [
                              createVNode("dt", { class: "text-sm font-medium text-gray-500" }, "Created Date"),
                  ...
                  createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6" }, [
                    createVNode("div", { class: "bg-white p-4 rounded-lg shadow-sm border border-gray-200" }, [
                      createVNode("div", { class: "text-sm font-medium text-gray-500 mb-1" }, "Revenue"),
                      createVNode("div", { class: "text-lg font-bold text-gray-900" }, " Rp " + toDisplayString(formatNumber(__props.profitAnalysis.revenue)), 1)
                    ]),
                    createVNode("div", { class: "bg-white p-4 rounded-lg shadow-sm border border-gray-200" }, [
                      createVNode("div", { class: "text-sm font-medium text-gray-500 mb-1" }, "Operational Costs"),
                      createVNode("div", { class: "text-lg font-bold text-gray-900" }, " Rp " + toDisplayString(formatNumber(__props.profitAnalysis.operational_costs)), 1)
                    ]),
                    createVNode("div", { class: "bg-white p-4 rounded-lg shadow-sm border border-gray-200" }, [
                      createVNode("div", { class: "text-sm font-medium text-gray-500 mb-1" }, "Tax Expense"),
                      createVNode("div", { class: "text-lg font-bold text-gray-900" }, " Rp " + toDisplayString(formatNumber(__props.profitAnalysis.tax_expense)), 1)
                    ]),
                    createVNode("div", { class: "bg-white p-4 rounded-lg shadow-sm border border-gray-200" }, [
                      createVNode("div", { class: "text-sm font-medium text-gray-500 mb-1" }, "Net Profit"),
                      createVNode("div", {
                        class: ["text-lg font-bold", __props.profitAnalysis.profit >= 0 ? "text-green-600" : "text-red-600"]
                      }, " Rp " + toDisplayString(formatNumber(__props.profitAnalysis.profit)), 3)
                    ]),
                    createVNode("div", { class: "bg-white p-4 rounded-lg shadow-sm border border-gray-200" }, [
                      createVNode("div", { class: "text-sm font-medium text-gray-500 mb-1" }, "Profit Margin"),
                      createVNode("div", { class: "text-lg font-bold text-gray-900" }, toDisplayString(formatPercentage(__props.profitAnalysis.profit_margin)) + "% ", 1)
                    ])
                  ]),
                  ...
                  createVNode("div", { class: "bg-white rounded-lg shadow-sm overflow-hidden mb-6" }, [
                    ...
                    createVNode("div", { class: "px-6 py-4 border-b border-gray-200 bg-white" }, [
                      createVNode("div", { class: "flex items-center justify-between text-sm font-medium text-gray-700" }, [
                        createVNode("span", null, "Tax Expense"),
                        createVNode("span", { class: "text-gray-900" }, "Rp " + toDisplayString(formatNumber(__props.profitAnalysis.tax_expense)), 1)
                      ])
                    ]),
                    createVNode("div", { class: "overflow-x-auto" }, [
                      createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
