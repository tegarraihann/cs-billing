        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (showPurchaseModal.value) {
              ...
              _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Kategori</label><input${ssrRenderAttr("value", unref(purchaseForm).category)} type="text" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" placeholder="Opsional"${_scopeId}></div></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Deskripsi</label><input${ssrRenderAttr("value", unref(purchaseForm).description)} type="text" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" placeholder="Keterangan tambahan"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Akun Beban (P&amp;L) *</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(purchaseForm).pl_account_id) ? ssrLooseContain(unref(purchaseForm).pl_account_id, "") : ssrLooseEqual(unref(purchaseForm).pl_account_id, "")) ? " selected" : ""}${_scopeId}>Pilih akun</option><!--[-->`);
              ssrRenderList(expenseAccounts.value, (acc) => {
                _push2(`<option${ssrRenderAttr("value", acc.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(purchaseForm).pl_account_id) ? ssrLooseContain(unref(purchaseForm).pl_account_id, acc.id) : ssrLooseEqual(unref(purchaseForm).pl_account_id, acc.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(acc.account_code)} - ${ssrInterpolate(acc.account_name)}</option>`);
              });
              _push2(`<!--]--></select>`);
              ...
              _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Sumber Dana *</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(purchaseForm).source_type) ? ssrLooseContain(unref(purchaseForm).source_type, "") : ssrLooseEqual(unref(purchaseForm).source_type, "")) ? " selected" : ""}${_scopeId}>Pilih sumber dana</option><option value="bank"${ssrIncludeBooleanAttr(Array.isArray(unref(purchaseForm).source_type) ? ssrLooseContain(unref(purchaseForm).source_type, "bank") : ssrLooseEqual(unref(purchaseForm).source_type, "bank")) ? " selected" : ""}${_scopeId}>Transfer Bank</option><option value="petty_cash"${ssrIncludeBooleanAttr(Array.isArray(unref(purchaseForm).source_type) ? ssrLooseContain(unref(purchaseForm).source_type, "petty_cash") : ssrLooseEqual(unref(purchaseForm).source_type, "petty_cash")) ? " selected" : ""}${_scopeId}>Petty Cash</option></select>`);
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", null, [
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        [vModelSelect, unref(purchaseForm).pl_account_id]
                      ]),
