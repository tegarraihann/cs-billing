    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6 max-w-4xl mx-auto" data-v-8b84c0c8${_scopeId}><div class="mb-6" data-v-8b84c0c8${_scopeId}><div class="flex items-center space-x-4 mb-2" data-v-8b84c0c8${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-8b84c0c8${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-8b84c0c8${_scopeId2}></path></svg>`);
                } else {
                  return [
            ...
            _push2(`<h1 class="text-2xl font-bold text-sage-800" data-v-8b84c0c8${_scopeId}>Add Petty Cash Transaction</h1></div><div class="flex items-center justify-between" data-v-8b84c0c8${_scopeId}><p class="text-sm text-sage-600" data-v-8b84c0c8${_scopeId}>Create a new petty cash transaction</p><div class="text-right" data-v-8b84c0c8${_scopeId}><div class="text-xs text-sage-500" data-v-8b84c0c8${_scopeId}>Current Balance</div><div class="text-lg font-bold text-sage-800" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(formatCurrency(__props.currentBalance))}</div></div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6" data-v-8b84c0c8${_scopeId}><form class="space-y-6" data-v-8b84c0c8${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-8b84c0c8${_scopeId}><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Transaction Date <span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).transaction_date)} type="date"${ssrRenderAttr("max", today.value)} class="${ssrRenderClass([{ "border-red-300": errors.value.transaction_date }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}>`);
            if (errors.value.transaction_date) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.transaction_date)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Transaction Type <span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span></label><select class="${ssrRenderClass([{ "border-red-300": errors.value.type }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}><option value="" data-v-8b84c0c8${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, "") : ssrLooseEqual(unref(form).type, "")) ? " selected" : ""}${_scopeId}>Select Transaction Type</option><option value="expense" data-v-8b84c0c8${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, "expense") : ssrLooseEqual(unref(form).type, "expense")) ? " selected" : ""}${_scopeId}>Expense</option><option value="topup" data-v-8b84c0c8${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, "topup") : ssrLooseEqual(unref(form).type, "topup")) ? " selected" : ""}${_scopeId}>Top Up</option><option value="refund" data-v-8b84c0c8${ssrIncludeBooleanAttr(Array.isArray(unref(form).type) ? ssrLooseContain(unref(form).type, "refund") : ssrLooseEqual(unref(form).type, "refund")) ? " selected" : ""}${_scopeId}>Refund</option></select>`);
            if (errors.value.type) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.type)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-8b84c0c8${_scopeId}><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Category `);
            if (unref(form).type === "expense") {
              _push2(`<span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</label>`);
            ...
            if (errors.value.category_id) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.category_id)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).type !== "expense") {
              _push2(`<p class="mt-1 text-xs text-sage-500" data-v-8b84c0c8${_scopeId}> Category is only for expense transactions </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Expense Account (P&amp;L) `);
            if (unref(form).type === "expense") {
              _push2(`<span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span>`);
            } else {
              _push2(`<!---->`);
            ...
            if (errors.value.pl_account_id) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.pl_account_id)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).type !== "expense") {
              _push2(`<p class="mt-1 text-xs text-sage-500" data-v-8b84c0c8${_scopeId}> P&amp;L account is only for expense transactions </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Bank Source `);
            if (["topup", "refund"].includes(unref(form).type)) {
              _push2(`<span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</label><select${ssrIncludeBooleanAttr(!["topup", "refund"].includes(unref(form).type)) ? " disabled" : ""} class="${ssrRenderClass([{ "border-red-300": errors.value.bank_account_id }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}><option value="" data-v-8b84c0c8${ssrIncludeBooleanAttr(Array.isArray(unref(form).bank_account_id) ? ssrLooseContain(unref(form).bank_account_id, "") : ssrLooseEqual(unref(form).bank_account_id, "")) ? " selected" : ""}${_scopeId}>Select Bank</option><!--[-->`);
            ssrRenderList(__props.bankAccounts, (bank) => {
              _push2(`<option${ssrRenderAttr("value", bank.id)} data-v-8b84c0c8${ssrIncludeBooleanAttr(Array.isArray(unref(form).bank_account_id) ? ssrLooseContain(unref(form).bank_account_id, bank.id) : ssrLooseEqual(unref(form).bank_account_id, bank.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(bank.bank_name)} • ${ssrInterpolate(bank.account_number)} (${ssrInterpolate(bank.account_name)}) </option>`);
            });
            _push2(`<!--]--></select>`);
            if (errors.value.bank_account_id) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.bank_account_id)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (["topup", "refund"].includes(unref(form).type)) {
              _push2(`<p class="mt-1 text-xs text-sage-500" data-v-8b84c0c8${_scopeId}> Bank balance will decrease by the top up/refund amount. </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Amount (Rp) <span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).amount)} type="number" step="0.01" min="0" placeholder="0" class="${ssrRenderClass([{ "border-red-300": errors.value.amount }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}>`);
            if (errors.value.amount) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.amount)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).amount && unref(form).type === "expense") {
              _push2(`<div class="${ssrRenderClass([willBeNegative.value ? "text-red-500" : "text-sage-500", "mt-1 text-xs"])}" data-v-8b84c0c8${_scopeId}> Balance after transaction: ${ssrInterpolate(formatCurrency(projectedBalance.value))} `);
              if (willBeNegative.value) {
                _push2(`<span class="font-medium" data-v-8b84c0c8${_scopeId}>(Balance will be negative!)</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            } else if (unref(form).amount && unref(form).type !== "expense") {
              _push2(`<div class="mt-1 text-xs text-sage-500" data-v-8b84c0c8${_scopeId}> Balance after transaction: ${ssrInterpolate(formatCurrency(projectedBalance.value))}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Description <span class="text-red-500" data-v-8b84c0c8${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).description)} type="text" placeholder="Enter transaction description" class="${ssrRenderClass([{ "border-red-300": errors.value.description }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}>`);
            if (errors.value.description) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.description)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Sales Order Number (Optional) </label><input${ssrRenderAttr("value", unref(form).so_number)} type="text" placeholder="Example: SO-2024-001" class="${ssrRenderClass([{ "border-red-300": errors.value.so_number }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}>`);
            if (errors.value.so_number) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.so_number)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Notes (Optional) </label><textarea rows="3" placeholder="Additional notes for this transaction" class="${ssrRenderClass([{ "border-red-300": errors.value.notes }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm resize-none"])}" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(unref(form).notes)}</textarea>`);
            if (errors.value.notes) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.notes)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-8b84c0c8${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-8b84c0c8${_scopeId}> Receipt File (Optional) </label><input type="file" accept=".jpg,.jpeg,.png,.pdf" class="${ssrRenderClass([{ "border-red-300": errors.value.receipt_file }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}" data-v-8b84c0c8${_scopeId}><p class="mt-1 text-xs text-sage-500" data-v-8b84c0c8${_scopeId}> Max 2MB. Supported formats: JPG, PNG, PDF </p>`);
            if (errors.value.receipt_file) {
              _push2(`<p class="mt-1 text-sm text-red-600" data-v-8b84c0c8${_scopeId}>${ssrInterpolate(errors.value.receipt_file)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="flex justify-end space-x-3 pt-4 border-t border-sage-200" data-v-8b84c0c8${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(route)("admin-keuangan.petty-cash.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(isDisabled.value) ? " disabled" : ""} class="${ssrRenderClass([willBeNegative.value ? "bg-red-600 hover:bg-red-700" : "bg-sage-600 hover:bg-sage-700", "px-4 py-2 text-sm font-medium text-white rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"])}" data-v-8b84c0c8${_scopeId}>`);
            if (processing.value) {
              _push2(`<span class="flex items-center" data-v-8b84c0c8${_scopeId}><svg class="animate-spin -ml-1 mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" data-v-8b84c0c8${_scopeId}><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" class="opacity-25" data-v-8b84c0c8${_scopeId}></circle><path fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" class="opacity-75" data-v-8b84c0c8${_scopeId}></path></svg> Saving... </span>`);
            } else {
              _push2(`<span data-v-8b84c0c8${_scopeId}>${ssrInterpolate(willBeNegative.value ? "Save (Negative Balance!)" : "Save Transaction")}</span>`);
            }
...
const Create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8b84c0c8"]]);
export {
  Create as default
};
