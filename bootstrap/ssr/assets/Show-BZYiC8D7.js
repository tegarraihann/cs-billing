...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const isAdditionalInvoice = computed(() => {
      var _a;
      return !!((_a = props.invoice) == null ? void 0 : _a.is_additional);
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-a2b07b96${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-a2b07b96${_scopeId}><div class="flex itemss-center justify-between" data-v-a2b07b96${_scopeId}><div data-v-a2b07b96${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-a2b07b96${_scopeId}>Invoice Details</h2><p class="text-sage-600" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.invoice_number)}</p></div><div class="flex space-x-3" data-v-a2b07b96${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-a2b07b96${_scopeId2}></path></svg> Back `);
                } else {
                  return [
            ...
            if (__props.invoice.status === "draft") {
              _push2(`<button class="inline-flex itemss-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors" data-v-a2b07b96${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" data-v-a2b07b96${_scopeId}></path></svg> Mark as Sent </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (shouldShowFixOperationalCostsButton.value) {
              _push2(`<button class="inline-flex itemss-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors" data-v-a2b07b96${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-l inecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" data-v-a2b07b96${_scopeId}></path></svg> Fix Operational Costs </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (shouldShowProfitLossButton.value) {
              _push2(`<button class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-600 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" data-v-a2b07b96${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" data-v-a2b07b96${_scopeId}></path></svg> Post to Profit &amp; Loss </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.invoice.posted_to_profit_loss) {
              _push2(`<button class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-600 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" data-v-a2b07b96${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" data-v-a2b07b96${_scopeId}></path></svg> Unpost Profit &amp; Loss </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6" data-v-a2b07b96${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-a2b07b96${_scopeId}>Invoice Information</h3><div class="space-y-3" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Invoice Number:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.invoice_number)}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Sales Order:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate((_a = __props.invoice.sales_order) == null ? void 0 : _a.order_number)}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Customer:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(((_b = __props.invoice.customer) == null ? void 0 : _b.consignee_shipper) || ((_c = __props.invoice.customer) == null ? void 0 : _c.company_name))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Invoice Date:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.invoice_date))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Due Date:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.due_date))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Term:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.term_days)} Days</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Status:</span><span class="${ssrRenderClass([getStatusColor(__props.invoice.status), "inline-flex itemss-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getStatusLabel(__props.invoice.status))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Payment Status:</span><span class="${ssrRenderClass([getPaymentStatusColor(__props.invoice), "inline-flex itemss-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getPaymentStatusLabel(__props.invoice))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Down Payment (DP):</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(hasDownPayment.value ? formatCurrency(downPaymentAmount.value) : "-")}</span></div>`);
            if (hasDownPayment.value) {
              _push2(`<div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>DP Date:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.down_payment_date))}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (hasDownPayment.value && __props.invoice.down_payment_notes) {
              _push2(`<div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>DP Notes:</span><span class="font-medium text-right" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.down_payment_notes)}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Profit &amp; Loss Status:</span><span class="${ssrRenderClass([__props.invoice.posted_to_profit_loss ? "bg-purple-100 text-purple-800" : "bg-gray-100 text-gray-800", "inline-flex itemss-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.posted_to_profit_loss ? "Posted" : "Not Posted")}</span></div></div></div><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-a2b07b96${_scopeId}>Shipment Details</h3><div class="space-y-3" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Shipper:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.shipper || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Consignee:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.consignee || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Vessel:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.vessel || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Flight/VOY:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.flight_voy || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>AWB/BL No:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.awb_bl_no || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>POL/POD:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.pol_pod || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Origin:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.origin || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Destination:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.destination || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Gross Weight:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.gross_weight || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Volume:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.volume || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>No. of Packages:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.no_of_packages || "-")} ${ssrInterpolate(__props.invoice.package_unit || "BAG")}</span></div></div></div>`);
            if (__props.invoice.status === "paid") {
              _push2(`<div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-a2b07b96${_scopeId}>Payment Information</h3><div class="space-y-3" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Payment Date:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.paid_date))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Amount Paid:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(__props.invoice.paid_amount))}</span></div>`);
              if (__props.invoice.payment_method) {
                _push2(`<div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Payment Method:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.payment_method)}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Confirmed By:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(((_d = __props.invoice.confirmed_by) == null ? void 0 : _d.name) || "-")}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Confirmation Time:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatDateTime(__props.invoice.payment_confirmed_at))}</span></div>`);
              if (__props.invoice.payment_notes) {
                _push2(`<div class="pt-2" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Notes:</span><p class="text-gray-900 mt-1" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.payment_notes)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            if (__props.invoice.posted_to_profit_loss) {
              _push2(`<div class="bg-white rounded-lg shadow-sm p-6 border border-purple-200" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-purple-800 mb-4" data-v-a2b07b96${_scopeId}>Profit &amp; Loss Posting Information</h3><div class="space-y-3" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Status:</span><span class="inline-flex itemss-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800" data-v-a2b07b96${_scopeId}> Posted </span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Posting Date:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatDateTime(__props.invoice.posted_to_profit_loss_at))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Posted By:</span><span class="font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(((_e = __props.invoice.posted_by_user) == null ? void 0 : _e.name) || "-")}</span></div>`);
              if (__props.invoice.profit_loss_entries && __props.invoice.profit_loss_entries.length > 0) {
                _push2(`<div class="pt-2" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Entry IDs:</span><p class="text-gray-900 mt-1 text-sm" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.profit_loss_entries.join(", "))}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            _push2(`</div>`);
            if (__props.invoice.invoice_type === "main" || __props.invoice.invoice_type === "combined" || getMainItems.value.length > 0) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden mb-6" data-v-a2b07b96${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-blue-50" data-v-a2b07b96${_scopeId}><div class="flex itemss-center justify-between" data-v-a2b07b96${_scopeId}><div class="flex itemss-center space-x-3" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-blue-800" data-v-a2b07b96${_scopeId}>Main Invoice Items</h3><span class="inline-flex itemss-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(displayMainInvoice.value.invoice_number)}</span></div><div class="flex space-x-2" data-v-a2b07b96${_scopeId}><a${ssrRenderAttr("href", route("admin-keuangan.invoices.preview-pdf", displayMainInvoice.value.id))} class="inline-flex itemss-center px-3 py-1.5 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-700 transition-colors" target="_blank" data-v-a2b07b96${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-a2b07b96${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-a2b07b96${_scopeId}></path></svg> Preview PDF </a><a${ssrRenderAttr("href", route("admin-keuangan.invoices.export-pdf", displayMainInvoice.value.id))} class="inline-flex itemss-center px-3 py-1.5 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700 transition-colors" target="_blank" data-v-a2b07b96${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" data-v-a2b07b96${_scopeId}></path></svg> Download PDF </a></div></div></div><div class="overflow-x-auto" data-v-a2b07b96${_scopeId}><table class="w-full" data-v-a2b07b96${_scopeId}><thead class="bg-sage-50" data-v-a2b07b96${_scopeId}><tr data-v-a2b07b96${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Description </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Amount </th></tr></thead><tbody class="bg-white divide-y divide-sage-200" data-v-a2b07b96${_scopeId}><!--[-->`);
              ssrRenderList(getMainItems.value, (items) => {
                _push2(`<tr class="hover:bg-sage-50" data-v-a2b07b96${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.description)}</div>`);
                if (getReimbursementLatestHistory(items)) {
                  _push2(`<div class="text-xs text-gray-500 mt-1 space-y-0.5" data-v-a2b07b96${_scopeId}><div class="flex flex-wrap itemss-center gap-2" data-v-a2b07b96${_scopeId}><span data-v-a2b07b96${_scopeId}>Latest:</span><span class="inline-flex itemss-center px-2 py-0.5 rounded-full bg-gray-100 text-gray-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getReimbursementStatusLabel(getReimbursementLatestHistory(items).status))}</span>`);
                  if (getReimbursementLatestHistory(items).vendor_name) {
                    _push2(`<span data-v-a2b07b96${_scopeId}> by ${ssrInterpolate(getReimbursementLatestHistory(items).vendor_name)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (getReimbursementLatestHistory(items).timestamp) {
                    _push2(`<span data-v-a2b07b96${_scopeId}> (${ssrInterpolate(formatDate(getReimbursementLatestHistory(items).timestamp))}) </span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                  if (getReimbursementLatestHistory(items).notes) {
                    _push2(`<div data-v-a2b07b96${_scopeId}> Notes: ${ssrInterpolate(getReimbursementLatestHistory(items).notes)}</div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (getReimbursementLatestHistory(items).user) {
                    _push2(`<div data-v-a2b07b96${_scopeId}> Processed by: ${ssrInterpolate(getReimbursementLatestHistory(items).user)}</div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                ...
                _push2(`</td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getOperationalQtyDisplay(items))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getOperationalUnitDisplay(items))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(items.rate, items.currency))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.currency)}</div></td><td class="px-6 py-4 whitespace-nowrap text-right" data-v-a2b07b96${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(
                  getOperationalAmountValue(items),
                  items.currency
                ))}</div></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div><div class="px-6 py-4 bg-blue-50 border-t border-sage-200" data-v-a2b07b96${_scopeId}><div class="flex justify-end" data-v-a2b07b96${_scopeId}><div class="w-64 space-y-2" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-gray-600" data-v-a2b07b96${_scopeId}>Subtotal Main:</span><span class="text-sm font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getMainTotal.value))}</span></div>`);
              if (hasDownPayment.value && __props.invoice.invoice_type === "main") {
                _push2(`<div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-gray-600" data-v-a2b07b96${_scopeId}>Down Payment (-):</span><span class="text-sm font-medium text-red-700" data-v-a2b07b96${_scopeId}>- ${ssrInterpolate(formatCurrency(downPaymentAmount.value))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex justify-between pt-2 border-t border-blue-200" data-v-a2b07b96${_scopeId}><span class="text-lg font-semibold text-blue-800" data-v-a2b07b96${_scopeId}>Total Main:</span><span class="text-lg font-bold text-blue-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(hasDownPayment.value && __props.invoice.invoice_type === "main" ? mainTotalAfterDownPayment.value : getMainTotal.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.invoice.invoice_type === "reimbursement" || __props.invoice.invoice_type === "combined" || getReimbursementItems.value.length > 0) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden mb-6" data-v-a2b07b96${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-orange-50" data-v-a2b07b96${_scopeId}><div class="flex itemss-center justify-between" data-v-a2b07b96${_scopeId}><div class="flex itemss-center space-x-3" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-orange-800" data-v-a2b07b96${_scopeId}>Reimbursement Invoice Items</h3><span class="inline-flex itemss-center px-2 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(displayReimbursementInvoice.value.invoice_number)}</span></div><div class="flex space-x-2" data-v-a2b07b96${_scopeId}><a${ssrRenderAttr("href", route("admin-keuangan.invoices.preview-pdf-reimbursement", displayReimbursementInvoice.value.id))} class="inline-flex itemss-center px-3 py-1.5 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-700 transition-colors" target="_blank" data-v-a2b07b96${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-a2b07b96${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-a2b07b96${_scopeId}></path></svg> Preview PDF </a><a${ssrRenderAttr("href", route("admin-keuangan.invoices.export-pdf-reimbursement", displayReimbursementInvoice.value.id))} class="inline-flex itemss-center px-3 py-1.5 bg-orange-600 text-white text-sm rounded-md hover:bg-orange-700 transition-colors" target="_blank" data-v-a2b07b96${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" data-v-a2b07b96${_scopeId}></path></svg> Download PDF </a></div></div></div>`);
              if (hasReimbursementEntries.value) {
                _push2(`<div class="overflow-x-auto" data-v-a2b07b96${_scopeId}><table class="w-full" data-v-a2b07b96${_scopeId}><thead class="bg-sage-50" data-v-a2b07b96${_scopeId}><tr data-v-a2b07b96${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Description </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Amount </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Vendor </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}></th></tr></thead><tbody class="bg-white divide-y divide-sage-200" data-v-a2b07b96${_scopeId}>`);
                if (filteredReimbursementEntries.value.length === 0) {
                  _push2(`<tr data-v-a2b07b96${_scopeId}><td colspan="10" class="px-6 py-6 text-center text-sm text-gray-500" data-v-a2b07b96${_scopeId}> No reimbursement data matches this filter. </td></tr>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--[-->`);
                ssrRenderList(filteredReimbursementEntries.value, (items) => {
                  _push2(`<tr class="hover:bg-sage-50" data-v-a2b07b96${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.description)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getOperationalQtyDisplay(items))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getOperationalUnitDisplay(items))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(items.rate, items.currency || reimbursementCurrency.value))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.currency || reimbursementCurrency.value)}</div></td><td class="px-6 py-4 whitespace-nowrap text-right" data-v-a2b07b96${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(items.amount, items.currency || reimbursementCurrency.value))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.vendor_name)}</div></td></tr>`);
                });
                _push2(`<!--]--></tbody></table></div>`);
              } else {
                _push2(`<div class="overflow-x-auto" data-v-a2b07b96${_scopeId}><table class="w-full" data-v-a2b07b96${_scopeId}><thead class="bg-sage-50" data-v-a2b07b96${_scopeId}><tr data-v-a2b07b96${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Description </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Amount </th></tr></thead><tbody class="bg-white divide-y divide-sage-200" data-v-a2b07b96${_scopeId}><!--[-->`);
                ssrRenderList(getReimbursementItems.value, (items) => {
                  _push2(`<tr class="hover:bg-sage-50" data-v-a2b07b96${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.description)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatNumber(items.quantity))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.unit)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(items.rate, items.currency))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-a2b07b96${_scopeId}><div class="text-sm text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(items.currency)}</div></td><td class="px-6 py-4 whitespace-nowrap text-right" data-v-a2b07b96${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(
                    items.amount,
                    items.currency
                  ))}</div></td></tr>`);
                });
              ...
              _push2(`<div class="px-6 py-4 bg-orange-50 border-t border-sage-200" data-v-a2b07b96${_scopeId}><div class="flex justify-end" data-v-a2b07b96${_scopeId}><div class="w-64 space-y-2" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-gray-600" data-v-a2b07b96${_scopeId}>${ssrInterpolate(reimbursementSubtotalLabel.value)}</span><span class="text-sm font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(reimbursementFilteredSubtotal.value, reimbursementCurrency.value))}</span></div>`);
              if (hasReimbursementEntries.value && reimbursementFilter.value !== "all") {
                _push2(`<div class="text-xs text-gray-500 text-right" data-v-a2b07b96${_scopeId}> Showing ${ssrInterpolate(filteredReimbursementEntries.value.length)} of ${ssrInterpolate(normalizedReimbursementEntries.value.length)} items </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex justify-between pt-2 border-t border-orange-200" data-v-a2b07b96${_scopeId}><span class="text-lg font-semibold text-orange-800" data-v-a2b07b96${_scopeId}>Total Reimbursement:</span><span class="text-lg font-bold text-orange-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(reimbursementOverallSubtotal.value, reimbursementCurrency.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (getOperationalCosts.value.length > 0) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-red-200 overflow-hidden mb-6" data-v-a2b07b96${_scopeId}><div class="px-6 py-4 border-b border-red-200 bg-red-50" data-v-a2b07b96${_scopeId}><div class="flex itemss-center justify-between" data-v-a2b07b96${_scopeId}><div class="flex itemss-center space-x-3" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-red-800" data-v-a2b07b96${_scopeId}>Other Costs / Operational Costs</h3><span class="inline-flex itemss-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800" data-v-a2b07b96${_scopeId}> Internal Only </span></div><div class="text-sm text-red-600" data-v-a2b07b96${_scopeId}> Not visible to customer </div></div></div><div class="overflow-x-auto" data-v-a2b07b96${_scopeId}><table class="w-full" data-v-a2b07b96${_scopeId}><thead class="bg-red-50" data-v-a2b07b96${_scopeId}><tr data-v-a2b07b96${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Description </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-red-500 uppercase tracking-wider" data-v-a2b07b96${_scopeId}> Amount </th></tr></thead><tbody class="bg-white divide-y divide-red-200" data-v-a2b07b96${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></tbody></table></div><div class="px-6 py-4 bg-red-50 border-t border-red-200" data-v-a2b07b96${_scopeId}><div class="flex justify-end" data-v-a2b07b96${_scopeId}><div class="w-64 space-y-2" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-gray-600" data-v-a2b07b96${_scopeId}>Other Costs Subtotal:</span><span class="text-sm font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div><div class="flex justify-between pt-2 border-t border-red-200" data-v-a2b07b96${_scopeId}><span class="text-lg font-semibold text-red-800" data-v-a2b07b96${_scopeId}>Total Other Costs:</span><span class="text-lg font-bold text-red-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="bg-white rounded-lg shadow-sm border border-purple-200 overflow-hidden mb-6" data-v-a2b07b96${_scopeId}><div class="px-6 py-4 border-b border-purple-200 bg-purple-50" data-v-a2b07b96${_scopeId}><div class="flex itemss-center justify-between" data-v-a2b07b96${_scopeId}><div class="flex itemss-center space-x-3" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-purple-800" data-v-a2b07b96${_scopeId}>Profit Analysis</h3><span class="inline-flex itemss-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800" data-v-a2b07b96${_scopeId}> Internal Analysis </span></div></div></div><div class="px-6 py-4" data-v-a2b07b96${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" data-v-a2b07b96${_scopeId}><div class="bg-green-50 rounded-lg p-4 border border-green-200" data-v-a2b07b96${_scopeId}><div class="text-center" data-v-a2b07b96${_scopeId}><div class="text-2xl font-bold text-green-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</div><div class="text-sm text-green-600 mt-1" data-v-a2b07b96${_scopeId}>Gross Revenue</div><div class="text-xs text-gray-500 mt-1" data-v-a2b07b96${_scopeId}>Total billable</div></div></div><div class="bg-red-50 rounded-lg p-4 border border-red-200" data-v-a2b07b96${_scopeId}><div class="text-center" data-v-a2b07b96${_scopeId}><div class="text-2xl font-bold text-red-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</div><div class="text-sm text-red-600 mt-1" data-v-a2b07b96${_scopeId}>Operational Costs</div><div class="text-xs text-gray-500 mt-1" data-v-a2b07b96${_scopeId}>Operational costs</div></div></div><div class="bg-blue-50 rounded-lg p-4 border border-blue-200" data-v-a2b07b96${_scopeId}><div class="text-center" data-v-a2b07b96${_scopeId}><div class="text-2xl font-bold text-blue-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getNetProfit.value))}</div><div class="text-sm text-blue-600 mt-1" data-v-a2b07b96${_scopeId}>Net Profit</div><div class="text-xs text-gray-500 mt-1" data-v-a2b07b96${_scopeId}>Net profit</div></div></div><div class="bg-purple-50 rounded-lg p-4 border border-purple-200" data-v-a2b07b96${_scopeId}><div class="text-center" data-v-a2b07b96${_scopeId}><div class="text-2xl font-bold text-purple-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getProfitMargin.value)}%</div><div class="text-sm text-purple-600 mt-1" data-v-a2b07b96${_scopeId}>Profit Margin</div><div class="text-xs text-gray-500 mt-1" data-v-a2b07b96${_scopeId}>Profit percentage</div></div></div></div><div class="mt-6 bg-gray-50 rounded-lg p-4" data-v-a2b07b96${_scopeId}><h4 class="text-sm font-semibold text-gray-800 mb-3" data-v-a2b07b96${_scopeId}>Calculation Details:</h4><div class="space-y-2 text-sm" data-v-a2b07b96${_scopeId}><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Main Invoice</span><span class="font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>VAT</span><span class="font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(vatAmount.value))}</span></div><div class="flex justify-between py-1 border-t border-b border-gray-200" data-v-a2b07b96${_scopeId}><span class="text-gray-700" data-v-a2b07b96${_scopeId}>Total Main Invoice + VAT</span><span class="font-semibold text-blue-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value + vatAmount.value))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Reimbursement</span><span class="font-medium text-gray-900" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getReimbursementTotal.value))}</span></div><div class="flex justify-between py-1 border-t border-b border-gray-200" data-v-a2b07b96${_scopeId}><span class="text-gray-700" data-v-a2b07b96${_scopeId}>Total Invoice + Reimbursement</span><span class="font-semibold text-blue-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value + vatAmount.value + getReimbursementTotal.value))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Operational Costs</span><span class="font-medium text-red-700" data-v-a2b07b96${_scopeId}>- ${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div><div class="flex justify-between font-semibold" data-v-a2b07b96${_scopeId}><span class="text-gray-800" data-v-a2b07b96${_scopeId}>Net Profit</span><span class="text-green-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getNetProfit.value))}</span></div><div class="flex justify-between text-sm" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Profit Percentage</span><span class="text-purple-700 font-medium" data-v-a2b07b96${_scopeId}>${ssrInterpolate(getProfitMargin.value)}%</span></div></div></div></div></div>`);
            if (__props.invoice.invoice_type === "combined" && getMainItems.value.length > 0 && getReimbursementItems.value.length > 0) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-a2b07b96${_scopeId}><div class="px-6 py-4 bg-sage-50" data-v-a2b07b96${_scopeId}><div class="flex justify-end" data-v-a2b07b96${_scopeId}><div class="w-80 space-y-3" data-v-a2b07b96${_scopeId}><div class="text-center text-lg font-semibold text-sage-800 pb-2 border-b border-sage-300" data-v-a2b07b96${_scopeId}> Combined Invoice Summary </div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-blue-700" data-v-a2b07b96${_scopeId}>Total Main Items:</span><span class="text-sm font-medium text-blue-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getMainTotal.value))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-gray-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(vatRateLabel.value)}:</span><span class="text-sm font-medium text-gray-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(vatAmount.value))}</span></div><div class="flex justify-between" data-v-a2b07b96${_scopeId}><span class="text-sm text-orange-700" data-v-a2b07b96${_scopeId}>Total Reimbursement Items:</span><span class="text-sm font-medium text-orange-700" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getReimbursementTotal.value))}</span></div><div class="flex justify-between pt-3 border-t border-sage-400" data-v-a2b07b96${_scopeId}><span class="text-xl font-bold text-sage-800" data-v-a2b07b96${_scopeId}>Grand Total:</span><span class="text-xl font-bold text-sage-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(combinedTotalBeforeDownPayment.value))}</span></div>`);
              if (hasDownPayment.value) {
                _push2(`<div class="flex justify-between text-sm text-red-700" data-v-a2b07b96${_scopeId}><span data-v-a2b07b96${_scopeId}>Down Payment (-):</span><span class="font-medium" data-v-a2b07b96${_scopeId}>- ${ssrInterpolate(formatCurrency(downPaymentAmount.value))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              if (hasDownPayment.value) {
                _push2(`<div class="flex justify-between pt-2 border-t border-sage-300" data-v-a2b07b96${_scopeId}><span class="text-lg font-bold text-sage-800" data-v-a2b07b96${_scopeId}>Total After DP:</span><span class="text-lg font-bold text-sage-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(combinedTotalAfterDownPayment.value))}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
            ...
            if (showPaymentModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex itemss-center justify-center z-50" data-v-a2b07b96${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-gray-900 mb-4" data-v-a2b07b96${_scopeId}>Confirm Payment</h3><form data-v-a2b07b96${_scopeId}><div class="space-y-4" data-v-a2b07b96${_scopeId}><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Amount Paid</label><input type="number"${ssrRenderAttr("value", paymentForm.paid_amount)}${ssrRenderAttr("placeholder", formatCurrency(__props.invoice.total))} step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-a2b07b96${_scopeId}></div><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Payment Date</label><input type="date"${ssrRenderAttr("value", paymentForm.paid_date)}${ssrRenderAttr("max", (/* @__PURE__ */ new Date()).toISOString().split("T")[0])} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-a2b07b96${_scopeId}></div><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Payment Method</label><input type="text"${ssrRenderAttr("value", paymentForm.payment_method)} placeholder="Bank transfer, cash, etc." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-a2b07b96${_scopeId}></div><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Notes (Optional)</label><textarea rows="3" placeholder="Additional notes about this payment..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-a2b07b96${_scopeId}>${ssrInterpolate(paymentForm.payment_notes)}</textarea></div></div><div class="flex justify-end space-x-3 mt-6" data-v-a2b07b96${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-a2b07b96${_scopeId}> Cancel </button><button type="submit"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""} class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50" data-v-a2b07b96${_scopeId}>${ssrInterpolate(processing.value ? "Processing..." : "Confirm Payment")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showMarkSentModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex itemss-center justify-center z-50" data-v-a2b07b96${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-gray-900 mb-4" data-v-a2b07b96${_scopeId}>Mark Invoice as Sent</h3><p class="text-gray-600 mb-6" data-v-a2b07b96${_scopeId}>Are you sure you want to mark this invoice as sent to the customer? </p><div class="flex justify-end space-x-3" data-v-a2b07b96${_scopeId}><button class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-a2b07b96${_scopeId}> Cancel </button><button class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors" data-v-a2b07b96${_scopeId}> Yes, Mark as Sent </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showReimbursementPaymentModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex itemss-center justify-center z-50" data-v-a2b07b96${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-orange-800 mb-4" data-v-a2b07b96${_scopeId}>Update Reimbursement Status</h3>`);
              if (selectedReimbursementEntry.value) {
                _push2(`<div class="mb-4 text-sm text-gray-600" data-v-a2b07b96${_scopeId}><div class="font-medium text-gray-800" data-v-a2b07b96${_scopeId}>${ssrInterpolate(selectedReimbursementEntry.value.description)}</div><div data-v-a2b07b96${_scopeId}>Amount: ${ssrInterpolate(formatCurrency(
              ...
              _push2(`<form data-v-a2b07b96${_scopeId}><div class="space-y-4" data-v-a2b07b96${_scopeId}><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Status</label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" data-v-a2b07b96${_scopeId}><option value="paid" data-v-a2b07b96${ssrIncludeBooleanAttr(Array.isArray(unref(reimbursementPaymentForm).status) ? ssrLooseContain(unref(reimbursementPaymentForm).status, "paid") : ssrLooseEqual(unref(reimbursementPaymentForm).status, "paid")) ? " selected" : ""}${_scopeId}>Paid</option><option value="invoiced" data-v-a2b07b96${ssrIncludeBooleanAttr(Array.isArray(unref(reimbursementPaymentForm).status) ? ssrLooseContain(unref(reimbursementPaymentForm).status, "invoiced") : ssrLooseEqual(unref(reimbursementPaymentForm).status, "invoiced")) ? " selected" : ""}${_scopeId}>Unpaid</option></select></div>`);
              if (unref(reimbursementPaymentForm).status === "paid") {
                _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-a2b07b96${_scopeId}><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Vendor / Payer</label><input type="text"${ssrRenderAttr("value", unref(reimbursementPaymentForm).vendor_name)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Eshaka Wijaya Logistics" required data-v-a2b07b96${_scopeId}></div><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Payment Date</label><input type="date"${ssrRenderAttr("value", unref(reimbursementPaymentForm).paid_at)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" required data-v-a2b07b96${_scopeId}></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Notes (Optional)</label><textarea rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Example: Paid via the company BCA account" data-v-a2b07b96${_scopeId}>${ssrInterpolate(unref(reimbursementPaymentForm).notes)}</textarea></div></div><div class="flex justify-end space-x-3 mt-6" data-v-a2b07b96${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-a2b07b96${_scopeId}> Cancel </button><button type="submit"${ssrIncludeBooleanAttr(unref(reimbursementPaymentForm).processing) ? " disabled" : ""} class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors disabled:opacity-50" data-v-a2b07b96${_scopeId}>${ssrInterpolate(unref(reimbursementPaymentForm).processing ? "Saving..." : "Save Changes")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showProfitLossModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex itemss-center justify-center z-50" data-v-a2b07b96${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-2xl mx-4" data-v-a2b07b96${_scopeId}><h3 class="text-lg font-semibold text-purple-800 mb-4" data-v-a2b07b96${_scopeId}>Post Invoice to Profit &amp; Loss</h3><div class="bg-purple-50 rounded-lg p-4 mb-6 border border-purple-200" data-v-a2b07b96${_scopeId}><h4 class="text-sm font-semibold text-purple-800 mb-3" data-v-a2b07b96${_scopeId}>Invoice Summary:</h4><div class="grid grid-cols-2 gap-4 text-sm" data-v-a2b07b96${_scopeId}><div data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Invoice Number:</span><span class="font-medium text-purple-800 ml-2" data-v-a2b07b96${_scopeId}>${ssrInterpolate(__props.invoice.invoice_number)}</span></div><div data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Customer:</span><span class="font-medium text-purple-800 ml-2" data-v-a2b07b96${_scopeId}>${ssrInterpolate((_f = __props.invoice.customer) == null ? void 0 : _f.company_name)}</span></div><div data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Gross Revenue:</span><span class="font-medium text-green-700 ml-2" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</span></div><div data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Operational Costs:</span><span class="font-medium text-red-700 ml-2" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div><div class="col-span-2 pt-2 border-t border-purple-200" data-v-a2b07b96${_scopeId}><span class="text-gray-600" data-v-a2b07b96${_scopeId}>Net Profit:</span><span class="font-bold text-blue-700 ml-2" data-v-a2b07b96${_scopeId}>${ssrInterpolate(formatCurrency(getNetProfit.value))}</span></div></div></div><form data-v-a2b07b96${_scopeId}><div class="space-y-4" data-v-a2b07b96${_scopeId}><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}> Profit &amp; Loss Period <span class="text-red-500" data-v-a2b07b96${_scopeId}>*</span></label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" required data-v-a2b07b96${_scopeId}><option value="" data-v-a2b07b96${ssrIncludeBooleanAttr(Array.isArray(profitLossForm.period_id) ? ssrLooseContain(profitLossForm.period_id, "") : ssrLooseEqual(profitLossForm.period_id, "")) ? " selected" : ""}${_scopeId}>Select period...</option><!--[-->`);
              ssrRenderList(profitLossPeriods.value, (period) => {
                _push2(`<option${ssrRenderAttr("value", period.id)} data-v-a2b07b96${ssrIncludeBooleanAttr(Array.isArray(profitLossForm.period_id) ? ssrLooseContain(profitLossForm.period_id, period.id) : ssrLooseEqual(profitLossForm.period_id, period.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(formatPeriodLabel(period))}</option>`);
              });
              _push2(`<!--]--></select><p class="text-xs text-gray-500 mt-1" data-v-a2b07b96${_scopeId}> Select the profit &amp; loss period where this transaction will be recorded. </p></div><div data-v-a2b07b96${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a2b07b96${_scopeId}>Notes (Optional)</label><textarea rows="3" placeholder="Additional notes for profit &amp; loss posting..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" data-v-a2b07b96${_scopeId}>${ssrInterpolate(profitLossForm.notes)}</textarea></div><div class="bg-blue-50 border border-blue-200 rounded-lg p-4" data-v-a2b07b96${_scopeId}><div class="flex itemss-start" data-v-a2b07b96${_scopeId}><svg class="w-5 h-5 text-blue-500 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a2b07b96${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-a2b07b96${_scopeId}></path></svg><div class="text-sm" data-v-a2b07b96${_scopeId}><p class="text-blue-800 font-medium mb-1" data-v-a2b07b96${_scopeId}>Items to be posted:</p><ul class="text-blue-700 space-y-1" data-v-a2b07b96${_scopeId}>`);
              if (getGrossRevenue.value > 0) {
                _push2(`<li data-v-a2b07b96${_scopeId}>Revenue: ${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</li>`);
              } else {
                _push2(`<!---->`);
              }
              if (getOperationalCostsTotal.value > 0) {
                _push2(`<li data-v-a2b07b96${_scopeId}>Operational Costs: ${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</li>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<li data-v-a2b07b96${_scopeId}>Net Profit Impact: ${ssrInterpolate(formatCurrency(getNetProfit.value))}</li></ul></div></div></div></div><div class="flex justify-end space-x-3 mt-6" data-v-a2b07b96${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-a2b07b96${_scopeId}> Cancel </button><button type="submit"${ssrIncludeBooleanAttr(processing.value || !profitLossForm.period_id) ? " disabled" : ""} class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50" data-v-a2b07b96${_scopeId}>${ssrInterpolate(processing.value ? "Processing..." : "Post to Profit & Loss")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createVNode("div", { class: "p-4 sm:p-6 lg:p-8" }, [
                ...
                __props.invoice.invoice_type === "main" || __props.invoice.invoice_type === "combined" || getMainItems.value.length > 0 ? (openBlock(), createBlock("div", {
                  key: 0,
                  ...
                  createVNode("div", { class: "px-6 py-4 border-b border-sage-200 bg-blue-50" }, [
                    createVNode("div", { class: "flex itemss-center justify-between" }, [
                      createVNode("div", { class: "flex itemss-center space-x-3" }, [
                        ...
                        createVNode("span", { class: "inline-flex itemss-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800" }, toDisplayString(displayMainInvoice.value.invoice_number), 1)
                      ]),
                      createVNode("div", { class: "flex space-x-2" }, [
                        createVNode("a", {
                          href: route("admin-keuangan.invoices.preview-pdf", displayMainInvoice.value.id),
                        ...
                        createVNode("a", {
                          href: route("admin-keuangan.invoices.export-pdf", displayMainInvoice.value.id),
                ...
                __props.invoice.invoice_type === "reimbursement" || __props.invoice.invoice_type === "combined" || getReimbursementItems.value.length > 0 ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden mb-6"
                }, [
                  createVNode("div", { class: "px-6 py-4 border-b border-sage-200 bg-orange-50" }, [
                    createVNode("div", { class: "flex itemss-center justify-between" }, [
                      createVNode("div", { class: "flex itemss-center space-x-3" }, [
                        ...
                        createVNode("span", { class: "inline-flex itemss-center px-2 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-800" }, toDisplayString(displayReimbursementInvoice.value.invoice_number), 1)
                      ]),
                      createVNode("div", { class: "flex space-x-2" }, [
                        createVNode("a", {
                          href: route("admin-keuangan.invoices.preview-pdf-reimbursement", displayReimbursementInvoice.value.id),
                          class: "inline-flex itemss-center px-3 py-1.5 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-700 transition-colors",
                          target: "_blank"
                        }, [
                          (openBlock(), createBlock("svg", {
                        ...
                        createVNode("a", {
                          href: route("admin-keuangan.invoices.export-pdf-reimbursement", displayReimbursementInvoice.value.id),
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a2b07b96"]]);
export {
  Show as default
};
