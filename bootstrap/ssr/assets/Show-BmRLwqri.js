    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-689b91a5${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-689b91a5${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-689b91a5${_scopeId}><div class="flex items-center" data-v-689b91a5${_scopeId}><div class="w-12 h-12 bg-sage-600 rounded-full flex items-center justify-center mr-4" data-v-689b91a5${_scopeId}><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-689b91a5${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" data-v-689b91a5${_scopeId}></path></svg></div><div data-v-689b91a5${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-689b91a5${_scopeId}>${ssrInterpolate(__props.vendor.nama_vendor)}</h2><p class="text-sage-600" data-v-689b91a5${_scopeId}> Detail informasi vendor </p></div></div><div class="flex space-x-2 mt-4 sm:mt-0" data-v-689b91a5${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-cs.vendors.edit", __props.vendor.id),
              class: "inline-flex items-center px-4 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-689b91a5${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-689b91a5${_scopeId2}></path></svg> Edit `);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-689b91a5${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-689b91a5${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "w-4 h-4 mr-2",
            ...
            _push2(`</div></div></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-6" data-v-689b91a5${_scopeId}><div class="lg:col-span-1" data-v-689b91a5${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-689b91a5${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-689b91a5${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-689b91a5${_scopeId}> Informasi Vendor </h3></div><div class="p-6" data-v-689b91a5${_scopeId}><div class="space-y-6" data-v-689b91a5${_scopeId}><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> ID Vendor </label><p class="text-gray-900 font-medium" data-v-689b91a5${_scopeId}>#${ssrInterpolate(__props.vendor.id)}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Nama Vendor </label><p class="text-gray-900" data-v-689b91a5${_scopeId}>${ssrInterpolate(__props.vendor.nama_vendor)}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Nomor Rekening </label><p class="text-gray-900 font-mono" data-v-689b91a5${_scopeId}>${ssrInterpolate(__props.vendor.nomor_rekening)}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Nama Rekening </label><p class="text-gray-900" data-v-689b91a5${_scopeId}>${ssrInterpolate(__props.vendor.nama_rekening)}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> NIB (Nomor Induk Berusaha) </label><p class="text-gray-900 font-mono" data-v-689b91a5${_scopeId}>${ssrInterpolate(__props.vendor.nib || "-")}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Foto Vendor </label>`);
            if (__props.vendor.photo_path) {
              _push2(`<div data-v-689b91a5${_scopeId}><img${ssrRenderAttr("src", `/storage/${__props.vendor.photo_path}`)} alt="Foto Vendor" class="w-32 h-32 object-cover rounded-lg border border-gray-200 mt-2" data-v-689b91a5${_scopeId}></div>`);
            } else {
              _push2(`<p class="text-gray-500 italic" data-v-689b91a5${_scopeId}>Tidak ada foto</p>`);
            }
            _push2(`</div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Dokumen Legal </label>`);
            if (__props.vendor.legal_document_path) {
              _push2(`<div data-v-689b91a5${_scopeId}><a${ssrRenderAttr("href", `/storage/${__props.vendor.legal_document_path}`)} target="_blank" class="inline-flex items-center px-4 py-2 mt-2 text-sm bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors" data-v-689b91a5${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-689b91a5${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" data-v-689b91a5${_scopeId}></path></svg> Lihat Dokumen </a></div>`);
            } else {
              _push2(`<p class="text-gray-500 italic" data-v-689b91a5${_scopeId}>Tidak ada dokumen</p>`);
            }
            _push2(`</div></div></div></div></div><div class="lg:col-span-1" data-v-689b91a5${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-689b91a5${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-689b91a5${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-689b91a5${_scopeId}> Informasi Sistem </h3></div><div class="p-6" data-v-689b91a5${_scopeId}><div class="space-y-6" data-v-689b91a5${_scopeId}><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Tanggal Dibuat </label><p class="text-gray-900" data-v-689b91a5${_scopeId}>${ssrInterpolate(formatDateTime(__props.vendor.created_at))}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Terakhir Diperbarui </label><p class="text-gray-900" data-v-689b91a5${_scopeId}>${ssrInterpolate(formatDateTime(__props.vendor.updated_at))}</p></div><div data-v-689b91a5${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-689b91a5${_scopeId}> Status </label><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800" data-v-689b91a5${_scopeId}><svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 8 8" data-v-689b91a5${_scopeId}><circle cx="4" cy="4" r="3" data-v-689b91a5${_scopeId}></circle></svg> Aktif </span></div></div></div></div><div class="mt-6" data-v-689b91a5${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-689b91a5${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-689b91a5${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-689b91a5${_scopeId}> Aksi </h3></div><div class="p-6" data-v-689b91a5${_scopeId}><div class="space-y-3" data-v-689b91a5${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-cs.vendors.edit", __props.vendor.id),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-689b91a5${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-689b91a5${_scopeId2}></path></svg> Edit Vendor `);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "w-4 h-4 mr-2",
            ...
            _push2(`<button class="w-full inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors" data-v-689b91a5${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-689b91a5${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-689b91a5${_scopeId}></path></svg> Hapus Vendor </button></div></div></div></div></div></div></div>`);
          } else {
            return [
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-689b91a5"]]);
export {
  Show as default
};
