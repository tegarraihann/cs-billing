...
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderAttr, ssrRenderList, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
...
import { S as SplitActionButton } from "./SplitActionButton-BjCYCuTo.js";
import { FileText, Percent, ArrowLeft, CreditCard } from "lucide-vue-next";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const pph23Rate = computed(() => {
      var _a, _b;
      const rate = parseFloat(((_b = (_a = props.receivable) == null ? void 0 : _a.invoice) == null ? void 0 : _b.pph23_rate) || 0);
      return Number.isNaN(rate) ? 0 : rate;
    });
    ...
    const canPostPph23Receivable = computed(() => {
      var _a, _b, _c, _d, _e;
      const pph23Amount = ((_b = (_a = props.receivable) == null ? void 0 : _a.invoice) == null ? void 0 : _b.pph23_amount) || 0;
      const pph23Posted = (_d = (_c = props.receivable) == null ? void 0 : _c.invoice) == null ? void 0 : _d.pph23_posted_at;
      return hasPph23WithVat.value && pph23Amount > 0 && ((_e = props.receivable) == null ? void 0 : _e.status) === "paid" && !pph23Posted;
    });
    ...
    const canPostTaxExpense = computed(() => {
      var _a, _b;
      return (((_a = props.receivable) == null ? void 0 : _a.outstanding_amount) || 0) > 0 && !((_b = props.receivable) == null ? void 0 : _b.tax_writeoff_at) && !hasPph23WithVat.value;
    });
    ...
    const postVatPayable = () => {
      ...
      openConfirm(
        `Post VAT Payable ${vatRateLabel.value} untuk invoice ${(_a = props.receivable) == null ? void 0 : _a.invoice_number}?`,
        () => {
    ...
    const postVatPayable11 = () => {
      ...
      openConfirm(
        `Post VAT Payable 11% untuk invoice ${(_a = props.receivable) == null ? void 0 : _a.invoice_number}?`,
        () => {
          postingVat.value = true;
          router.post(
    ...
    const postVatPayable11_1 = () => {
      ...
      openConfirm(
        `Post VAT Payable 1.1% untuk invoice ${(_a = props.receivable) == null ? void 0 : _a.invoice_number}?`,
        () => {
          postingVat.value = true;
          router.post(
    ...
    const postPph23Receivable = (rateOverride = null) => {
      ...
      openConfirm(
        `Post VAT Receivable PPh23 ${rateLabel}% untuk invoice ${(_a = props.receivable) == null ? void 0 : _a.invoice_number}?`,
        () => {
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</span>`);
            if (canPostVat.value) {
              _push2(ssrRenderComponent(SplitActionButton, {
                label: postingVat.value ? "Posting..." : `Post VAT Payable ${vatRateLabel.value}`,
                icon: unref(FileText),
                "on-click": postVatPayable,
                disabled: postingVat.value,
                items: vatActionItems.value
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            if (canPostPph23Receivable.value) {
              _push2(ssrRenderComponent(SplitActionButton, {
                label: postingPph23.value ? "Posting..." : `Post VAT Receivable PPh23 ${pph23Rate.value}%`,
                icon: unref(Percent),
                "on-click": () => postPph23Receivable(),
                disabled: postingPph23.value,
                items: pph23ActionItems.value
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            if (canPostTaxExpense.value) {
              _push2(`<button class="inline-flex items-center justify-center px-4 py-2 min-w-[170px] bg-orange-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-orange-700 focus:bg-orange-700 active:bg-orange-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150"${ssrIncludeBooleanAttr(postingTax.value) ? " disabled" : ""}${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Percent), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(postingTax.value ? "Posting..." : "Post Beban Pajak 0.5%")}</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (canPostTaxExpense.value) {
              _push2(`<button class="inline-flex items-center justify-center px-4 py-2 min-w-[170px] bg-orange-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-orange-700 focus:bg-orange-700 active:bg-orange-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150"${ssrIncludeBooleanAttr(postingTax.value) ? " disabled" : ""}${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Percent), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(postingTax.value ? "Posting..." : "Post Beban Pajak 2%")}</button>`);
            } else {
              _push2(`<!---->`);
            }
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    ...
                    createVNode("div", { class: "flex flex-wrap items-center justify-end gap-2" }, [
                      ...
                      canPostVat.value ? (openBlock(), createBlock(SplitActionButton, {
                        key: 0,
                        label: postingVat.value ? "Posting..." : `Post VAT Payable ${vatRateLabel.value}`,
                        icon: unref(FileText),
                        "on-click": postVatPayable,
                        disabled: postingVat.value,
                        items: vatActionItems.value
                      }, null, 8, ["label", "icon", "disabled", "items"])) : createCommentVNode("", true),
                      canPostPph23Receivable.value ? (openBlock(), createBlock(SplitActionButton, {
                        key: 1,
                        label: postingPph23.value ? "Posting..." : `Post VAT Receivable PPh23 ${pph23Rate.value}%`,
                        icon: unref(Percent),
                        "on-click": () => postPph23Receivable(),
                        disabled: postingPph23.value,
                        items: pph23ActionItems.value
                      }, null, 8, ["label", "icon", "on-click", "disabled", "items"])) : createCommentVNode("", true),
                      canPostTaxExpense.value ? (openBlock(), createBlock("button", {
                        key: 2,
                        onClick: ($event) => postTaxExpense(0.5),
                        ...
                        disabled: postingTax.value
                      }, [
                        createVNode(unref(Percent), { class: "w-4 h-4 mr-2" }),
                        createTextVNode(" " + toDisplayString(postingTax.value ? "Posting..." : "Post Beban Pajak 0.5%"), 1)
                      ], 8, ["onClick", "disabled"])) : createCommentVNode("", true),
                      canPostTaxExpense.value ? (openBlock(), createBlock("button", {
                        key: 3,
                        onClick: ($event) => postTaxExpense(2),
                        class: "inline-flex items-center justify-center px-4 py-2 min-w-[170px] bg-orange-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-wider hover:bg-orange-700 focus:bg-orange-700 active:bg-orange-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150",
                        disabled: postingTax.value
                      }, [
                        createVNode(unref(Percent), { class: "w-4 h-4 mr-2" }),
                        createTextVNode(" " + toDisplayString(postingTax.value ? "Posting..." : "Post Beban Pajak 2%"), 1)
                      ], 8, ["onClick", "disabled"])) : createCommentVNode("", true),
