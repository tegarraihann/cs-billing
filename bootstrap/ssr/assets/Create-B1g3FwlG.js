      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Amount (IDR)</label><input${ssrRenderAttr("value", unref(form).amount)} type="number" min="0" step="0.01" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${ssrIncludeBooleanAttr(isAnnualClosing.value) ? " disabled" : ""}${ssrIncludeBooleanAttr(!isAnnualClosing.value) ? " required" : ""}${_scopeId}>`);
            if (isAnnualClosing.value) {
              _push2(`<p class="text-xs text-gray-500 mt-2"${_scopeId}> Amount will be calculated automatically based on the year-end closing formula. </p>`);
            } else {
              _push2(`<!---->`);
            }
                      ...
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                        ...
                        createVNode("div", null, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            step: "0.01",
                            class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500",
                            disabled: isAnnualClosing.value,
                            required: !isAnnualClosing.value
                          }, null, 8, ["onUpdate:modelValue", "disabled", "required"]), [
                            [vModelText, unref(form).amount]
                          ]),
                          isAnnualClosing.value ? (openBlock(), createBlock("p", {
                            key: 0,
                            class: "text-xs text-gray-500 mt-2"
                          }, " Amount will be calculated automatically based on the year-end closing formula. ")) : createCommentVNode("", true),
