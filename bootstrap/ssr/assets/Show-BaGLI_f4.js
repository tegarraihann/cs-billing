...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const canPostVatReceivable = computed(() => {
      ...
      return summaryStatus.value === "paid" && Number(outstanding) <= 0 && !((_a = payable.value) == null ? void 0 : _a.vat_receivable_posted_at);
    });
    ...
    const canPostVatForComponent = (component) => {
      const outstanding = Number((component == null ? void 0 : component.outstanding_amount) ?? 0);
      return canPostVat.value && outstanding > 0;
    };
    const hasVatActions = (component) => canPostVatForComponent(component) || canPostVatReceivable.value;
              ...
              ssrRenderList(visibleComponents.value, (component) => {
                ...
                if (hasVatActions(component)) {
                  ...
                  if (isVatMenuOpen(component.id)) {
                    _push2(`<div class="absolute right-0 z-20 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5"${_scopeId}><div class="py-1"${_scopeId}>`);
                    if (canPostVatForComponent(component)) {
                      _push2(`<button type="button" class="flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"${ssrIncludeBooleanAttr(isPostingVat.value) ? " disabled" : ""}${_scopeId}> Post VAT Payable 11% </button>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    if (canPostVatForComponent(component)) {
                      _push2(`<button type="button" class="flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"${ssrIncludeBooleanAttr(isPostingVat.value) ? " disabled" : ""}${_scopeId}> Post VAT Payable 1.1% </button>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    if (canPostVatForComponent(component)) {
                      _push2(`<button type="button" class="flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"${ssrIncludeBooleanAttr(isPostingVat.value) ? " disabled" : ""}${_scopeId}> Post VAT Payable PPh23 0.5% </button>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    if (canPostVatForComponent(component)) {
                      _push2(`<button type="button" class="flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"${ssrIncludeBooleanAttr(isPostingVat.value) ? " disabled" : ""}${_scopeId}> Post VAT Payable PPh23 2% </button>`);
                    } else {
                      _push2(`<!---->`);
                    }
                    _push2(`<div class="my-1 border-t border-gray-100"${_scopeId}></div><button type="button" class="flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(isPostingVat.value || !canPostVatReceivable.value) ? " disabled" : ""}${_scopeId}> Post VAT Receivable 11% </button><button type="button" class="flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"${ssrIncludeBooleanAttr(isPostingVat.value || !canPostVatReceivable.value) ? " disabled" : ""}${_scopeId}> Post VAT Receivable 1.1% </button></div></div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                          ...
                          createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(visibleComponents.value, (component) => {
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "px-4 py-3 text-sm text-right" }, [
                                  hasVatActions(component) ? (openBlock(), createBlock("div", {
                                    key: 0,
                                    ...
                                    isVatMenuOpen(component.id) ? (openBlock(), createBlock("div", {
                                      ...
                                      createVNode("div", { class: "py-1" }, [
                                        canPostVatForComponent(component) ? (openBlock(), createBlock("button", {
                                          key: 0,
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100",
                                          disabled: isPostingVat.value,
                                          onClick: ($event) => handleVatAction(postVatPayable11)
                                        }, " Post VAT Payable 11% ", 8, ["disabled", "onClick"])) : createCommentVNode("", true),
                                        canPostVatForComponent(component) ? (openBlock(), createBlock("button", {
                                          key: 1,
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100",
                                          disabled: isPostingVat.value,
                                          onClick: ($event) => handleVatAction(postVatPayable11_1)
                                        }, " Post VAT Payable 1.1% ", 8, ["disabled", "onClick"])) : createCommentVNode("", true),
                                        canPostVatForComponent(component) ? (openBlock(), createBlock("button", {
                                          key: 2,
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100",
                                          disabled: isPostingVat.value,
                                          onClick: ($event) => handleVatAction(postPph23Payable05)
                                        }, " Post VAT Payable PPh23 0.5% ", 8, ["disabled", "onClick"])) : createCommentVNode("", true),
                                        canPostVatForComponent(component) ? (openBlock(), createBlock("button", {
                                          key: 3,
                                          type: "button",
                                          class: "flex w-full items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100",
                                          disabled: isPostingVat.value,
                                          onClick: ($event) => handleVatAction(postPph23Payable2)
                                        }, " Post VAT Payable PPh23 2% ", 8, ["disabled", "onClick"])) : createCommentVNode("", true),
