...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const categoryInputClass = computed(() => {
      ...
      const error = ((_a = form.errors) == null ? void 0 : _a.category) ? " border-red-300" : " border-sage-300";
    ...
    const customerInputClass = computed(() => {
      var _a;
      const base = "w-full px-3 py-2 pr-10 border rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm";
      const error = ((_a = form.errors) == null ? void 0 : _a.customer_id) ? " border-red-300" : " border-sage-300";
      return `${base}${error}`;
    });
    ...
    const isDisabled = computed(() => {
      ...
      const requiredFilled = form.transaction_date && form.category && form.description && form.amount && form.bank_account_id && form.pl_account_id;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Add Other Income" }, null, _parent2, _scopeId));
            ...
            _push2(`<h1 class="text-2xl font-bold text-sage-800"${_scopeId}>Add Other Income</h1></div><p class="text-sm text-sage-600 ml-9"${_scopeId}>Record income outside logistics services</p></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6"${_scopeId}><form class="space-y-6"${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Reference Number </label><input${ssrRenderAttr("value", unref(form).reference_number)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm" placeholder="Example: OR-2024-001"${_scopeId}>`);
            ...
            _push2(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Customer </label>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              "value-field": "value",
              "search-fields": ["label"],
              "input-class": customerInputClass.value
            ...
            if (categoryOptions.value.length === 0) {
              _push2(`<p class="mt-1 text-xs text-sage-500"${_scopeId}> No active categories. Add categories in the Operational Cost Categories master before recording income. </p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`<p class="mt-1 text-xs text-sage-500"${_scopeId}> Use categories from the Operational Cost Categories master to keep reports consistent. </p></div></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Description <span class="text-red-500"${_scopeId}>*</span></label><textarea rows="3" class="${ssrRenderClass([{ "border-red-300": unref(form).errors.description }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm resize-none"])}" placeholder="Example: Bank interest for December 2024" required${_scopeId}>${ssrInterpolate(unref(form).description)}</textarea>`);
            ...
            _push2(`<p class="mt-1 text-xs text-sage-500"${_scopeId}> This income will immediately increase the selected bank balance. </p></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Revenue Account (P&amp;L) <span class="text-red-500"${_scopeId}>*</span></label>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
            ...
            _push2(`<p class="mt-1 text-xs text-sage-500"${_scopeId}> Income will be recorded to this account in the profit &amp; loss report. </p></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Notes (Optional) </label><textarea rows="2" class="${ssrRenderClass([{ "border-red-300": unref(form).errors.notes }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm resize-none"])}" placeholder="Additional notes if any..."${_scopeId}>${ssrInterpolate(unref(form).notes)}</textarea>`);
            if (unref(form).errors.notes) {
              _push2(`<p class="mt-1 text-sm text-red-600"${_scopeId}>${ssrInterpolate(unref(form).errors.notes)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Upload Receipt (Optional) </label><div class="flex items-center space-x-4"${_scopeId}><label class="flex-1 flex items-center justify-center px-4 py-3 border-2 border-dashed border-sage-300 rounded-lg cursor-pointer hover:border-sage-400 transition-colors"${_scopeId}><div class="text-center"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Upload), { class: "mx-auto h-8 w-8 text-sage-400" }, null, _parent2, _scopeId));
            _push2(`<p class="mt-1 text-sm text-sage-600"${_scopeId}><span class="font-medium"${_scopeId}>Click to upload</span> or drag &amp; drop </p><p class="text-xs text-sage-500"${_scopeId}>JPG, PNG, PDF (max 2MB)</p></div><input type="file" accept=".jpg,.jpeg,.png,.pdf" class="hidden"${_scopeId}></label></div>`);
            if (filePreview.value) {
              _push2(`<p class="mt-2 text-sm text-sage-600"${_scopeId}> Selected file: <span class="font-medium"${_scopeId}>${ssrInterpolate(filePreview.value)}</span><button type="button" class="ml-2 text-red-600 hover:text-red-800"${_scopeId}>`);
            ...
            _push2(`</div><div class="ml-3"${_scopeId}><p class="text-sm text-blue-700"${_scopeId}><strong${_scopeId}>Info:</strong> Other income is income NOT from logistics services (no SO). Example: bank interest, asset sales, rental income, etc. </p></div></div></div><div class="flex justify-end space-x-3 pt-4 border-t border-sage-200"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.other-incomes.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(isDisabled.value) ? " disabled" : ""} class="inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-lg font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-700 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition disabled:opacity-50"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Save), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(form).processing ? "Saving..." : "Save Income")}</button></div></form></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Add Other Income" }),
              createVNode("div", { class: "p-6 max-w-4xl mx-auto" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("div", { class: "flex items-center space-x-4 mb-2" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-sage-800" }, "Add Other Income")
                  ]),
                  createVNode("p", { class: "text-sm text-sage-600 ml-9" }, "Record income outside logistics services")
                ]),
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, " Reference Number "),
                      ...
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, " Due Date "),
                        withDirectives(createVNode("input", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                      ...
                      createVNode("div", null, [
                        createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, " Customer Name (optional) "),
                        withDirectives(createVNode("input", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                      ...
                      createVNode("div", null, [
                        ...
                        }, " No active categories. Add categories in the Operational Cost Categories master before recording income. ")) : createCommentVNode("", true),
                        unref(form).errors.category ? (openBlock(), createBlock("p", {
                          key: 1,
                          class: "mt-1 text-sm text-red-600"
                        }, toDisplayString(unref(form).errors.category), 1)) : createCommentVNode("", true),
                        createVNode("p", { class: "mt-1 text-xs text-sage-500" }, " Use categories from the Operational Cost Categories master to keep reports consistent. ")
                      ])
                    ]),
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, [
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "mt-1 text-xs text-sage-500" }, " Enter the income amount received ")
                    ]),
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, [
                        createTextVNode(" Receiving Bank "),
                        createVNode("span", { class: "text-red-500" }, "*")
                      ]),
                      ...
                      createVNode("p", { class: "mt-1 text-xs text-sage-500" }, " This income will immediately increase the selected bank balance. ")
                    ]),
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, [
                        createTextVNode(" Revenue Account (P&L) "),
                        createVNode("span", { class: "text-red-500" }, "*")
                      ]),
                      createVNode(_sfc_main$1, {
                        modelValue: unref(form).pl_account_id,
                      ...
                      createVNode("p", { class: "mt-1 text-xs text-sage-500" }, " Income will be recorded to this account in the profit & loss report. ")
                    ]),
                    createVNode("div", null, [
                    ...
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, " Upload Receipt (Optional) "),
                        ...
                        createVNode("label", { class: "flex-1 flex items-center justify-center px-4 py-3 border-2 border-dashed border-sage-300 rounded-lg cursor-pointer hover:border-sage-400 transition-colors" }, [
                          createVNode("div", { class: "text-center" }, [
                            ...
                            createVNode("p", { class: "mt-1 text-sm text-sage-600" }, [
                              createVNode("span", { class: "font-medium" }, "Click to upload"),
                              createTextVNode(" or drag & drop ")
                            ]),
                      ...
                      createVNode("div", { class: "flex" }, [
                        ...
                        createVNode("div", { class: "ml-3" }, [
                          createVNode("p", { class: "text-sm text-blue-700" }, [
                            ...
                            createTextVNode(" Other income is income NOT from logistics services (no SO). Example: bank interest, asset sales, rental income, etc. ")
                          ])
                        ])
                      ])
                    ]),
                    createVNode("div", { class: "flex justify-end space-x-3 pt-4 border-t border-sage-200" }, [
                      ...
                      createVNode("button", {
                        ...
                        createTextVNode(" " + toDisplayString(unref(form).processing ? "Saving..." : "Save Income"), 1)
                      ], 8, ["disabled"])
                    ])
                  ], 32)
                ])
