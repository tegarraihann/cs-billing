import { computed, withCtx, unref, createVNode, createTextVNode, toDisplayString, withDirectives, vModelText, createBlock, openBlock, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const filterForm = useRemember({
      period_month: ((_a = props.filters) == null ? void 0 : _a.period_month) || ""
    }, `bank-balance-history-filters-${(_b = props.bank) == null ? void 0 : _b.id}`);
    const indexFilters = computed(() => ({
      period_month: filterForm.period_month || void 0
    }));
    const applyFilters = () => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.bank-balance.show", { bankBalance: __props.bank.id, ...indexFilters.value }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.bank-balance.index", indexFilters.value),
              class: "inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            if (__props.balances && __props.balances.data && __props.balances.data.length > 0) {
              ...
              ssrRenderList(__props.balances.data, (balance) => {
                ...
                _push2(`</div><div class="text-right"${_scopeId}><p class="text-xs text-gray-400"${_scopeId}>Created by</p><p class="text-sm text-gray-600"${_scopeId}>${ssrInterpolate(((_a2 = balance.creator) == null ? void 0 : _a2.name) || "-")}</p><p class="text-xs text-gray-400 mt-1"${_scopeId}>${ssrInterpolate(formatDateTime(balance.created_at))}</p></div></div></div>`);
              });
              _push2(`<!--]-->`);
              if (__props.balances.links) {
                _push2(`<div class="mt-4"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(__props.balances.from || 0)} to ${ssrInterpolate(__props.balances.to || 0)} of ${ssrInterpolate(__props.balances.total || 0)} results </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
                      ...
                      createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                        ...
                        __props.balances && __props.balances.data && __props.balances.data.length > 0 ? (openBlock(), createBlock("div", {
                            ...
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "flex justify-between items-start" }, [
                                ...
                                createVNode("div", { class: "text-right" }, [
                                  ...
                                  createVNode("p", { class: "text-sm text-gray-600" }, toDisplayString(((_a2 = balance.creator) == null ? void 0 : _a2.name) || "-"), 1),
                          ...
                          __props.balances.links ? (openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "flex items-center justify-between" }, [
                              createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(__props.balances.from || 0) + " to " + toDisplayString(__props.balances.to || 0) + " of " + toDisplayString(__props.balances.total || 0) + " results ", 1),
