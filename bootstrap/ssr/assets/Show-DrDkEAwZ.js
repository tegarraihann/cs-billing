    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-f2a0b586${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-f2a0b586${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-f2a0b586${_scopeId}><div class="flex items-center" data-v-f2a0b586${_scopeId}><div class="w-12 h-12 bg-sage-600 rounded-full flex items-center justify-center mr-4" data-v-f2a0b586${_scopeId}><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f2a0b586${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-f2a0b586${_scopeId}></path></svg></div><div data-v-f2a0b586${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-f2a0b586${_scopeId}> Sales Order: ${ssrInterpolate(__props.salesOrder.order_number)}</h2><p class="text-sage-600" data-v-f2a0b586${_scopeId}> Detail informasi sales order </p></div></div><div class="mt-4 sm:mt-0 flex space-x-3" data-v-f2a0b586${_scopeId}>`);
            if (__props.salesOrder.status === "released" || __props.salesOrder.status === "confirmed" || __props.salesOrder.status === "approved") {
              _push2(`<a${ssrRenderAttr("href", _ctx.route("admin-cs.sales-orders.print", __props.salesOrder.id))} target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors" data-v-f2a0b586${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f2a0b586${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" data-v-f2a0b586${_scopeId}></path></svg> Print PDF </a>`);
            } else {
              _push2(`<button disabled class="inline-flex items-center px-4 py-2 bg-gray-400 text-gray-700 rounded-lg cursor-not-allowed" title="Sales order harus dirilis terlebih dahulu untuk dapat dicetak" data-v-f2a0b586${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f2a0b586${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" data-v-f2a0b586${_scopeId}></path></svg> Print PDF (Belum Dirilis) </button>`);
            }
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f2a0b586${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-f2a0b586${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "w-4 h-4 mr-2",
            ...
            _push2(`</div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-6" data-v-f2a0b586${_scopeId}><div class="lg:col-span-2 space-y-6" data-v-f2a0b586${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-f2a0b586${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-f2a0b586${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-f2a0b586${_scopeId}>Informasi Sales Order</h3></div><div class="p-6 space-y-4" data-v-f2a0b586${_scopeId}><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>ORDER NUMB</label><p class="text-gray-900 font-semibold" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.order_number)}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>CUSTOMER</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.customer)}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>SHIPPER</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.shipper || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>BL/AWB</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.bl_awb || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>LINER</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.liner || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>VESSEL</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.vessel || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>ETA</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.eta ? formatDate(__props.salesOrder.eta) : "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>AJU</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.aju || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>SPPB DATE</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.sppb_date ? formatDate(__props.salesOrder.sppb_date) : "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>SHIPMENT TYPE</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.shipment_type || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>POL</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.pol || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>POD</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.pod || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>GUDANG/UTC</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.gudang_utc || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>PARTY/LCL</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.party_lcl || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>PREPARED BY</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.prepared_by || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>EXCHANGE RATE</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.exchange_rate || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>JENIS BIAYA</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.jenis_biaya || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>BUYING</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.buying ? formatCurrency(__props.salesOrder.buying) : "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>SELLING</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.selling ? formatCurrency(__props.salesOrder.selling) : "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>REVENUE</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.revenue ? formatCurrency(__props.salesOrder.revenue) : "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>REMARKS</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.remarks || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>GOODS</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.goods || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>CONTAINER NO</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.container_no || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>INVOICE NUMB</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.invoice_number || "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>INVOICE DATE</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.invoice_date ? formatDate(__props.salesOrder.invoice_date) : "-")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>T.O.P</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(__props.salesOrder.top || "-")}</p></div></div></div></div><div class="space-y-6" data-v-f2a0b586${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-f2a0b586${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-f2a0b586${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-f2a0b586${_scopeId}>Status</h3></div><div class="p-6" data-v-f2a0b586${_scopeId}><span class="${ssrRenderClass([getStatusColor(__props.salesOrder.status), "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium w-full justify-center"])}" data-v-f2a0b586${_scopeId}>${ssrInterpolate(getStatusLabel(__props.salesOrder.status || "draft"))}</span></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-f2a0b586${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-f2a0b586${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-f2a0b586${_scopeId}>System Information</h3></div><div class="p-6 space-y-4" data-v-f2a0b586${_scopeId}><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>Created By</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(((_a = __props.salesOrder.creator) == null ? void 0 : _a.name) || "Unknown")}</p></div><div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>Created At</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.created_at))}</p></div>`);
            if (__props.salesOrder.last_modified_at) {
              _push2(`<div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>Last Modified</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.last_modified_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.sent_at) {
              _push2(`<div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>Sent At</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.sent_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.confirmed_at) {
              _push2(`<div data-v-f2a0b586${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-f2a0b586${_scopeId}>Confirmed At</label><p class="text-gray-900" data-v-f2a0b586${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.confirmed_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
            if (__props.salesOrder.customer_id) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-f2a0b586${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-f2a0b586${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-f2a0b586${_scopeId}>Related Customer</h3></div><div class="p-6" data-v-f2a0b586${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-f2a0b586${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-f2a0b586${_scopeId2}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-f2a0b586${_scopeId2}></path></svg> Lihat Data Customer `);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "w-4 h-4 mr-2",
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f2a0b586"]]);
export {
  Show as default
};
