...
import { ArrowLeft, CreditCard, Edit, Plus } from "lucide-vue-next";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (showPaymentModal.value) {
              ...
              _push2(`</div><div class="mb-4"${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Bank Account *</label><select required class="${ssrRenderClass([unref(paymentForm).errors.bank_account_id ? "border-red-300 focus:border-red-500 focus:ring-red-500" : "border-gray-300", "w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"])}"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(paymentForm).bank_account_id) ? ssrLooseContain(unref(paymentForm).bank_account_id, "") : ssrLooseEqual(unref(paymentForm).bank_account_id, "")) ? " selected" : ""}${_scopeId}>Select Bank Account</option><!--[-->`);
