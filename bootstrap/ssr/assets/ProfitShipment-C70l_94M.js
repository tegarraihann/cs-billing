      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></select></div>`);
            if (isMonthly.value) {
              _push2(`<div class=""${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Bulan</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><!--[-->`);
              ...
              _push2(`<div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Kuartal</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><!--[-->`);
            ...
            if (showYearSelect.value) {
              _push2(`<div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Tahun</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><!--[-->`);
            ...
            if (__props.profitData.length === 0) {
              _push2(`<tr${_scopeId}><td colspan="9" class="px-6 py-4 text-center text-gray-500"${_scopeId}> Tidak ada data untuk periode yang dipilih </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      ...
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4" }, [
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Periode"),
                        ...
                        isMonthly.value ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Bulan"),
                          withDirectives(createVNode("select", {
                          ...
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Kuartal"),
                          withDirectives(createVNode("select", {
                        ...
                        showYearSelect.value ? (openBlock(), createBlock("div", { key: 2 }, [
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, "Tahun"),
                          withDirectives(createVNode("select", {
