          ...
          if (_push2) {
            ...
            if (showAdditionalCostModal.value) {
              ...
              if (shouldShowCategoryField.value) {
                _push2(`<div class="mb-4"${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Kategori Biaya *</label>`);
              ...
              _push2(`<div class="mb-4"${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Vendor / Penerima</label>`);
              _push2(ssrRenderComponent(_sfc_main$1, {
                        ...
                        createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                          createVNode("thead", { class: "bg-gray-50" }, [
                            createVNode("tr", null, [
                              ...
                              createVNode("th", { class: "px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" }, " Aksi ")
                            ])
                          ]),
                    ...
                    createVNode("div", { class: "relative top-20 mx-auto p-5 border w-[420px] shadow-lg rounded-md bg-white" }, [
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "mb-4" }, [
                          ...
                          createVNode("p", { class: "text-xs text-gray-500 mt-1" }, " Biaya operasional hanya memengaruhi profit. Reimbursement akan otomatis masuk ke invoice reimbursement. VAT reimbursement tidak masuk invoice customer dan akan dipost ke Financial Position setelah hutang paid. ")
                        ]),
                        shouldShowVatRateField.value ? (openBlock(), createBlock("div", {
                          ...
                          withDirectives(createVNode("select", {
                            ...
                            createVNode("option", { value: "" }, "-- Pilih VAT Rate --"),
