      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-6" data-v-d8516515${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-d8516515${_scopeId}><div class="flex justify-between items-center mb-6" data-v-d8516515${_scopeId}><div data-v-d8516515${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-d8516515${_scopeId}>Manajemen Hutang</h1><p class="mt-1 text-sm text-gray-600" data-v-d8516515${_scopeId}>Kelola hutang dan pembayaran vendor</p></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6" data-v-d8516515${_scopeId}><div class="bg-white overflow-hidden shadow rounded-lg" data-v-d8516515${_scopeId}><div class="p-5" data-v-d8516515${_scopeId}><div class="flex items-center" data-v-d8516515${_scopeId}><div class="flex-shrink-0" data-v-d8516515${_scopeId}>`);
            _push2(ssrRenderComponent(unref(CreditCard), { class: "h-6 w-6 text-red-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-d8516515${_scopeId}><dl data-v-d8516515${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-d8516515${_scopeId}>Total Outstanding</dt><dd class="text-lg font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(formatCurrency(__props.summary.total_outstanding))}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg" data-v-d8516515${_scopeId}><div class="p-5" data-v-d8516515${_scopeId}><div class="flex items-center" data-v-d8516515${_scopeId}><div class="flex-shrink-0" data-v-d8516515${_scopeId}>`);
            _push2(ssrRenderComponent(unref(AlertTriangle), { class: "h-6 w-6 text-orange-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-d8516515${_scopeId}><dl data-v-d8516515${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-d8516515${_scopeId}>Total Overdue</dt><dd class="text-lg font-medium text-orange-600" data-v-d8516515${_scopeId}>${ssrInterpolate(formatCurrency(__props.summary.total_overdue))}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg" data-v-d8516515${_scopeId}><div class="p-5" data-v-d8516515${_scopeId}><div class="flex items-center" data-v-d8516515${_scopeId}><div class="flex-shrink-0" data-v-d8516515${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Users), { class: "h-6 w-6 text-yellow-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-d8516515${_scopeId}><dl data-v-d8516515${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-d8516515${_scopeId}>Jumlah Overdue</dt><dd class="text-lg font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(__props.summary.count_overdue)}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg" data-v-d8516515${_scopeId}><div class="p-5" data-v-d8516515${_scopeId}><div class="flex items-center" data-v-d8516515${_scopeId}><div class="flex-shrink-0" data-v-d8516515${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Building2), { class: "h-6 w-6 text-blue-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-5 w-0 flex-1" data-v-d8516515${_scopeId}><dl data-v-d8516515${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate" data-v-d8516515${_scopeId}>Unpaid Active</dt><dd class="text-lg font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(__props.summary.count_unpaid)}</dd></dl></div></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-d8516515${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-d8516515${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-d8516515${_scopeId}>Filter Data</h3><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4" data-v-d8516515${_scopeId}><div data-v-d8516515${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d8516515${_scopeId}>Search</label><input${ssrRenderAttr("value", searchForm.search)} type="text" placeholder="Cari vendor atau service..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-d8516515${_scopeId}></div><div data-v-d8516515${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d8516515${_scopeId}>Status</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-d8516515${_scopeId}><option value="" data-v-d8516515${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "") : ssrLooseEqual(searchForm.status, "")) ? " selected" : ""}${_scopeId}>Semua Status</option><option value="unpaid" data-v-d8516515${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "unpaid") : ssrLooseEqual(searchForm.status, "unpaid")) ? " selected" : ""}${_scopeId}>Unpaid</option><option value="partial" data-v-d8516515${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "partial") : ssrLooseEqual(searchForm.status, "partial")) ? " selected" : ""}${_scopeId}>Partial</option><option value="paid" data-v-d8516515${ssrIncludeBooleanAttr(Array.isArray(searchForm.status) ? ssrLooseContain(searchForm.status, "paid") : ssrLooseEqual(searchForm.status, "paid")) ? " selected" : ""}${_scopeId}>Paid</option></select></div><div data-v-d8516515${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d8516515${_scopeId}>Vendor</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-d8516515${_scopeId}><option value="" data-v-d8516515${ssrIncludeBooleanAttr(Array.isArray(searchForm.vendor_id) ? ssrLooseContain(searchForm.vendor_id, "") : ssrLooseEqual(searchForm.vendor_id, "")) ? " selected" : ""}${_scopeId}>Semua Vendor</option><!--[-->`);
            ssrRenderList(__props.vendors, (vendor) => {
              _push2(`<option${ssrRenderAttr("value", vendor.id)} data-v-d8516515${ssrIncludeBooleanAttr(Array.isArray(searchForm.vendor_id) ? ssrLooseContain(searchForm.vendor_id, vendor.id) : ssrLooseEqual(searchForm.vendor_id, vendor.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendor.nama_vendor)}</option>`);
            });
            _push2(`<!--]--></select></div><div data-v-d8516515${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d8516515${_scopeId}>Dari Tanggal</label><input${ssrRenderAttr("value", searchForm.date_from)} type="date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-d8516515${_scopeId}></div><div data-v-d8516515${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-d8516515${_scopeId}>Sampai Tanggal</label><input${ssrRenderAttr("value", searchForm.date_to)} type="date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500" data-v-d8516515${_scopeId}></div></div></div></div>`);
            if (vendorSummaryRows.value.length > 0) {
              _push2(`<div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-d8516515${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-d8516515${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-d8516515${_scopeId}>Ringkasan per Vendor</h3><div class="overflow-x-auto" style="${ssrRenderStyle({ "overflow-x": "auto" })}" data-v-d8516515${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-d8516515${_scopeId}><thead class="bg-gray-50" data-v-d8516515${_scopeId}><tr data-v-d8516515${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}>Vendor</th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}>Total Amount</th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}>Total Paid</th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}>Total Outstanding</th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}>Jumlah Invoice</th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}>Overdue</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-d8516515${_scopeId}><!--[-->`);
              ssrRenderList(vendorSummaryRows.value, (vendor) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-d8516515${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-d8516515${_scopeId}><div class="inline-flex items-center space-x-1 text-sm font-medium text-gray-900 cursor-pointer select-none" data-vendor-popover-trigger="true"${ssrRenderAttr("data-vendor-popover-trigger-key", vendor.key)} tabindex="0" data-v-d8516515${_scopeId}><span data-v-d8516515${_scopeId}>${ssrInterpolate(vendor.vendor_name)}</span><svg class="w-4 h-4 text-sage-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d8516515${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M12 18a6 6 0 100-12 6 6 0 000 12z" data-v-d8516515${_scopeId}></path></svg></div></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-d8516515${_scopeId}> Rp ${ssrInterpolate(formatNumber(vendor.total_amount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-green-600" data-v-d8516515${_scopeId}> Rp ${ssrInterpolate(formatNumber(vendor.total_paid))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" data-v-d8516515${_scopeId}><span class="${ssrRenderClass(vendor.total_outstanding > 0 ? "text-red-600" : "text-green-600")}" data-v-d8516515${_scopeId}> Rp ${ssrInterpolate(formatNumber(vendor.total_outstanding))}</span></td><td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(vendor.count_invoices)}</td><td class="px-6 py-4 whitespace-nowrap text-center text-sm" data-v-d8516515${_scopeId}>`);
                if (vendor.count_overdue > 0) {
                  _push2(`<span class="text-red-600 font-medium" data-v-d8516515${_scopeId}>${ssrInterpolate(vendor.count_overdue)}</span>`);
                } else {
                  _push2(`<span class="text-gray-400" data-v-d8516515${_scopeId}>0</span>`);
                }
                _push2(`</td></tr>`);
              });
              ...
              ssrRenderTeleport(_push2, (_push3) => {
                if (activeVendorPopover.value) {
                  _push3(`<div class="absolute z-50 w-72 rounded-lg border border-sage-200 bg-white shadow-xl p-4" style="${ssrRenderStyle({ top: popoverPosition.top + "px", left: popoverPosition.left + "px", transform: "translateX(-50%)" })}" data-v-d8516515${_scopeId}><div class="flex items-start justify-between" data-v-d8516515${_scopeId}><div data-v-d8516515${_scopeId}><h4 class="text-sm font-semibold text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(activeVendorPopover.value.vendor_name)}</h4><p class="text-xs text-gray-500" data-v-d8516515${_scopeId}> Summary for outstanding payables </p></div><span class="${ssrRenderClass([activeVendorPopover.value.total_outstanding > 0 ? "bg-red-100 text-red-700" : "bg-green-100 text-green-700", "px-2 py-0.5 text-xs font-medium rounded-full"])}" data-v-d8516515${_scopeId}>${ssrInterpolate(activeVendorPopover.value.total_outstanding > 0 ? "Outstanding" : "Cleared")}</span></div><div class="mt-3 space-y-2 text-sm" data-v-d8516515${_scopeId}><div class="flex justify-between" data-v-d8516515${_scopeId}><span class="text-gray-600" data-v-d8516515${_scopeId}>Total Amount</span><span class="font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(formatCurrency(activeVendorPopover.value.total_amount))}</span></div><div class="flex justify-between" data-v-d8516515${_scopeId}><span class="text-gray-600" data-v-d8516515${_scopeId}>Total Paid</span><span class="font-medium text-green-600" data-v-d8516515${_scopeId}>${ssrInterpolate(formatCurrency(activeVendorPopover.value.total_paid))}</span></div><div class="flex justify-between" data-v-d8516515${_scopeId}><span class="text-gray-600" data-v-d8516515${_scopeId}>Outstanding</span><span class="${ssrRenderClass(activeVendorPopover.value.total_outstanding > 0 ? "font-medium text-red-600" : "font-medium text-green-600")}" data-v-d8516515${_scopeId}>${ssrInterpolate(formatCurrency(activeVendorPopover.value.total_outstanding))}</span></div><div class="flex justify-between" data-v-d8516515${_scopeId}><span class="text-gray-600" data-v-d8516515${_scopeId}>Invoices</span><span class="font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(activeVendorPopover.value.count_invoices)}</span></div><div class="flex justify-between" data-v-d8516515${_scopeId}><span class="text-gray-600" data-v-d8516515${_scopeId}>Overdue</span><span class="${ssrRenderClass(activeVendorPopover.value.count_overdue > 0 ? "font-medium text-red-600" : "font-medium text-gray-500")}" data-v-d8516515${_scopeId}>${ssrInterpolate(activeVendorPopover.value.count_overdue)}</span></div></div><div class="mt-4" data-v-d8516515${_scopeId}><button type="button" class="w-full inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-sage-600 hover:bg-sage-700 rounded-md transition" data-v-d8516515${_scopeId}> View Details </button></div></div>`);
                } else {
                  _push3(`<!---->`);
                }
              }, "body", false, _parent2);
              _push2(`<div class="bg-white rounded-lg shadow-sm overflow-hidden" data-v-d8516515${_scopeId}><div class="overflow-x-auto" data-v-d8516515${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-d8516515${_scopeId}><thead class="bg-gray-50" data-v-d8516515${_scopeId}><tr data-v-d8516515${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Sales Order </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Vendor / Service </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Invoice </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Amount </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Paid </th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Outstanding </th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Status </th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-d8516515${_scopeId}> Actions </th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-d8516515${_scopeId}><!--[-->`);
              ssrRenderList(tableRows.value, (row) => {
                var _a, _b, _c, _d, _e;
                _push2(`<tr class="hover:bg-gray-50" data-v-d8516515${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-d8516515${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(((_a = row.salesOrder) == null ? void 0 : _a.order_number) || "Tanpa Sales Order")}</div><div class="text-sm text-gray-600" data-v-d8516515${_scopeId}>${ssrInterpolate(((_b = row.salesOrder) == null ? void 0 : _b.customer) || "-")}</div><div class="text-sm text-gray-500" data-v-d8516515${_scopeId}>${ssrInterpolate(((_c = row.salesOrder) == null ? void 0 : _c.shipper) || "-")}</div><div class="text-xs text-gray-500 mt-1" data-v-d8516515${_scopeId}> Release: ${ssrInterpolate(((_d = row.salesOrder) == null ? void 0 : _d.released_at) ? formatDate(row.salesOrder.released_at) : "-")}</div></td><td class="px-6 py-4" data-v-d8516515${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-d8516515${_scopeId}>${ssrInterpolate(row.vendorSummaryLabel || "-")}</div>`);
                if (row.serviceDescription) {
                  _push2(`<div class="text-sm text-gray-600" data-v-d8516515${_scopeId}>${ssrInterpolate(row.serviceDescription)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (row.serviceRemarks) {
                  _push2(`<div class="text-sm text-gray-500" data-v-d8516515${_scopeId}>${ssrInterpolate(row.serviceRemarks.substring(0, 50))}${ssrInterpolate(row.serviceRemarks.length > 50 ? "..." : "")}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</td><td class="px-6 py-4 whitespace-nowrap" data-v-d8516515${_scopeId}><div class="text-sm text-gray-900" data-v-d8516515${_scopeId}><div data-v-d8516515${_scopeId}> Invoice: ${ssrInterpolate(row.invoiceSummary || "-")}</div>`);
                if ((_e = row.salesOrder) == null ? void 0 : _e.order_number) {
                  _push2(`<div data-v-d8516515${_scopeId}> SO: ${ssrInterpolate(row.salesOrder.order_number)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="text-sm text-gray-500" data-v-d8516515${_scopeId}>${ssrInterpolate(row.vendorInvoiceDate ? formatDate(row.vendorInvoiceDate) : "-")}</div></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-d8516515${_scopeId}> Rp ${ssrInterpolate(formatNumber(row.amount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-d8516515${_scopeId}> Rp ${ssrInterpolate(formatNumber(row.paidAmount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900" data-v-d8516515${_scopeId}> Rp ${ssrInterpolate(formatNumber(row.outstanding))}</td><td class="px-6 py-4 whitespace-nowrap text-center" data-v-d8516515${_scopeId}><span class="${ssrRenderClass([getStatusClass(row.status), "inline-flex px-2 py-1 text-xs font-semibold rounded-full"])}" data-v-d8516515${_scopeId}>${ssrInterpolate(getStatusText(row.status))} `);
                if (row.daysOverdue > 0) {
                  _push2(`<span class="ml-1" data-v-d8516515${_scopeId}> (${ssrInterpolate(row.daysOverdue)} hari) </span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</span></td><td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium" data-v-d8516515${_scopeId}><button class="inline-flex items-center px-3 py-2 border border-blue-200 rounded-md text-blue-600 hover:text-blue-900 hover:border-blue-400 disabled:text-gray-400 disabled:border-gray-200"${ssrIncludeBooleanAttr(!row.primaryPayableId) ? " disabled" : ""} data-v-d8516515${_scopeId}><svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d8516515${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-d8516515${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-d8516515${_scopeId}></path></svg> Detail </button></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div><div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6" data-v-d8516515${_scopeId}><div class="flex items-center justify-between" data-v-d8516515${_scopeId}><div class="text-sm text-gray-700" data-v-d8516515${_scopeId}> Showing ${ssrInterpolate(__props.payables.from || 0)} to ${ssrInterpolate(__props.payables.to || 0)} of ${ssrInterpolate(__props.payables.total || 0)} results </div><div class="flex space-x-1" data-v-d8516515${_scopeId}><!--[-->`);
              ssrRenderList(__props.payables.links, (link) => {
                ...
                if (link.url) {
                  ...
                  ])}" data-v-d8516515${_scopeId}>${link.label ?? ""}</button>`);
                } else {
                  _push2(`<span class="px-3 py-2 text-sm text-gray-400" data-v-d8516515${_scopeId}>${link.label ?? ""}</span>`);
                }
                _push2(`<!--]-->`);
              });
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d8516515"]]);
export {
  Index as default
};
