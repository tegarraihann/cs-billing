          ...
          if (_push2) {
            ...
            if (unref(form).employees.length === 0) {
              ...
              ssrRenderList(unref(form).employees, (employee, index) => {
                ...
                _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div class="md:col-span-2"${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Pilih Karyawan (opsional) </label><select class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(employee.employee_record_id) ? ssrLooseContain(employee.employee_record_id, "") : ssrLooseEqual(employee.employee_record_id, "")) ? " selected" : ""}${_scopeId}>Pilih karyawan dari master admin</option><!--[-->`);
                              ...
                              return openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                                  createVNode("div", { class: "md:col-span-2" }, [
                                    createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-2" }, " Pilih Karyawan (opsional) "),
