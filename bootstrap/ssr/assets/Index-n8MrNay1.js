      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_b2 = __props.serviceTypes) == null ? void 0 : _b2.data) && __props.serviceTypes.data.length > 0) {
            ...
            return [
              createVNode("div", { class: "p-4 sm:p-6 lg:p-8" }, [
                ...
                createVNode("div", { class: "bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" }, [
                  ...
                  ((_e = __props.serviceTypes) == null ? void 0 : _e.data) && __props.serviceTypes.data.length > 0 ? (openBlock(), createBlock("div", {
                    key: 0,
