import { reactive, withCtx, unref, createBlock, createTextVNode, openBlock, createVNode, withDirectives, vModelText, vModelSelect, toDisplayString, Fragment, renderList, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<!--]--></tbody></table></div><div class="px-6 py-4 border-t border-sage-200"${_scopeId}>`);
              ...
              createVNode("div", { class: "p-4 sm:p-6 lg:p-8" }, [
                ...
                createVNode("div", { class: "bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" }, [
                  createVNode("div", { class: "px-6 py-4 border-b border-sage-200" }, [
                    ...
                    createVNode("p", { class: "text-sm text-sage-600 mt-1" }, " Total: " + toDisplayString(((_c = __props.serviceTypes) == null ? void 0 : _c.total) || 0) + " data ", 1)
                  ]),
                  ...
                  createVNode("div", { class: "px-6 py-4 border-t border-sage-200" }, [
