      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="mb-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Input Opening Balance</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}> Enter bank opening balances for a specific month. </p></div>`);
            ...
            _push2(`</div><div class="ml-3"${_scopeId}><h3 class="text-sm font-medium text-blue-800"${_scopeId}> Opening Balance Information </h3><div class="mt-2 text-sm text-blue-700"${_scopeId}><ul class="list-disc list-inside space-y-1"${_scopeId}><li${_scopeId}>Opening balances only need to be entered once per month for each bank.</li><li${_scopeId}>Balances update automatically when customer or vendor payments are posted.</li><li${_scopeId}>If an opening balance already exists for this period, the new entry will overwrite it.</li></ul></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg"${_scopeId}><form${_scopeId}><div class="px-4 py-5 sm:p-6 space-y-6"${_scopeId}><div${_scopeId}><label for="period_month" class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Period Month </label><input id="period_month"${ssrRenderAttr("value", unref(form).period_month)} type="month" class="${ssrRenderClass([{ "border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500": __props.errors.period_month }, "mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm"])}"${_scopeId}>`);
            ...
            _push2(`<p class="mt-1 text-sm text-gray-500"${_scopeId}> Select the month and year for the opening balance. </p></div>`);
            if (hasExistingBalances.value) {
              ...
              _push2(`</div><div class="ml-3"${_scopeId}><h3 class="text-sm font-medium text-yellow-800"${_scopeId}> Opening Balance Already Exists </h3><div class="mt-2 text-sm text-yellow-700"${_scopeId}><p${_scopeId}>An opening balance for period ${ssrInterpolate(unref(form).period_month)} already exists. A new entry will update the existing data.</p></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            ssrRenderList(__props.bankAccounts, (bank, index) => {
              ...
              _push2(`</div><div${_scopeId}><label${ssrRenderAttr("for", `notes_${bank.id}`)} class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Notes (Optional) </label><textarea${ssrRenderAttr("id", `notes_${bank.id}`)} rows="3" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm" placeholder="Notes for this opening balance..."${_scopeId}>${ssrInterpolate(unref(form).balances[index].notes)}</textarea></div></div></div></div>`);
            });
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(isDisabled.value) ? " disabled" : ""} class="${ssrRenderClass([{ "opacity-25": isDisabled.value }, "inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-700 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition ease-in-out duration-150"])}"${_scopeId}>`);
            ...
            _push2(` ${ssrInterpolate(unref(form).processing ? "Saving..." : "Save Opening Balance")}</button></div></div></form></div></div></div>`);
          } else {
            return [
                  ...
                  createVNode("div", { class: "mb-6" }, [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", null, [
                        ...
                        createVNode("p", { class: "mt-1 text-sm text-gray-600" }, " Enter bank opening balances for a specific month. ")
                      ]),
                  ...
                  createVNode("div", { class: "bg-blue-50 border border-blue-200 rounded-md p-4 mb-6" }, [
                    createVNode("div", { class: "flex" }, [
                      ...
                      createVNode("div", { class: "ml-3" }, [
                        createVNode("h3", { class: "text-sm font-medium text-blue-800" }, " Opening Balance Information "),
                        createVNode("div", { class: "mt-2 text-sm text-blue-700" }, [
                          createVNode("ul", { class: "list-disc list-inside space-y-1" }, [
                            createVNode("li", null, "Opening balances only need to be entered once per month for each bank."),
                            createVNode("li", null, "Balances update automatically when customer or vendor payments are posted."),
                            createVNode("li", null, "If an opening balance already exists for this period, the new entry will overwrite it.")
                          ])
                        ])
                      ])
                    ])
                    ...
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "px-4 py-5 sm:p-6 space-y-6" }, [
                        createVNode("div", null, [
                          ...
                          createVNode("p", { class: "mt-1 text-sm text-gray-500" }, " Select the month and year for the opening balance. ")
                        ]),
                        hasExistingBalances.value ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "flex" }, [
                            ...
                            createVNode("div", { class: "ml-3" }, [
                              createVNode("h3", { class: "text-sm font-medium text-yellow-800" }, " Opening Balance Already Exists "),
                              createVNode("div", { class: "mt-2 text-sm text-yellow-700" }, [
                                createVNode("p", null, "An opening balance for period " + toDisplayString(unref(form).period_month) + " already exists. A new entry will update the existing data.", 1)
                              ])
                            ])
                          ])
                                  ...
                                  createVNode("div", null, [
                                    ...
                                    createVNode("div", { class: "relative rounded-md shadow-sm" }, [
                                      ...
                                      withDirectives(createVNode("input", {
                                        ...
                                        placeholder: "0"
                                      }, null, 10, ["id", "onUpdate:modelValue"]), [
                      ...
                      createVNode("div", { class: "px-4 py-3 bg-gray-50 text-right sm:px-6" }, [
                        createVNode("div", { class: "flex justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            class: ["inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-700 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition ease-in-out duration-150", { "opacity-25": isDisabled.value }]
                          }, [
                            ...
                            createTextVNode(" " + toDisplayString(unref(form).processing ? "Saving..." : "Save Opening Balance"), 1)
                          ], 10, ["disabled"])
                        ])
                      ])
                    ], 32)
