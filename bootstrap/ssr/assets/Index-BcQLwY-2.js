      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.receivables.data.length) {
            ...
            _push2(`</div>`);
            if (__props.receivables) {
              _push2(`<div class="mt-6"${_scopeId}>`);
              _push2(ssrRenderComponent(Pagination, { data: __props.receivables }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            }
              ...
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    __props.receivables.data.length ? (openBlock(), createBlock("div", {
                      key: 0,
                  ...
                  __props.receivables ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "mt-6"
                  }, [
                    createVNode(Pagination, { data: __props.receivables }, null, 8, ["data"])
