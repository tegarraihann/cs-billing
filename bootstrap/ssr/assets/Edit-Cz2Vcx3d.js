        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (categoryOptions.value.length === 0) {
              _push2(`<p class="mt-1 text-sm text-sage-500"${_scopeId}> Tidak ada kategori aktif. Silakan tambah kategori pada master Operational Cost Categories terlebih dahulu. </p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Akun Beban (P&amp;L) <span class="text-red-500"${_scopeId}>*</span></label><select class="${ssrRenderClass([{ "border-red-300": errors.value.pl_account_id }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).pl_account_id) ? ssrLooseContain(unref(form).pl_account_id, "") : ssrLooseEqual(unref(form).pl_account_id, "")) ? " selected" : ""}${_scopeId}>Pilih Akun</option><!--[-->`);
            ...
            _push2(`<p class="mt-1 text-xs text-sage-500"${_scopeId}> Pengeluaran ini akan dicatat ke akun ini di laporan laba rugi. </p></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Bank Sumber Dana `);
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-6" }, [
                      ...
                      createVNode("div", null, [
                        ...
                        }, " Tidak ada kategori aktif. Silakan tambah kategori pada master Operational Cost Categories terlebih dahulu. ")) : createCommentVNode("", true),
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "mt-1 text-xs text-sage-500" }, " Pengeluaran ini akan dicatat ke akun ini di laporan laba rugi. ")
                    ]),
                    createVNode("div", null, [
                      createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, [
                        createTextVNode(" Bank Sumber Dana "),
                      ...
                      createVNode("p", { class: "mt-1 text-xs text-sage-500" }, " Saat status Approved, pengeluaran akan otomatis mendebit saldo bank terpilih. ")
                    ]),
