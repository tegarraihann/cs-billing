    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-0c0213aa${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-0c0213aa${_scopeId}><div class="flex items-center justify-between" data-v-0c0213aa${_scopeId}><div data-v-0c0213aa${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-0c0213aa${_scopeId}>Buat Invoice Baru</h2><p class="text-sage-600" data-v-0c0213aa${_scopeId}>Buat invoice dari sales order yang telah disetujui</p></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0c0213aa${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-0c0213aa${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
            ...
            _push2(`</div></div><form class="space-y-6" data-v-0c0213aa${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-0c0213aa${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-0c0213aa${_scopeId}>Pilih Sales Order</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-0c0213aa${_scopeId}><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Sales Order</label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}><option value="" data-v-0c0213aa${ssrIncludeBooleanAttr(Array.isArray(unref(form).sales_order_id) ? ssrLooseContain(unref(form).sales_order_id, "") : ssrLooseEqual(unref(form).sales_order_id, "")) ? " selected" : ""}${_scopeId}>Pilih Sales Order</option><!--[-->`);
            ssrRenderList(__props.salesOrders, (order) => {
              _push2(`<option${ssrRenderAttr("value", order.id)} data-v-0c0213aa${ssrIncludeBooleanAttr(Array.isArray(unref(form).sales_order_id) ? ssrLooseContain(unref(form).sales_order_id, order.id) : ssrLooseEqual(unref(form).sales_order_id, order.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(order.order_number)} - ${ssrInterpolate(order.customer || order.customer_name || "No Customer")}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (__props.errors.sales_order_id) {
              _push2(`<div class="text-red-500 text-sm mt-1" data-v-0c0213aa${_scopeId}>${ssrInterpolate(__props.errors.sales_order_id)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-0c0213aa${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-0c0213aa${_scopeId}>Detail Invoice</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-0c0213aa${_scopeId}><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Tanggal Invoice</label><input type="date"${ssrRenderAttr("value", unref(form).invoice_date)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}>`);
            if (__props.errors.invoice_date) {
              _push2(`<div class="text-red-500 text-sm mt-1" data-v-0c0213aa${_scopeId}>${ssrInterpolate(__props.errors.invoice_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Term (Hari)</label><input type="number"${ssrRenderAttr("value", unref(form).term_days)} min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}>`);
            if (__props.errors.term_days) {
              _push2(`<div class="text-red-500 text-sm mt-1" data-v-0c0213aa${_scopeId}>${ssrInterpolate(__props.errors.term_days)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-0c0213aa${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-0c0213aa${_scopeId}>Detail Pengiriman</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-6" data-v-0c0213aa${_scopeId}><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Shipper</label><input type="text"${ssrRenderAttr("value", unref(form).shipper)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
            ...
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Consignee</label><input type="text"${ssrRenderAttr("value", unref(form).consignee)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>AWB/BL No.</label><input type="text"${ssrRenderAttr("value", unref(form).awb_bl_no)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>MAWB/OBL No.</label><input type="text"${ssrRenderAttr("value", unref(form).mawb_obl_no)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Vessel</label><input type="text"${ssrRenderAttr("value", unref(form).vessel)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Flight/VOY</label><input type="text"${ssrRenderAttr("value", unref(form).flight_voy)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>POL/POD</label><input type="text"${ssrRenderAttr("value", unref(form).pol_pod)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Origin</label><input type="text"${ssrRenderAttr("value", unref(form).origin)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Destination</label><input type="text"${ssrRenderAttr("value", unref(form).destination)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>ETD</label><input type="date"${ssrRenderAttr("value", unref(form).etd)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>ETA</label><input type="date"${ssrRenderAttr("value", unref(form).eta)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
              ...
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Volume</label><input type="text"${ssrRenderAttr("value", unref(form).volume)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
              ...
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>20&#39;/40&#39;/45&#39;</label><input type="text"${ssrRenderAttr("value", unref(form).container_size)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" placeholder="e.g., 20GP, 40GP, 45GP" data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Container No.</label><input type="text"${ssrRenderAttr("value", unref(form).container_no)}${ssrIncludeBooleanAttr(unref(form).sales_order_id) ? " readonly" : ""} class="${ssrRenderClass([
              "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500",
              unref(form).sales_order_id ? "bg-gray-100 text-gray-600" : ""
            ])}" placeholder="e.g., MSKU2934199" data-v-0c0213aa${_scopeId}></div><div class="md:col-span-2" data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Remarks</label><textarea rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0c0213aa${_scopeId}>${ssrInterpolate(unref(form).remarks)}</textarea></div></div></div><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-0c0213aa${_scopeId}><div class="flex items-center justify-between mb-4" data-v-0c0213aa${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0c0213aa${_scopeId}>Item Invoice</h3><button type="button" class="inline-flex items-center px-3 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors" data-v-0c0213aa${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0c0213aa${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-0c0213aa${_scopeId}></path></svg> Tambah Item </button></div><div class="space-y-4" data-v-0c0213aa${_scopeId}><!--[-->`);
            ssrRenderList(unref(form).items, (item, index) => {
              _push2(`<div class="border border-gray-200 rounded-lg p-4" data-v-0c0213aa${_scopeId}><div class="flex items-center justify-between mb-4" data-v-0c0213aa${_scopeId}><h4 class="font-medium text-gray-900" data-v-0c0213aa${_scopeId}>Item ${ssrInterpolate(index + 1)}</h4>`);
              if (unref(form).items.length > 1) {
                _push2(`<button type="button" class="text-red-600 hover:text-red-800" data-v-0c0213aa${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0c0213aa${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-0c0213aa${_scopeId}></path></svg></button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="grid grid-cols-1 md:grid-cols-6 gap-4" data-v-0c0213aa${_scopeId}><div class="md:col-span-2" data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Deskripsi</label><input type="text"${ssrRenderAttr("value", item.description)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Qty</label><input type="number"${ssrRenderAttr("value", item.quantity)} step="0.01" min="0.01" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Unit</label><input type="text"${ssrRenderAttr("value", item.unit)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Rate</label><input type="number"${ssrRenderAttr("value", item.rate)} step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-0c0213aa${_scopeId}></div><div data-v-0c0213aa${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-0c0213aa${_scopeId}>Amount</label><input type="text"${ssrRenderAttr("value", formatCurrency(item.amount || 0))} class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100" readonly data-v-0c0213aa${_scopeId}></div></div></div>`);
            });
            _push2(`<!--]--></div></div><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-0c0213aa${_scopeId}><div class="flex items-center justify-between" data-v-0c0213aa${_scopeId}><div class="text-lg font-semibold text-sage-800" data-v-0c0213aa${_scopeId}> Total: ${ssrInterpolate(formatCurrency(calculateTotal()))}</div><div class="flex space-x-4" data-v-0c0213aa${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(route)("admin-keuangan.invoices.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(_ctx.processing) ? " disabled" : ""} class="px-6 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors disabled:opacity-50" data-v-0c0213aa${_scopeId}>${ssrInterpolate(_ctx.processing ? "Menyimpan..." : "Simpan Invoice")}</button></div></div></div></form></div>`);
          } else {
            return [
...
const Create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0c0213aa"]]);
export {
  Create as default
};
