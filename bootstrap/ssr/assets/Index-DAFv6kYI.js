        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(AlertDialog, {
              ...
              message: `Are you sure you want to delete service type '${(_b2 = deleteModal.serviceType) == null ? void 0 : _b2.code}'?`,
              "confirm-text": "Delete",
              "cancel-text": "Cancel",
            ...
            return [
              ...
              createVNode(AlertDialog, {
                show: deleteModal.show,
                title: "Confirm Deletion",
                message: `Are you sure you want to delete service type '${(_d = deleteModal.serviceType) == null ? void 0 : _d.code}'?`,
                "confirm-text": "Delete",
                "cancel-text": "Cancel",
                onConfirm: deleteServiceType,
                onCancel: ($event) => deleteModal.show = false
