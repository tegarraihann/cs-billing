    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminCSLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="py-6" data-v-a1dd88df${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-a1dd88df${_scopeId}><div class="bg-white shadow rounded-lg mb-6" data-v-a1dd88df${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-a1dd88df${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-a1dd88df${_scopeId}><div class="flex items-center" data-v-a1dd88df${_scopeId}><div class="w-12 h-12 bg-sage-800 rounded-full flex items-center justify-center mr-4" data-v-a1dd88df${_scopeId}>`);
            _push2(ssrRenderComponent(unref(FileText), { class: "w-6 h-6 text-white" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-a1dd88df${_scopeId}><h1 class="text-2xl font-semibold text-gray-900" data-v-a1dd88df${_scopeId}> Sales Order: ${ssrInterpolate(__props.salesOrder.order_number)}</h1><p class="mt-1 text-sm text-gray-600" data-v-a1dd88df${_scopeId}> Detail informasi sales order </p></div></div><div class="mt-4 sm:mt-0 flex flex-wrap gap-3" data-v-a1dd88df${_scopeId}>`);
            if (__props.salesOrder.status === "released" || __props.salesOrder.status === "confirmed" || __props.salesOrder.status === "approved") {
              _push2(`<a${ssrRenderAttr("href", _ctx.route("admin-cs.sales-orders.print", __props.salesOrder.id))} target="_blank" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition" data-v-a1dd88df${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileDown), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` Export PDF </a>`);
            } else {
              _push2(`<button disabled class="inline-flex items-center px-4 py-2 bg-gray-300 text-gray-600 rounded-md cursor-not-allowed" title="Sales order harus dirilis terlebih dahulu untuk dapat dicetak" data-v-a1dd88df${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileDown), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            ...
            if (__props.salesOrder.status === "draft") {
              ...
              _push2(`<button disabled class="inline-flex items-center px-4 py-2 bg-gray-300 text-gray-600 rounded-md cursor-not-allowed" title="Sales order tidak dapat diedit (sudah dirilis)" data-v-a1dd88df${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-6" data-v-a1dd88df${_scopeId}><div class="lg:col-span-2 space-y-6" data-v-a1dd88df${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden" data-v-a1dd88df${_scopeId}><div class="px-6 py-4 border-b border-gray-200 bg-gray-50" data-v-a1dd88df${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>Informasi Sales Order</h3></div><div class="p-6" data-v-a1dd88df${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8" data-v-a1dd88df${_scopeId}><div class="space-y-3" data-v-a1dd88df${_scopeId}><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>ORDER NUMB:</span><span class="font-semibold" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.order_number)}</span></p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>REF NO:</span> ${ssrInterpolate(__props.salesOrder.ref_no || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>DATE:</span> ${ssrInterpolate(__props.salesOrder.so_date ? formatDate(__props.salesOrder.so_date) : "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>CUSTOMER:</span> ${ssrInterpolate(__props.salesOrder.customer)}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>SHIPPER:</span> ${ssrInterpolate(__props.salesOrder.shipper || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>BL/AWB:</span> ${ssrInterpolate(__props.salesOrder.bl_awb || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>LINER:</span> ${ssrInterpolate(__props.salesOrder.liner || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>VESSEL:</span> ${ssrInterpolate(__props.salesOrder.vessel || "-")}</p></div><div class="space-y-3" data-v-a1dd88df${_scopeId}><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>ETA:</span> ${ssrInterpolate(__props.salesOrder.eta ? formatDate(__props.salesOrder.eta) : "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>ETD:</span> ${ssrInterpolate(__props.salesOrder.etd ? formatDate(__props.salesOrder.etd) : "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>AJU:</span> ${ssrInterpolate(__props.salesOrder.aju || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>SPPB DATE:</span> ${ssrInterpolate(__props.salesOrder.sppb_date ? formatDate(__props.salesOrder.sppb_date) : "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>SHIPMENT TYPE:</span> ${ssrInterpolate(__props.salesOrder.shipment_type || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>POL/POD:</span> ${ssrInterpolate([__props.salesOrder.pol, __props.salesOrder.pod].filter(Boolean).join(" / ") || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>GUDANG/UTC:</span> ${ssrInterpolate(__props.salesOrder.gudang_utc || "-")}</p><p class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="font-semibold text-gray-700" data-v-a1dd88df${_scopeId}>PARTY/LCL:</span> ${ssrInterpolate(__props.salesOrder.party_lcl || "-")}</p></div></div><div class="border-t border-gray-200 pt-6 mb-6" data-v-a1dd88df${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-a1dd88df${_scopeId}><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a1dd88df${_scopeId}>EXCHANGE RATE</label><p class="text-gray-900 font-mono" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.exchange_rate ? formatNumber(__props.salesOrder.exchange_rate) : "-")}</p></div></div></div><div class="border-t border-gray-200 pt-6" data-v-a1dd88df${_scopeId}><h4 class="text-md font-semibold text-gray-800 mb-4" data-v-a1dd88df${_scopeId}>Detail Informasi</h4><div class="overflow-x-auto mb-6" data-v-a1dd88df${_scopeId}><table class="min-w-full" data-v-a1dd88df${_scopeId}><thead data-v-a1dd88df${_scopeId}><tr class="bg-gray-50" data-v-a1dd88df${_scopeId}><th class="px-6 py-4 text-left text-sm font-bold text-gray-900 uppercase tracking-wide" data-v-a1dd88df${_scopeId}>JENIS BIAYA</th><th class="px-6 py-4 text-center text-sm font-bold text-gray-900 uppercase tracking-wide" data-v-a1dd88df${_scopeId}>BUYING</th><th class="px-6 py-4 text-center text-sm font-bold text-gray-900 uppercase tracking-wide" data-v-a1dd88df${_scopeId}>SELLING</th><th class="px-6 py-4 text-center text-sm font-bold text-gray-900 uppercase tracking-wide" data-v-a1dd88df${_scopeId}>REVENUE</th><th class="px-6 py-4 text-left text-sm font-bold text-gray-900 uppercase tracking-wide" data-v-a1dd88df${_scopeId}>REMARKS</th></tr></thead><tbody data-v-a1dd88df${_scopeId}>`);
            if (__props.salesOrder.vendor_breakdown && __props.salesOrder.vendor_breakdown.length > 0) {
              ...
              ssrRenderList(__props.salesOrder.vendor_breakdown, (item, index) => {
                _push2(`<tr class="hover:bg-gray-50 transition-colors" data-v-a1dd88df${_scopeId}><td class="px-6 py-4 text-sm text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(item.description || "Service Type")}</td><td class="px-6 py-4 text-center text-sm font-mono text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(item.buying_amount || 0))}</td><td class="px-6 py-4 text-center text-sm font-mono text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(item.selling_amount || 0))}</td><td class="${ssrRenderClass([getVendorProfit(item) >= 0 ? "text-green-700" : "text-red-600", "px-6 py-4 text-center text-sm font-mono"])}" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(getVendorProfit(item)))}</td><td class="px-6 py-4 text-sm text-gray-600" data-v-a1dd88df${_scopeId}>${ssrInterpolate(item.remarks || "-")}</td></tr>`);
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<tr data-v-a1dd88df${_scopeId}><td colspan="5" class="px-6 py-12 text-center text-gray-500" data-v-a1dd88df${_scopeId}><div class="flex flex-col items-center" data-v-a1dd88df${_scopeId}><div class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4" data-v-a1dd88df${_scopeId}><svg class="w-8 h-8 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a1dd88df${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-a1dd88df${_scopeId}></path></svg></div><h3 class="text-lg font-medium text-gray-900 mb-2" data-v-a1dd88df${_scopeId}>Tidak ada data breakdown</h3><p class="text-sm text-gray-500 max-w-sm" data-v-a1dd88df${_scopeId}>Belum ada informasi vendor breakdown. Data akan muncul setelah informasi pricing diisi.</p></div></td></tr>`);
            }
            if (__props.salesOrder.vendor_breakdown && __props.salesOrder.vendor_breakdown.length > 0) {
              _push2(`<tr class="bg-gray-50 border-t border-gray-200" data-v-a1dd88df${_scopeId}><td class="px-6 py-4 text-sm font-semibold text-gray-900 uppercase" data-v-a1dd88df${_scopeId}> TOTAL </td><td class="px-6 py-4 text-center text-sm font-mono font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</td><td class="px-6 py-4 text-center text-sm font-mono font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</td><td class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-green-700" : "text-red-600", "px-6 py-4 text-center text-sm font-mono font-semibold"])}" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</td><td class="px-6 py-4 text-center text-gray-400" data-v-a1dd88df${_scopeId}> - </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div>`);
            if (__props.salesOrder.note) {
              _push2(`<div class="mb-6" data-v-a1dd88df${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-a1dd88df${_scopeId}>Catatan Tambahan (Note)</h5><div class="bg-blue-50 border border-blue-200 rounded-lg p-4" data-v-a1dd88df${_scopeId}><p class="text-gray-900 whitespace-pre-wrap" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.note)}</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.other_costs && __props.salesOrder.other_costs.length > 0) {
              _push2(`<div class="mb-6" data-v-a1dd88df${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-a1dd88df${_scopeId}>Biaya Beban Lain (Operational)</h5><div class="bg-white border border-gray-200 rounded-lg overflow-hidden" data-v-a1dd88df${_scopeId}><div class="overflow-x-auto" data-v-a1dd88df${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-a1dd88df${_scopeId}><thead class="bg-red-50" data-v-a1dd88df${_scopeId}><tr data-v-a1dd88df${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-red-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Description</th><th class="px-6 py-3 text-right text-xs font-medium text-red-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Amount</th><th class="px-6 py-3 text-left text-xs font-medium text-red-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Category</th><th class="px-6 py-3 text-left text-xs font-medium text-red-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Notes</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-a1dd88df${_scopeId}><!--[-->`);
              ssrRenderList(__props.salesOrder.other_costs, (cost, index) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-a1dd88df${_scopeId}><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(cost.description || "-")}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-mono text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(cost.amount || 0))}</td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600" data-v-a1dd88df${_scopeId}>${ssrInterpolate(cost.category || "-")}</td><td class="px-6 py-4 text-sm text-gray-600" data-v-a1dd88df${_scopeId}>${ssrInterpolate(cost.notes || "-")}</td></tr>`);
              });
              _push2(`<!--]--></tbody><tfoot class="bg-red-50" data-v-a1dd88df${_scopeId}><tr data-v-a1dd88df${_scopeId}><td class="px-6 py-3 text-sm font-semibold text-red-800 uppercase" data-v-a1dd88df${_scopeId}>Total</td><td class="px-6 py-3 text-right text-sm font-mono font-semibold text-red-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(__props.salesOrder.other_costs.reduce((total, cost) => total + (parseFloat(cost.amount) || 0), 0)))}</td><td colspan="2" class="px-6 py-3" data-v-a1dd88df${_scopeId}></td></tr></tfoot></table></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.reimbursement_items && __props.salesOrder.reimbursement_items.length > 0) {
              _push2(`<div class="mb-6" data-v-a1dd88df${_scopeId}><h5 class="text-sm font-semibold text-gray-800 mb-3" data-v-a1dd88df${_scopeId}>Items Reimbursement</h5><div class="bg-white border border-gray-200 rounded-lg overflow-hidden" data-v-a1dd88df${_scopeId}><div class="overflow-x-auto" data-v-a1dd88df${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-a1dd88df${_scopeId}><thead class="bg-orange-50" data-v-a1dd88df${_scopeId}><tr data-v-a1dd88df${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Description</th><th class="px-6 py-3 text-right text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Amount</th><th class="px-6 py-3 text-center text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Status</th><th class="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider" data-v-a1dd88df${_scopeId}>Notes</th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-a1dd88df${_scopeId}><!--[-->`);
              ssrRenderList(__props.salesOrder.reimbursement_items, (item, index) => {
                _push2(`<tr class="hover:bg-gray-50" data-v-a1dd88df${_scopeId}><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(item.description || "-")}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-mono text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(item.amount || 0))}</td><td class="px-6 py-4 whitespace-nowrap text-center" data-v-a1dd88df${_scopeId}><span class="${ssrRenderClass([getReimbursementStatusColor(item.status), "inline-flex px-2 py-1 text-xs font-semibold rounded-full"])}" data-v-a1dd88df${_scopeId}>${ssrInterpolate(getReimbursementStatusText(item.status))}</span></td><td class="px-6 py-4 text-sm text-gray-600" data-v-a1dd88df${_scopeId}>${ssrInterpolate(item.notes || "-")}</td></tr>`);
              });
              _push2(`<!--]--></tbody><tfoot class="bg-orange-50" data-v-a1dd88df${_scopeId}><tr data-v-a1dd88df${_scopeId}><td class="px-6 py-3 text-sm font-semibold text-orange-800 uppercase" data-v-a1dd88df${_scopeId}>Total</td><td class="px-6 py-3 text-right text-sm font-mono font-semibold text-orange-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(__props.salesOrder.reimbursement_items.reduce((total, item) => total + (parseFloat(item.amount) || 0), 0)))}</td><td colspan="2" class="px-6 py-3" data-v-a1dd88df${_scopeId}></td></tr></tfoot></table></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 pt-6 border-t border-gray-200" data-v-a1dd88df${_scopeId}><div class="space-y-3" data-v-a1dd88df${_scopeId}><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>COMMODITY/URAIAN BARANG</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.commodity || "-")}</p></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>QTY</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.qty || "-")}</p></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>NET WEIGHT (KG)</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.net_weight ? formatWeight(__props.salesOrder.net_weight) : "-")}</p></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>MEAS (M³)</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.measurement ? formatMeasurement(__props.salesOrder.measurement) : "-")}</p></div></div><div class="space-y-3" data-v-a1dd88df${_scopeId}><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>CONTAINER NO</label>`);
            if (__props.salesOrder.container_no && Array.isArray(__props.salesOrder.container_no)) {
              _push2(`<div class="space-y-2" data-v-a1dd88df${_scopeId}><div class="flex flex-wrap gap-2" data-v-a1dd88df${_scopeId}><!--[-->`);
              ssrRenderList(__props.salesOrder.container_no, (container, index) => {
                _push2(`<span class="inline-block bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full" data-v-a1dd88df${_scopeId}>${ssrInterpolate(container)}</span>`);
              });
              _push2(`<!--]--></div><p class="text-xs text-gray-500" data-v-a1dd88df${_scopeId}>Total: ${ssrInterpolate(__props.salesOrder.container_no.length)} container</p></div>`);
            } else if (__props.salesOrder.container_no) {
              _push2(`<div class="text-gray-900" data-v-a1dd88df${_scopeId}><span class="inline-block bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.container_no)}</span></div>`);
            } else {
              _push2(`<p class="text-gray-900" data-v-a1dd88df${_scopeId}>-</p>`);
            }
            _push2(`</div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>INVOICE NUMB</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.invoice_number || "-")}</p></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>INVOICE DATE</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.invoice_date ? formatDate(__props.salesOrder.invoice_date) : "-")}</p></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>T.O.P</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(__props.salesOrder.top || "-")}</p></div></div></div></div></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden" data-v-a1dd88df${_scopeId}><div class="px-6 py-4 border-b border-gray-200 bg-gray-50" data-v-a1dd88df${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>Voucher Information</h3></div><div class="p-6 space-y-6" data-v-a1dd88df${_scopeId}>`);
            if (__props.paymentVouchers && __props.paymentVouchers.length > 0) {
              _push2(`<div class="space-y-4" data-v-a1dd88df${_scopeId}><h4 class="text-md font-semibold text-gray-700 border-b border-gray-200 pb-2" data-v-a1dd88df${_scopeId}>Payment Vouchers</h4><div class="grid grid-cols-1 gap-4" data-v-a1dd88df${_scopeId}><!--[-->`);
              ssrRenderList(__props.paymentVouchers, (voucher) => {
                _push2(`<div class="border border-gray-200 rounded-lg p-4 space-y-3" data-v-a1dd88df${_scopeId}><div class="flex justify-between items-start" data-v-a1dd88df${_scopeId}><div data-v-a1dd88df${_scopeId}><h5 class="font-medium text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.voucher_no)}</h5><span class="${ssrRenderClass([getVoucherStatusColor(voucher.status), "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1"])}" data-v-a1dd88df${_scopeId}>${ssrInterpolate(getVoucherStatusLabel(voucher.status))}</span></div><div class="text-right" data-v-a1dd88df${_scopeId}><p class="text-lg font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(voucher.amount))}</p><p class="text-sm text-gray-500" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatDate(voucher.date))}</p></div></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Description</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.description)}</p></div><div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm" data-v-a1dd88df${_scopeId}>`);
                if (voucher.prepared_by) {
                  _push2(`<div data-v-a1dd88df${_scopeId}><label class="block font-medium text-gray-700" data-v-a1dd88df${_scopeId}>Prepared By</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.prepared_by)}</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (voucher.authorized_by) {
                  _push2(`<div data-v-a1dd88df${_scopeId}><label class="block font-medium text-gray-700" data-v-a1dd88df${_scopeId}>Authorized By</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.authorized_by)}</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (voucher.finance_by) {
                  _push2(`<div data-v-a1dd88df${_scopeId}><label class="block font-medium text-gray-700" data-v-a1dd88df${_scopeId}>Finance By</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.finance_by)}</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (voucher.receipt_by) {
                  _push2(`<div data-v-a1dd88df${_scopeId}><label class="block font-medium text-gray-700" data-v-a1dd88df${_scopeId}>Receipt By</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.receipt_by)}</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
            ...
            if (__props.receiptVouchers && __props.receiptVouchers.length > 0) {
              _push2(`<div class="space-y-4" data-v-a1dd88df${_scopeId}><h4 class="text-md font-semibold text-gray-700 border-b border-gray-200 pb-2" data-v-a1dd88df${_scopeId}>Receipt Vouchers</h4><div class="grid grid-cols-1 gap-4" data-v-a1dd88df${_scopeId}><!--[-->`);
              ssrRenderList(__props.receiptVouchers, (voucher) => {
                _push2(`<div class="border border-green-200 rounded-lg p-4 space-y-3 bg-green-50" data-v-a1dd88df${_scopeId}><div class="flex justify-between items-start" data-v-a1dd88df${_scopeId}><div data-v-a1dd88df${_scopeId}><h5 class="font-medium text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.voucher_no)}</h5><span class="${ssrRenderClass([getVoucherStatusColor(voucher.status), "inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1"])}" data-v-a1dd88df${_scopeId}>${ssrInterpolate(getVoucherStatusLabel(voucher.status))}</span></div><div class="text-right" data-v-a1dd88df${_scopeId}><p class="text-lg font-semibold text-green-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatCurrency(voucher.amount))}</p><p class="text-sm text-gray-500" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatDate(voucher.date))}</p></div></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Description</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.description)}</p></div><div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm" data-v-a1dd88df${_scopeId}>`);
                if (voucher.prepared_by) {
                  _push2(`<div data-v-a1dd88df${_scopeId}><label class="block font-medium text-gray-700" data-v-a1dd88df${_scopeId}>Prepared By</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(voucher.prepared_by)}</p></div>`);
                } else {
                  _push2(`<!---->`);
            ...
            if ((!__props.paymentVouchers || __props.paymentVouchers.length === 0) && (!__props.receiptVouchers || __props.receiptVouchers.length === 0)) {
              _push2(`<div class="text-center py-8" data-v-a1dd88df${_scopeId}><div class="text-gray-400 mb-2" data-v-a1dd88df${_scopeId}><svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a1dd88df${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-a1dd88df${_scopeId}></path></svg></div><p class="text-gray-500" data-v-a1dd88df${_scopeId}>No vouchers created for this sales order</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="space-y-6" data-v-a1dd88df${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden" data-v-a1dd88df${_scopeId}><div class="px-6 py-4 border-b border-gray-200 bg-gray-50" data-v-a1dd88df${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>Status</h3></div><div class="p-6" data-v-a1dd88df${_scopeId}><span class="${ssrRenderClass([getStatusColor(__props.salesOrder.status), "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium w-full justify-center"])}" data-v-a1dd88df${_scopeId}>${ssrInterpolate(getStatusLabel(__props.salesOrder.status || "draft"))}</span></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden" data-v-a1dd88df${_scopeId}><div class="px-6 py-4 border-b border-gray-200 bg-gray-50" data-v-a1dd88df${_scopeId}><h3 class="text-lg font-semibold text-gray-900" data-v-a1dd88df${_scopeId}>System Information</h3></div><div class="p-6 space-y-4" data-v-a1dd88df${_scopeId}><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Created By</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(((_a = __props.salesOrder.creator) == null ? void 0 : _a.name) || "Unknown")}</p></div><div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Created At</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.created_at))}</p></div>`);
            if (__props.salesOrder.last_modified_at) {
              _push2(`<div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Last Modified</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.last_modified_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.sent_at) {
              _push2(`<div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Sent At</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.sent_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrder.confirmed_at) {
              _push2(`<div data-v-a1dd88df${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-a1dd88df${_scopeId}>Confirmed At</label><p class="text-gray-900" data-v-a1dd88df${_scopeId}>${ssrInterpolate(formatDateTime(__props.salesOrder.confirmed_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a1dd88df"]]);
export {
  Show as default
};
