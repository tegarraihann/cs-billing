    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Edit Other Income" }, null, _parent2, _scopeId));
            ...
            _push2(`<h1 class="text-2xl font-bold text-sage-800"${_scopeId}>Edit Other Income</h1></div><p class="text-sm text-sage-600 ml-9"${_scopeId}>Update other income details</p></div>`);
            if (__props.otherIncome.posted_to_profit_loss) {
              ...
              _push2(`</div><div class="ml-3"${_scopeId}><p class="text-sm text-yellow-700"${_scopeId}><strong${_scopeId}>Warning:</strong> This income has been posted to Profit &amp; Loss and cannot be edited. Please unpost first if you need to make changes. </p></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}> Category <span class="text-red-500"${_scopeId}>*</span></label><select class="${ssrRenderClass([{ "border-red-300": unref(form).errors.category }, "w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm"])}"${ssrIncludeBooleanAttr(__props.otherIncome.posted_to_profit_loss || categoryOptions.value.length === 0) ? " disabled" : ""}${_scopeId}><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).category) ? ssrLooseContain(unref(form).category, "") : ssrLooseEqual(unref(form).category, "")) ? " selected" : ""}${_scopeId}>Select Category</option><!--[-->`);
            ...
            if (!__props.otherIncome.posted_to_profit_loss && categoryOptions.value.length === 0) {
              _push2(`<p class="mt-1 text-xs text-sage-500"${_scopeId}> No active categories. Add categories in the Operational Cost Categories master. </p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            if (__props.otherIncome.receipt_file && !filePreview.value) {
              ...
              _push2(` View current file </a></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (!__props.otherIncome.posted_to_profit_loss) {
            ...
            if (filePreview.value) {
              _push2(`<p class="mt-2 text-sm text-sage-600"${_scopeId}> New file selected: <span class="font-medium"${_scopeId}>${ssrInterpolate(filePreview.value)}</span><button type="button" class="ml-2 text-red-600 hover:text-red-800"${_scopeId}>`);
            ...
            if (!__props.otherIncome.posted_to_profit_loss) {
              ...
              _push2(` ${ssrInterpolate(unref(form).processing ? "Saving..." : "Save Changes")}</button>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode(unref(Head), { title: "Edit Other Income" }),
              createVNode("div", { class: "p-6 max-w-4xl mx-auto" }, [
                createVNode("div", { class: "mb-6" }, [
                  createVNode("div", { class: "flex items-center space-x-4 mb-2" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-sage-800" }, "Edit Other Income")
                  ]),
                  createVNode("p", { class: "text-sm text-sage-600 ml-9" }, "Update other income details")
                ]),
                  ...
                  createVNode("div", { class: "flex" }, [
                    ...
                    createVNode("div", { class: "ml-3" }, [
                      createVNode("p", { class: "text-sm text-yellow-700" }, [
                        ...
                        createTextVNode(" This income has been posted to Profit & Loss and cannot be edited. Please unpost first if you need to make changes. ")
                      ])
                    ])
                  ])
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                      createVNode("div", null, [
                        ...
                        withDirectives(createVNode("select", {
                          ...
                          createVNode("option", { value: "" }, "- No Customer -"),
                    ...
                    createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                      ...
                      createVNode("div", null, [
                        ...
                        }, " No active categories. Add categories in the Operational Cost Categories master. ")) : createCommentVNode("", true),
                    ...
                    createVNode("div", null, [
                      ...
                      __props.otherIncome.receipt_file && !filePreview.value ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("a", {
                          ...
                          createTextVNode(" View current file ")
                        ], 8, ["href"])
                      ])) : createCommentVNode("", true),
                      !__props.otherIncome.posted_to_profit_loss ? (openBlock(), createBlock("div", {
                        key: 1,
                      ...
                      filePreview.value ? (openBlock(), createBlock("p", {
                        ...
                        createTextVNode(" New file selected: "),
