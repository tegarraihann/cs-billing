...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const submit = () => {
      form.post(route("admin-keuangan.petty-cash-categories.store"));
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Create Petty Cash Category" }, null, _parent2, _scopeId));
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Saving..." : "Save Category")}</button></div></form></div></div></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Create Petty Cash Category" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Add a new petty cash category for transactions.")
                  ]),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "mt-8 flex justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            createTextVNode(" " + toDisplayString(processing.value ? "Saving..." : "Save Category"), 1)
                          ], 8, ["disabled"])
                        ])
                      ], 32)
                    ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/AdminKeuangan/PettyCashCategories/Create.vue");
