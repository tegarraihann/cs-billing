    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-0ace0620${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-0ace0620${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-0ace0620${_scopeId}><div data-v-0ace0620${_scopeId}><h2 class="text-2xl font-bold text-sage-800 mb-2" data-v-0ace0620${_scopeId}> Manajemen Shipment Type </h2><p class="text-sage-600" data-v-0ace0620${_scopeId}> Kelola data jenis pengiriman untuk sales order </p></div><div class="mt-4 sm:mt-0" data-v-0ace0620${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0ace0620${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-0ace0620${_scopeId2}></path></svg> Tambah Shipment Type `);
                } else {
                  return [
            ...
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-0ace0620${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-0ace0620${_scopeId}><div data-v-0ace0620${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-0ace0620${_scopeId}>Cari Data</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Cari nama, kode, atau deskripsi..." class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-0ace0620${_scopeId}></div><div class="flex items-end" data-v-0ace0620${_scopeId}><button class="w-full px-4 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors" data-v-0ace0620${_scopeId}> Cari </button></div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-0ace0620${_scopeId}><div class="px-6 py-4 border-b border-sage-200" data-v-0ace0620${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-0ace0620${_scopeId}>Daftar Shipment Type</h3><p class="text-sm text-sage-600 mt-1" data-v-0ace0620${_scopeId}> Total: ${ssrInterpolate(((_a = __props.shipmentTypes) == null ? void 0 : _a.total) || 0)} data </p></div><div class="overflow-x-auto" data-v-0ace0620${_scopeId}><table class="w-full" data-v-0ace0620${_scopeId}><thead class="bg-sage-50" data-v-0ace0620${_scopeId}><tr data-v-0ace0620${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-0ace0620${_scopeId}> Kode </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-0ace0620${_scopeId}> Nama </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-0ace0620${_scopeId}> Deskripsi </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-0ace0620${_scopeId}> Status </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-0ace0620${_scopeId}> Aksi </th></tr></thead><tbody class="divide-y divide-sage-200" data-v-0ace0620${_scopeId}><!--[-->`);
            ssrRenderList(__props.shipmentTypes.data, (shipmentType) => {
              _push2(`<tr class="hover:bg-sage-50 transition-colors" data-v-0ace0620${_scopeId}><td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-sage-900" data-v-0ace0620${_scopeId}>${ssrInterpolate(shipmentType.code)}</td><td class="px-6 py-4 whitespace-nowrap text-sm text-sage-900" data-v-0ace0620${_scopeId}>${ssrInterpolate(shipmentType.name)}</td><td class="px-6 py-4 text-sm text-sage-900" data-v-0ace0620${_scopeId}>${ssrInterpolate(shipmentType.description || "-")}</td><td class="px-6 py-4 whitespace-nowrap" data-v-0ace0620${_scopeId}><span class="${ssrRenderClass(
              ...
              )}" data-v-0ace0620${_scopeId}>${ssrInterpolate(shipmentType.is_active ? "Aktif" : "Tidak Aktif")}</span></td><td class="px-6 py-4 whitespace-nowrap text-sm font-medium" data-v-0ace0620${_scopeId}><div class="flex items-center space-x-2" data-v-0ace0620${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
              ...
              _push2(`<button class="inline-flex items-center justify-center w-8 h-8 text-red-600 hover:text-red-900 hover:bg-red-100 rounded-full transition-colors" title="Hapus" data-v-0ace0620${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0ace0620${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-0ace0620${_scopeId}></path></svg></button></div></td></tr>`);
            });
            _push2(`<!--]--></tbody></table></div>`);
            if (__props.shipmentTypes.data.length === 0) {
              _push2(`<div class="px-6 py-8 text-center text-sage-500" data-v-0ace0620${_scopeId}><div class="flex flex-col items-center" data-v-0ace0620${_scopeId}><svg class="w-12 h-12 text-sage-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-0ace0620${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" data-v-0ace0620${_scopeId}></path></svg><p class="text-lg font-medium" data-v-0ace0620${_scopeId}>Tidak ada data shipment type</p><p class="text-sm mt-1" data-v-0ace0620${_scopeId}>Mulai dengan menambahkan shipment type baru</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.shipmentTypes.data.length > 0 && __props.shipmentTypes.last_page > 1) {
              _push2(`<div class="px-6 py-4 border-t border-sage-200" data-v-0ace0620${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0ace0620"]]);
export {
  Index as default
};
