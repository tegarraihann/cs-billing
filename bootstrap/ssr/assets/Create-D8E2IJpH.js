import { ref, withCtx, unref, createBlock, createTextVNode, openBlock, createVNode, withModifiers, withDirectives, createCommentVNode, vModelText, toDisplayString, vModelSelect, vShow, Fragment, renderList, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-a8d11c23${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-a8d11c23${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-a8d11c23${_scopeId}><div class="flex items-center" data-v-a8d11c23${_scopeId}><div class="w-12 h-12 bg-sage-600 rounded-full flex items-center justify-center mr-4" data-v-a8d11c23${_scopeId}><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-a8d11c23${_scopeId}></path></svg></div><div data-v-a8d11c23${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-a8d11c23${_scopeId}> Tambah Pelanggan Baru </h2><p class="text-sage-600" data-v-a8d11c23${_scopeId}> Tambahkan data pelanggan baru ke dalam sistem </p></div></div><div class="mt-4 sm:mt-0" data-v-a8d11c23${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-a8d11c23${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
            ...
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-a8d11c23${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-a8d11c23${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> Form Tambah Pelanggan </h3><p class="text-sm text-sage-600 mt-1" data-v-a8d11c23${_scopeId}> Lengkapi informasi pelanggan dengan benar </p></div><div class="p-6" data-v-a8d11c23${_scopeId}><form class="space-y-8" data-v-a8d11c23${_scopeId}><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> 🏢 Informasi Perusahaan/Perorangan </h4><svg class="${ssrRenderClass([{ "rotate-180": isCompanyInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isCompanyInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="company_name" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Nama PT/Perorangan <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).company_name)} type="text" id="company_name" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Masukkan nama perusahaan atau nama lengkap" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.company_name) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.company_name)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="company_type" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Jenis Usaha <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><select id="company_type" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}><option value="" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "") : ssrLooseEqual(unref(form).company_type, "")) ? " selected" : ""}${_scopeId}>Pilih jenis usaha...</option><option value="PT" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "PT") : ssrLooseEqual(unref(form).company_type, "PT")) ? " selected" : ""}${_scopeId}>PT (Perseroan Terbatas)</option><option value="CV" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "CV") : ssrLooseEqual(unref(form).company_type, "CV")) ? " selected" : ""}${_scopeId}>CV (Commanditaire Vennootschap)</option><option value="Perorangan" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "Perorangan") : ssrLooseEqual(unref(form).company_type, "Perorangan")) ? " selected" : ""}${_scopeId}>Perorangan</option><option value="Yayasan" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "Yayasan") : ssrLooseEqual(unref(form).company_type, "Yayasan")) ? " selected" : ""}${_scopeId}>Yayasan</option><option value="Koperasi" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "Koperasi") : ssrLooseEqual(unref(form).company_type, "Koperasi")) ? " selected" : ""}${_scopeId}>Koperasi</option><option value="Lainnya" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).company_type) ? ssrLooseContain(unref(form).company_type, "Lainnya") : ssrLooseEqual(unref(form).company_type, "Lainnya")) ? " selected" : ""}${_scopeId}>Lainnya</option></select>`);
            if (unref(form).errors.company_type) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.company_type)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="company_address" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Alamat PT/Domisili <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><textarea id="company_address" rows="3" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors resize-none" placeholder="Masukkan alamat lengkap perusahaan/domisili" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).company_address)}</textarea>`);
            if (unref(form).errors.company_address) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.company_address)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="invoice_address" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Alamat Kirim Invoice </label><textarea id="invoice_address" rows="3" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors resize-none" placeholder="Masukkan alamat untuk pengiriman invoice (opsional)" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).invoice_address)}</textarea>`);
            if (unref(form).errors.invoice_address) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_address)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> 📄 Data Legalitas </h4><svg class="${ssrRenderClass([{ "rotate-180": isLegalInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isLegalInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="nib" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> NIB (Nomor Induk Berusaha) </label><input${ssrRenderAttr("value", unref(form).nib)} type="text" id="nib" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Masukkan nomor induk berusaha" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.nib) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.nib)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="npwp" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> NPWP </label><input${ssrRenderAttr("value", unref(form).npwp)} type="text" id="npwp" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Masukkan nomor NPWP" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.npwp) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.npwp)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div style="${ssrRenderStyle(unref(form).company_type === "Perorangan" ? null : { display: "none" })}" data-v-a8d11c23${_scopeId}><label for="ktp_number" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Nomor KTP </label><input${ssrRenderAttr("value", unref(form).ktp_number)} type="text" id="ktp_number" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Masukkan nomor KTP" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.ktp_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.ktp_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> 👤 Data PIC (Person In Charge) </h4><svg class="${ssrRenderClass([{ "rotate-180": isPicInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isPicInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="pic_name" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Nama PIC <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).pic_name)} type="text" id="pic_name" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Masukkan nama lengkap PIC" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.pic_name) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.pic_name)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="pic_phone" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Kontak/Telepon Aktif PIC <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).pic_phone)} type="tel" id="pic_phone" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Contoh: 08123456789" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.pic_phone) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.pic_phone)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="pic_email" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Email Aktif PIC <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).pic_email)} type="email" id="pic_email" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="contoh@email.com" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.pic_email) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.pic_email)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> 📈 Data Marketing </h4><svg class="${ssrRenderClass([{ "rotate-180": isMarketingInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isMarketingInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="marketing_name" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Nama Marketing </label><input${ssrRenderAttr("value", unref(form).marketing_name)} type="text" id="marketing_name" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Masukkan nama marketing yang bertanggung jawab" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.marketing_name) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.marketing_name)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="marketing_phone" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Nomor Telepon Marketing </label><input${ssrRenderAttr("value", unref(form).marketing_phone)} type="tel" id="marketing_phone" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="Contoh: 08123456789" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.marketing_phone) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.marketing_phone)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="marketing_email" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Email Marketing </label><input${ssrRenderAttr("value", unref(form).marketing_email)} type="email" id="marketing_email" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" placeholder="marketing@email.com" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.marketing_email) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.marketing_email)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> Informasi Pengiriman </h4><svg class="${ssrRenderClass([{ "rotate-180": isShippingInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isShippingInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="so_number" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> SO Number <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).so_number)} type="text" id="so_number" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.so_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.so_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="customer_code" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Customer Code <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).customer_code)} type="text" id="customer_code" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.customer_code) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.customer_code)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="consignee_shipper" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Consignee/Shipper <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).consignee_shipper)} type="text" id="consignee_shipper" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.consignee_shipper) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.consignee_shipper)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="awb_bl_number" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> AWB/BL Number <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).awb_bl_number)} type="text" id="awb_bl_number" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.awb_bl_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.awb_bl_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="cust_doc_name" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Cust Doc Name </label><input${ssrRenderAttr("value", unref(form).cust_doc_name)} type="text" id="cust_doc_name" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.cust_doc_name) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.cust_doc_name)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="type_qty" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Type Qty </label><input${ssrRenderAttr("value", unref(form).type_qty)} type="text" id="type_qty" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.type_qty) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.type_qty)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="no_kont_pallet" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> No Kont/Pallet </label><input${ssrRenderAttr("value", unref(form).no_kont_pallet)} type="text" id="no_kont_pallet" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.no_kont_pallet) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.no_kont_pallet)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="pol_pod" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> POL/POD </label><input${ssrRenderAttr("value", unref(form).pol_pod)} type="text" id="pol_pod" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.pol_pod) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.pol_pod)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="eta" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> ETA </label><input${ssrRenderAttr("value", unref(form).eta)} type="date" id="eta" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).errors.eta) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.eta)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> Dokumen &amp; Foto </h4><svg class="${ssrRenderClass([{ "rotate-180": isDocumentInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isDocumentInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="photo" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Foto Pelanggan </label><input type="file" id="photo" accept="image/*" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-sage-100 file:text-sage-700 hover:file:bg-sage-200" data-v-a8d11c23${_scopeId}><p class="mt-1 text-xs text-gray-500" data-v-a8d11c23${_scopeId}> Format yang didukung: JPG, PNG, GIF. Maksimal 2MB. </p>`);
            if (unref(form).errors.photo) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.photo)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="legal_document" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Dokumen Legal </label><input type="file" id="legal_document" accept=".pdf" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-sage-100 file:text-sage-700 hover:file:bg-sage-200" data-v-a8d11c23${_scopeId}><p class="mt-1 text-xs text-gray-500" data-v-a8d11c23${_scopeId}> Format yang didukung: PDF. Maksimal 10MB. </p>`);
            if (unref(form).errors.legal_document) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.legal_document)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="border border-sage-200 rounded-lg" data-v-a8d11c23${_scopeId}><button type="button" class="w-full flex items-center justify-between p-4 bg-sage-50 hover:bg-sage-100 transition-colors rounded-t-lg" data-v-a8d11c23${_scopeId}><h4 class="text-lg font-semibold text-sage-800" data-v-a8d11c23${_scopeId}> Buying to Vendor </h4><svg class="${ssrRenderClass([{ "rotate-180": isVendorInfoOpen.value }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-a8d11c23${_scopeId}></path></svg></button><div style="${ssrRenderStyle(isVendorInfoOpen.value ? null : { display: "none" })}" class="p-4 space-y-4" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label for="deskripsi" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Deskripsi <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><textarea id="deskripsi" rows="2" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors resize-none" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).vendor.deskripsi)}</textarea>`);
            if ((_a = unref(form).errors.vendor) == null ? void 0 : _a.deskripsi) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.vendor.deskripsi)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="nominal" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Nominal <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).vendor.nominalFormatted)} type="text" id="nominal" required placeholder="0" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if ((_b = unref(form).errors.vendor) == null ? void 0 : _b.nominal) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.vendor.nominal)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-a8d11c23${_scopeId}><label for="vendor_id" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> Pilih Vendor <span class="text-red-500" data-v-a8d11c23${_scopeId}>*</span></label><select id="vendor_id" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}><option value="" data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).vendor.vendor_id) ? ssrLooseContain(unref(form).vendor.vendor_id, "") : ssrLooseEqual(unref(form).vendor.vendor_id, "")) ? " selected" : ""}${_scopeId}>Pilih vendor...</option><!--[-->`);
            ssrRenderList(__props.vendors, (vendorOption) => {
              _push2(`<option${ssrRenderAttr("value", vendorOption.id)} data-v-a8d11c23${ssrIncludeBooleanAttr(Array.isArray(unref(form).vendor.vendor_id) ? ssrLooseContain(unref(form).vendor.vendor_id, vendorOption.id) : ssrLooseEqual(unref(form).vendor.vendor_id, vendorOption.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendorOption.nama_vendor)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if ((_c = unref(form).errors.vendor) == null ? void 0 : _c.vendor_id) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.vendor.vendor_id)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (unref(form).vendor.vendor_id) {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-3 bg-sage-100 rounded-lg" data-v-a8d11c23${_scopeId}><div data-v-a8d11c23${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-a8d11c23${_scopeId}> Nomor Rekening </label><p class="text-sm text-gray-900 font-mono" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).vendor.no_rekening || "-")}</p></div><div data-v-a8d11c23${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-a8d11c23${_scopeId}> Nama Rekening </label><p class="text-sm text-gray-900" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).vendor.nama_rekening || "-")}</p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div data-v-a8d11c23${_scopeId}><label for="rcvd_inv" class="block text-sm font-medium text-sage-700 mb-2" data-v-a8d11c23${_scopeId}> RCVD INV </label><input${ssrRenderAttr("value", unref(form).vendor.rcvd_inv)} type="text" id="rcvd_inv" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 transition-colors" data-v-a8d11c23${_scopeId}>`);
            if ((_d = unref(form).errors.vendor) == null ? void 0 : _d.rcvd_inv) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-a8d11c23${_scopeId}>${ssrInterpolate(unref(form).errors.vendor.rcvd_inv)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-3 pt-6 border-t border-sage-200" data-v-a8d11c23${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-cs.customers.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="inline-flex items-center justify-center px-6 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" data-v-a8d11c23${_scopeId}>`);
            if (unref(form).processing) {
              _push2(`<svg class="animate-spin -ml-1 mr-3 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" data-v-a8d11c23${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-a8d11c23${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-a8d11c23${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).processing) {
              _push2(`<span data-v-a8d11c23${_scopeId}>Menyimpan...</span>`);
            } else {
              _push2(`<span data-v-a8d11c23${_scopeId}>Simpan Pelanggan</span>`);
            }
...
const Create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a8d11c23"]]);
export {
  Create as default
};
