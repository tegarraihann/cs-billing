  ...
  setup(__props) {
    ...
    const openAdditionalCostModal = (context = {}) => {
      ...
      additionalCostContext.value = {
        ...
        vendorId: context.vendorId ? String(context.vendorId) : props.payable.vendor_id ? String(props.payable.vendor_id) : "",
                                      ...
                                      createVNode("button", {
                                        ...
                                        onClick: ($event) => {
                                          ...
                                          return openAdditionalCostModal({
                                            ...
                                            categoryId: ((_a3 = component.related_items) == null ? void 0 : _a3.category_id) || "",
                                            vendorId: component.vendor_id ? String(component.vendor_id) : __props.payable.vendor_id ? String(__props.payable.vendor_id) : "",
                                            fromComponent: true
                                          });
                                        }
                                      }, [
