import { reactive, computed, ref, withCtx, unref, createVNode, createTextVNode, createBlock, createCommentVNode, toDisplayString, withDirectives, vModelText, vModelSelect, openBlock, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentIndexQuery = computed(() => {
      var _a;
      const query = {
        period: formFilters.period || void 0,
        category: formFilters.category || void 0,
        status: formFilters.status || void 0,
        expense_date: formFilters.expense_date || void 0
      };
      const currentPage = (_a = props.expenses) == null ? void 0 : _a.current_page;
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_g = __props.expenses) == null ? void 0 : _g.links) && __props.expenses.links.length > 3) {
              _push2(`<div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(((_h = __props.expenses) == null ? void 0 : _h.from) ?? 0)} to ${ssrInterpolate(((_i = __props.expenses) == null ? void 0 : _i.to) ?? 0)} of ${ssrInterpolate(((_j = __props.expenses) == null ? void 0 : _j.total) ?? 0)} expenses </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    ...
                    ((_s = __props.expenses) == null ? void 0 : _s.links) && __props.expenses.links.length > 3 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(((_t = __props.expenses) == null ? void 0 : _t.from) ?? 0) + " to " + toDisplayString(((_u = __props.expenses) == null ? void 0 : _u.to) ?? 0) + " of " + toDisplayString(((_v = __props.expenses) == null ? void 0 : _v.total) ?? 0) + " expenses ", 1),
