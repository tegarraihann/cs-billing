import { ref, computed, reactive, withCtx, unref, createVNode, createTextVNode, toDisplayString, withDirectives, vModelText, createBlock, openBlock, Fragment, renderList, vModelSelect, createCommentVNode, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentIndexQuery = computed(() => {
      ...
      const currentPage = (_a2 = props.otherIncomes) == null ? void 0 : _a2.current_page;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Other Income" }, null, _parent2, _scopeId));
            ...
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="flex justify-between items-center mb-6"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Other Income</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Manage income outside logistics services</p></div>`);
            ...
            _push2(`</div><div class="ml-5 w-0 flex-1"${_scopeId}><dl${_scopeId}><dt class="text-sm font-medium text-gray-500 truncate"${_scopeId}>Total Overall</dt><dd class="text-lg font-medium text-gray-900"${_scopeId}>${ssrInterpolate(formatCurrency(__props.summary.total_amount))}</dd></dl></div></div></div></div><div class="bg-white overflow-hidden shadow rounded-lg"${_scopeId}><div class="p-5"${_scopeId}><div class="flex items-center"${_scopeId}><div class="flex-shrink-0"${_scopeId}>`);
            ...
            _push2(`<!--]--></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Receivable Status</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(filterForm.value.status) ? ssrLooseContain(filterForm.value.status, "") : ssrLooseEqual(filterForm.value.status, "")) ? " selected" : ""}${_scopeId}>All</option><!--[-->`);
            ...
            _push2(`<!--]--></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Posting Status</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(filterForm.value.posted) ? ssrLooseContain(filterForm.value.posted, "") : ssrLooseEqual(filterForm.value.posted, "")) ? " selected" : ""}${_scopeId}>All</option><option value="yes"${ssrIncludeBooleanAttr(Array.isArray(filterForm.value.posted) ? ssrLooseContain(filterForm.value.posted, "yes") : ssrLooseEqual(filterForm.value.posted, "yes")) ? " selected" : ""}${_scopeId}>Posted</option><option value="no"${ssrIncludeBooleanAttr(Array.isArray(filterForm.value.posted) ? ssrLooseContain(filterForm.value.posted, "no") : ssrLooseEqual(filterForm.value.posted, "no")) ? " selected" : ""}${_scopeId}>Pending</option></select></div></div><div class="mt-4 flex space-x-2"${_scopeId}><button class="inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-700 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Filter), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            _push2(` Apply Filters </button><button class="inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(X), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            _push2(` Reset </button></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md"${_scopeId}><div class="px-4 py-5 sm:p-6"${_scopeId}><div class="overflow-x-auto"${_scopeId}><table class="min-w-full divide-y divide-gray-200"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Date / Due </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Reference / Customer </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Category &amp; Description </th><th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Amount </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Status </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Created By </th><th scope="col" class="relative px-6 py-3"${_scopeId}><span class="sr-only"${_scopeId}>Actions</span></th></tr></thead><tbody class="bg-white divide-y divide-gray-200"${_scopeId}><!--[-->`);
            ssrRenderList(__props.otherIncomes.data, (income) => {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("admin-keuangan.other-incomes.show", {
                  otherIncome: income.id,
                  ...currentIndexQuery.value
                }),
              ...
              if (!income.posted_to_profit_loss) {
                _push2(`<button class="text-green-600 hover:text-green-900 p-2 rounded-md hover:bg-green-50" title="Post to Profit &amp; Loss"${_scopeId}>`);
              ...
              if (income.posted_to_profit_loss) {
                _push2(`<button class="text-orange-600 hover:text-orange-900 p-2 rounded-md hover:bg-orange-50" title="Unpost from Profit &amp; Loss"${_scopeId}>`);
            ...
            if (__props.otherIncomes.data.length === 0) {
              ...
              _push2(`<h3 class="mt-2 text-sm font-medium text-gray-900"${_scopeId}>No other income yet</h3><p class="mt-1 text-sm text-gray-500"${_scopeId}>Get started by adding your first other income</p><div class="mt-6"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("admin-keuangan.other-incomes.create"),
            ...
            if (__props.otherIncomes.links && __props.otherIncomes.data.length > 0) {
              _push2(`<div class="mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(__props.otherIncomes.from || 0)} to ${ssrInterpolate(__props.otherIncomes.to || 0)} of ${ssrInterpolate(__props.otherIncomes.total || 0)} results </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
              ssrRenderList(__props.otherIncomes.links, (link) => {
                _push2(`<!--[-->`);
                if (link.url) {
            ...
            return [
              createVNode(unref(Head), { title: "Other Income" }),
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Other Income"),
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Manage income outside logistics services")
                    ]),
                      ...
                      createVNode("div", { class: "p-5" }, [
                        createVNode("div", { class: "flex items-center" }, [
                          ...
                          createVNode("div", { class: "ml-5 w-0 flex-1" }, [
                            createVNode("dl", null, [
                              createVNode("dt", { class: "text-sm font-medium text-gray-500 truncate" }, "Total Overall"),
                  ...
                  createVNode("div", { class: "bg-white shadow rounded-lg mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-5 gap-4" }, [
                        ...
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-2" }, "Receivable Status"),
                          withDirectives(createVNode("select", {
                        ...
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-2" }, "Posting Status"),
                          withDirectives(createVNode("select", {
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      ...
                      __props.otherIncomes.data.length === 0 ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("h3", { class: "mt-2 text-sm font-medium text-gray-900" }, "No other income yet"),
                        createVNode("p", { class: "mt-1 text-sm text-gray-500" }, "Get started by adding your first other income"),
                      ...
                      __props.otherIncomes.links && __props.otherIncomes.data.length > 0 ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(__props.otherIncomes.from || 0) + " to " + toDisplayString(__props.otherIncomes.to || 0) + " of " + toDisplayString(__props.otherIncomes.total || 0) + " results ", 1),
                          createVNode("div", { class: "flex space-x-1" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(__props.otherIncomes.links, (link) => {
