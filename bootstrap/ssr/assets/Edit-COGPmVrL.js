    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Edit Package Unit" }, null, _parent2, _scopeId));
            ...
            return [
              createVNode(unref(Head), { title: "Edit Package Unit" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Edit Package Unit"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Edit package unit " + toDisplayString(__props.packageUnit.code), 1)
                  ]),
