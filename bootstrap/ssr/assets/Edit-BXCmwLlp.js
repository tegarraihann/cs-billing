        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), {
              title: "Edit Gaji - " + __props.salary.employee_name
            ...
            _push2(`<h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Edit Gaji Karyawan</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Edit data gaji ${ssrInterpolate(__props.salary.employee_name)}</p></div><div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl"${_scopeId}><div class="px-6 py-8"${_scopeId}><form${_scopeId}><div class="grid grid-cols-1 gap-6"${_scopeId}><div class="border-b border-gray-200 pb-6"${_scopeId}><h3 class="text-lg font-medium leading-6 text-gray-900 mb-4"${_scopeId}>Informasi Karyawan</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}><div class="md:col-span-2"${_scopeId}><label for="employee_source" class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Pilih Karyawan (opsional) </label><select id="employee_source" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(selectedEmployeeId.value) ? ssrLooseContain(selectedEmployeeId.value, "") : ssrLooseEqual(selectedEmployeeId.value, "")) ? " selected" : ""}${_scopeId}>Pilih karyawan dari master admin</option><!--[-->`);
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Menyimpan..." : "Update Gaji")}</button></div></form></div></div><div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-md p-4"${_scopeId}><div class="flex"${_scopeId}><div class="flex-shrink-0"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(AlertTriangle), { class: "h-5 w-5 text-yellow-400" }, null, _parent2, _scopeId));
            _push2(`</div><div class="ml-3"${_scopeId}><h3 class="text-sm font-medium text-yellow-800"${_scopeId}>Peringatan</h3><div class="mt-2 text-sm text-yellow-700"${_scopeId}><ul class="list-disc list-inside space-y-1"${_scopeId}><li${_scopeId}>Hanya gaji dengan status &quot;Draft&quot; yang dapat diedit</li><li${_scopeId}>Setelah gaji di-approve, data tidak dapat lagi diubah</li><li${_scopeId}>Pastikan semua data sudah benar sebelum menyimpan</li></ul></div></div></div></div></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Edit Gaji Karyawan"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Edit data gaji " + toDisplayString(__props.salary.employee_name), 1)
                  ]),
                      ...
                      createVNode("form", {
                            ...
                            createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                              createVNode("div", { class: "md:col-span-2" }, [
                                ...
                                withDirectives(createVNode("select", {
                                  ...
                                  createVNode("option", { value: "" }, "Pilih karyawan dari master admin"),
                                ...
                                createVNode("p", { class: "mt-1 text-xs text-gray-500" }, " Mengisi otomatis Nama, ID, dan Jabatan dari data karyawan. ")
                              ]),
                        ...
                        createVNode("div", { class: "mt-8 flex justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            createTextVNode(" " + toDisplayString(processing.value ? "Menyimpan..." : "Update Gaji"), 1)
                          ], 8, ["disabled"])
                        ])
                      ], 32)
                    ])
                      ...
                      createVNode("div", { class: "ml-3" }, [
                        ...
                        createVNode("div", { class: "mt-2 text-sm text-yellow-700" }, [
                          createVNode("ul", { class: "list-disc list-inside space-y-1" }, [
                            createVNode("li", null, 'Hanya gaji dengan status "Draft" yang dapat diedit'),
                            createVNode("li", null, "Setelah gaji di-approve, data tidak dapat lagi diubah"),
                            createVNode("li", null, "Pastikan semua data sudah benar sebelum menyimpan")
                          ])
                        ])
                      ])
                    ])
