    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b;
          if (_push2) {
            _push2(`<div class="py-6" data-v-a3355cbc${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-a3355cbc${_scopeId}><div class="bg-white shadow rounded-lg mb-6" data-v-a3355cbc${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-a3355cbc${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-a3355cbc${_scopeId}><div data-v-a3355cbc${_scopeId}><h1 class="text-2xl font-semibold text-gray-900" data-v-a3355cbc${_scopeId}>Vendor Master Data</h1><p class="mt-1 text-sm text-gray-600" data-v-a3355cbc${_scopeId}>Manage vendor records for transactions</p></div><div class="mt-4 sm:mt-0 flex space-x-3" data-v-a3355cbc${_scopeId}><button class="inline-flex items-center px-4 py-2 bg-sage-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2" data-v-a3355cbc${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-a3355cbc${_scopeId}><div class="px-6 py-4" data-v-a3355cbc${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-a3355cbc${_scopeId}><div data-v-a3355cbc${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-a3355cbc${_scopeId}>Search</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Search vendor name, contact, phone, email, office, account number, account name, NIB..." class="block w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500 sm:text-sm" data-v-a3355cbc${_scopeId}></div><div class="flex items-end" data-v-a3355cbc${_scopeId}><button class="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-sage-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-500" data-v-a3355cbc${_scopeId}> Search </button></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-a3355cbc${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-a3355cbc${_scopeId}><h3 class="text-lg font-medium text-gray-900" data-v-a3355cbc${_scopeId}>Vendor List</h3><p class="mt-1 text-sm text-gray-600" data-v-a3355cbc${_scopeId}> Total: ${ssrInterpolate(((_a2 = __props.vendors) == null ? void 0 : _a2.total) || 0)} records </p></div><div class="overflow-x-auto" data-v-a3355cbc${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-a3355cbc${_scopeId}><thead class="bg-gray-50" data-v-a3355cbc${_scopeId}><tr data-v-a3355cbc${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> ID </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Vendor Name </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Contact </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Phone </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Email </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Office Phone </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Account Number </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Account Name </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> NIB </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Document Status </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Created Date </th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-a3355cbc${_scopeId}> Delete </th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-a3355cbc${_scopeId}><!--[-->`);
            ssrRenderList(__props.vendors.data, (vendor) => {
              _push2(`<tr class="hover:bg-gray-50 cursor-pointer" data-v-a3355cbc${_scopeId}><td class="px-6 py-4 text-sm font-medium text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.id)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.nama_vendor)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.pic || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.no_hp || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.email || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.no_kantor || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.nomor_rekening)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.nama_rekening)}</td><td class="px-6 py-4 text-sm text-gray-900 font-mono" data-v-a3355cbc${_scopeId}>${ssrInterpolate(vendor.nib || "-")}</td><td class="px-6 py-4 text-sm" data-v-a3355cbc${_scopeId}><div class="flex space-x-1" data-v-a3355cbc${_scopeId}>`);
              if (vendor.photo_path) {
                _push2(`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800" data-v-a3355cbc${_scopeId}> Photo </span>`);
              } else {
                _push2(`<!---->`);
              }
              if (vendor.legal_document_path) {
                _push2(`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" data-v-a3355cbc${_scopeId}> Legal </span>`);
              } else {
                _push2(`<!---->`);
              }
              if (!vendor.photo_path && !vendor.legal_document_path) {
                _push2(`<span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800" data-v-a3355cbc${_scopeId}> None </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td><td class="px-6 py-4 text-sm text-gray-900" data-v-a3355cbc${_scopeId}>${ssrInterpolate(formatDate(vendor.created_at))}</td><td class="px-6 py-4 whitespace-nowrap text-sm font-medium" data-v-a3355cbc${_scopeId}><button class="text-red-600 hover:text-red-900 p-2 rounded-md hover:bg-red-50" title="Delete Vendor" data-v-a3355cbc${_scopeId}>`);
            ...
            if (!__props.vendors.data || __props.vendors.data.length === 0) {
              _push2(`<tr data-v-a3355cbc${_scopeId}><td colspan="12" class="px-6 py-12 text-center" data-v-a3355cbc${_scopeId}><div class="flex flex-col items-center" data-v-a3355cbc${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Users), { class: "h-12 w-12 text-gray-300 mb-4" }, null, _parent2, _scopeId));
              _push2(`<h3 class="text-sm font-medium text-gray-900 mb-1" data-v-a3355cbc${_scopeId}>No vendor data</h3><p class="text-sm text-gray-500" data-v-a3355cbc${_scopeId}>There are no vendor records yet</p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div>`);
            if (__props.vendors.last_page > 1) {
              _push2(`<div class="bg-white px-6 py-3 border-t border-gray-200" data-v-a3355cbc${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a3355cbc"]]);
export {
  Index as default
};
