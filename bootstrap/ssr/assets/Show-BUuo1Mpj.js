      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="mb-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Bank ${ssrInterpolate(__props.bank.bank_name)} Details</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}> Detail saldo dan transaksi bank ${ssrInterpolate(__props.bank.bank_name)}</p></div><div class="flex items-center space-x-2"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("admin-keuangan.bank-balance.export-pdf", __props.bank.id))} class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-offset-2" target="_blank" rel="noopener noreferrer"${_scopeId}>`);
            ...
            _push2(` Setor Modal </button></div></div>`);
                    ...
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "flex flex-col sm:flex-row sm:items-end sm:space-x-3 space-y-3 sm:space-y-0" }, [
                        createVNode("div", { class: "w-full sm:w-32" }, [
                          createVNode("label", { class: "block text-xs font-medium text-gray-600 mb-1" }, "Tanggal"),
                        ...
                        createVNode("div", { class: "w-full sm:w-40" }, [
                          createVNode("label", { class: "block text-xs font-medium text-gray-600 mb-1" }, "Jumlah Setoran"),
                          withDirectives(createVNode("input", {
                        ...
                        createVNode("div", { class: "w-full sm:w-48" }, [
                          createVNode("label", { class: "block text-xs font-medium text-gray-600 mb-1" }, "Catatan (opsional)"),
                          withDirectives(createVNode("input", {
                            "onUpdate:modelValue": ($event) => unref(capitalForm).notes = $event,
                            type: "text",
                            class: "w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 text-sm",
                            placeholder: "Mis: Setor modal pemegang saham"
                          }, null, 8, ["onUpdate:modelValue"]), [
