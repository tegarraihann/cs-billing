    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-6" data-v-ed902170${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-ed902170${_scopeId}><div class="bg-white shadow rounded-lg mb-6" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-ed902170${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-ed902170${_scopeId}><div class="flex items-center" data-v-ed902170${_scopeId}><div class="w-12 h-12 bg-sage-800 rounded-full flex items-center justify-center mr-4" data-v-ed902170${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Plus), { class: "w-6 h-6 text-white" }, null, _parent2, _scopeId));
            _push2(`</div><div data-v-ed902170${_scopeId}><h1 class="text-2xl font-semibold text-gray-900" data-v-ed902170${_scopeId}>Buat Sales Order Baru</h1><p class="mt-1 text-sm text-gray-600" data-v-ed902170${_scopeId}>Buat dokumen sales order untuk pelanggan</p></div></div><div class="mt-4 sm:mt-0 flex space-x-3" data-v-ed902170${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-gray-200" data-v-ed902170${_scopeId}><h3 class="text-lg font-medium text-gray-900" data-v-ed902170${_scopeId}>Form Sales Order Baru</h3><p class="mt-1 text-sm text-gray-600" data-v-ed902170${_scopeId}>Lengkapi informasi sales order dengan benar</p></div><div class="p-6" data-v-ed902170${_scopeId}><form class="space-y-6" data-v-ed902170${_scopeId}><div class="bg-white shadow overflow-hidden sm:rounded-lg" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-gray-200 bg-gray-50" data-v-ed902170${_scopeId}><h3 class="text-lg font-medium text-gray-900" data-v-ed902170${_scopeId}>Pilih Metode Input</h3></div><div class="p-6" data-v-ed902170${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="flex items-center" data-v-ed902170${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(inputMethod.value, "manual")) ? " checked" : ""} value="manual" class="mr-3 text-sage-600 focus:ring-sage-500" data-v-ed902170${_scopeId}><span class="text-sm font-medium text-sage-700" data-v-ed902170${_scopeId}>Input Manual</span></label><p class="text-xs text-sage-500 mt-1 ml-6" data-v-ed902170${_scopeId}>Isi semua data secara manual</p></div><div data-v-ed902170${_scopeId}><label class="flex items-center" data-v-ed902170${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(inputMethod.value, "customer")) ? " checked" : ""} value="customer" class="mr-3 text-sage-600 focus:ring-sage-500" data-v-ed902170${_scopeId}><span class="text-sm font-medium text-sage-700" data-v-ed902170${_scopeId}>Berdasarkan Data Pelanggan</span></label><p class="text-xs text-sage-500 mt-1 ml-6" data-v-ed902170${_scopeId}>Auto-fill dari data pelanggan</p></div></div>`);
            if (inputMethod.value === "customer") {
              _push2(`<div class="mt-4" data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>Pilih Pelanggan</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}><option value="" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(selectedCustomerId.value) ? ssrLooseContain(selectedCustomerId.value, "") : ssrLooseEqual(selectedCustomerId.value, "")) ? " selected" : ""}${_scopeId}>-- Pilih Pelanggan --</option><!--[-->`);
              ssrRenderList(__props.customers, (customer) => {
                _push2(`<option${ssrRenderAttr("value", customer.id)} data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(selectedCustomerId.value) ? ssrLooseContain(selectedCustomerId.value, customer.id) : ssrLooseEqual(selectedCustomerId.value, customer.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(customer.company_name)} - ${ssrInterpolate(customer.pic_name)}</option>`);
              });
              _push2(`<!--]--></select></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Informasi Dasar</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.basic }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.basic ? null : { display: "none" })}" class="p-6 space-y-4" data-v-ed902170${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>ORDER NUMB <span class="text-red-500" data-v-ed902170${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).order_number)} type="text" required readonly placeholder="EWILOG2509001001" class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.order_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.order_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>REF NO</label><input${ssrRenderAttr("value", unref(form).ref_no)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.ref_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.ref_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>DATE</label><input${ssrRenderAttr("value", unref(form).so_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.so_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.so_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>CUSTOMER <span class="text-red-500" data-v-ed902170${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).customer)} type="text" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.customer) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.customer)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>SHIPPER</label><input${ssrRenderAttr("value", unref(form).shipper)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.shipper) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.shipper)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Informasi Pengiriman</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.shipping }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.shipping ? null : { display: "none" })}" class="p-6 space-y-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>BL/AWB</label><input${ssrRenderAttr("value", unref(form).bl_awb)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.bl_awb) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.bl_awb)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>LINER</label><input${ssrRenderAttr("value", unref(form).liner)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.liner) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.liner)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>VESSEL</label><input${ssrRenderAttr("value", unref(form).vessel)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.vessel) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.vessel)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>ETA</label><input${ssrRenderAttr("value", unref(form).eta)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.eta) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.eta)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>ETD</label><input${ssrRenderAttr("value", unref(form).etd)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.etd) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.etd)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>AJU</label><input${ssrRenderAttr("value", unref(form).aju)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.aju) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.aju)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>SPPB DATE</label><input${ssrRenderAttr("value", unref(form).sppb_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.sppb_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.sppb_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>SHIPMENT TYPE</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}><option value="" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, "") : ssrLooseEqual(unref(form).shipment_type, "")) ? " selected" : ""}${_scopeId}>Pilih Shipment Type</option><!--[-->`);
            ssrRenderList(__props.shipmentTypes, (shipmentType) => {
              _push2(`<option${ssrRenderAttr("value", shipmentType.code)} data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, shipmentType.code) : ssrLooseEqual(unref(form).shipment_type, shipmentType.code)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(shipmentType.name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (unref(form).errors.shipment_type) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.shipment_type)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>POL</label><input${ssrRenderAttr("value", unref(form).pol)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.pol) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.pol)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>POD</label><input${ssrRenderAttr("value", unref(form).pod)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.pod) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.pod)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>GUDANG/UTC</label><input${ssrRenderAttr("value", unref(form).gudang_utc)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.gudang_utc) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.gudang_utc)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>PARTY/LCL</label><input${ssrRenderAttr("value", unref(form).party_lcl)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.party_lcl) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.party_lcl)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>PREPARED BY</label><input${ssrRenderAttr("value", unref(form).prepared_by)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.prepared_by) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.prepared_by)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>EXCHANGE RATE</label><input${ssrRenderAttr("value", unref(form).exchange_rate)} type="number" step="0.0001" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.exchange_rate) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.exchange_rate)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Informasi Pricing</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.pricing }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.pricing ? null : { display: "none" })}" class="p-6 space-y-6" data-v-ed902170${_scopeId}><div class="bg-gray-50 rounded-lg p-4" data-v-ed902170${_scopeId}><div class="flex justify-between items-center mb-4" data-v-ed902170${_scopeId}><h4 class="text-md font-semibold text-sage-800" data-v-ed902170${_scopeId}>Rincian Vendor (Buying &amp; Selling)</h4><button type="button" class="text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-ed902170${_scopeId}> + Tambah Vendor </button></div><!--[-->`);
            ssrRenderList(unref(form).vendor_breakdown, (item, index) => {
              _push2(`<div class="border border-sage-200 rounded-lg p-4 mb-4 space-y-4" data-v-ed902170${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-ed902170${_scopeId}><div class="col-span-11" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>Nama Vendor</label><select class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}><option value="" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, "") : ssrLooseEqual(item.vendor_id, "")) ? " selected" : ""}${_scopeId}>Pilih vendor...</option><!--[-->`);
              ssrRenderList(__props.vendors, (vendorOption) => {
                _push2(`<option${ssrRenderAttr("value", vendorOption.id)} data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, vendorOption.id) : ssrLooseEqual(item.vendor_id, vendorOption.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendorOption.nama_vendor)}</option>`);
              });
              _push2(`<!--]--></select></div><div class="col-span-1" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-transparent mb-1" data-v-ed902170${_scopeId}>Del</label><button type="button" class="w-full h-10 text-red-600 hover:text-red-900 hover:bg-red-100 rounded transition-colors" data-v-ed902170${_scopeId}> × </button></div></div><div class="grid grid-cols-2 gap-3" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>Deskripsi Service / Jenis Biaya</label><select class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}><option value="" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "") : ssrLooseEqual(item.description, "")) ? " selected" : ""}${_scopeId}>Pilih Jenis Biaya</option><option value="OF/AF" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "OF/AF") : ssrLooseEqual(item.description, "OF/AF")) ? " selected" : ""}${_scopeId}>OF/AF</option><option value="HANDLING" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "HANDLING") : ssrLooseEqual(item.description, "HANDLING")) ? " selected" : ""}${_scopeId}>HANDLING</option><option value="PIB EDI" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "PIB EDI") : ssrLooseEqual(item.description, "PIB EDI")) ? " selected" : ""}${_scopeId}>PIB EDI</option><option value="ADMIN DOC" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "ADMIN DOC") : ssrLooseEqual(item.description, "ADMIN DOC")) ? " selected" : ""}${_scopeId}>ADMIN DOC</option><option value="TRUCKING" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "TRUCKING") : ssrLooseEqual(item.description, "TRUCKING")) ? " selected" : ""}${_scopeId}>TRUCKING</option><option value="D/O CHARGES" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "D/O CHARGES") : ssrLooseEqual(item.description, "D/O CHARGES")) ? " selected" : ""}${_scopeId}>D/O CHARGES</option><option value="LOLO" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "LOLO") : ssrLooseEqual(item.description, "LOLO")) ? " selected" : ""}${_scopeId}>LOLO</option><option value="STORAGE" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "STORAGE") : ssrLooseEqual(item.description, "STORAGE")) ? " selected" : ""}${_scopeId}>STORAGE</option><option value="REFUND" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "REFUND") : ssrLooseEqual(item.description, "REFUND")) ? " selected" : ""}${_scopeId}>REFUND</option><option value="OTHER" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "OTHER") : ssrLooseEqual(item.description, "OTHER")) ? " selected" : ""}${_scopeId}>OTHER</option></select></div><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>RCVD INV</label><input${ssrRenderAttr("value", item.rcvd_inv)} type="text" placeholder="Nomor invoice yang diterima" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}></div></div><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>Remarks (Individual)</label><input${ssrRenderAttr("value", item.remarks)} type="text" placeholder="Catatan khusus untuk item ini" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}></div><div class="grid grid-cols-3 gap-3 p-3 bg-blue-50 rounded-lg" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-blue-700 mb-1" data-v-ed902170${_scopeId}>Buying Amount (Cost)</label><input${ssrRenderAttr("value", item.buying_amount)} type="number" step="0.01" placeholder="0.00" class="w-full px-3 py-2 border border-blue-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500" data-v-ed902170${_scopeId}></div><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-green-700 mb-1" data-v-ed902170${_scopeId}>Selling Amount (Revenue)</label><input${ssrRenderAttr("value", item.selling_amount)} type="number" step="0.01" placeholder="0.00" class="w-full px-3 py-2 border border-green-300 rounded focus:ring-2 focus:ring-green-500 focus:border-green-500" data-v-ed902170${_scopeId}></div><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-ed902170${_scopeId}>Revenue</label><p class="${ssrRenderClass([getProfit(item) >= 0 ? "text-green-600" : "text-red-600", "px-3 py-2 bg-white border border-purple-300 rounded text-sm font-semibold"])}" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(getProfit(item)))}</p></div></div>`);
              if (item.vendor_id) {
                _push2(`<div class="grid grid-cols-3 gap-3 p-3 bg-sage-50 rounded-lg" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>Nama Vendor</label><p class="text-sm text-gray-900" data-v-ed902170${_scopeId}>${ssrInterpolate(item.nama_vendor || "-")}</p></div><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>Nomor Rekening</label><p class="text-sm text-gray-900 font-mono" data-v-ed902170${_scopeId}>${ssrInterpolate(item.no_rekening || "-")}</p></div><div data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-ed902170${_scopeId}>Nama Rekening</label><p class="text-sm text-gray-900" data-v-ed902170${_scopeId}>${ssrInterpolate(item.nama_rekening || "-")}</p></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--><div class="mt-4 pt-4 border-t border-gray-300 grid grid-cols-3 gap-4 text-center" data-v-ed902170${_scopeId}><div class="p-3 bg-blue-100 rounded-lg" data-v-ed902170${_scopeId}><p class="text-xs font-medium text-blue-700" data-v-ed902170${_scopeId}>Total Buying</p><p class="text-lg font-bold text-blue-800" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</p></div><div class="p-3 bg-green-100 rounded-lg" data-v-ed902170${_scopeId}><p class="text-xs font-medium text-green-700" data-v-ed902170${_scopeId}>Total Selling</p><p class="text-lg font-bold text-green-800" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</p></div><div class="${ssrRenderClass([totalRevenue.value >= 0 ? "bg-purple-100" : "bg-red-100", "p-3 rounded-lg"])}" data-v-ed902170${_scopeId}><p class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-purple-700" : "text-red-700", "text-xs font-medium"])}" data-v-ed902170${_scopeId}>Net Profit</p><p class="text-xs text-gray-500 mb-1" data-v-ed902170${_scopeId}>(Sudah dikurangi semua biaya)</p><p class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-purple-800" : "text-red-800", "text-lg font-bold"])}" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</p></div></div>`);
            if (unref(form).vendor_breakdown.length > 0) {
              _push2(`<div class="flex justify-center mt-6 pt-4 border-t border-gray-200" data-v-ed902170${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Tambah Vendor Lagi </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="bg-blue-50 rounded-lg p-4" data-v-ed902170${_scopeId}><h4 class="text-md font-semibold text-blue-800 mb-3" data-v-ed902170${_scopeId}>Ringkasan Revenue &amp; Profit</h4><div class="space-y-2" data-v-ed902170${_scopeId}><div class="flex justify-between" data-v-ed902170${_scopeId}><span data-v-ed902170${_scopeId}>Total Pemasukan (Selling):</span><span class="font-medium text-green-700" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</span></div><div class="flex justify-between" data-v-ed902170${_scopeId}><span data-v-ed902170${_scopeId}>Total Pengeluaran (Buying):</span><span class="font-medium text-red-700" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</span></div><div class="flex justify-between" data-v-ed902170${_scopeId}><span data-v-ed902170${_scopeId}>Biaya Operasional:</span><span class="font-medium text-orange-700" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalOtherCosts.value))}</span></div><div class="flex justify-between" data-v-ed902170${_scopeId}><span data-v-ed902170${_scopeId}>Total Reimbursement:</span><span class="font-medium text-purple-700" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalReimbursement.value))}</span></div><div class="flex justify-between border-t border-blue-200 pt-2 mt-1" data-v-ed902170${_scopeId}><span class="text-sm font-medium text-gray-700" data-v-ed902170${_scopeId}>Total Pengeluaran Keseluruhan:</span><span class="text-sm font-bold text-red-800" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value + totalOtherCosts.value + totalReimbursement.value))}</span></div><div class="flex justify-between items-center pt-2 border-t border-blue-300 font-bold text-lg" data-v-ed902170${_scopeId}><span data-v-ed902170${_scopeId}>Net Profit:</span><span class="${ssrRenderClass(totalRevenue.value >= 0 ? "text-green-600" : "text-red-600")}" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</span></div></div></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>REMARKS</label><textarea rows="3" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).remarks)}</textarea>`);
            if (unref(form).errors.remarks) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.remarks)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>NOTE</label><textarea rows="3" placeholder="Catatan tambahan untuk sales order ini" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).note)}</textarea>`);
            if (unref(form).errors.note) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.note)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Biaya Beban Lain (Operational)</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.other_costs }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.other_costs ? null : { display: "none" })}" class="p-6" data-v-ed902170${_scopeId}><div class="bg-orange-50 rounded-lg p-4" data-v-ed902170${_scopeId}><div class="flex justify-between items-center mb-4" data-v-ed902170${_scopeId}><h4 class="text-md font-semibold text-orange-800" data-v-ed902170${_scopeId}>Biaya Beban Lain (Operational)</h4><button type="button" class="text-sm bg-orange-600 text-white px-3 py-1 rounded hover:bg-orange-700 transition-colors" data-v-ed902170${_scopeId}> + Tambah Biaya </button></div>`);
            if (unref(form).other_costs && unref(form).other_costs.length > 0) {
              _push2(`<div class="space-y-3" data-v-ed902170${_scopeId}><!--[-->`);
              ssrRenderList(unref(form).other_costs, (cost, index) => {
                _push2(`<div class="border border-orange-200 rounded-lg p-3 bg-white" data-v-ed902170${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-ed902170${_scopeId}><div class="col-span-5" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-ed902170${_scopeId}>Deskripsi Biaya</label><input${ssrRenderAttr("value", cost.description)} type="text" placeholder="Contoh: Biaya handling, dokumen, dll" class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-ed902170${_scopeId}></div><div class="col-span-3" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-ed902170${_scopeId}>Jumlah Biaya</label><input${ssrRenderAttr("value", cost.amount)} type="number" min="0" step="0.01" placeholder="0" class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-ed902170${_scopeId}></div><div class="col-span-3" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-ed902170${_scopeId}>Kategori</label><select class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-ed902170${_scopeId}><option value="" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(cost.category) ? ssrLooseContain(cost.category, "") : ssrLooseEqual(cost.category, "")) ? " selected" : ""}${_scopeId}>Pilih kategori</option><!--[-->`);
                ssrRenderList(__props.operationalCostCategories, (category) => {
                  _push2(`<option${ssrRenderAttr("value", category.name)}${ssrRenderAttr("title", category.description)} data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(cost.category) ? ssrLooseContain(cost.category, category.name) : ssrLooseEqual(cost.category, category.name)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(category.name)}</option>`);
                });
                _push2(`<!--]--></select></div><div class="col-span-1 flex items-end" data-v-ed902170${_scopeId}><button type="button" class="w-full px-2 py-1 text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors"${ssrIncludeBooleanAttr(unref(form).other_costs.length <= 1) ? " disabled" : ""} data-v-ed902170${_scopeId}><svg class="w-4 h-4 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-ed902170${_scopeId}></path></svg></button></div></div></div>`);
              });
              _push2(`<!--]--><div class="pt-3 border-t border-orange-300" data-v-ed902170${_scopeId}><div class="flex justify-between items-center" data-v-ed902170${_scopeId}><span class="text-sm font-medium text-orange-700" data-v-ed902170${_scopeId}>Total Biaya Beban Lain:</span><span class="text-lg font-bold text-orange-800" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalOtherCosts.value))}</span></div></div><div class="flex justify-center mt-6 pt-4 border-t border-orange-200" data-v-ed902170${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Tambah Biaya Lagi </button></div></div>`);
            } else {
              _push2(`<div class="text-center py-4 text-orange-600" data-v-ed902170${_scopeId}><p class="text-sm" data-v-ed902170${_scopeId}>Belum ada biaya beban lain</p><p class="text-xs text-orange-500" data-v-ed902170${_scopeId}>Klik tombol &quot;Tambah Biaya&quot; untuk menambahkan</p></div>`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Items Reimbursement</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.reimbursement }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.reimbursement ? null : { display: "none" })}" class="p-6" data-v-ed902170${_scopeId}><div class="bg-purple-50 rounded-lg p-4" data-v-ed902170${_scopeId}><div class="flex justify-between items-center mb-4" data-v-ed902170${_scopeId}><h4 class="text-md font-semibold text-purple-800" data-v-ed902170${_scopeId}>Items Reimbursement</h4><button type="button" class="text-sm bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-700 transition-colors" data-v-ed902170${_scopeId}> + Tambah Reimbursement </button></div>`);
            if (reimbursementItems.value && reimbursementItems.value.length > 0) {
              _push2(`<div class="space-y-3" data-v-ed902170${_scopeId}><!--[-->`);
              ssrRenderList(reimbursementItems.value, (item, index) => {
                _push2(`<div class="border border-purple-200 rounded-lg p-3 bg-white" data-v-ed902170${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-ed902170${_scopeId}><div class="col-span-4" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-ed902170${_scopeId}>Deskripsi</label><input${ssrRenderAttr("value", item.description)} type="text" placeholder="Contoh: Transport, Akomodasi, dll" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-ed902170${_scopeId}></div><div class="col-span-3" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-ed902170${_scopeId}>Jumlah</label><input${ssrRenderAttr("value", item.amount)} type="number" min="0" step="0.01" placeholder="0" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-ed902170${_scopeId}></div><div class="col-span-3" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-ed902170${_scopeId}>Kategori</label><select class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-ed902170${_scopeId}><option value="" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "") : ssrLooseEqual(item.category, "")) ? " selected" : ""}${_scopeId}>Pilih kategori</option><option value="transport" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "transport") : ssrLooseEqual(item.category, "transport")) ? " selected" : ""}${_scopeId}>Transport</option><option value="accommodation" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "accommodation") : ssrLooseEqual(item.category, "accommodation")) ? " selected" : ""}${_scopeId}>Akomodasi</option><option value="meal" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "meal") : ssrLooseEqual(item.category, "meal")) ? " selected" : ""}${_scopeId}>Makan</option><option value="fuel" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "fuel") : ssrLooseEqual(item.category, "fuel")) ? " selected" : ""}${_scopeId}>BBM</option><option value="parking" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "parking") : ssrLooseEqual(item.category, "parking")) ? " selected" : ""}${_scopeId}>Parkir</option><option value="toll" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "toll") : ssrLooseEqual(item.category, "toll")) ? " selected" : ""}${_scopeId}>Tol</option><option value="admin" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "admin") : ssrLooseEqual(item.category, "admin")) ? " selected" : ""}${_scopeId}>Admin</option><option value="communication" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "communication") : ssrLooseEqual(item.category, "communication")) ? " selected" : ""}${_scopeId}>Komunikasi</option><option value="equipment" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "equipment") : ssrLooseEqual(item.category, "equipment")) ? " selected" : ""}${_scopeId}>Peralatan</option><option value="general" data-v-ed902170${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "general") : ssrLooseEqual(item.category, "general")) ? " selected" : ""}${_scopeId}>Umum</option></select></div><div class="col-span-1 flex items-end" data-v-ed902170${_scopeId}><button type="button" class="w-full px-2 py-1 text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-ed902170${_scopeId}></path></svg></button></div></div><div class="mt-2" data-v-ed902170${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-ed902170${_scopeId}>Catatan (opsional)</label><textarea rows="2" placeholder="Catatan tambahan untuk item reimbursement ini" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500 resize-none" data-v-ed902170${_scopeId}>${ssrInterpolate(item.notes)}</textarea></div></div>`);
              });
              _push2(`<!--]--><div class="pt-3 border-t border-purple-300" data-v-ed902170${_scopeId}><div class="flex justify-between items-center" data-v-ed902170${_scopeId}><span class="text-sm font-medium text-purple-700" data-v-ed902170${_scopeId}>Total Reimbursement:</span><span class="text-lg font-bold text-purple-800" data-v-ed902170${_scopeId}>${ssrInterpolate(formatCurrency(totalReimbursement.value))}</span></div></div><div class="flex justify-center mt-6 pt-4 border-t border-purple-200" data-v-ed902170${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Tambah Reimbursement Lagi </button></div></div>`);
            } else {
              _push2(`<div class="text-center py-4 text-purple-600" data-v-ed902170${_scopeId}><p class="text-sm" data-v-ed902170${_scopeId}>Belum ada item reimbursement</p><p class="text-xs text-purple-500" data-v-ed902170${_scopeId}>Klik tombol &quot;Tambah Reimbursement&quot; untuk menambahkan</p></div>`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Informasi Barang</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.goods }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.goods ? null : { display: "none" })}" class="p-6 space-y-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>COMMODITY/URAIAN BARANG</label><textarea rows="3" placeholder="Masukkan uraian barang/commodity yang detail" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).commodity)}</textarea>`);
            if (unref(form).errors.commodity) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.commodity)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>QTY</label><input${ssrRenderAttr("value", unref(form).qty)} type="number" min="0" placeholder="Masukkan quantity" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.qty) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.qty)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>NET WEIGHT (KG)</label><input${ssrRenderAttr("value", unref(form).net_weight)} type="number" step="0.01" min="0" placeholder="Masukkan berat netto dalam kg" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.net_weight) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.net_weight)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>MEAS (M³)</label><input${ssrRenderAttr("value", unref(form).measurement)} type="number" step="0.001" min="0" placeholder="Masukkan volume dalam m³" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.measurement) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.measurement)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-ed902170${_scopeId}><div class="flex justify-between items-center mb-2" data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700" data-v-ed902170${_scopeId}>CONTAINER NO</label><button type="button" class="text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-ed902170${_scopeId}> + Tambah Container </button></div><!--[-->`);
            ssrRenderList(unref(form).container_no, (container, index) => {
              _push2(`<div class="flex gap-2 mb-2" data-v-ed902170${_scopeId}><input${ssrRenderAttr("value", unref(form).container_no[index])} type="text" placeholder="Masukkan nomor container (misal: TCLU1234567)" class="flex-1 px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
              if (unref(form).container_no.length > 1) {
                _push2(`<button type="button" class="px-3 py-2 text-red-600 hover:text-red-900 hover:bg-red-100 rounded-lg transition-colors" data-v-ed902170${_scopeId}> × </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (unref(form).errors.container_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.container_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).container_no.length > 0) {
              _push2(`<div class="flex justify-center mt-4 pt-4 border-t border-sage-200" data-v-ed902170${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Tambah Container Lagi </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Informasi Invoice</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.invoice }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.invoice ? null : { display: "none" })}" class="p-6 space-y-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>INVOICE NUMB</label><input${ssrRenderAttr("value", unref(form).invoice_number)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.invoice_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>INVOICE DATE</label><input${ssrRenderAttr("value", unref(form).invoice_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.invoice_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-ed902170${_scopeId}>T.O.P</label><input${ssrRenderAttr("value", unref(form).top)} type="text" placeholder="e.g., NET 30" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}>`);
            if (unref(form).errors.top) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-ed902170${_scopeId}>${ssrInterpolate(unref(form).errors.top)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-ed902170${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-ed902170${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-ed902170${_scopeId}>Voucher Management</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.voucher }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-ed902170${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.voucher ? null : { display: "none" })}" class="p-6 space-y-6" data-v-ed902170${_scopeId}><div class="space-y-4" data-v-ed902170${_scopeId}><div class="flex items-center justify-between" data-v-ed902170${_scopeId}><h4 class="text-md font-semibold text-sage-700" data-v-ed902170${_scopeId}>Payment Vouchers</h4><button type="button" class="inline-flex items-center px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Add Payment </button></div>`);
            if (paymentVouchers.value.length === 0) {
              _push2(`<div class="text-gray-500 text-center py-4 border-2 border-dashed border-gray-300 rounded-lg" data-v-ed902170${_scopeId}> No payment vouchers added yet </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(paymentVouchers.value, (voucher, index) => {
              _push2(`<div class="border border-gray-200 rounded-lg p-4 space-y-3" data-v-ed902170${_scopeId}><div class="flex justify-between items-center" data-v-ed902170${_scopeId}><h5 class="font-medium text-gray-700" data-v-ed902170${_scopeId}>Payment Voucher #${ssrInterpolate(index + 1)}</h5><button type="button" class="text-red-600 hover:text-red-800" data-v-ed902170${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-ed902170${_scopeId}></path></svg></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Voucher No</label><input${ssrRenderAttr("value", voucher.voucher_no)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="e.g., PAY-001" data-v-ed902170${_scopeId}></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Date</label><input${ssrRenderAttr("value", voucher.date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}></div></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Description</label><textarea rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" placeholder="e.g., Biaya Driver" data-v-ed902170${_scopeId}>${ssrInterpolate(voucher.description)}</textarea></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Amount</label><input${ssrRenderAttr("value", voucher.amount)} type="number" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="500000" data-v-ed902170${_scopeId}></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Prepared By</label><input${ssrRenderAttr("value", voucher.prepared_by)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="Staff name" data-v-ed902170${_scopeId}></div></div></div>`);
            });
            _push2(`<!--]-->`);
            if (paymentVouchers.value.length > 0) {
              _push2(`<div class="flex justify-center mt-6 pt-4 border-t border-blue-200" data-v-ed902170${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Add Payment Lagi </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="space-y-4" data-v-ed902170${_scopeId}><div class="flex items-center justify-between" data-v-ed902170${_scopeId}><h4 class="text-md font-semibold text-sage-700" data-v-ed902170${_scopeId}>Receipt Vouchers</h4><button type="button" class="inline-flex items-center px-3 py-1 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Add Receipt </button></div>`);
            if (receiptVouchers.value.length === 0) {
              _push2(`<div class="text-gray-500 text-center py-4 border-2 border-dashed border-gray-300 rounded-lg" data-v-ed902170${_scopeId}> No receipt vouchers added yet </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(receiptVouchers.value, (voucher, index) => {
              _push2(`<div class="border border-gray-200 rounded-lg p-4 space-y-3" data-v-ed902170${_scopeId}><div class="flex justify-between items-center" data-v-ed902170${_scopeId}><h5 class="font-medium text-gray-700" data-v-ed902170${_scopeId}>Receipt Voucher #${ssrInterpolate(index + 1)}</h5><button type="button" class="text-red-600 hover:text-red-800" data-v-ed902170${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-ed902170${_scopeId}></path></svg></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Voucher No</label><input${ssrRenderAttr("value", voucher.voucher_no)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="e.g., REC-001" data-v-ed902170${_scopeId}></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Date</label><input${ssrRenderAttr("value", voucher.date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-ed902170${_scopeId}></div></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Description</label><textarea rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" placeholder="e.g., Payment received from client" data-v-ed902170${_scopeId}>${ssrInterpolate(voucher.description)}</textarea></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-ed902170${_scopeId}><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Amount</label><input${ssrRenderAttr("value", voucher.amount)} type="number" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="1000000" data-v-ed902170${_scopeId}></div><div data-v-ed902170${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-ed902170${_scopeId}>Prepared By</label><input${ssrRenderAttr("value", voucher.prepared_by)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="Staff name" data-v-ed902170${_scopeId}></div></div></div>`);
            });
            _push2(`<!--]-->`);
            if (receiptVouchers.value.length > 0) {
              _push2(`<div class="flex justify-center mt-6 pt-4 border-t border-green-200" data-v-ed902170${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors" data-v-ed902170${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-ed902170${_scopeId}></path></svg> Add Receipt Lagi </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-3 pt-6" data-v-ed902170${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.sales-orders.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="inline-flex items-center justify-center px-6 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" data-v-ed902170${_scopeId}>`);
            if (unref(form).processing) {
              _push2(`<svg class="animate-spin -ml-1 mr-3 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" data-v-ed902170${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-ed902170${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-ed902170${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).processing) {
              _push2(`<span data-v-ed902170${_scopeId}>Menyimpan...</span>`);
            } else {
              _push2(`<span data-v-ed902170${_scopeId}>Simpan Sales Order</span>`);
            }
...
const Create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ed902170"]]);
export {
  Create as default
};
