                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(visibleSections.value, (section, sectionKey) => {
                      return openBlock(), createBlock("div", {
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(section.groups, (group) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "flex items-center justify-between" }, [
                                ...
                                createVNode("span", { class: "text-sm font-semibold text-gray-900" }, toDisplayString(sectionKey === "equity" ? "-" : formatCurrency(group.total)), 1)
                              ]),
                                ...
                                createVNode("table", { class: "min-w-full divide-y divide-gray-100" }, [
                                  ...
                                  createVNode("tfoot", null, [
                                    createVNode("tr", { class: "bg-gray-50" }, [
                                      ...
                                      createVNode("td", { class: "px-4 py-3 text-right text-sm font-semibold text-gray-900" }, toDisplayString(sectionKey === "equity" ? "-" : formatCurrency(group.total)), 1),
                                      createVNode("td")
                                    ])
                                  ])
                                ])
                        ...
                        createVNode("div", { class: "px-6 py-4 border-t border-sage-200 bg-sage-50 flex items-center justify-between" }, [
                          ...
                          createVNode("span", { class: "text-base font-bold text-sage-900" }, toDisplayString(sectionKey === "equity" ? "-" : formatCurrency(section.total)), 1)
                        ])
                      ]);
                    }), 128))
                  ])
