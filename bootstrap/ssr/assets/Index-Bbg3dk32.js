import { computed, withCtx, unref, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, toDisplayString, withDirectives, vModelText, vModelSelect, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const filterForm = useRemember({
      start_date: ((_a = props.filters) == null ? void 0 : _a.start_date) || currentMonthRange.value.start,
      end_date: ((_b = props.filters) == null ? void 0 : _b.end_date) || currentMonthRange.value.end,
    ...
    const currentIndexQuery = computed(() => {
      var _a2;
      const query = {
        start_date: filterForm.start_date || void 0,
        end_date: filterForm.end_date || void 0,
        type: filterForm.type || void 0,
        status: filterForm.status || void 0,
        opening: filterForm.opening !== "" ? filterForm.opening : void 0
      };
      const currentPage = (_a2 = props.entries) == null ? void 0 : _a2.current_page;
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="bg-white shadow rounded-lg mb-6"${_scopeId}><div class="px-4 py-5 sm:p-6"${_scopeId}><div class="grid grid-cols-1 md:grid-cols-5 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Start Date</label><input${ssrRenderAttr("value", unref(filterForm).start_date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>End Date</label><input${ssrRenderAttr("value", unref(filterForm).end_date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Type</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).type) ? ssrLooseContain(unref(filterForm).type, "") : ssrLooseEqual(unref(filterForm).type, "")) ? " selected" : ""}${_scopeId}>All Types</option><!--[-->`);
            ssrRenderList(__props.typeOptions, (option) => {
              _push2(`<option${ssrRenderAttr("value", option.value)}${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).type) ? ssrLooseContain(unref(filterForm).type, option.value) : ssrLooseEqual(unref(filterForm).type, option.value)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(option.label)}</option>`);
            });
            _push2(`<!--]--></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Status</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).status) ? ssrLooseContain(unref(filterForm).status, "") : ssrLooseEqual(unref(filterForm).status, "")) ? " selected" : ""}${_scopeId}>All</option><option value="recorded"${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).status) ? ssrLooseContain(unref(filterForm).status, "recorded") : ssrLooseEqual(unref(filterForm).status, "recorded")) ? " selected" : ""}${_scopeId}>Recorded</option><option value="settled"${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).status) ? ssrLooseContain(unref(filterForm).status, "settled") : ssrLooseEqual(unref(filterForm).status, "settled")) ? " selected" : ""}${_scopeId}>Settled</option></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}>Opening</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).opening) ? ssrLooseContain(unref(filterForm).opening, "") : ssrLooseEqual(unref(filterForm).opening, "")) ? " selected" : ""}${_scopeId}>All</option><option value="1"${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).opening) ? ssrLooseContain(unref(filterForm).opening, "1") : ssrLooseEqual(unref(filterForm).opening, "1")) ? " selected" : ""}${_scopeId}>Opening Only</option><option value="0"${ssrIncludeBooleanAttr(Array.isArray(unref(filterForm).opening) ? ssrLooseContain(unref(filterForm).opening, "0") : ssrLooseEqual(unref(filterForm).opening, "0")) ? " selected" : ""}${_scopeId}>Non-opening</option></select></div></div><div class="mt-4 flex items-center space-x-2"${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-sage-600 text-white text-xs font-semibold rounded-md hover:bg-sage-700 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2"${_scopeId}> Apply Filters </button><button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 text-xs font-semibold rounded-md text-gray-700 hover:bg-gray-50"${_scopeId}> Reset </button></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md"${_scopeId}>`);
            if (__props.entries.data.length) {
              ...
              ssrRenderList(__props.entries.data, (entry) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  href: _ctx.route("admin-keuangan.equity.show", { equityEntry: entry.id, ...currentIndexQuery.value }),
            ...
            _push2(`</div>`);
            if (__props.entries) {
              _push2(`<div class="mt-6 bg-white px-4 py-3 border border-gray-200 rounded-lg"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(__props.entries.from || 0)} to ${ssrInterpolate(__props.entries.to || 0)} of ${ssrInterpolate(__props.entries.total || 0)} results </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
              ssrRenderList(__props.entries.links, (link) => {
                _push2(`<!--[-->`);
                if (link.url) {
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                      ...
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-5 gap-4" }, [
                        ...
                        createVNode("div", null, [
                          ...
                          withDirectives(createVNode("select", {
                            "onUpdate:modelValue": ($event) => unref(filterForm).type = $event,
                            class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"
                          }, [
                            ...
                            [vModelSelect, unref(filterForm).type]
                          ])
                        ]),
                        createVNode("div", null, [
                        ...
                        createVNode("div", null, [
                          ...
                          withDirectives(createVNode("select", {
                            "onUpdate:modelValue": ($event) => unref(filterForm).opening = $event,
                            class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-sage-500 focus:border-sage-500"
                          }, [
                            createVNode("option", { value: "" }, "All"),
                            ...
                            [vModelSelect, unref(filterForm).opening]
                          ])
                        ])
                      ]),
                  ...
                  __props.entries ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(__props.entries.from || 0) + " to " + toDisplayString(__props.entries.to || 0) + " of " + toDisplayString(__props.entries.total || 0) + " results ", 1),
                      createVNode("div", { class: "flex space-x-1" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.entries.links, (link) => {
