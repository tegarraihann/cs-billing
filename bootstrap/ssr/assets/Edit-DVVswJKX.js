    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-b5837e0e${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-b5837e0e${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-b5837e0e${_scopeId}><div class="flex items-center" data-v-b5837e0e${_scopeId}><div class="w-12 h-12 bg-sage-600 rounded-full flex items-center justify-center mr-4" data-v-b5837e0e${_scopeId}><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-b5837e0e${_scopeId}></path></svg></div><div data-v-b5837e0e${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-b5837e0e${_scopeId}>Edit Sales Order: ${ssrInterpolate(__props.salesOrder.order_number)}</h2><p class="text-sage-600" data-v-b5837e0e${_scopeId}>Edit dokumen sales order untuk pelanggan</p></div></div><div class="mt-4 sm:mt-0" data-v-b5837e0e${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-b5837e0e${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
            ...
            _push2(`</div></div></div><form class="space-y-6" data-v-b5837e0e${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Informasi Dasar</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.basic }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.basic ? null : { display: "none" })}" class="p-6 space-y-4" data-v-b5837e0e${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>ORDER NUMB <span class="text-red-500" data-v-b5837e0e${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).order_number)} type="text" required readonly placeholder="EWILOG2509001001" class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.order_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.order_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>REF NO</label><input${ssrRenderAttr("value", unref(form).ref_no)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.ref_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.ref_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>DATE</label><input${ssrRenderAttr("value", unref(form).so_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.so_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.so_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>CUSTOMER <span class="text-red-500" data-v-b5837e0e${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).customer)} type="text" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.customer) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.customer)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>SHIPPER</label><input${ssrRenderAttr("value", unref(form).shipper)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.shipper) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.shipper)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Informasi Pengiriman</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.shipping }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.shipping ? null : { display: "none" })}" class="p-6 space-y-4" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>BL/AWB</label><input${ssrRenderAttr("value", unref(form).bl_awb)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.bl_awb) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.bl_awb)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>LINER</label><input${ssrRenderAttr("value", unref(form).liner)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.liner) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.liner)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>VESSEL</label><input${ssrRenderAttr("value", unref(form).vessel)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.vessel) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.vessel)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>ETA</label><input${ssrRenderAttr("value", unref(form).eta)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.eta) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.eta)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>ETD</label><input${ssrRenderAttr("value", unref(form).etd)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.etd) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.etd)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>AJU</label><input${ssrRenderAttr("value", unref(form).aju)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.aju) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.aju)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>SPPB DATE</label><input${ssrRenderAttr("value", unref(form).sppb_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.sppb_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.sppb_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>SHIPMENT TYPE</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}><option value="" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, "") : ssrLooseEqual(unref(form).shipment_type, "")) ? " selected" : ""}${_scopeId}>Pilih Shipment Type</option><!--[-->`);
            ssrRenderList(__props.shipmentTypes, (shipmentType) => {
              _push2(`<option${ssrRenderAttr("value", shipmentType.code)} data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, shipmentType.code) : ssrLooseEqual(unref(form).shipment_type, shipmentType.code)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(shipmentType.name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (unref(form).errors.shipment_type) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.shipment_type)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>POL</label><input${ssrRenderAttr("value", unref(form).pol)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.pol) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.pol)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>POD</label><input${ssrRenderAttr("value", unref(form).pod)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.pod) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.pod)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>GUDANG/UTC</label><input${ssrRenderAttr("value", unref(form).gudang_utc)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.gudang_utc) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.gudang_utc)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>PARTY/LCL</label><input${ssrRenderAttr("value", unref(form).party_lcl)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.party_lcl) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.party_lcl)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>EXCHANGE RATE</label><input${ssrRenderAttr("value", unref(form).exchange_rate)} type="number" step="0.0001" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.exchange_rate) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.exchange_rate)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Informasi Pricing</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.pricing }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.pricing ? null : { display: "none" })}" class="p-6 space-y-6" data-v-b5837e0e${_scopeId}><div class="bg-gray-50 rounded-lg p-4" data-v-b5837e0e${_scopeId}><div class="flex justify-between items-center mb-4" data-v-b5837e0e${_scopeId}><h4 class="text-md font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Rincian Vendor (Buying &amp; Selling)</h4><button type="button" class="text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-b5837e0e${_scopeId}> + Tambah Vendor </button></div><!--[-->`);
            ssrRenderList(unref(form).vendor_breakdown, (item, index) => {
              _push2(`<div class="border border-sage-200 rounded-lg p-4 mb-4 space-y-4" data-v-b5837e0e${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-b5837e0e${_scopeId}><div class="col-span-11" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>Nama Vendor</label><select class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}><option value="" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, "") : ssrLooseEqual(item.vendor_id, "")) ? " selected" : ""}${_scopeId}>Pilih vendor...</option><!--[-->`);
              ssrRenderList(__props.vendors, (vendorOption) => {
                _push2(`<option${ssrRenderAttr("value", vendorOption.id)} data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.vendor_id) ? ssrLooseContain(item.vendor_id, vendorOption.id) : ssrLooseEqual(item.vendor_id, vendorOption.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendorOption.nama_vendor)}</option>`);
              });
              _push2(`<!--]--></select></div><div class="col-span-1" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-transparent mb-1" data-v-b5837e0e${_scopeId}>Del</label><button type="button" class="w-full h-10 text-red-600 hover:text-red-900 hover:bg-red-100 rounded transition-colors" data-v-b5837e0e${_scopeId}> × </button></div></div><div class="grid grid-cols-2 gap-3" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>Deskripsi Service / Jenis Biaya</label><select class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}><option value="" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "") : ssrLooseEqual(item.description, "")) ? " selected" : ""}${_scopeId}>Pilih Jenis Biaya</option><option value="OF/AF" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "OF/AF") : ssrLooseEqual(item.description, "OF/AF")) ? " selected" : ""}${_scopeId}>OF/AF</option><option value="HANDLING" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "HANDLING") : ssrLooseEqual(item.description, "HANDLING")) ? " selected" : ""}${_scopeId}>HANDLING</option><option value="PIB EDI" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "PIB EDI") : ssrLooseEqual(item.description, "PIB EDI")) ? " selected" : ""}${_scopeId}>PIB EDI</option><option value="ADMIN DOC" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "ADMIN DOC") : ssrLooseEqual(item.description, "ADMIN DOC")) ? " selected" : ""}${_scopeId}>ADMIN DOC</option><option value="TRUCKING" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "TRUCKING") : ssrLooseEqual(item.description, "TRUCKING")) ? " selected" : ""}${_scopeId}>TRUCKING</option><option value="D/O CHARGES" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "D/O CHARGES") : ssrLooseEqual(item.description, "D/O CHARGES")) ? " selected" : ""}${_scopeId}>D/O CHARGES</option><option value="LOLO" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "LOLO") : ssrLooseEqual(item.description, "LOLO")) ? " selected" : ""}${_scopeId}>LOLO</option><option value="STORAGE" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "STORAGE") : ssrLooseEqual(item.description, "STORAGE")) ? " selected" : ""}${_scopeId}>STORAGE</option><option value="REFUND" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "REFUND") : ssrLooseEqual(item.description, "REFUND")) ? " selected" : ""}${_scopeId}>REFUND</option><option value="OTHER" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.description) ? ssrLooseContain(item.description, "OTHER") : ssrLooseEqual(item.description, "OTHER")) ? " selected" : ""}${_scopeId}>OTHER</option></select></div><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>RCVD INV</label><input${ssrRenderAttr("value", item.rcvd_inv)} type="text" placeholder="Nomor invoice yang diterima" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}></div></div><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>Remarks (Individual)</label><input${ssrRenderAttr("value", item.remarks)} type="text" placeholder="Catatan khusus untuk item ini" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}></div><div class="grid grid-cols-3 gap-3 p-3 bg-blue-50 rounded-lg" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-blue-700 mb-1" data-v-b5837e0e${_scopeId}>Buying Amount (Cost)</label><input${ssrRenderAttr("value", item.buying_amount)} type="text" placeholder="0" class="w-full px-3 py-2 border border-blue-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500" data-v-b5837e0e${_scopeId}></div><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-green-700 mb-1" data-v-b5837e0e${_scopeId}>Selling Amount (Revenue)</label><input${ssrRenderAttr("value", item.selling_amount)} type="text" placeholder="0" class="w-full px-3 py-2 border border-green-300 rounded focus:ring-2 focus:ring-green-500 focus:border-green-500" data-v-b5837e0e${_scopeId}></div><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-b5837e0e${_scopeId}>Profit</label><p class="${ssrRenderClass([getProfit(item) >= 0 ? "text-green-600" : "text-red-600", "px-3 py-2 bg-white border border-purple-300 rounded text-sm font-semibold"])}" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(getProfit(item)))}</p></div></div>`);
              if (item.vendor_id) {
                _push2(`<div class="grid grid-cols-3 gap-3 p-3 bg-sage-50 rounded-lg" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>Nama Vendor</label><p class="text-sm text-gray-900" data-v-b5837e0e${_scopeId}>${ssrInterpolate(item.nama_vendor || "-")}</p></div><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>Nomor Rekening</label><p class="text-sm text-gray-900 font-mono" data-v-b5837e0e${_scopeId}>${ssrInterpolate(item.no_rekening || "-")}</p></div><div data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-sage-700 mb-1" data-v-b5837e0e${_scopeId}>Nama Rekening</label><p class="text-sm text-gray-900" data-v-b5837e0e${_scopeId}>${ssrInterpolate(item.nama_rekening || "-")}</p></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--><div class="mt-4 pt-4 border-t border-gray-300 grid grid-cols-3 gap-4 text-center" data-v-b5837e0e${_scopeId}><div class="p-3 bg-blue-100 rounded-lg" data-v-b5837e0e${_scopeId}><p class="text-xs font-medium text-blue-700" data-v-b5837e0e${_scopeId}>Total Buying</p><p class="text-lg font-bold text-blue-800" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</p></div><div class="p-3 bg-green-100 rounded-lg" data-v-b5837e0e${_scopeId}><p class="text-xs font-medium text-green-700" data-v-b5837e0e${_scopeId}>Total Selling</p><p class="text-lg font-bold text-green-800" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</p></div><div class="${ssrRenderClass([totalRevenue.value >= 0 ? "bg-purple-100" : "bg-red-100", "p-3 rounded-lg"])}" data-v-b5837e0e${_scopeId}><p class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-purple-700" : "text-red-700", "text-xs font-medium"])}" data-v-b5837e0e${_scopeId}>Total Profit</p><p class="${ssrRenderClass([totalRevenue.value >= 0 ? "text-purple-800" : "text-red-800", "text-lg font-bold"])}" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</p></div></div></div><div class="bg-blue-50 rounded-lg p-4" data-v-b5837e0e${_scopeId}><h4 class="text-md font-semibold text-blue-800 mb-3" data-v-b5837e0e${_scopeId}>Ringkasan Revenue</h4><div class="space-y-2" data-v-b5837e0e${_scopeId}><div class="flex justify-between" data-v-b5837e0e${_scopeId}><span data-v-b5837e0e${_scopeId}>Total Pemasukan (Selling):</span><span class="font-medium" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</span></div><div class="flex justify-between" data-v-b5837e0e${_scopeId}><span data-v-b5837e0e${_scopeId}>Total Pengeluaran (Buying):</span><span class="font-medium" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</span></div><div class="flex justify-between items-center pt-2 border-t border-blue-300 font-bold text-lg" data-v-b5837e0e${_scopeId}><span data-v-b5837e0e${_scopeId}>Profit (Revenue):</span><span class="${ssrRenderClass(totalRevenue.value >= 0 ? "text-green-600" : "text-red-600")}" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</span></div></div></div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>REMARKS</label><textarea rows="3" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).remarks)}</textarea>`);
            if (unref(form).errors.remarks) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.remarks)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>NOTE</label><textarea rows="3" placeholder="Catatan tambahan untuk sales order ini" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).note)}</textarea>`);
            if (unref(form).errors.note) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.note)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Informasi Barang</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.goods }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.goods ? null : { display: "none" })}" class="p-6 space-y-4" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>COMMODITY/URAIAN BARANG</label><textarea rows="3" placeholder="Masukkan uraian barang/commodity yang detail" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).commodity)}</textarea>`);
            if (unref(form).errors.commodity) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.commodity)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>QTY</label><input${ssrRenderAttr("value", unref(form).qty)} type="number" min="0" placeholder="Masukkan quantity" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.qty) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.qty)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>NET WEIGHT (KG)</label><input${ssrRenderAttr("value", unref(form).net_weight)} type="number" step="0.01" min="0" placeholder="Masukkan berat netto dalam kg" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.net_weight) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.net_weight)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>GROSS WEIGHT (KG)</label><input${ssrRenderAttr("value", unref(form).gross_weight)} type="number" step="0.01" min="0" placeholder="Masukkan berat kotor dalam kg" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.gross_weight) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.gross_weight)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>MEAS (M³)</label><input${ssrRenderAttr("value", unref(form).measurement)} type="number" step="0.001" min="0" placeholder="Masukkan volume dalam m³" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.measurement) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.measurement)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-b5837e0e${_scopeId}><div class="flex justify-between items-center mb-2" data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700" data-v-b5837e0e${_scopeId}>CONTAINER NO</label><button type="button" class="text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-b5837e0e${_scopeId}> + Tambah Container </button></div><!--[-->`);
            ssrRenderList(unref(form).container_no, (container, index) => {
              _push2(`<div class="flex gap-2 mb-2" data-v-b5837e0e${_scopeId}><input${ssrRenderAttr("value", unref(form).container_no[index])} type="text" placeholder="Masukkan nomor container (misal: TCLU1234567)" class="flex-1 px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
              if (unref(form).container_no.length > 1) {
                _push2(`<button type="button" class="px-3 py-2 text-red-600 hover:text-red-900 hover:bg-red-100 rounded-lg transition-colors" data-v-b5837e0e${_scopeId}> × </button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (unref(form).errors.container_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.container_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Informasi Invoice</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.invoice }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.invoice ? null : { display: "none" })}" class="p-6 space-y-4" data-v-b5837e0e${_scopeId}><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>INVOICE NUMB</label><input${ssrRenderAttr("value", unref(form).invoice_number)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.invoice_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>INVOICE DATE</label><input${ssrRenderAttr("value", unref(form).invoice_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.invoice_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-b5837e0e${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-b5837e0e${_scopeId}>T.O.P</label><input${ssrRenderAttr("value", unref(form).top)} type="text" placeholder="e.g., NET 30" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).errors.top) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-b5837e0e${_scopeId}>${ssrInterpolate(unref(form).errors.top)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Biaya Beban Lain (Operational)</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.other_costs }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.other_costs ? null : { display: "none" })}" class="p-6" data-v-b5837e0e${_scopeId}><div class="bg-orange-50 rounded-lg p-4" data-v-b5837e0e${_scopeId}><div class="flex justify-between items-center mb-4" data-v-b5837e0e${_scopeId}><h4 class="text-md font-semibold text-orange-800" data-v-b5837e0e${_scopeId}>Biaya Beban Lain (Operational)</h4><button type="button" class="text-sm bg-orange-600 text-white px-3 py-1 rounded hover:bg-orange-700 transition-colors" data-v-b5837e0e${_scopeId}> + Tambah Biaya </button></div>`);
            if (unref(form).other_costs && unref(form).other_costs.length > 0) {
              _push2(`<div class="space-y-3" data-v-b5837e0e${_scopeId}><!--[-->`);
              ssrRenderList(unref(form).other_costs, (cost, index) => {
                _push2(`<div class="border border-orange-200 rounded-lg p-3 bg-white" data-v-b5837e0e${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-b5837e0e${_scopeId}><div class="col-span-5" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-b5837e0e${_scopeId}>Deskripsi Biaya</label><input${ssrRenderAttr("value", cost.description)} type="text" placeholder="Contoh: Biaya handling, dokumen, dll" class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-b5837e0e${_scopeId}></div><div class="col-span-3" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-b5837e0e${_scopeId}>Jumlah Biaya</label><input${ssrRenderAttr("value", cost.amount)} type="number" min="0" step="0.01" placeholder="0" class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-b5837e0e${_scopeId}></div><div class="col-span-3" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-orange-700 mb-1" data-v-b5837e0e${_scopeId}>Kategori</label><select class="w-full px-2 py-1 border border-orange-300 rounded text-sm focus:ring-1 focus:ring-orange-500 focus:border-orange-500" data-v-b5837e0e${_scopeId}><option value="" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(cost.category) ? ssrLooseContain(cost.category, "") : ssrLooseEqual(cost.category, "")) ? " selected" : ""}${_scopeId}>Pilih kategori</option><!--[-->`);
                ssrRenderList(__props.operationalCostCategories, (category) => {
                  _push2(`<option${ssrRenderAttr("value", category.name)}${ssrRenderAttr("title", category.description)} data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(cost.category) ? ssrLooseContain(cost.category, category.name) : ssrLooseEqual(cost.category, category.name)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(category.name)}</option>`);
                });
                _push2(`<!--]--></select></div><div class="col-span-1 flex items-end" data-v-b5837e0e${_scopeId}><button type="button" class="w-full px-2 py-1 text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors"${ssrIncludeBooleanAttr(unref(form).other_costs.length <= 1) ? " disabled" : ""} data-v-b5837e0e${_scopeId}><svg class="w-4 h-4 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-b5837e0e${_scopeId}></path></svg></button></div></div></div>`);
              });
              _push2(`<!--]--><div class="pt-3 border-t border-orange-300" data-v-b5837e0e${_scopeId}><div class="flex justify-between items-center" data-v-b5837e0e${_scopeId}><span class="text-sm font-medium text-orange-700" data-v-b5837e0e${_scopeId}>Total Biaya Beban Lain:</span><span class="text-lg font-bold text-orange-800" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalOtherCosts.value))}</span></div></div><div class="flex justify-center mt-6 pt-4 border-t border-orange-200" data-v-b5837e0e${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors" data-v-b5837e0e${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-b5837e0e${_scopeId}></path></svg> Tambah Biaya Lagi </button></div></div>`);
            } else {
              _push2(`<div class="text-center py-4 text-orange-600" data-v-b5837e0e${_scopeId}><p class="text-sm" data-v-b5837e0e${_scopeId}>Belum ada biaya beban lain</p><p class="text-xs text-orange-500" data-v-b5837e0e${_scopeId}>Klik tombol &quot;Tambah Biaya&quot; untuk menambahkan</p></div>`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-b5837e0e${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-b5837e0e${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-b5837e0e${_scopeId}>Items Reimbursement</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.reimbursement }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-b5837e0e${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.reimbursement ? null : { display: "none" })}" class="p-6" data-v-b5837e0e${_scopeId}><div class="bg-purple-50 rounded-lg p-4" data-v-b5837e0e${_scopeId}><div class="flex justify-between items-center mb-4" data-v-b5837e0e${_scopeId}><h4 class="text-md font-semibold text-purple-800" data-v-b5837e0e${_scopeId}>Items Reimbursement</h4><button type="button" class="text-sm bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-700 transition-colors" data-v-b5837e0e${_scopeId}> + Tambah Reimbursement </button></div>`);
            if (reimbursementItems.value && reimbursementItems.value.length > 0) {
              _push2(`<div class="space-y-3" data-v-b5837e0e${_scopeId}><!--[-->`);
              ssrRenderList(reimbursementItems.value, (item, index) => {
                _push2(`<div class="border border-purple-200 rounded-lg p-3 bg-white" data-v-b5837e0e${_scopeId}><div class="grid grid-cols-12 gap-3" data-v-b5837e0e${_scopeId}><div class="col-span-4" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-b5837e0e${_scopeId}>Deskripsi</label><input${ssrRenderAttr("value", item.description)} type="text" placeholder="Contoh: Transport ke pelabuhan" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-b5837e0e${_scopeId}></div><div class="col-span-2" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-b5837e0e${_scopeId}>Jumlah</label><input${ssrRenderAttr("value", item.amount)} type="number" step="0.01" placeholder="0.00" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-b5837e0e${_scopeId}></div><div class="col-span-3" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-b5837e0e${_scopeId}>Kategori</label><select class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-b5837e0e${_scopeId}><option value="" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "") : ssrLooseEqual(item.category, "")) ? " selected" : ""}${_scopeId}>Pilih Kategori</option><option value="transport" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "transport") : ssrLooseEqual(item.category, "transport")) ? " selected" : ""}${_scopeId}>Transportasi</option><option value="accommodation" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "accommodation") : ssrLooseEqual(item.category, "accommodation")) ? " selected" : ""}${_scopeId}>Akomodasi</option><option value="meal" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "meal") : ssrLooseEqual(item.category, "meal")) ? " selected" : ""}${_scopeId}>Makan &amp; Minum</option><option value="fuel" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "fuel") : ssrLooseEqual(item.category, "fuel")) ? " selected" : ""}${_scopeId}>BBM</option><option value="parking" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "parking") : ssrLooseEqual(item.category, "parking")) ? " selected" : ""}${_scopeId}>Parkir</option><option value="toll" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "toll") : ssrLooseEqual(item.category, "toll")) ? " selected" : ""}${_scopeId}>Tol</option><option value="admin" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "admin") : ssrLooseEqual(item.category, "admin")) ? " selected" : ""}${_scopeId}>Administrasi</option><option value="communication" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "communication") : ssrLooseEqual(item.category, "communication")) ? " selected" : ""}${_scopeId}>Komunikasi</option><option value="equipment" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "equipment") : ssrLooseEqual(item.category, "equipment")) ? " selected" : ""}${_scopeId}>Peralatan</option><option value="general" data-v-b5837e0e${ssrIncludeBooleanAttr(Array.isArray(item.category) ? ssrLooseContain(item.category, "general") : ssrLooseEqual(item.category, "general")) ? " selected" : ""}${_scopeId}>Lain-lain</option></select></div><div class="col-span-2" data-v-b5837e0e${_scopeId}><label class="block text-xs font-medium text-purple-700 mb-1" data-v-b5837e0e${_scopeId}>Catatan</label><input${ssrRenderAttr("value", item.notes)} type="text" placeholder="Opsional" class="w-full px-2 py-1 border border-purple-300 rounded text-sm focus:ring-1 focus:ring-purple-500 focus:border-purple-500" data-v-b5837e0e${_scopeId}></div><div class="col-span-1 flex items-end" data-v-b5837e0e${_scopeId}><button type="button" class="w-full px-2 py-1 text-red-600 hover:text-red-800 hover:bg-red-100 rounded transition-colors" data-v-b5837e0e${_scopeId}><svg class="w-4 h-4 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-b5837e0e${_scopeId}></path></svg></button></div></div></div>`);
              });
              _push2(`<!--]--><div class="pt-3 border-t border-purple-300" data-v-b5837e0e${_scopeId}><div class="flex justify-between items-center" data-v-b5837e0e${_scopeId}><span class="text-sm font-medium text-purple-700" data-v-b5837e0e${_scopeId}>Total Reimbursement:</span><span class="text-lg font-bold text-purple-800" data-v-b5837e0e${_scopeId}>${ssrInterpolate(formatCurrency(totalReimbursement.value))}</span></div></div><div class="flex justify-center mt-6 pt-4 border-t border-purple-200" data-v-b5837e0e${_scopeId}><button type="button" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors" data-v-b5837e0e${_scopeId}><svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-b5837e0e${_scopeId}></path></svg> Tambah Reimbursement Lagi </button></div></div>`);
            } else {
              _push2(`<div class="text-center py-4 text-purple-600" data-v-b5837e0e${_scopeId}><p class="text-sm" data-v-b5837e0e${_scopeId}>Belum ada item reimbursement</p><p class="text-xs text-purple-500" data-v-b5837e0e${_scopeId}>Klik tombol &quot;Tambah Reimbursement&quot; untuk menambahkan</p></div>`);
            }
            _push2(`</div></div></div><div class="flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-3 pt-6" data-v-b5837e0e${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-cs.sales-orders.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="inline-flex items-center justify-center px-6 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" data-v-b5837e0e${_scopeId}>`);
            if (unref(form).processing) {
              _push2(`<svg class="animate-spin -ml-1 mr-3 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" data-v-b5837e0e${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-b5837e0e${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-b5837e0e${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).processing) {
              _push2(`<span data-v-b5837e0e${_scopeId}>Menyimpan...</span>`);
            } else {
              _push2(`<span data-v-b5837e0e${_scopeId}>Update Sales Order</span>`);
            }
...
const Edit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b5837e0e"]]);
export {
  Edit as default
};
