    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b, _c, _d;
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-1fdef914${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-1fdef914${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-1fdef914${_scopeId}><div data-v-1fdef914${_scopeId}><h2 class="text-2xl font-bold text-sage-800 mb-2" data-v-1fdef914${_scopeId}> Manajemen Data Pelanggan </h2><p class="text-sage-600" data-v-1fdef914${_scopeId}> Kelola data pelanggan dan informasi kontak </p></div><div class="mt-4 sm:mt-0 flex space-x-2" data-v-1fdef914${_scopeId}><a${ssrRenderAttr("href", exportPdfUrl.value)} target="_blank" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors" data-v-1fdef914${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1fdef914${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2z" data-v-1fdef914${_scopeId}></path></svg> Export PDF </a>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1fdef914${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-1fdef914${_scopeId2}></path></svg> Tambah Data Pelanggan `);
                } else {
                  return [
            ...
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-1fdef914${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-1fdef914${_scopeId}><div data-v-1fdef914${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-1fdef914${_scopeId}>Cari Data</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Cari nama perusahaan, PIC, email, marketing..." class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-1fdef914${_scopeId}></div><div class="flex items-end" data-v-1fdef914${_scopeId}><button class="w-full px-4 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 transition-colors" data-v-1fdef914${_scopeId}> Cari </button></div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-1fdef914${_scopeId}><div class="px-6 py-4 border-b border-sage-200" data-v-1fdef914${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-1fdef914${_scopeId}>Daftar Data Pelanggan</h3><p class="text-sm text-sage-600 mt-1" data-v-1fdef914${_scopeId}> Total: ${ssrInterpolate(((_a2 = __props.customers) == null ? void 0 : _a2.total) || 0)} data </p></div><div class="overflow-x-auto" data-v-1fdef914${_scopeId}><table class="w-full" data-v-1fdef914${_scopeId}><thead class="bg-sage-50" data-v-1fdef914${_scopeId}><tr data-v-1fdef914${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> Nama Perusahaan </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> Jenis Usaha </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> PIC Name </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> PIC Email </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> Marketing </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> Handler </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1fdef914${_scopeId}> Aksi </th></tr></thead><tbody class="divide-y divide-sage-200" data-v-1fdef914${_scopeId}><!--[-->`);
            ssrRenderList(__props.customers.data, (customer) => {
              var _a3;
              _push2(`<tr class="hover:bg-sage-50 transition-colors" data-v-1fdef914${_scopeId}><td class="px-6 py-4 text-sm font-medium text-gray-900" data-v-1fdef914${_scopeId}>${ssrInterpolate(customer.company_name)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-1fdef914${_scopeId}>${ssrInterpolate(customer.company_type)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-1fdef914${_scopeId}>${ssrInterpolate(customer.pic_name)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-1fdef914${_scopeId}>${ssrInterpolate(customer.pic_email)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-1fdef914${_scopeId}>${ssrInterpolate(customer.marketing_name || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-1fdef914${_scopeId}>${ssrInterpolate(((_a3 = customer.handler) == null ? void 0 : _a3.name) || "-")}</td><td class="px-6 py-4 text-sm font-medium" data-v-1fdef914${_scopeId}><div class="flex items-center space-x-2" data-v-1fdef914${_scopeId}><a${ssrRenderAttr("href", `/admin-cs/customers/${customer.id}/print`)} class="inline-flex items-center justify-center w-8 h-8 text-blue-600 hover:text-blue-900 hover:bg-blue-100 rounded-full transition-colors" title="Cetak PDF" target="_blank" data-v-1fdef914${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1fdef914${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" data-v-1fdef914${_scopeId}></path></svg></a>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1fdef914${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-1fdef914${_scopeId2}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-1fdef914${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "w-4 h-4",
              ...
              _push2(`<button class="inline-flex items-center justify-center w-8 h-8 text-red-600 hover:text-red-900 hover:bg-red-100 rounded-full transition-colors" title="Hapus" data-v-1fdef914${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1fdef914${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-1fdef914${_scopeId}></path></svg></button></div></td></tr>`);
            });
            _push2(`<!--]-->`);
            if (!__props.customers.data || __props.customers.data.length === 0) {
              _push2(`<tr data-v-1fdef914${_scopeId}><td colspan="7" class="px-6 py-8 text-center text-gray-500" data-v-1fdef914${_scopeId}><div class="flex flex-col items-center" data-v-1fdef914${_scopeId}><svg class="w-12 h-12 text-gray-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1fdef914${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" data-v-1fdef914${_scopeId}></path></svg><p class="text-lg font-medium mb-2" data-v-1fdef914${_scopeId}>Tidak ada data</p><p class="text-sm text-gray-400" data-v-1fdef914${_scopeId}> Belum ada data pelanggan yang tersedia </p></div></td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div>`);
            if (__props.customers.last_page > 1) {
              _push2(`<div class="px-6 py-4 border-t border-sage-200" data-v-1fdef914${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1fdef914"]]);
export {
  Index as default
};
