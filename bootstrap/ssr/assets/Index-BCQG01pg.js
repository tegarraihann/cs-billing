...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentIndexQuery = computed(() => {
      ...
      const currentPage = (_a2 = props.shipmentTypes) == null ? void 0 : _a2.current_page;
    ...
    const getEditUrl = (shipmentTypeId) => {
      return appendQuery(route("admin-keuangan.shipment-types.edit", shipmentTypeId), currentIndexQuery.value);
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Shipment Type Management" }, null, _parent2, _scopeId));
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="flex justify-between items-center mb-6"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Shipment Type Management</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Manage shipment types for sales orders.</p></div>`);
            ...
            ssrRenderList(__props.shipmentTypes.data, (shipmentType, index) => {
              _push2(`<tr class="hover:bg-gray-50"${_scopeId}><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"${_scopeId}>${ssrInterpolate((__props.shipmentTypes.from ?? 1) + index)}</td><td class="px-6 py-4 whitespace-nowrap"${_scopeId}><div class="text-sm font-medium text-gray-900"${_scopeId}>${ssrInterpolate(shipmentType.code)}</div></td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"${_scopeId}>${ssrInterpolate(shipmentType.name)}</td><td class="px-6 py-4 text-sm text-gray-500"${_scopeId}>${ssrInterpolate(shipmentType.description || "-")}</td><td class="px-6 py-4 whitespace-nowrap"${_scopeId}><span class="${ssrRenderClass(
              ...
              )}"${_scopeId}>${ssrInterpolate(shipmentType.is_active ? "Active" : "Inactive")}</span></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium"${_scopeId}><div class="flex space-x-2"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: getEditUrl(shipmentType.id),
            ...
            if (__props.shipmentTypes.data.length === 0) {
              ...
              _push2(`<h3 class="mt-2 text-sm font-medium text-gray-900"${_scopeId}>No shipment types yet</h3><p class="mt-1 text-sm text-gray-500"${_scopeId}>Start by adding the first shipment type.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (((_a2 = __props.shipmentTypes) == null ? void 0 : _a2.links) && __props.shipmentTypes.links.length > 3) {
              _push2(`<div class="mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(((_b2 = __props.shipmentTypes) == null ? void 0 : _b2.from) ?? 0)} to ${ssrInterpolate(((_c = __props.shipmentTypes) == null ? void 0 : _c.to) ?? 0)} of ${ssrInterpolate(((_d = __props.shipmentTypes) == null ? void 0 : _d.total) ?? 0)} shipment types </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
              ssrRenderList(((_e = __props.shipmentTypes) == null ? void 0 : _e.links) || [], (link) => {
                _push2(`<!--[-->`);
                if (link.url) {
            ...
            _push2(ssrRenderComponent(AlertDialog, {
              ...
              message: `Are you sure you want to delete shipment type '${(_f = deleteModal.shipmentType) == null ? void 0 : _f.name}'?`,
              "confirm-text": "Delete",
              "cancel-text": "Cancel",
              onConfirm: deleteShipmentType,
              onCancel: ($event) => deleteModal.show = false
            }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(unref(Head), { title: "Shipment Type Management" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Shipment Type Management"),
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Manage shipment types for sales orders.")
                    ]),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      createVNode("div", { class: "overflow-x-auto" }, [
                        createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                          ...
                          createVNode("tbody", { class: "bg-white divide-y divide-gray-200" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(__props.shipmentTypes.data, (shipmentType, index) => {
                              return openBlock(), createBlock("tr", {
                                key: shipmentType.id,
                                class: "hover:bg-gray-50"
                              }, [
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-900" }, toDisplayString((__props.shipmentTypes.from ?? 1) + index), 1),
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                  createVNode("div", { class: "text-sm font-medium text-gray-900" }, toDisplayString(shipmentType.code), 1)
                                ]),
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-900" }, toDisplayString(shipmentType.name), 1),
                                createVNode("td", { class: "px-6 py-4 text-sm text-gray-500" }, toDisplayString(shipmentType.description || "-"), 1),
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                  createVNode("span", {
                      ...
                      __props.shipmentTypes.data.length === 0 ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("h3", { class: "mt-2 text-sm font-medium text-gray-900" }, "No shipment types yet"),
                        createVNode("p", { class: "mt-1 text-sm text-gray-500" }, "Start by adding the first shipment type.")
                      ])) : createCommentVNode("", true),
                      ((_g = __props.shipmentTypes) == null ? void 0 : _g.links) && __props.shipmentTypes.links.length > 3 ? (openBlock(), createBlock("div", {
                        key: 1,
                        class: "mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"
                      }, [
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(((_h = __props.shipmentTypes) == null ? void 0 : _h.from) ?? 0) + " to " + toDisplayString(((_i = __props.shipmentTypes) == null ? void 0 : _i.to) ?? 0) + " of " + toDisplayString(((_j = __props.shipmentTypes) == null ? void 0 : _j.total) ?? 0) + " shipment types ", 1),
                          createVNode("div", { class: "flex space-x-1" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(((_k = __props.shipmentTypes) == null ? void 0 : _k.links) || [], (link) => {
              ...
              createVNode(AlertDialog, {
                show: deleteModal.show,
                title: "Confirm Deletion",
                message: `Are you sure you want to delete shipment type '${(_l = deleteModal.shipmentType) == null ? void 0 : _l.name}'?`,
                "confirm-text": "Delete",
                "cancel-text": "Cancel",
                onConfirm: deleteShipmentType,
                onCancel: ($event) => deleteModal.show = false
