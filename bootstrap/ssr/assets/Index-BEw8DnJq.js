import { reactive, computed, ref, onMounted, watch, withCtx, unref, createVNode, createBlock, createCommentVNode, toDisplayString, withDirectives, vModelText, vModelSelect, openBlock, Fragment, renderList, createTextVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getSoaUrl = (receivable) => {
      var _a;
      const customerId = ((_a = receivable == null ? void 0 : receivable.customer) == null ? void 0 : _a.id) || (receivable == null ? void 0 : receivable.customer_id);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Accounts Receivable" }, null, _parent2, _scopeId));
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="flex justify-between items-center mb-6"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Accounts Receivable</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Manage receivables and customer payments</p></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6"${_scopeId}><div class="bg-white overflow-hidden shadow rounded-lg"${_scopeId}><div class="p-5"${_scopeId}><div class="flex items-center"${_scopeId}><div class="flex-shrink-0"${_scopeId}>`);
            ...
            ssrRenderList(__props.receivables.data, (receivable) => {
              var _a2, _b2;
              _push2(`<tr class="hover:bg-gray-50"${_scopeId}><td class="px-6 py-4 whitespace-nowrap"${_scopeId}><div class="text-sm font-medium text-gray-900"${_scopeId}>${ssrInterpolate(receivable.invoice_number)}</div><div class="text-sm text-gray-500"${_scopeId}>${ssrInterpolate(formatDate(receivable.invoice_date))}</div>`);
              if (receivable.is_opening) {
                _push2(`<div class="mt-1 inline-flex items-center rounded-full bg-sage-100 px-2 py-0.5 text-xs font-semibold text-sage-700"${_scopeId}>${ssrInterpolate(openingTypeLabel(receivable.opening_type))}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</td><td class="px-6 py-4 whitespace-nowrap"${_scopeId}><div class="text-sm font-medium text-gray-900"${_scopeId}>${ssrInterpolate(((_a2 = receivable.customer) == null ? void 0 : _a2.company_name) || receivable.customer_name)}</div></td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"${_scopeId}>${ssrInterpolate(((_b2 = receivable.sales_order) == null ? void 0 : _b2.order_number) || receivable.source_so_number || "-")} `);
              if (receivable.is_opening && receivable.opening_payment_date) {
                _push2(`<div class="text-xs text-gray-500"${_scopeId}> Opening Payment: ${ssrInterpolate(formatDate(receivable.opening_payment_date))}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(receivable.invoice_amount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(receivable.paid_amount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(receivable.outstanding_amount))}</td><td class="px-6 py-4 whitespace-nowrap text-center"${_scopeId}><span class="${ssrRenderClass([getStatusClass(receivable.status), "inline-flex px-2 py-1 text-xs font-semibold rounded-full"])}"${_scopeId}>${ssrInterpolate(getStatusText(receivable.status))} `);
              if (receivable.days_overdue > 0) {
                _push2(`<span class="ml-1"${_scopeId}> (${ssrInterpolate(receivable.days_overdue)} days) </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</span></td><td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium"${_scopeId}><div class="flex items-center justify-center space-x-2"${_scopeId}><button class="text-blue-600 hover:text-blue-900" title="View Details"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"${_scopeId}></path></svg></button>`);
              ...
              if (receivable.customer || receivable.customer_id) {
                _push2(`<button type="button" class="text-purple-600 hover:text-purple-900" title="Generate SOA"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"${_scopeId}></path></svg></button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td></tr>`);
            });
            _push2(`<!--]--></tbody><tfoot class="bg-gray-100 font-semibold"${_scopeId}><tr${_scopeId}><td colspan="3" class="px-6 py-4 text-left text-sm text-gray-900"${_scopeId}> Total This Page (${ssrInterpolate(__props.receivables.data.length)} items) </td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(currentPageTotals.value.totalAmount))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(currentPageTotals.value.totalPaid))}</td><td class="px-6 py-4 whitespace-nowrap text-right text-sm text-gray-900"${_scopeId}> Rp ${ssrInterpolate(formatNumber(currentPageTotals.value.totalOutstanding))}</td><td colspan="2" class="px-6 py-4"${_scopeId}></td></tr></tfoot></table></div><div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(__props.receivables.from || 0)} to ${ssrInterpolate(__props.receivables.to || 0)} of ${ssrInterpolate(__props.receivables.total || 0)} results </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
            ...
            if (showPaymentModal.value) {
              ...
              if (paymentDataLoading.value) {
                _push2(`<div class="py-6 text-center text-sm text-gray-600"${_scopeId}> Loading payment data... </div>`);
              } else {
                _push2(`<div${_scopeId}>`);
                ...
                if (paymentComponents.value.length > 0) {
                  _push2(`<div class="mb-4"${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}> Payment Component `);
                ...
                if (amountError.value) {
                  ...
                  _push2(`<p class="mt-1 text-xs text-gray-500"${_scopeId}> Maximum: Rp ${ssrInterpolate(formatNumber(currentOutstandingLimit.value))}</p>`);
                }
                ...
                if (bankAccounts.value.length === 0) {
                  _push2(`<p class="mt-1 text-xs text-red-600"${_scopeId}> No active bank accounts. Add a bank account first. </p>`);
                } else {
                  _push2(`<!---->`);
                }
                ...
                _push2(`</div><div class="mb-6"${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Notes</label><textarea rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Payment notes (optional)"${_scopeId}>${ssrInterpolate(paymentForm.notes)}</textarea>`);
                if (formErrors.value.notes) {
                  _push2(`<p class="mt-1 text-xs text-red-600"${_scopeId}>${ssrInterpolate(formErrors.value.notes)}</p>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div><div class="flex justify-end space-x-3"${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50"${_scopeId}> Cancel </button><button type="submit"${ssrIncludeBooleanAttr(processing.value || bankAccounts.value.length === 0) ? " disabled" : ""} class="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 disabled:opacity-50"${_scopeId}>${ssrInterpolate(processing.value ? "Saving..." : "Record Payment")}</button></div></form></div>`);
              }
            ...
            return [
              createVNode(unref(Head), { title: "Accounts Receivable" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Accounts Receivable"),
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Manage receivables and customer payments")
                    ])
                  ]),
                      ...
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4" }, [
                        createVNode("div", null, [
                          ...
                          withDirectives(createVNode("input", {
                            ...
                            type: "text",
                            placeholder: "Search invoice, customer, or SO number...",
                  ...
                  __props.customerSummary && __props.customerSummary.length > 0 ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900 mb-4" }, "Customer Summary"),
                              ...
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-center text-sm" }, [
                                  createVNode("button", {
                                    ...
                                    onClick: ($event) => downloadSOAForCustomer(customer.customer_id)
                                  }, " Download SOA ", 8, ["onClick"])
                                ])
                              ]);
                            }), 128))
                          ]),
                        ...
                        createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(__props.receivables.data, (receivable) => {
                              ...
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                  ...
                                  receivable.is_opening ? (openBlock(), createBlock("div", {
                                    key: 0,
                                    class: "mt-1 inline-flex items-center rounded-full bg-sage-100 px-2 py-0.5 text-xs font-semibold text-sage-700"
                                  }, toDisplayString(openingTypeLabel(receivable.opening_type)), 1)) : createCommentVNode("", true)
                                ]),
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap" }, [
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-sm text-gray-900" }, [
                                  createTextVNode(toDisplayString(((_b2 = receivable.sales_order) == null ? void 0 : _b2.order_number) || receivable.source_so_number || "-") + " ", 1),
                                  receivable.is_opening && receivable.opening_payment_date ? (openBlock(), createBlock("div", {
                                    key: 0,
                                    class: "text-xs text-gray-500"
                                  }, " Opening Payment: " + toDisplayString(formatDate(receivable.opening_payment_date)), 1)) : createCommentVNode("", true)
                                ]),
                                ...
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-center" }, [
                                  createVNode("span", {
                                    ...
                                    receivable.days_overdue > 0 ? (openBlock(), createBlock("span", {
                                      key: 0,
                                      class: "ml-1"
                                    }, " (" + toDisplayString(receivable.days_overdue) + " days) ", 1)) : createCommentVNode("", true)
                                  ], 2)
                                ]),
                                createVNode("td", { class: "px-6 py-4 whitespace-nowrap text-center text-sm font-medium" }, [
                                  createVNode("div", { class: "flex items-center justify-center space-x-2" }, [
                                    ...
                                    receivable.customer || receivable.customer_id ? (openBlock(), createBlock("button", {
                                      key: 1,
                                      type: "button",
                                      class: "text-purple-600 hover:text-purple-900",
                                      title: "Generate SOA",
                                      onClick: withModifiers(($event) => downloadSOA(receivable), ["stop"])
                                    }, [
                                      (openBlock(), createBlock("svg", {
                                        class: "w-4 h-4",
                                        fill: "none",
                          ...
                          createVNode("tfoot", { class: "bg-gray-100 font-semibold" }, [
                            createVNode("tr", null, [
                              ...
                              }, " Total This Page (" + toDisplayString(__props.receivables.data.length) + " items) ", 1),
                    ...
                    createVNode("div", { class: "relative top-12 mx-auto w-full max-w-lg px-4" }, [
                      createVNode("div", { class: "bg-white rounded-lg shadow-lg border" }, [
                        ...
                        createVNode("div", { class: "px-6 py-5" }, [
                          ...
                          }, " Loading payment data... ")) : (openBlock(), createBlock("div", { key: 1 }, [
                            ...
                            createVNode("form", {
                              ...
                              paymentComponents.value.length > 0 ? (openBlock(), createBlock("div", {
                                ...
                                createVNode("label", { class: "block text-sm font-medium text-gray-700 mb-1" }, [
                                  createTextVNode(" Payment Component "),
                              ...
                              createVNode("div", { class: "mb-4" }, [
                                ...
                                }, " Maximum: Rp " + toDisplayString(formatNumber(currentOutstandingLimit.value)), 1))
                              ]),
                              createVNode("div", { class: "mb-4" }, [
                              ...
                              createVNode("div", { class: "mb-4" }, [
                                ...
                                bankAccounts.value.length === 0 ? (openBlock(), createBlock("p", {
                                  key: 0,
                                  class: "mt-1 text-xs text-red-600"
                                }, " No active bank accounts. Add a bank account first. ")) : createCommentVNode("", true),
                              ...
                              createVNode("div", { class: "flex justify-end space-x-3" }, [
                                ...
                                }, toDisplayString(processing.value ? "Saving..." : "Record Payment"), 9, ["disabled"])
                              ])
                            ], 32)
                          ]))
                        ])
