      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="py-6" data-v-fb74515f${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-fb74515f${_scopeId}><div class="flex justify-between items-center mb-6" data-v-fb74515f${_scopeId}><div data-v-fb74515f${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-fb74515f${_scopeId}>Customer Management</h1><p class="mt-1 text-sm text-gray-600" data-v-fb74515f${_scopeId}>Manage customer records and contact information</p></div><div class="flex space-x-2" data-v-fb74515f${_scopeId}><a${ssrRenderAttr("href", exportPdfUrl.value)} target="_blank" class="inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-900 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition ease-in-out duration-150" data-v-fb74515f${_scopeId}>`);
            ...
            _push2(`</div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-fb74515f${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-fb74515f${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-fb74515f${_scopeId}>Filters</h3><div class="grid grid-cols-1 md:grid-cols-4 gap-4" data-v-fb74515f${_scopeId}><div class="md:col-span-3" data-v-fb74515f${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-fb74515f${_scopeId}>Search</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Search company name, contact, email, marketing..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-fb74515f${_scopeId}></div><div class="flex items-end" data-v-fb74515f${_scopeId}><button class="w-full px-4 py-2 bg-sage-600 text-white rounded-md hover:bg-sage-900 transition-colors" data-v-fb74515f${_scopeId}> Search </button></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md" data-v-fb74515f${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-fb74515f${_scopeId}><div class="sm:flex sm:items-center sm:justify-between mb-4" data-v-fb74515f${_scopeId}><div data-v-fb74515f${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-fb74515f${_scopeId}>Customer Data List</h3><p class="mt-1 text-sm text-gray-600" data-v-fb74515f${_scopeId}>Total: ${ssrInterpolate(((_a2 = __props.customers) == null ? void 0 : _a2.total) || 0)} records</p></div></div><div class="overflow-x-auto" data-v-fb74515f${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-fb74515f${_scopeId}><thead class="bg-gray-50" data-v-fb74515f${_scopeId}><tr data-v-fb74515f${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Customer Code </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Company Name </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Business Type </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Contact Name </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Contact Email </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Marketing </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-fb74515f${_scopeId}> Handler </th><th scope="col" class="relative px-6 py-3" data-v-fb74515f${_scopeId}><span class="sr-only" data-v-fb74515f${_scopeId}>Delete</span></th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-fb74515f${_scopeId}><!--[-->`);
            ssrRenderList(__props.customers.data, (customer) => {
              var _a3;
              _push2(`<tr class="hover:bg-gray-50 cursor-pointer" data-v-fb74515f${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.customer_code || "-")}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.company_name)}</div><div class="text-sm text-gray-500" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.company_type)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.company_type)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.pic_name)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.pic_email)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(customer.marketing_name || "-")}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-fb74515f${_scopeId}><div class="text-sm text-gray-900" data-v-fb74515f${_scopeId}>${ssrInterpolate(((_a3 = customer.handler) == null ? void 0 : _a3.name) || "-")}</div></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" data-v-fb74515f${_scopeId}><button class="text-red-600 hover:text-red-900 p-2 rounded-md hover:bg-red-50" title="Delete" data-v-fb74515f${_scopeId}>`);
            ...
            if (!__props.customers.data || __props.customers.data.length === 0) {
              _push2(`<div class="text-center py-12" data-v-fb74515f${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Users), { class: "mx-auto h-12 w-12 text-gray-400" }, null, _parent2, _scopeId));
              _push2(`<h3 class="mt-2 text-sm font-medium text-gray-900" data-v-fb74515f${_scopeId}>No customer data yet</h3><p class="mt-1 text-sm text-gray-500" data-v-fb74515f${_scopeId}>Start by adding your first customer</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.customers.links) {
              _push2(`<div class="mt-6" data-v-fb74515f${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fb74515f"]]);
export {
  Index as default
};
