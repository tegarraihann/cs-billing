    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Tambah Service Type" }, null, _parent2, _scopeId));
            ...
            _push2(`</div><div class="flex items-center"${_scopeId}><label class="flex items-center cursor-pointer"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).is_active) ? ssrLooseContain(unref(form).is_active, null) : unref(form).is_active) ? " checked" : ""} type="checkbox" class="h-4 w-4 text-sage-600 focus:ring-sage-500 border-gray-300 rounded"${_scopeId}><span class="ml-2 block text-sm text-gray-900"${_scopeId}> Status Aktif </span></label></div></div><div class="mt-8 flex justify-end space-x-3"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-keuangan.service-types.index"),
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Menyimpan..." : "Simpan Service Type")}</button></div></form></div></div></div></div>`);
          } else {
            return [
              createVNode(unref(Head), { title: "Tambah Service Type" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "Tambah Service Type Baru"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Tambahkan jenis biaya/service baru untuk vendor items")
                  ]),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                          createVNode("div", null, [
                            ...
                            createVNode("p", { class: "mt-1 text-sm text-gray-500" }, "Angka lebih kecil akan muncul lebih dahulu"),
                        ...
                        createVNode("div", { class: "mt-8 flex justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            createTextVNode(" " + toDisplayString(processing.value ? "Menyimpan..." : "Simpan Service Type"), 1)
                          ], 8, ["disabled"])
                        ])
                      ], 32)
                    ])
