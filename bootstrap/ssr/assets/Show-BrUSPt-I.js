    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-1e50c06d${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-1e50c06d${_scopeId}><div class="flex items-center justify-between" data-v-1e50c06d${_scopeId}><div data-v-1e50c06d${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-1e50c06d${_scopeId}>Detail Invoice</h2><p class="text-sage-600" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.invoice_number)}</p></div><div class="flex space-x-3" data-v-1e50c06d${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-1e50c06d${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
            ...
            if (__props.invoice.status === "draft") {
              _push2(`<button class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors" data-v-1e50c06d${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" data-v-1e50c06d${_scopeId}></path></svg> Tandai Terkirim </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (shouldShowFixOperationalCostsButton.value) {
              _push2(`<button class="inline-flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors" data-v-1e50c06d${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" data-v-1e50c06d${_scopeId}></path></svg> Fix Operational Costs </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (shouldShowProfitLossButton.value) {
              _push2(`<button class="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors" data-v-1e50c06d${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" data-v-1e50c06d${_scopeId}></path></svg> Post ke Laba Rugi </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.invoice.posted_to_profit_loss) {
              _push2(`<button class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors" data-v-1e50c06d${_scopeId}><svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" data-v-1e50c06d${_scopeId}></path></svg> Batal Post Laba Rugi </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6" data-v-1e50c06d${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-1e50c06d${_scopeId}>Informasi Invoice</h3><div class="space-y-3" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Nomor Invoice:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.invoice_number)}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Sales Order:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate((_a = __props.invoice.sales_order) == null ? void 0 : _a.order_number)}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Customer:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(((_b = __props.invoice.customer) == null ? void 0 : _b.consignee_shipper) || ((_c = __props.invoice.customer) == null ? void 0 : _c.company_name))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Tanggal Invoice:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.invoice_date))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Jatuh Tempo:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.due_date))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Term:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.term_days)} Hari</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Status:</span><span class="${ssrRenderClass([getStatusColor(__props.invoice.status), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-1e50c06d${_scopeId}>${ssrInterpolate(getStatusLabel(__props.invoice.status))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Payment Status:</span><span class="${ssrRenderClass([getPaymentStatusColor(__props.invoice), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-1e50c06d${_scopeId}>${ssrInterpolate(getPaymentStatusLabel(__props.invoice))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Status Laba Rugi:</span><span class="${ssrRenderClass([__props.invoice.posted_to_profit_loss ? "bg-purple-100 text-purple-800" : "bg-gray-100 text-gray-800", "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.posted_to_profit_loss ? "Sudah Di-post" : "Belum Di-post")}</span></div></div></div><div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-1e50c06d${_scopeId}>Detail Pengiriman</h3><div class="space-y-3" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Shipper:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.shipper || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Consignee:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.consignee || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Vessel:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.vessel || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Flight/VOY:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.flight_voy || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>AWB/BL No:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.awb_bl_no || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>POL/POD:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.pol_pod || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Origin:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.origin || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Destination:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.destination || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Gross Weight:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.gross_weight || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Volume:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.volume || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>No. of Packages:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.no_of_packages || "-")} ${ssrInterpolate(__props.invoice.package_unit || "BAG")}</span></div></div></div>`);
            if (__props.invoice.status === "paid") {
              _push2(`<div class="bg-white rounded-lg shadow-sm p-6 border border-sage-200" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-sage-800 mb-4" data-v-1e50c06d${_scopeId}>Informasi Pembayaran</h3><div class="space-y-3" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Tanggal Dibayar:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatDate(__props.invoice.paid_date))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Jumlah Dibayar:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(__props.invoice.paid_amount))}</span></div>`);
              if (__props.invoice.payment_method) {
                _push2(`<div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Metode Pembayaran:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.payment_method)}</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Dikonfirmasi oleh:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(((_d = __props.invoice.confirmed_by) == null ? void 0 : _d.name) || "-")}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Waktu Konfirmasi:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatDateTime(__props.invoice.payment_confirmed_at))}</span></div>`);
              if (__props.invoice.payment_notes) {
                _push2(`<div class="pt-2" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Catatan:</span><p class="text-gray-900 mt-1" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.payment_notes)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            if (__props.invoice.posted_to_profit_loss) {
              _push2(`<div class="bg-white rounded-lg shadow-sm p-6 border border-purple-200" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-purple-800 mb-4" data-v-1e50c06d${_scopeId}>Informasi Posting Laba Rugi</h3><div class="space-y-3" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Status:</span><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800" data-v-1e50c06d${_scopeId}> Sudah Di-post </span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Tanggal Posting:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatDateTime(__props.invoice.posted_to_profit_loss_at))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Di-post oleh:</span><span class="font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(((_e = __props.invoice.posted_by_user) == null ? void 0 : _e.name) || "-")}</span></div>`);
              if (__props.invoice.profit_loss_entries && __props.invoice.profit_loss_entries.length > 0) {
                _push2(`<div class="pt-2" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Entry IDs:</span><p class="text-gray-900 mt-1 text-sm" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.profit_loss_entries.join(", "))}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            if (__props.mainInvoice || __props.invoice.invoice_type === "main" || __props.invoice.invoice_type === "combined") {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden mb-6" data-v-1e50c06d${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-blue-50" data-v-1e50c06d${_scopeId}><div class="flex items-center justify-between" data-v-1e50c06d${_scopeId}><div class="flex items-center space-x-3" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-blue-800" data-v-1e50c06d${_scopeId}>Items Invoice Main</h3><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate((__props.mainInvoice || __props.invoice).invoice_number)}</span></div><div class="flex space-x-2" data-v-1e50c06d${_scopeId}><a${ssrRenderAttr("href", unref(route)("admin-keuangan.invoices.preview-pdf", (__props.mainInvoice || __props.invoice).id))} class="inline-flex items-center px-3 py-1.5 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-700 transition-colors" target="_blank" data-v-1e50c06d${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-1e50c06d${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-1e50c06d${_scopeId}></path></svg> Preview PDF </a><a${ssrRenderAttr("href", unref(route)("admin-keuangan.invoices.export-pdf", (__props.mainInvoice || __props.invoice).id))} class="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700 transition-colors" target="_blank" data-v-1e50c06d${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" data-v-1e50c06d${_scopeId}></path></svg> Download PDF </a></div></div></div><div class="overflow-x-auto" data-v-1e50c06d${_scopeId}><table class="w-full" data-v-1e50c06d${_scopeId}><thead class="bg-sage-50" data-v-1e50c06d${_scopeId}><tr data-v-1e50c06d${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Deskripsi </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Amount </th></tr></thead><tbody class="bg-white divide-y divide-sage-200" data-v-1e50c06d${_scopeId}><!--[-->`);
              ssrRenderList(getMainItems.value, (item) => {
                _push2(`<tr class="hover:bg-sage-50" data-v-1e50c06d${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.description)}</div>`);
                if (getReimbursementLatestHistory(item)) {
                  _push2(`<div class="text-xs text-gray-500 mt-1 space-y-0.5" data-v-1e50c06d${_scopeId}><div class="flex flex-wrap items-center gap-2" data-v-1e50c06d${_scopeId}><span data-v-1e50c06d${_scopeId}>Terakhir:</span><span class="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-100 text-gray-700" data-v-1e50c06d${_scopeId}>${ssrInterpolate(getReimbursementStatusLabel(getReimbursementLatestHistory(item).status))}</span>`);
                  if (getReimbursementLatestHistory(item).vendor_name) {
                    _push2(`<span data-v-1e50c06d${_scopeId}> oleh ${ssrInterpolate(getReimbursementLatestHistory(item).vendor_name)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (getReimbursementLatestHistory(item).timestamp) {
                    _push2(`<span data-v-1e50c06d${_scopeId}> (${ssrInterpolate(formatDate(getReimbursementLatestHistory(item).timestamp))}) </span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                  if (getReimbursementLatestHistory(item).notes) {
                    _push2(`<div data-v-1e50c06d${_scopeId}> Catatan: ${ssrInterpolate(getReimbursementLatestHistory(item).notes)}</div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  if (getReimbursementLatestHistory(item).user) {
                    _push2(`<div data-v-1e50c06d${_scopeId}> Diproses oleh: ${ssrInterpolate(getReimbursementLatestHistory(item).user)}</div>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                ...
                _push2(`</td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatNumber(item.quantity))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.unit)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(item.rate, item.currency))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.currency)}</div></td><td class="px-6 py-4 whitespace-nowrap text-right" data-v-1e50c06d${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(
                  item.amount,
                  item.currency
                ))}</div></td></tr>`);
              });
              _push2(`<!--]--></tbody></table></div><div class="px-6 py-4 bg-blue-50 border-t border-sage-200" data-v-1e50c06d${_scopeId}><div class="flex justify-end" data-v-1e50c06d${_scopeId}><div class="w-64 space-y-2" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-sm text-gray-600" data-v-1e50c06d${_scopeId}>Subtotal Main:</span><span class="text-sm font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getMainTotal.value))}</span></div><div class="flex justify-between pt-2 border-t border-blue-200" data-v-1e50c06d${_scopeId}><span class="text-lg font-semibold text-blue-800" data-v-1e50c06d${_scopeId}>Total Main:</span><span class="text-lg font-bold text-blue-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getMainTotal.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.reimbursementInvoice || __props.invoice.invoice_type === "reimbursement" || __props.invoice.invoice_type === "combined") {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden mb-6" data-v-1e50c06d${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-orange-50" data-v-1e50c06d${_scopeId}><div class="flex items-center justify-between" data-v-1e50c06d${_scopeId}><div class="flex items-center space-x-3" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-orange-800" data-v-1e50c06d${_scopeId}>Items Invoice Reimbursement</h3><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate((__props.reimbursementInvoice || __props.invoice).invoice_number)}</span></div><div class="flex space-x-2" data-v-1e50c06d${_scopeId}><a${ssrRenderAttr("href", unref(route)("admin-keuangan.invoices.preview-pdf-reimbursement", (__props.reimbursementInvoice || __props.invoice).id))} class="inline-flex items-center px-3 py-1.5 bg-gray-600 text-white text-sm rounded-md hover:bg-gray-700 transition-colors" target="_blank" data-v-1e50c06d${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" data-v-1e50c06d${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" data-v-1e50c06d${_scopeId}></path></svg> Preview PDF </a><a${ssrRenderAttr("href", unref(route)("admin-keuangan.invoices.export-pdf-reimbursement", (__props.reimbursementInvoice || __props.invoice).id))} class="inline-flex items-center px-3 py-1.5 bg-orange-600 text-white text-sm rounded-md hover:bg-orange-700 transition-colors" target="_blank" data-v-1e50c06d${_scopeId}><svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" data-v-1e50c06d${_scopeId}></path></svg> Download PDF </a></div></div></div>`);
              if (hasReimbursementEntries.value) {
                _push2(`<div class="overflow-x-auto" data-v-1e50c06d${_scopeId}><table class="w-full" data-v-1e50c06d${_scopeId}><thead class="bg-sage-50" data-v-1e50c06d${_scopeId}><tr data-v-1e50c06d${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Deskripsi </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Amount </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Vendor </th><th class="px-6 py-3 text-left text-xs font-medium text-sage-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}></th></tr></thead><tbody class="bg-white divide-y divide-sage-200" data-v-1e50c06d${_scopeId}>`);
                if (filteredReimbursementEntries.value.length === 0) {
                  _push2(`<tr data-v-1e50c06d${_scopeId}><td colspan="10" class="px-6 py-6 text-center text-sm text-gray-500" data-v-1e50c06d${_scopeId}> Tidak ada data reimbursement untuk filter ini. </td></tr>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--[-->`);
                ssrRenderList(filteredReimbursementEntries.value, (item) => {
                  _push2(`<tr class="hover:bg-sage-50" data-v-1e50c06d${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.description)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatNumber(item.quantity))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.unit)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(item.rate, item.currency || reimbursementCurrency.value))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.currency || reimbursementCurrency.value)}</div></td><td class="px-6 py-4 whitespace-nowrap text-right" data-v-1e50c06d${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(item.amount, item.currency || reimbursementCurrency.value))}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-1e50c06d${_scopeId}><div class="text-sm text-gray-900" data-v-1e50c06d${_scopeId}>${ssrInterpolate(item.vendor_name)}</div></td></tr>`);
                });
              ...
              _push2(`<div class="px-6 py-4 bg-orange-50 border-t border-sage-200" data-v-1e50c06d${_scopeId}><div class="flex justify-end" data-v-1e50c06d${_scopeId}><div class="w-64 space-y-2" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-sm text-gray-600" data-v-1e50c06d${_scopeId}>${ssrInterpolate(reimbursementSubtotalLabel.value)}</span><span class="text-sm font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(reimbursementFilteredSubtotal.value, reimbursementCurrency.value))}</span></div>`);
              if (hasReimbursementEntries.value && reimbursementFilter.value !== "all") {
                _push2(`<div class="text-xs text-gray-500 text-right" data-v-1e50c06d${_scopeId}> Menampilkan ${ssrInterpolate(filteredReimbursementEntries.value.length)} dari ${ssrInterpolate(normalizedReimbursementEntries.value.length)} item </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex justify-between pt-2 border-t border-orange-200" data-v-1e50c06d${_scopeId}><span class="text-lg font-semibold text-orange-800" data-v-1e50c06d${_scopeId}>Total Reimbursement:</span><span class="text-lg font-bold text-orange-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(reimbursementOverallSubtotal.value, reimbursementCurrency.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (getOperationalCosts.value.length > 0) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-red-200 overflow-hidden mb-6" data-v-1e50c06d${_scopeId}><div class="px-6 py-4 border-b border-red-200 bg-red-50" data-v-1e50c06d${_scopeId}><div class="flex items-center justify-between" data-v-1e50c06d${_scopeId}><div class="flex items-center space-x-3" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-red-800" data-v-1e50c06d${_scopeId}>Biaya Lain / Operational Costs</h3><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800" data-v-1e50c06d${_scopeId}> Internal Only </span></div><div class="text-sm text-red-600" data-v-1e50c06d${_scopeId}> Tidak terlihat oleh customer </div></div></div><div class="overflow-x-auto" data-v-1e50c06d${_scopeId}><table class="w-full" data-v-1e50c06d${_scopeId}><thead class="bg-red-50" data-v-1e50c06d${_scopeId}><tr data-v-1e50c06d${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Deskripsi </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Qty </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Unit </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Rate </th><th class="px-6 py-3 text-left text-xs font-medium text-red-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Currency </th><th class="px-6 py-3 text-right text-xs font-medium text-red-500 uppercase tracking-wider" data-v-1e50c06d${_scopeId}> Amount </th></tr></thead><tbody class="bg-white divide-y divide-red-200" data-v-1e50c06d${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></tbody></table></div><div class="px-6 py-4 bg-red-50 border-t border-red-200" data-v-1e50c06d${_scopeId}><div class="flex justify-end" data-v-1e50c06d${_scopeId}><div class="w-64 space-y-2" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-sm text-gray-600" data-v-1e50c06d${_scopeId}>Subtotal Biaya Lain:</span><span class="text-sm font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div><div class="flex justify-between pt-2 border-t border-red-200" data-v-1e50c06d${_scopeId}><span class="text-lg font-semibold text-red-800" data-v-1e50c06d${_scopeId}>Total Biaya Lain:</span><span class="text-lg font-bold text-red-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="bg-white rounded-lg shadow-sm border border-purple-200 overflow-hidden mb-6" data-v-1e50c06d${_scopeId}><div class="px-6 py-4 border-b border-purple-200 bg-purple-50" data-v-1e50c06d${_scopeId}><div class="flex items-center justify-between" data-v-1e50c06d${_scopeId}><div class="flex items-center space-x-3" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-purple-800" data-v-1e50c06d${_scopeId}>Analisis Profit</h3><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800" data-v-1e50c06d${_scopeId}> Internal Analysis </span></div></div></div><div class="px-6 py-4" data-v-1e50c06d${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" data-v-1e50c06d${_scopeId}><div class="bg-green-50 rounded-lg p-4 border border-green-200" data-v-1e50c06d${_scopeId}><div class="text-center" data-v-1e50c06d${_scopeId}><div class="text-2xl font-bold text-green-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</div><div class="text-sm text-green-600 mt-1" data-v-1e50c06d${_scopeId}>Gross Revenue</div><div class="text-xs text-gray-500 mt-1" data-v-1e50c06d${_scopeId}>Total yang dapat ditagih</div></div></div><div class="bg-red-50 rounded-lg p-4 border border-red-200" data-v-1e50c06d${_scopeId}><div class="text-center" data-v-1e50c06d${_scopeId}><div class="text-2xl font-bold text-red-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</div><div class="text-sm text-red-600 mt-1" data-v-1e50c06d${_scopeId}>Operational Costs</div><div class="text-xs text-gray-500 mt-1" data-v-1e50c06d${_scopeId}>Biaya operasional</div></div></div><div class="bg-blue-50 rounded-lg p-4 border border-blue-200" data-v-1e50c06d${_scopeId}><div class="text-center" data-v-1e50c06d${_scopeId}><div class="text-2xl font-bold text-blue-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getNetProfit.value))}</div><div class="text-sm text-blue-600 mt-1" data-v-1e50c06d${_scopeId}>Net Profit</div><div class="text-xs text-gray-500 mt-1" data-v-1e50c06d${_scopeId}>Keuntungan bersih</div></div></div><div class="bg-purple-50 rounded-lg p-4 border border-purple-200" data-v-1e50c06d${_scopeId}><div class="text-center" data-v-1e50c06d${_scopeId}><div class="text-2xl font-bold text-purple-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(getProfitMargin.value)}%</div><div class="text-sm text-purple-600 mt-1" data-v-1e50c06d${_scopeId}>Profit Margin</div><div class="text-xs text-gray-500 mt-1" data-v-1e50c06d${_scopeId}>Persentase keuntungan</div></div></div></div><div class="mt-6 bg-gray-50 rounded-lg p-4" data-v-1e50c06d${_scopeId}><h4 class="text-sm font-semibold text-gray-800 mb-3" data-v-1e50c06d${_scopeId}>Detail Perhitungan:</h4><div class="space-y-2 text-sm" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Gross Revenue (Items yang dapat ditagih):</span><span class="font-medium text-green-700" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Operational Costs (Biaya internal):</span><span class="font-medium text-red-700" data-v-1e50c06d${_scopeId}>- ${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div><hr class="border-gray-300" data-v-1e50c06d${_scopeId}><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Reimbursement (Cost Neutral - Tidak mengurangi profit):</span><span class="font-medium text-orange-700" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getReimbursementTotal.value))}</span></div><hr class="border-gray-300" data-v-1e50c06d${_scopeId}><div class="flex justify-between font-semibold" data-v-1e50c06d${_scopeId}><span class="text-gray-800" data-v-1e50c06d${_scopeId}>Net Profit:</span><span class="text-blue-700" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getNetProfit.value))}</span></div><div class="flex justify-between text-sm" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Profit Margin:</span><span class="text-purple-700 font-medium" data-v-1e50c06d${_scopeId}>${ssrInterpolate(getProfitMargin.value)}%</span></div></div></div></div></div>`);
            if (__props.invoice.invoice_type === "combined" && getMainItems.value.length > 0 && getReimbursementItems.value.length > 0) {
              _push2(`<div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-1e50c06d${_scopeId}><div class="px-6 py-4 bg-sage-50" data-v-1e50c06d${_scopeId}><div class="flex justify-end" data-v-1e50c06d${_scopeId}><div class="w-80 space-y-3" data-v-1e50c06d${_scopeId}><div class="text-center text-lg font-semibold text-sage-800 pb-2 border-b border-sage-300" data-v-1e50c06d${_scopeId}> Combined Invoice Summary </div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-sm text-blue-700" data-v-1e50c06d${_scopeId}>Total Main Items:</span><span class="text-sm font-medium text-blue-700" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getMainTotal.value))}</span></div><div class="flex justify-between" data-v-1e50c06d${_scopeId}><span class="text-sm text-orange-700" data-v-1e50c06d${_scopeId}>Total Reimbursement Items:</span><span class="text-sm font-medium text-orange-700" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getReimbursementTotal.value))}</span></div><div class="flex justify-between pt-3 border-t border-sage-400" data-v-1e50c06d${_scopeId}><span class="text-xl font-bold text-sage-800" data-v-1e50c06d${_scopeId}>Grand Total:</span><span class="text-xl font-bold text-sage-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getMainTotal.value + getReimbursementTotal.value))}</span></div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (showPaymentModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-1e50c06d${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-gray-900 mb-4" data-v-1e50c06d${_scopeId}>Konfirmasi Pembayaran</h3><form data-v-1e50c06d${_scopeId}><div class="space-y-4" data-v-1e50c06d${_scopeId}><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Jumlah Dibayar</label><input type="number"${ssrRenderAttr("value", paymentForm.paid_amount)}${ssrRenderAttr("placeholder", formatCurrency(__props.invoice.total))} step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-1e50c06d${_scopeId}></div><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Tanggal Pembayaran</label><input type="date"${ssrRenderAttr("value", paymentForm.paid_date)}${ssrRenderAttr("max", (/* @__PURE__ */ new Date()).toISOString().split("T")[0])} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" required data-v-1e50c06d${_scopeId}></div><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Metode Pembayaran</label><input type="text"${ssrRenderAttr("value", paymentForm.payment_method)} placeholder="Transfer Bank, Cash, dll." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-1e50c06d${_scopeId}></div><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Catatan (Opsional)</label><textarea rows="3" placeholder="Catatan tambahan tentang pembayaran..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-1e50c06d${_scopeId}>${ssrInterpolate(paymentForm.payment_notes)}</textarea></div></div><div class="flex justify-end space-x-3 mt-6" data-v-1e50c06d${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-1e50c06d${_scopeId}> Batal </button><button type="submit"${ssrIncludeBooleanAttr(processing.value) ? " disabled" : ""} class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50" data-v-1e50c06d${_scopeId}>${ssrInterpolate(processing.value ? "Memproses..." : "Konfirmasi Pembayaran")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showMarkSentModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-1e50c06d${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-gray-900 mb-4" data-v-1e50c06d${_scopeId}>Tandai Invoice Sebagai Terkirim</h3><p class="text-gray-600 mb-6" data-v-1e50c06d${_scopeId}>Apakah Anda yakin ingin menandai invoice ini sebagai terkirim ke customer? </p><div class="flex justify-end space-x-3" data-v-1e50c06d${_scopeId}><button class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-1e50c06d${_scopeId}> Batal </button><button class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors" data-v-1e50c06d${_scopeId}> Ya, Tandai Terkirim </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showReimbursementPaymentModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-1e50c06d${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-orange-800 mb-4" data-v-1e50c06d${_scopeId}>Perbarui Status Reimbursement</h3>`);
              if (selectedReimbursementEntry.value) {
                _push2(`<div class="mb-4 text-sm text-gray-600" data-v-1e50c06d${_scopeId}><div class="font-medium text-gray-800" data-v-1e50c06d${_scopeId}>${ssrInterpolate(selectedReimbursementEntry.value.description)}</div><div data-v-1e50c06d${_scopeId}>Nominal: ${ssrInterpolate(formatCurrency(
              ...
              _push2(`<form data-v-1e50c06d${_scopeId}><div class="space-y-4" data-v-1e50c06d${_scopeId}><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Status</label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" data-v-1e50c06d${_scopeId}><option value="paid" data-v-1e50c06d${ssrIncludeBooleanAttr(Array.isArray(unref(reimbursementPaymentForm).status) ? ssrLooseContain(unref(reimbursementPaymentForm).status, "paid") : ssrLooseEqual(unref(reimbursementPaymentForm).status, "paid")) ? " selected" : ""}${_scopeId}>Sudah Dibayar</option><option value="invoiced" data-v-1e50c06d${ssrIncludeBooleanAttr(Array.isArray(unref(reimbursementPaymentForm).status) ? ssrLooseContain(unref(reimbursementPaymentForm).status, "invoiced") : ssrLooseEqual(unref(reimbursementPaymentForm).status, "invoiced")) ? " selected" : ""}${_scopeId}>Belum Dibayar</option></select></div>`);
              if (unref(reimbursementPaymentForm).status === "paid") {
                _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-1e50c06d${_scopeId}><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Vendor / Pembayar</label><input type="text"${ssrRenderAttr("value", unref(reimbursementPaymentForm).vendor_name)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Eshaka Wijaya Logistics" required data-v-1e50c06d${_scopeId}></div><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Tanggal Bayar</label><input type="date"${ssrRenderAttr("value", unref(reimbursementPaymentForm).paid_at)} class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" required data-v-1e50c06d${_scopeId}></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Catatan (Opsional)</label><textarea rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Contoh: Dibayar melalui rekening BCA perusahaan" data-v-1e50c06d${_scopeId}>${ssrInterpolate(unref(reimbursementPaymentForm).notes)}</textarea></div></div><div class="flex justify-end space-x-3 mt-6" data-v-1e50c06d${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-1e50c06d${_scopeId}> Batal </button><button type="submit"${ssrIncludeBooleanAttr(unref(reimbursementPaymentForm).processing) ? " disabled" : ""} class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors disabled:opacity-50" data-v-1e50c06d${_scopeId}>${ssrInterpolate(unref(reimbursementPaymentForm).processing ? "Menyimpan..." : "Simpan Perubahan")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showProfitLossModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-v-1e50c06d${_scopeId}><div class="bg-white rounded-lg p-6 w-full max-w-2xl mx-4" data-v-1e50c06d${_scopeId}><h3 class="text-lg font-semibold text-purple-800 mb-4" data-v-1e50c06d${_scopeId}>Post Invoice ke Laba Rugi</h3><div class="bg-purple-50 rounded-lg p-4 mb-6 border border-purple-200" data-v-1e50c06d${_scopeId}><h4 class="text-sm font-semibold text-purple-800 mb-3" data-v-1e50c06d${_scopeId}>Ringkasan Invoice:</h4><div class="grid grid-cols-2 gap-4 text-sm" data-v-1e50c06d${_scopeId}><div data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Invoice Number:</span><span class="font-medium text-purple-800 ml-2" data-v-1e50c06d${_scopeId}>${ssrInterpolate(__props.invoice.invoice_number)}</span></div><div data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Customer:</span><span class="font-medium text-purple-800 ml-2" data-v-1e50c06d${_scopeId}>${ssrInterpolate((_f = __props.invoice.customer) == null ? void 0 : _f.company_name)}</span></div><div data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Gross Revenue:</span><span class="font-medium text-green-700 ml-2" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</span></div><div data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Operational Costs:</span><span class="font-medium text-red-700 ml-2" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</span></div><div class="col-span-2 pt-2 border-t border-purple-200" data-v-1e50c06d${_scopeId}><span class="text-gray-600" data-v-1e50c06d${_scopeId}>Net Profit:</span><span class="font-bold text-blue-700 ml-2" data-v-1e50c06d${_scopeId}>${ssrInterpolate(formatCurrency(getNetProfit.value))}</span></div></div></div><form data-v-1e50c06d${_scopeId}><div class="space-y-4" data-v-1e50c06d${_scopeId}><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}> Periode Laba Rugi <span class="text-red-500" data-v-1e50c06d${_scopeId}>*</span></label><select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" required data-v-1e50c06d${_scopeId}><option value="" data-v-1e50c06d${ssrIncludeBooleanAttr(Array.isArray(profitLossForm.period_id) ? ssrLooseContain(profitLossForm.period_id, "") : ssrLooseEqual(profitLossForm.period_id, "")) ? " selected" : ""}${_scopeId}>Pilih Periode...</option><!--[-->`);
              ssrRenderList(profitLossPeriods.value, (period) => {
                _push2(`<option${ssrRenderAttr("value", period.id)} data-v-1e50c06d${ssrIncludeBooleanAttr(Array.isArray(profitLossForm.period_id) ? ssrLooseContain(profitLossForm.period_id, period.id) : ssrLooseEqual(profitLossForm.period_id, period.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(formatPeriodLabel(period))}</option>`);
              });
              _push2(`<!--]--></select><p class="text-xs text-gray-500 mt-1" data-v-1e50c06d${_scopeId}> Pilih periode laba rugi dimana transaksi ini akan dicatat </p></div><div data-v-1e50c06d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-1e50c06d${_scopeId}>Catatan (Opsional)</label><textarea rows="3" placeholder="Catatan tambahan untuk posting laba rugi..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500" data-v-1e50c06d${_scopeId}>${ssrInterpolate(profitLossForm.notes)}</textarea></div><div class="bg-blue-50 border border-blue-200 rounded-lg p-4" data-v-1e50c06d${_scopeId}><div class="flex items-start" data-v-1e50c06d${_scopeId}><svg class="w-5 h-5 text-blue-500 mt-0.5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-1e50c06d${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-1e50c06d${_scopeId}></path></svg><div class="text-sm" data-v-1e50c06d${_scopeId}><p class="text-blue-800 font-medium mb-1" data-v-1e50c06d${_scopeId}>Yang akan di-posting:</p><ul class="text-blue-700 space-y-1" data-v-1e50c06d${_scopeId}>`);
              if (getGrossRevenue.value > 0) {
                _push2(`<li data-v-1e50c06d${_scopeId}>• Pendapatan: ${ssrInterpolate(formatCurrency(getGrossRevenue.value))}</li>`);
              } else {
                _push2(`<!---->`);
              }
              if (getOperationalCostsTotal.value > 0) {
                _push2(`<li data-v-1e50c06d${_scopeId}>• Biaya Operasional: ${ssrInterpolate(formatCurrency(getOperationalCostsTotal.value))}</li>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<li data-v-1e50c06d${_scopeId}>• Net Profit Impact: ${ssrInterpolate(formatCurrency(getNetProfit.value))}</li></ul></div></div></div></div><div class="flex justify-end space-x-3 mt-6" data-v-1e50c06d${_scopeId}><button type="button" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" data-v-1e50c06d${_scopeId}> Batal </button><button type="submit"${ssrIncludeBooleanAttr(processing.value || !profitLossForm.period_id) ? " disabled" : ""} class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50" data-v-1e50c06d${_scopeId}>${ssrInterpolate(processing.value ? "Memproses..." : "Post ke Laba Rugi")}</button></div></form></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const Show = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1e50c06d"]]);
export {
  Show as default
};
