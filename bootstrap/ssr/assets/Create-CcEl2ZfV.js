...
import { A as AdminLayout } from "./AdminLayout-GL968NSd.js";
import { A as AlertDialog } from "./AlertDialog-EBWNJU3S.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./DropdownLink-DStkidMI.js";
import "./SidebarNavigation-b3lo_u81.js";
const _sfc_main = {
  __name: "Create",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4 sm:p-6 lg:p-8" data-v-90491cb6${_scopeId}><div class="bg-white rounded-lg shadow-sm p-6 mb-6 border border-sage-200" data-v-90491cb6${_scopeId}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between" data-v-90491cb6${_scopeId}><div class="flex items-center" data-v-90491cb6${_scopeId}><div class="w-12 h-12 bg-sage-600 rounded-full flex items-center justify-center mr-4" data-v-90491cb6${_scopeId}><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-90491cb6${_scopeId}></path></svg></div><div data-v-90491cb6${_scopeId}><h2 class="text-2xl font-bold text-sage-800" data-v-90491cb6${_scopeId}>Buat Sales Order Baru</h2><p class="text-sage-600" data-v-90491cb6${_scopeId}>Buat dokumen sales order untuk pelanggan</p></div></div><div class="mt-4 sm:mt-0" data-v-90491cb6${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-90491cb6${_scopeId2}></path></svg> Kembali `);
                } else {
                  return [
            ...
            _push2(`</div></div></div><form class="space-y-6" data-v-90491cb6${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Pilih Metode Input</h3></div><div class="p-6" data-v-90491cb6${_scopeId}><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="flex items-center" data-v-90491cb6${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(inputMethod.value, "manual")) ? " checked" : ""} value="manual" class="mr-3 text-sage-600 focus:ring-sage-500" data-v-90491cb6${_scopeId}><span class="text-sm font-medium text-sage-700" data-v-90491cb6${_scopeId}>Input Manual</span></label><p class="text-xs text-sage-500 mt-1 ml-6" data-v-90491cb6${_scopeId}>Isi semua data secara manual</p></div><div data-v-90491cb6${_scopeId}><label class="flex items-center" data-v-90491cb6${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(inputMethod.value, "customer")) ? " checked" : ""} value="customer" class="mr-3 text-sage-600 focus:ring-sage-500" data-v-90491cb6${_scopeId}><span class="text-sm font-medium text-sage-700" data-v-90491cb6${_scopeId}>Berdasarkan Data Pelanggan</span></label><p class="text-xs text-sage-500 mt-1 ml-6" data-v-90491cb6${_scopeId}>Auto-fill dari data pelanggan</p></div></div>`);
            if (inputMethod.value === "customer") {
              _push2(`<div class="mt-4" data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>Pilih Pelanggan</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}><option value="" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(selectedCustomerId.value) ? ssrLooseContain(selectedCustomerId.value, "") : ssrLooseEqual(selectedCustomerId.value, "")) ? " selected" : ""}${_scopeId}>-- Pilih Pelanggan --</option><!--[-->`);
              ssrRenderList(__props.customers, (customer) => {
                _push2(`<option${ssrRenderAttr("value", customer.id)} data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(selectedCustomerId.value) ? ssrLooseContain(selectedCustomerId.value, customer.id) : ssrLooseEqual(selectedCustomerId.value, customer.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(customer.company_name)} - ${ssrInterpolate(customer.pic_name)}</option>`);
              });
              _push2(`<!--]--></select></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Informasi Dasar</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.basic }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.basic ? null : { display: "none" })}" class="p-6 space-y-4" data-v-90491cb6${_scopeId}><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>ORDER NUMB <span class="text-red-500" data-v-90491cb6${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).order_number)} type="text" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.order_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.order_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>REF NO</label><input${ssrRenderAttr("value", unref(form).ref_no)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.ref_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.ref_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>DATE</label><input${ssrRenderAttr("value", unref(form).so_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.so_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.so_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>CUSTOMER <span class="text-red-500" data-v-90491cb6${_scopeId}>*</span></label><input${ssrRenderAttr("value", unref(form).customer)} type="text" required class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.customer) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.customer)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>SHIPPER</label><input${ssrRenderAttr("value", unref(form).shipper)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.shipper) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.shipper)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Informasi Pengiriman</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.shipping }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.shipping ? null : { display: "none" })}" class="p-6 space-y-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>BL/AWB</label><input${ssrRenderAttr("value", unref(form).bl_awb)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.bl_awb) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.bl_awb)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>LINER</label><input${ssrRenderAttr("value", unref(form).liner)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.liner) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.liner)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>VESSEL</label><input${ssrRenderAttr("value", unref(form).vessel)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.vessel) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.vessel)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>ETA</label><input${ssrRenderAttr("value", unref(form).eta)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.eta) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.eta)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>ETD</label><input${ssrRenderAttr("value", unref(form).etd)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.etd) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.etd)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>AJU</label><input${ssrRenderAttr("value", unref(form).aju)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.aju) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.aju)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>SPPB DATE</label><input${ssrRenderAttr("value", unref(form).sppb_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.sppb_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.sppb_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>SHIPMENT TYPE</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}><option value="" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, "") : ssrLooseEqual(unref(form).shipment_type, "")) ? " selected" : ""}${_scopeId}>Pilih Shipment Type</option><!--[-->`);
            ssrRenderList(__props.shipmentTypes, (shipmentType) => {
              _push2(`<option${ssrRenderAttr("value", shipmentType.code)} data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).shipment_type) ? ssrLooseContain(unref(form).shipment_type, shipmentType.code) : ssrLooseEqual(unref(form).shipment_type, shipmentType.code)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(shipmentType.name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            if (unref(form).errors.shipment_type) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.shipment_type)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>POL</label><input${ssrRenderAttr("value", unref(form).pol)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.pol) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.pol)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>POD</label><input${ssrRenderAttr("value", unref(form).pod)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.pod) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.pod)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>GUDANG/UTC</label><input${ssrRenderAttr("value", unref(form).gudang_utc)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.gudang_utc) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.gudang_utc)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>PARTY/LCL</label><input${ssrRenderAttr("value", unref(form).party_lcl)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.party_lcl) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.party_lcl)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>PREPARED BY</label><input${ssrRenderAttr("value", unref(form).prepared_by)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.prepared_by) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.prepared_by)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>EXCHANGE RATE</label><input${ssrRenderAttr("value", unref(form).exchange_rate)} type="number" step="0.0001" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.exchange_rate) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.exchange_rate)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Informasi Pricing</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.pricing }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.pricing ? null : { display: "none" })}" class="p-6 space-y-6" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>JENIS BIAYA</label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}><option value="" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "") : ssrLooseEqual(unref(form).jenis_biaya, "")) ? " selected" : ""}${_scopeId}>Pilih Jenis Biaya</option><option value="OF/AF" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "OF/AF") : ssrLooseEqual(unref(form).jenis_biaya, "OF/AF")) ? " selected" : ""}${_scopeId}>OF/AF</option><option value="HANDLING" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "HANDLING") : ssrLooseEqual(unref(form).jenis_biaya, "HANDLING")) ? " selected" : ""}${_scopeId}>HANDLING</option><option value="PIB EDI" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "PIB EDI") : ssrLooseEqual(unref(form).jenis_biaya, "PIB EDI")) ? " selected" : ""}${_scopeId}>PIB EDI</option><option value="ADMIN DOC" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "ADMIN DOC") : ssrLooseEqual(unref(form).jenis_biaya, "ADMIN DOC")) ? " selected" : ""}${_scopeId}>ADMIN DOC</option><option value="TRUCKING" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "TRUCKING") : ssrLooseEqual(unref(form).jenis_biaya, "TRUCKING")) ? " selected" : ""}${_scopeId}>TRUCKING</option><option value="D/O CHARGES" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "D/O CHARGES") : ssrLooseEqual(unref(form).jenis_biaya, "D/O CHARGES")) ? " selected" : ""}${_scopeId}>D/O CHARGES</option><option value="LOLO" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "LOLO") : ssrLooseEqual(unref(form).jenis_biaya, "LOLO")) ? " selected" : ""}${_scopeId}>LOLO</option><option value="STORAGE" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "STORAGE") : ssrLooseEqual(unref(form).jenis_biaya, "STORAGE")) ? " selected" : ""}${_scopeId}>STORAGE</option><option value="REFUND" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "REFUND") : ssrLooseEqual(unref(form).jenis_biaya, "REFUND")) ? " selected" : ""}${_scopeId}>REFUND</option><option value="OTHER" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(unref(form).jenis_biaya) ? ssrLooseContain(unref(form).jenis_biaya, "OTHER") : ssrLooseEqual(unref(form).jenis_biaya, "OTHER")) ? " selected" : ""}${_scopeId}>OTHER</option></select>`);
            if (unref(form).errors.jenis_biaya) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.jenis_biaya)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="bg-gray-50 rounded-lg p-4" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center mb-4" data-v-90491cb6${_scopeId}><h4 class="text-md font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Rincian Buying (Pengeluaran)</h4><button type="button" class="text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-90491cb6${_scopeId}> + Tambah Item </button></div><!--[-->`);
            ssrRenderList(unref(form).buying_breakdown, (item, index) => {
              _push2(`<div class="grid grid-cols-12 gap-3 mb-3" data-v-90491cb6${_scopeId}><div class="col-span-5" data-v-90491cb6${_scopeId}><input${ssrRenderAttr("value", item.vendor)} type="text" placeholder="Nama Vendor / Deskripsi" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div><div class="col-span-6" data-v-90491cb6${_scopeId}><input${ssrRenderAttr("value", item.amount)} type="number" step="0.01" placeholder="0.00" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div><div class="col-span-1" data-v-90491cb6${_scopeId}><button type="button" class="w-full h-10 text-red-600 hover:text-red-900 hover:bg-red-100 rounded transition-colors" data-v-90491cb6${_scopeId}> × </button></div></div>`);
            });
            _push2(`<!--]--><div class="mt-4 pt-3 border-t border-gray-300" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center font-semibold" data-v-90491cb6${_scopeId}><span data-v-90491cb6${_scopeId}>Total Buying:</span><span class="text-lg" data-v-90491cb6${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</span></div></div></div><div class="bg-gray-50 rounded-lg p-4" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center mb-4" data-v-90491cb6${_scopeId}><h4 class="text-md font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Rincian Selling (Pemasukan)</h4><button type="button" class="text-sm bg-sage-600 text-white px-3 py-1 rounded hover:bg-sage-700 transition-colors" data-v-90491cb6${_scopeId}> + Tambah Item </button></div><!--[-->`);
            ssrRenderList(unref(form).selling_breakdown, (item, index) => {
              _push2(`<div class="grid grid-cols-12 gap-3 mb-3" data-v-90491cb6${_scopeId}><div class="col-span-5" data-v-90491cb6${_scopeId}><input${ssrRenderAttr("value", item.description)} type="text" placeholder="Deskripsi Layanan" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div><div class="col-span-6" data-v-90491cb6${_scopeId}><input${ssrRenderAttr("value", item.amount)} type="number" step="0.01" placeholder="0.00" class="w-full px-3 py-2 border border-sage-300 rounded focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div><div class="col-span-1" data-v-90491cb6${_scopeId}><button type="button" class="w-full h-10 text-red-600 hover:text-red-900 hover:bg-red-100 rounded transition-colors" data-v-90491cb6${_scopeId}> × </button></div></div>`);
            });
            _push2(`<!--]--><div class="mt-4 pt-3 border-t border-gray-300" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center font-semibold" data-v-90491cb6${_scopeId}><span data-v-90491cb6${_scopeId}>Total Selling:</span><span class="text-lg" data-v-90491cb6${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</span></div></div></div><div class="bg-blue-50 rounded-lg p-4" data-v-90491cb6${_scopeId}><h4 class="text-md font-semibold text-blue-800 mb-3" data-v-90491cb6${_scopeId}>Ringkasan Revenue</h4><div class="space-y-2" data-v-90491cb6${_scopeId}><div class="flex justify-between" data-v-90491cb6${_scopeId}><span data-v-90491cb6${_scopeId}>Total Pemasukan (Selling):</span><span class="font-medium" data-v-90491cb6${_scopeId}>${ssrInterpolate(formatCurrency(totalSelling.value))}</span></div><div class="flex justify-between" data-v-90491cb6${_scopeId}><span data-v-90491cb6${_scopeId}>Total Pengeluaran (Buying):</span><span class="font-medium" data-v-90491cb6${_scopeId}>${ssrInterpolate(formatCurrency(totalBuying.value))}</span></div><div class="flex justify-between items-center pt-2 border-t border-blue-300 font-bold text-lg" data-v-90491cb6${_scopeId}><span data-v-90491cb6${_scopeId}>Profit (Revenue):</span><span class="${ssrRenderClass(totalRevenue.value >= 0 ? "text-green-600" : "text-red-600")}" data-v-90491cb6${_scopeId}>${ssrInterpolate(formatCurrency(totalRevenue.value))}</span></div></div></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>REMARKS</label><textarea rows="3" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).remarks)}</textarea>`);
            if (unref(form).errors.remarks) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.remarks)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Informasi Barang</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.goods }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.goods ? null : { display: "none" })}" class="p-6 space-y-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>COMMODITY/URAIAN BARANG</label><textarea rows="3" placeholder="Masukkan uraian barang/commodity yang detail" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).commodity)}</textarea>`);
            if (unref(form).errors.commodity) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.commodity)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="grid grid-cols-1 md:grid-cols-3 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>QTY</label><input${ssrRenderAttr("value", unref(form).qty)} type="number" min="0" placeholder="Masukkan quantity" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.qty) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.qty)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>NET WEIGHT (KG)</label><input${ssrRenderAttr("value", unref(form).net_weight)} type="number" step="0.01" min="0" placeholder="Masukkan berat netto dalam kg" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.net_weight) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.net_weight)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>MEAS (M³)</label><input${ssrRenderAttr("value", unref(form).measurement)} type="number" step="0.001" min="0" placeholder="Masukkan volume dalam m³" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.measurement) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.measurement)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>CONTAINER NO</label><input${ssrRenderAttr("value", unref(form).container_no)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.container_no) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.container_no)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Informasi Invoice</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.invoice }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.invoice ? null : { display: "none" })}" class="p-6 space-y-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>INVOICE NUMB</label><input${ssrRenderAttr("value", unref(form).invoice_number)} type="text" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.invoice_number) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_number)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>INVOICE DATE</label><input${ssrRenderAttr("value", unref(form).invoice_date)} type="date" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.invoice_date) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.invoice_date)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}>T.O.P</label><input${ssrRenderAttr("value", unref(form).top)} type="text" placeholder="e.g., NET 30" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}>`);
            if (unref(form).errors.top) {
              _push2(`<div class="mt-2 text-sm text-red-600" data-v-90491cb6${_scopeId}>${ssrInterpolate(unref(form).errors.top)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Buying to Vendor</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.vendor }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.vendor ? null : { display: "none" })}" class="p-6 space-y-4" data-v-90491cb6${_scopeId}><div class="flex items-center justify-between mb-4" data-v-90491cb6${_scopeId}><p class="text-sm text-gray-600" data-v-90491cb6${_scopeId}>Tambahkan detail vendor untuk setiap item buying</p><button type="button" class="inline-flex items-center px-3 py-1 bg-sage-600 text-white rounded-md hover:bg-sage-700 transition-colors" data-v-90491cb6${_scopeId}><svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-90491cb6${_scopeId}></path></svg> Add Vendor </button></div>`);
            if (vendorDetails.value.length === 0) {
              _push2(`<div class="text-gray-500 text-center py-8 border-2 border-dashed border-gray-300 rounded-lg" data-v-90491cb6${_scopeId}> No vendor details added yet. Click &quot;Add Vendor&quot; to start. </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(vendorDetails.value, (vendorDetail, index) => {
              _push2(`<div class="border border-sage-200 rounded-lg p-4 space-y-4" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center" data-v-90491cb6${_scopeId}><h5 class="font-medium text-sage-700" data-v-90491cb6${_scopeId}>Vendor #${ssrInterpolate(index + 1)}</h5><button type="button" class="text-red-600 hover:text-red-800 p-1" data-v-90491cb6${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-90491cb6${_scopeId}></path></svg></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}> Pilih Vendor <span class="text-red-500" data-v-90491cb6${_scopeId}>*</span></label><select class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}><option value="" data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(vendorDetail.vendor_id) ? ssrLooseContain(vendorDetail.vendor_id, "") : ssrLooseEqual(vendorDetail.vendor_id, "")) ? " selected" : ""}${_scopeId}>Pilih vendor...</option><!--[-->`);
              ssrRenderList(__props.vendors, (vendorOption) => {
                _push2(`<option${ssrRenderAttr("value", vendorOption.id)} data-v-90491cb6${ssrIncludeBooleanAttr(Array.isArray(vendorDetail.vendor_id) ? ssrLooseContain(vendorDetail.vendor_id, vendorOption.id) : ssrLooseEqual(vendorDetail.vendor_id, vendorOption.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(vendorOption.nama_vendor)}</option>`);
              });
              _push2(`<!--]--></select></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}> Deskripsi Service </label><input${ssrRenderAttr("value", vendorDetail.deskripsi)} type="text" placeholder="Deskripsi layanan vendor" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div></div>`);
              if (vendorDetail.vendor_id) {
                _push2(`<div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-3 bg-sage-50 rounded-lg" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-90491cb6${_scopeId}>Nama Vendor</label><p class="text-sm text-gray-900" data-v-90491cb6${_scopeId}>${ssrInterpolate(vendorDetail.nama_vendor || "-")}</p></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-90491cb6${_scopeId}>Nomor Rekening</label><p class="text-sm text-gray-900 font-mono" data-v-90491cb6${_scopeId}>${ssrInterpolate(vendorDetail.no_rekening || "-")}</p></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1" data-v-90491cb6${_scopeId}>Nama Rekening</label><p class="text-sm text-gray-900" data-v-90491cb6${_scopeId}>${ssrInterpolate(vendorDetail.nama_rekening || "-")}</p></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}> Nominal <span class="text-red-500" data-v-90491cb6${_scopeId}>*</span></label><input${ssrRenderAttr("value", vendorDetail.nominal)} type="number" step="0.01" placeholder="0" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2" data-v-90491cb6${_scopeId}> RCVD INV </label><input${ssrRenderAttr("value", vendorDetail.rcvd_inv)} type="text" placeholder="Nomor invoice yang diterima" class="w-full px-3 py-2 border border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div></div></div>`);
            });
            _push2(`<!--]-->`);
            if (vendorDetails.value.length > 0) {
              _push2(`<div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center" data-v-90491cb6${_scopeId}><span class="font-medium text-blue-700" data-v-90491cb6${_scopeId}>Total Vendor Costs:</span><span class="text-xl font-bold text-blue-800" data-v-90491cb6${_scopeId}>${ssrInterpolate(formatCurrency(totalVendorCosts.value))}</span></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 overflow-hidden" data-v-90491cb6${_scopeId}><div class="px-6 py-4 border-b border-sage-200 bg-sage-50 cursor-pointer flex justify-between items-center hover:bg-sage-100 transition-colors" data-v-90491cb6${_scopeId}><h3 class="text-lg font-semibold text-sage-800" data-v-90491cb6${_scopeId}>Voucher Management</h3><svg class="${ssrRenderClass([{ "rotate-180": !sections.value.voucher }, "w-5 h-5 text-sage-600 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-90491cb6${_scopeId}></path></svg></div><div style="${ssrRenderStyle(sections.value.voucher ? null : { display: "none" })}" class="p-6 space-y-6" data-v-90491cb6${_scopeId}><div class="space-y-4" data-v-90491cb6${_scopeId}><div class="flex items-center justify-between" data-v-90491cb6${_scopeId}><h4 class="text-md font-semibold text-sage-700" data-v-90491cb6${_scopeId}>Payment Vouchers</h4><button type="button" class="inline-flex items-center px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors" data-v-90491cb6${_scopeId}><svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-90491cb6${_scopeId}></path></svg> Add Payment </button></div>`);
            if (paymentVouchers.value.length === 0) {
              _push2(`<div class="text-gray-500 text-center py-4 border-2 border-dashed border-gray-300 rounded-lg" data-v-90491cb6${_scopeId}> No payment vouchers added yet </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(paymentVouchers.value, (voucher, index) => {
              _push2(`<div class="border border-gray-200 rounded-lg p-4 space-y-3" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center" data-v-90491cb6${_scopeId}><h5 class="font-medium text-gray-700" data-v-90491cb6${_scopeId}>Payment Voucher #${ssrInterpolate(index + 1)}</h5><button type="button" class="text-red-600 hover:text-red-800" data-v-90491cb6${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-90491cb6${_scopeId}></path></svg></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Voucher No</label><input${ssrRenderAttr("value", voucher.voucher_no)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="e.g., PAY-001" data-v-90491cb6${_scopeId}></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Date</label><input${ssrRenderAttr("value", voucher.date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Description</label><textarea rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" placeholder="e.g., Biaya Driver" data-v-90491cb6${_scopeId}>${ssrInterpolate(voucher.description)}</textarea></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Amount</label><input${ssrRenderAttr("value", voucher.amount)} type="number" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="500000" data-v-90491cb6${_scopeId}></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Prepared By</label><input${ssrRenderAttr("value", voucher.prepared_by)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="Staff name" data-v-90491cb6${_scopeId}></div></div></div>`);
            });
            _push2(`<!--]--></div><div class="space-y-4" data-v-90491cb6${_scopeId}><div class="flex items-center justify-between" data-v-90491cb6${_scopeId}><h4 class="text-md font-semibold text-sage-700" data-v-90491cb6${_scopeId}>Receipt Vouchers</h4><button type="button" class="inline-flex items-center px-3 py-1 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors" data-v-90491cb6${_scopeId}><svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" data-v-90491cb6${_scopeId}></path></svg> Add Receipt </button></div>`);
            if (receiptVouchers.value.length === 0) {
              _push2(`<div class="text-gray-500 text-center py-4 border-2 border-dashed border-gray-300 rounded-lg" data-v-90491cb6${_scopeId}> No receipt vouchers added yet </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(receiptVouchers.value, (voucher, index) => {
              _push2(`<div class="border border-gray-200 rounded-lg p-4 space-y-3" data-v-90491cb6${_scopeId}><div class="flex justify-between items-center" data-v-90491cb6${_scopeId}><h5 class="font-medium text-gray-700" data-v-90491cb6${_scopeId}>Receipt Voucher #${ssrInterpolate(index + 1)}</h5><button type="button" class="text-red-600 hover:text-red-800" data-v-90491cb6${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-90491cb6${_scopeId}></path></svg></button></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Voucher No</label><input${ssrRenderAttr("value", voucher.voucher_no)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="e.g., REC-001" data-v-90491cb6${_scopeId}></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Date</label><input${ssrRenderAttr("value", voucher.date)} type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-90491cb6${_scopeId}></div></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Description</label><textarea rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500 resize-none" placeholder="e.g., Payment received from client" data-v-90491cb6${_scopeId}>${ssrInterpolate(voucher.description)}</textarea></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-90491cb6${_scopeId}><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Amount</label><input${ssrRenderAttr("value", voucher.amount)} type="number" step="0.01" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="1000000" data-v-90491cb6${_scopeId}></div><div data-v-90491cb6${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1" data-v-90491cb6${_scopeId}>Prepared By</label><input${ssrRenderAttr("value", voucher.prepared_by)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" placeholder="Staff name" data-v-90491cb6${_scopeId}></div></div></div>`);
            });
            _push2(`<!--]--></div></div></div><div class="flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-3 pt-6" data-v-90491cb6${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin-cs.sales-orders.index"),
            ...
            _push2(`<button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="inline-flex items-center justify-center px-6 py-2 bg-sage-600 text-white rounded-lg hover:bg-sage-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" data-v-90491cb6${_scopeId}>`);
            if (unref(form).processing) {
              _push2(`<svg class="animate-spin -ml-1 mr-3 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" data-v-90491cb6${_scopeId}><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-90491cb6${_scopeId}></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-90491cb6${_scopeId}></path></svg>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(form).processing) {
              _push2(`<span data-v-90491cb6${_scopeId}>Menyimpan...</span>`);
            } else {
              _push2(`<span data-v-90491cb6${_scopeId}>Simpan Sales Order</span>`);
            }
...
const Create = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-90491cb6"]]);
export {
  Create as default
};
