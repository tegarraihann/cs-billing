...
import { ArrowLeft, PlusCircle, Download, RefreshCw, Edit, CheckCircle } from "lucide-vue-next";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const revenuesOther = computed(() => {
      var _a2, _b;
      return ((_b = (_a2 = props.reportData) == null ? void 0 : _a2.revenues) == null ? void 0 : _b.other) || [];
    });
    ...
    const operationalEntries = computed(() => {
      var _a2, _b, _c;
      const grouped = ((_c = (_b = (_a2 = props.reportData) == null ? void 0 : _a2.expenses) == null ? void 0 : _b.operational) == null ? void 0 : _c.grouped) || [];
            ...
            _push2(ssrRenderComponent(unref(SectionCard), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (manualRevenueEntries.value.length) {
                    _push3(`<div class="space-y-2"${_scopeId2}><div class="text-xs font-semibold text-gray-600 uppercase tracking-wide"${_scopeId2}>Manual Entries</div><div class="space-y-2"${_scopeId2}><!--[-->`);
                    ssrRenderList(manualRevenueEntries.value, (entry) => {
                      _push3(`<div class="flex items-center justify-between border border-gray-100 rounded px-3 py-2 bg-gray-50"${_scopeId2}><div class="text-sm text-gray-800"${_scopeId2}>${ssrInterpolate(entry.description)} <span class="ml-2 inline-flex px-2 py-0.5 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-800"${_scopeId2}>Manual</span></div><div class="text-sm font-bold text-gray-900"${_scopeId2}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
                    });
                    _push3(`<!--]--></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  ...
                  return [
                    ...
                    manualRevenueEntries.value.length ? (openBlock(), createBlock("div", {
                      key: 4,
                      class: "space-y-2"
                    }, [
                      createVNode("div", { class: "text-xs font-semibold text-gray-600 uppercase tracking-wide" }, "Manual Entries"),
                      createVNode("div", { class: "space-y-2" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(manualRevenueEntries.value, (entry) => {
                          return openBlock(), createBlock("div", {
                            key: entry.id,
                            class: "flex items-center justify-between border border-gray-100 rounded px-3 py-2 bg-gray-50"
                          }, [
                            createVNode("div", { class: "text-sm text-gray-800" }, [
                              createTextVNode(toDisplayString(entry.description) + " ", 1),
                              createVNode("span", { class: "ml-2 inline-flex px-2 py-0.5 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-800" }, "Manual")
                            ]),
                            createVNode("div", { class: "text-sm font-bold text-gray-900" }, toDisplayString(formatCurrency(entry.amount)), 1)
                          ]);
                        }), 128))
                      ])
            ...
            _push2(ssrRenderComponent(unref(SectionCard), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (manualExpenseEntries.value.length) {
                    _push3(`<div class="space-y-2"${_scopeId2}><div class="text-xs font-semibold text-gray-600 uppercase tracking-wide"${_scopeId2}>Manual Entries</div><div class="space-y-2"${_scopeId2}><!--[-->`);
                    ssrRenderList(manualExpenseEntries.value, (entry) => {
                      _push3(`<div class="flex items-center justify-between border border-gray-100 rounded px-3 py-2 bg-gray-50"${_scopeId2}><div class="text-sm text-gray-800"${_scopeId2}>${ssrInterpolate(entry.description)} <span class="ml-2 inline-flex px-2 py-0.5 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-800"${_scopeId2}>Manual</span></div><div class="text-sm font-bold text-gray-900"${_scopeId2}>${ssrInterpolate(formatCurrency(entry.amount))}</div></div>`);
                    });
                    _push3(`<!--]--></div></div>`);
                  } else {
                  ...
                  return [
                    ...
                    manualExpenseEntries.value.length ? (openBlock(), createBlock("div", {
                      key: 8,
                      class: "space-y-2"
                    }, [
                      createVNode("div", { class: "text-xs font-semibold text-gray-600 uppercase tracking-wide" }, "Manual Entries"),
                      createVNode("div", { class: "space-y-2" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(manualExpenseEntries.value, (entry) => {
                          return openBlock(), createBlock("div", {
                            key: entry.id,
                            class: "flex items-center justify-between border border-gray-100 rounded px-3 py-2 bg-gray-50"
                          }, [
