...
import { FileText, Percent, ArrowLeft, CreditCard, Edit, Plus } from "lucide-vue-next";
          ...
          if (_push2) {
            ...
            if (canPostVat.value) {
              _push2(ssrRenderComponent(SplitActionButton, {
                label: postingVat11.value ? "Posting..." : "Post VAT Payable",
                icon: unref(FileText),
                "on-click": postVatPayable11,
                disabled: postingVat11.value || postingVat11_1.value || postingPph23_05.value || postingPph23_2.value,
                items: vatActionItems.value
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            if (canPostVatReceivable.value) {
              _push2(ssrRenderComponent(SplitActionButton, {
                label: postingVatReceivable11.value ? "Posting..." : "Post VAT Receivable",
                icon: unref(FileText),
                "on-click": postVatReceivable11,
                disabled: postingVatReceivable11.value || postingVatReceivable11_1.value,
                items: vatReceivableActionItems.value
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    ...
                    createVNode("div", { class: "flex items-center space-x-3" }, [
                      ...
                      canPostVatReceivable.value ? (openBlock(), createBlock(SplitActionButton, {
                        key: 2,
                        label: postingVatReceivable11.value ? "Posting..." : "Post VAT Receivable",
                        icon: unref(FileText),
                        "on-click": postVatReceivable11,
