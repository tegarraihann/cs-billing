...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentIndexQuery = computed(() => {
      ...
      const currentPage = (_a2 = props.accounts) == null ? void 0 : _a2.current_page;
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_a2 = __props.accounts) == null ? void 0 : _a2.links) && __props.accounts.links.length > 3) {
              _push2(`<div class="mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(((_b2 = __props.accounts) == null ? void 0 : _b2.from) ?? 0)} to ${ssrInterpolate(((_c = __props.accounts) == null ? void 0 : _c.to) ?? 0)} of ${ssrInterpolate(((_d = __props.accounts) == null ? void 0 : _d.total) ?? 0)} accounts </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
              ssrRenderList(((_e = __props.accounts) == null ? void 0 : _e.links) || [], (link) => {
                _push2(`<!--[-->`);
                if (link.url) {
            ...
            _push2(ssrRenderComponent(AlertDialog, {
              ...
              message: `Are you sure you want to deactivate account '${(_f = deleteModal.account) == null ? void 0 : _f.account_code}'?`,
            ...
            return [
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      ...
                      ((_g = __props.accounts) == null ? void 0 : _g.links) && __props.accounts.links.length > 3 ? (openBlock(), createBlock("div", {
                        key: 1,
                        class: "mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"
                      }, [
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(((_h = __props.accounts) == null ? void 0 : _h.from) ?? 0) + " to " + toDisplayString(((_i = __props.accounts) == null ? void 0 : _i.to) ?? 0) + " of " + toDisplayString(((_j = __props.accounts) == null ? void 0 : _j.total) ?? 0) + " accounts ", 1),
                          createVNode("div", { class: "flex space-x-1" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(((_k = __props.accounts) == null ? void 0 : _k.links) || [], (link) => {
              ...
              createVNode(AlertDialog, {
                show: deleteModal.show,
                title: "Deactivate Account",
                message: `Are you sure you want to deactivate account '${(_l = deleteModal.account) == null ? void 0 : _l.account_code}'?`,
                "confirm-text": "Deactivate",
                "cancel-text": "Cancel",
                onConfirm: deactivateAccount,
                onCancel: ($event) => deleteModal.show = false
