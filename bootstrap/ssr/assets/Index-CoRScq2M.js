    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="py-6" data-v-db3f19e8${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-db3f19e8${_scopeId}><div class="flex justify-between items-center mb-6" data-v-db3f19e8${_scopeId}><div data-v-db3f19e8${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-db3f19e8${_scopeId}>Shipping Order Management</h1><p class="mt-1 text-sm text-gray-600" data-v-db3f19e8${_scopeId}>Manage CS shipping orders and create new shipping orders </p></div><div class="flex space-x-2" data-v-db3f19e8${_scopeId}>`);
            ...
            _push2(`</div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-db3f19e8${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-db3f19e8${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-db3f19e8${_scopeId}>Filters</h3><div class="grid grid-cols-1 md:grid-cols-4 gap-4" data-v-db3f19e8${_scopeId}><div class="md:col-span-3" data-v-db3f19e8${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-db3f19e8${_scopeId}>Search</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Search by order number, customer, or invoice..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-db3f19e8${_scopeId}></div><div class="flex items-end" data-v-db3f19e8${_scopeId}><button class="w-full px-4 py-2 bg-sage-800 text-white rounded-md transition-colors" data-v-db3f19e8${_scopeId}> Search </button></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md" data-v-db3f19e8${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-db3f19e8${_scopeId}><div class="sm:flex sm:items-center sm:justify-between mb-4" data-v-db3f19e8${_scopeId}><div data-v-db3f19e8${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-db3f19e8${_scopeId}>Shipping Orders List</h3><p class="mt-1 text-sm text-gray-600" data-v-db3f19e8${_scopeId}>Total: ${ssrInterpolate(((_a = __props.salesOrders) == null ? void 0 : _a.total) || 0)} records</p></div></div><div class="overflow-x-auto" data-v-db3f19e8${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-db3f19e8${_scopeId}><thead class="bg-gray-50" data-v-db3f19e8${_scopeId}><tr data-v-db3f19e8${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Order Number </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Customer </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Shipper </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Shipment Type </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Commodity </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> QTY </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Container No </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Status </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-db3f19e8${_scopeId}> Actions </th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-db3f19e8${_scopeId}><!--[-->`);
            ssrRenderList(__props.salesOrders.data, (salesOrder) => {
              _push2(`<tr class="hover:bg-gray-50" data-v-db3f19e8${_scopeId}><td class="px-6 py-4 text-sm font-medium text-gray-900" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.order_number || salesOrder.so_number)}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-db3f19e8${_scopeId}><div data-v-db3f19e8${_scopeId}><div class="font-medium" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.customer || salesOrder.customer_name)}</div>`);
              if (salesOrder.customer_code) {
                _push2(`<div class="text-gray-500" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.customer_code)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></td><td class="px-6 py-4 text-sm text-gray-900" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.shipper || salesOrder.consignee_shipper || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-db3f19e8${_scopeId}><span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.shipment_type || "-")}</span></td><td class="px-6 py-4 text-sm text-gray-900" data-v-db3f19e8${_scopeId}><div class="max-w-32 truncate"${ssrRenderAttr("title", salesOrder.commodity)} data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.commodity || salesOrder.goods || "-")}</div></td><td class="px-6 py-4 text-sm text-gray-900" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.qty || "-")}</td><td class="px-6 py-4 text-sm text-gray-900" data-v-db3f19e8${_scopeId}>`);
              if (salesOrder.container_no && Array.isArray(salesOrder.container_no)) {
                _push2(`<div class="space-y-1" data-v-db3f19e8${_scopeId}><!--[-->`);
                ssrRenderList(salesOrder.container_no.slice(0, 2), (container, index) => {
                  _push2(`<span class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full mr-1" data-v-db3f19e8${_scopeId}>${ssrInterpolate(container)}</span>`);
                });
                _push2(`<!--]-->`);
                if (salesOrder.container_no.length > 2) {
                  _push2(`<div class="text-xs text-gray-500" data-v-db3f19e8${_scopeId}> +${ssrInterpolate(salesOrder.container_no.length - 2)} more </div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              } else if (salesOrder.container_no) {
                _push2(`<span class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full" data-v-db3f19e8${_scopeId}>${ssrInterpolate(salesOrder.container_no)}</span>`);
              } else {
                _push2(`<span class="text-gray-500" data-v-db3f19e8${_scopeId}>-</span>`);
              }
              _push2(`</td><td class="px-6 py-4 text-sm" data-v-db3f19e8${_scopeId}><span class="${ssrRenderClass([getStatusColor(salesOrder.status), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"])}" data-v-db3f19e8${_scopeId}>${ssrInterpolate(getStatusLabel(salesOrder.status))}</span></td><td class="px-6 py-4 text-sm font-medium" data-v-db3f19e8${_scopeId}><div class="flex items-center space-x-2" data-v-db3f19e8${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
              ...
              _push2(`<a${ssrRenderAttr("href", _ctx.route("admin-keuangan.sales-orders.print", salesOrder.id))} class="text-green-600 hover:text-green-900 p-2 rounded-md hover:bg-green-50" title="Download PDF" target="_blank" data-v-db3f19e8${_scopeId}>`);
            ...
            if (!__props.salesOrders.data || __props.salesOrders.data.length === 0) {
              _push2(`<div class="text-center py-12" data-v-db3f19e8${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FileText), { class: "mx-auto h-12 w-12 text-gray-400" }, null, _parent2, _scopeId));
              _push2(`<h3 class="mt-2 text-sm font-medium text-gray-900" data-v-db3f19e8${_scopeId}>No shipping orders yet</h3><p class="mt-1 text-sm text-gray-500" data-v-db3f19e8${_scopeId}>Start by adding your first shipping order</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.salesOrders.links) {
              _push2(`<div class="mt-6" data-v-db3f19e8${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-db3f19e8"]]);
export {
  Index as default
};
