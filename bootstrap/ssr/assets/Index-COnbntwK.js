import { reactive, computed, ref, onMounted, withCtx, unref, createTextVNode, createVNode, createBlock, createCommentVNode, toDisplayString, withDirectives, vModelText, openBlock, Fragment, renderList, vModelSelect, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentIndexQuery = computed(() => {
      var _a;
      const query = {
        start_date: formFilters.start_date || void 0,
        end_date: formFilters.end_date || void 0,
        category_id: formFilters.category_id || void 0,
        type: formFilters.type || void 0,
        status: formFilters.status || void 0
      };
      const currentPage = (_a = props.transactions) == null ? void 0 : _a.current_page;
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="py-6"${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"${_scopeId}><div class="flex justify-between items-center mb-6"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-bold text-gray-900"${_scopeId}>Petty Cash Management</h1><p class="mt-1 text-sm text-gray-600"${_scopeId}>Manage daily petty cash transactions</p></div><div class="flex items-center space-x-3"${_scopeId}><button class="inline-flex items-center px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" title="Sync table balances with current balance"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(RefreshCw), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
            _push2(` Sync Balance </button>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(route)("admin-keuangan.petty-cash.create", { type: "opening" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` Add Transaction `);
                } else {
                  return [
                    createVNode(unref(Plus), { class: "w-4 h-4 mr-2" }),
                    createTextVNode(" Add Transaction ")
                  ];
                }
              }),
              _: 1
            ...
            _push2(`<!--]--></select></div><div${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-1"${_scopeId}>Type</label><select class="w-full rounded-md border-gray-300 shadow-sm focus:border-sage-500 focus:ring-sage-500"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(formFilters.type) ? ssrLooseContain(formFilters.type, "") : ssrLooseEqual(formFilters.type, "")) ? " selected" : ""}${_scopeId}>All Types</option><option value="expense"${ssrIncludeBooleanAttr(Array.isArray(formFilters.type) ? ssrLooseContain(formFilters.type, "expense") : ssrLooseEqual(formFilters.type, "expense")) ? " selected" : ""}${_scopeId}>Expense</option><option value="topup"${ssrIncludeBooleanAttr(Array.isArray(formFilters.type) ? ssrLooseContain(formFilters.type, "topup") : ssrLooseEqual(formFilters.type, "topup")) ? " selected" : ""}${_scopeId}>Top Up</option><option value="refund"${ssrIncludeBooleanAttr(Array.isArray(formFilters.type) ? ssrLooseContain(formFilters.type, "refund") : ssrLooseEqual(formFilters.type, "refund")) ? " selected" : ""}${_scopeId}>Refund</option><option value="opening"${ssrIncludeBooleanAttr(Array.isArray(formFilters.type) ? ssrLooseContain(formFilters.type, "opening") : ssrLooseEqual(formFilters.type, "opening")) ? " selected" : ""}${_scopeId}>Opening Balance</option></select></div></div><div class="flex justify-end space-x-3 mt-4"${_scopeId}><button class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"${_scopeId}> Clear </button><button class="px-4 py-2 text-sm font-medium text-white bg-sage-600 rounded-md hover:bg-sage-700 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2"${_scopeId}> Apply Filters </button></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md"${_scopeId}><div class="px-4 py-5 sm:px-6"${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900"${_scopeId}>Transaction List</h3></div><div class="overflow-x-auto"${_scopeId}><table class="min-w-full divide-y divide-gray-200"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Date</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Description</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Category</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Type</th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Amount</th><th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Balance</th><th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}>Actions</th></tr></thead><tbody class="bg-white divide-y divide-gray-200"${_scopeId}><!--[-->`);
            ...
            if (props.transactions.data.length === 0) {
              _push2(`<tr${_scopeId}><td colspan="7" class="px-6 py-12 text-center text-sm text-gray-500"${_scopeId}> No transactions found </td></tr>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tbody></table></div>`);
            if (props.transactions.links.length > 3) {
              _push2(`<div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(props.transactions.from ?? 0)} to ${ssrInterpolate(props.transactions.to ?? 0)} of ${ssrInterpolate(props.transactions.total)} transactions </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
            ...
            if (showDeleteModal.value) {
              _push2(`<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50"${_scopeId}><div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white"${_scopeId}><div class="mt-3 text-center"${_scopeId}><h3 class="text-lg font-medium text-gray-900 mb-4"${_scopeId}>Confirm Delete</h3><div class="mt-2 px-7 py-3"${_scopeId}><p class="text-sm text-gray-500"${_scopeId}> Are you sure you want to delete the transaction &quot;${ssrInterpolate((_a = selectedTransaction.value) == null ? void 0 : _a.description)}&quot;? This action cannot be undone and will affect the petty cash balance. </p></div><div class="flex justify-center space-x-3 mt-4"${_scopeId}><button class="px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"${_scopeId}> Cancel </button><button class="px-4 py-2 bg-red-600 text-white rounded-md text-sm font-medium hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"${_scopeId}> Delete </button></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-6" }, [
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Manage daily petty cash transactions")
                    ]),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md mb-6" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900 mb-4" }, "Transaction Filters"),
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:px-6" }, [
                      createVNode("h3", { class: "text-lg leading-6 font-medium text-gray-900" }, "Transaction List")
                    ]),
                      ...
                      createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                        createVNode("thead", { class: "bg-gray-50" }, [
                          createVNode("tr", null, [
                            ...
                            createVNode("th", { class: "px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider" }, "Balance"),
                    ...
                    props.transactions.links.length > 3 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(props.transactions.from ?? 0) + " to " + toDisplayString(props.transactions.to ?? 0) + " of " + toDisplayString(props.transactions.total) + " transactions ", 1),
                ...
                createVNode("div", { class: "relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" }, [
                  createVNode("div", { class: "mt-3 text-center" }, [
                    ...
                    createVNode("div", { class: "mt-2 px-7 py-3" }, [
                      createVNode("p", { class: "text-sm text-gray-500" }, ' Are you sure you want to delete the transaction "' + toDisplayString((_b = selectedTransaction.value) == null ? void 0 : _b.description) + '"? This action cannot be undone and will affect the petty cash balance. ', 1)
                    ]),
