    ...
    const route = window.route || function(name, params) {
      ...
      if (typeof definition !== "function") {
        ...
        const queryString = new URLSearchParams(
          Object.entries(params).filter(([, value]) => value !== void 0 && value !== null && value !== "")
        ).toString();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "General Expense Details" }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(route)("admin-keuangan.general-expenses.index", __props.returnQuery),
            ...
            _push2(`<div${_scopeId}><h1 class="text-2xl font-bold text-sage-800"${_scopeId}>General Expense Details</h1><p class="text-sm text-sage-600"${_scopeId}>ID: ${ssrInterpolate(__props.generalExpense.id)}</p></div></div><div class="flex items-center space-x-3"${_scopeId}><span class="${ssrRenderClass([getStatusClass(__props.generalExpense.status), "px-3 py-1 rounded-full text-sm font-medium"])}"${_scopeId}>${ssrInterpolate(getStatusLabel(__props.generalExpense.status))}</span><div class="flex space-x-2"${_scopeId}>`);
            if (__props.generalExpense.status === "draft") {
              _push2(ssrRenderComponent(unref(Link), {
                href: unref(route)("admin-keuangan.general-expenses.edit", {
                  generalExpense: __props.generalExpense.id,
                  ...__props.returnQuery
                }),
            ...
            _push2(`</div></div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-6"${_scopeId}><div class="lg:col-span-2 space-y-6"${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6"${_scopeId}><h2 class="text-lg font-semibold text-sage-800 mb-4"${_scopeId}>Expense Information</h2><div class="grid grid-cols-1 md:grid-cols-2 gap-6"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}>Expense Date</label><p class="text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg"${_scopeId}>${ssrInterpolate(formatDate(__props.generalExpense.expense_date))}</p></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}>Category</label><p class="text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg"${_scopeId}>${ssrInterpolate(__props.generalExpense.category)}</p></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}>Period</label><p class="text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg"${_scopeId}>${ssrInterpolate(formatPeriod(__props.generalExpense.period_month, __props.generalExpense.period_year))}</p></div><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}>Status</label><span class="${ssrRenderClass([getStatusClass(__props.generalExpense.status), "inline-flex px-3 py-1 rounded-full text-sm font-medium"])}"${_scopeId}>${ssrInterpolate(getStatusLabel(__props.generalExpense.status))}</span></div></div>`);
            if (__props.generalExpense.notes) {
              _push2(`<div class="mt-6"${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-2"${_scopeId}>Notes</label><p class="text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg"${_scopeId}>${ssrInterpolate(__props.generalExpense.notes)}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6"${_scopeId}><h2 class="text-lg font-semibold text-sage-800 mb-4"${_scopeId}>Expense Item Details</h2><div class="space-y-4"${_scopeId}><!--[-->`);
            ssrRenderList(__props.generalExpense.items, (item, index) => {
              _push2(`<div class="p-4 border border-gray-200 rounded-lg bg-white"${_scopeId}><div class="flex justify-between items-start mb-3"${_scopeId}><h3 class="text-sm font-medium text-sage-800"${_scopeId}>Item #${ssrInterpolate(index + 1)}</h3><span class="text-lg font-semibold text-sage-900"${_scopeId}>${ssrInterpolate(formatCurrency(item.amount))}</span></div><div class="grid grid-cols-1 gap-4"${_scopeId}><div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1"${_scopeId}>Description</label><p class="text-sm text-sage-900"${_scopeId}>${ssrInterpolate(item.description)}</p></div>`);
              if (item.notes) {
                _push2(`<div${_scopeId}><label class="block text-sm font-medium text-sage-700 mb-1"${_scopeId}>Item Notes</label><p class="text-sm text-sage-600"${_scopeId}>${ssrInterpolate(item.notes)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
            ...
            if (!__props.generalExpense.items || __props.generalExpense.items.length === 0) {
              ...
              _push2(`<p class="text-sm"${_scopeId}>No expense items</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            _push2(`</div></div><div class="space-y-6"${_scopeId}><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6"${_scopeId}><h2 class="text-lg font-semibold text-sage-800 mb-4"${_scopeId}>Amount Summary</h2><div class="space-y-4"${_scopeId}><div class="text-center"${_scopeId}><div class="text-3xl font-bold text-red-600 mb-2"${_scopeId}>${ssrInterpolate(formatCurrency(__props.generalExpense.total_amount))}</div><div class="text-sm text-sage-600"${_scopeId}> Total Expense </div></div><div class="border-t border-sage-200 pt-4"${_scopeId}><div class="flex justify-between items-center text-sm"${_scopeId}><span class="text-sage-600"${_scopeId}>Item Count:</span><span class="font-medium"${_scopeId}>${ssrInterpolate(((_a = __props.generalExpense.items) == null ? void 0 : _a.length) || 0)}</span></div><div class="flex justify-between items-center text-sm mt-2"${_scopeId}><span class="text-sage-600"${_scopeId}>Average per Item:</span><span class="font-medium"${_scopeId}>${ssrInterpolate(((_b = __props.generalExpense.items) == null ? void 0 : _b.length) > 0 ? formatCurrency(__props.generalExpense.total_amount / __props.generalExpense.items.length) : formatCurrency(0))}</span></div></div></div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6"${_scopeId}><h2 class="text-lg font-semibold text-sage-800 mb-4"${_scopeId}>Additional Information</h2><div class="space-y-4 text-sm"${_scopeId}><div${_scopeId}><span class="font-medium text-sage-700"${_scopeId}>Created by:</span><p class="text-sage-900 mt-1"${_scopeId}>${ssrInterpolate(((_c = __props.generalExpense.creator) == null ? void 0 : _c.name) || "-")}</p></div><div${_scopeId}><span class="font-medium text-sage-700"${_scopeId}>Created date:</span><p class="text-sage-900 mt-1"${_scopeId}>${ssrInterpolate(formatDateTime(__props.generalExpense.created_at))}</p></div>`);
            if (__props.generalExpense.updated_at !== __props.generalExpense.created_at) {
              _push2(`<div${_scopeId}><span class="font-medium text-sage-700"${_scopeId}>Last updated:</span><p class="text-sage-900 mt-1"${_scopeId}>${ssrInterpolate(formatDateTime(__props.generalExpense.updated_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.generalExpense.approved_by && __props.generalExpense.approved_at) {
              _push2(`<div${_scopeId}><span class="font-medium text-sage-700"${_scopeId}>Approved by:</span><p class="text-sage-900 mt-1"${_scopeId}>${ssrInterpolate(((_d = __props.generalExpense.approver) == null ? void 0 : _d.name) || "-")}</p><p class="text-sage-600 text-xs mt-1"${_scopeId}>${ssrInterpolate(formatDateTime(__props.generalExpense.approved_at))}</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="bg-white rounded-lg shadow-sm border border-sage-200 p-6"${_scopeId}><h2 class="text-lg font-semibold text-sage-800 mb-4"${_scopeId}>Actions</h2><div class="space-y-3"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(route)("admin-keuangan.general-expenses.index", __props.returnQuery),
            ...
            if (showDeleteModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"${_scopeId}><div class="bg-white rounded-lg p-6 max-w-md w-full mx-4"${_scopeId}><h3 class="text-lg font-medium text-sage-900 mb-4"${_scopeId}>Confirm Delete</h3><p class="text-sm text-sage-600 mb-6"${_scopeId}> Are you sure you want to delete the expense in category &quot;${ssrInterpolate(__props.generalExpense.category)}&quot;? This action cannot be undone. </p><div class="flex justify-end space-x-3"${_scopeId}><button class="px-4 py-2 text-sm font-medium text-sage-700 bg-white border border-sage-300 rounded-lg hover:bg-sage-50 transition-colors"${_scopeId}> Cancel </button><button class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition-colors"${_scopeId}> Delete </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showApproveModal.value) {
              _push2(`<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"${_scopeId}><div class="bg-white rounded-lg p-6 max-w-md w-full mx-4"${_scopeId}><h3 class="text-lg font-medium text-sage-900 mb-4"${_scopeId}>Confirm Approval</h3><p class="text-sm text-sage-600 mb-6"${_scopeId}> Are you sure you want to approve the expense in category &quot;${ssrInterpolate(__props.generalExpense.category)}&quot; with a total of ${ssrInterpolate(formatCurrency(__props.generalExpense.total_amount))}? </p><div class="flex justify-end space-x-3"${_scopeId}><button class="px-4 py-2 text-sm font-medium text-sage-700 bg-white border border-sage-300 rounded-lg hover:bg-sage-50 transition-colors"${_scopeId}> Cancel </button><button class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors"${_scopeId}> Approve </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createVNode(unref(Head), { title: "General Expense Details" }),
                  ...
                  createVNode("div", { class: "flex items-center justify-between mb-4" }, [
                    createVNode("div", { class: "flex items-center space-x-4" }, [
                      ...
                      createVNode("div", null, [
                        createVNode("h1", { class: "text-2xl font-bold text-sage-800" }, "General Expense Details"),
                ...
                createVNode("div", { class: "grid grid-cols-1 lg:grid-cols-3 gap-6" }, [
                  createVNode("div", { class: "lg:col-span-2 space-y-6" }, [
                    createVNode("div", { class: "bg-white rounded-lg shadow-sm border border-sage-200 p-6" }, [
                      createVNode("h2", { class: "text-lg font-semibold text-sage-800 mb-4" }, "Expense Information"),
                      createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-6" }, [
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, "Expense Date"),
                          createVNode("p", { class: "text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg" }, toDisplayString(formatDate(__props.generalExpense.expense_date)), 1)
                        ]),
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, "Category"),
                          createVNode("p", { class: "text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg" }, toDisplayString(__props.generalExpense.category), 1)
                        ]),
                        createVNode("div", null, [
                          createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-2" }, "Period"),
                          createVNode("p", { class: "text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg" }, toDisplayString(formatPeriod(__props.generalExpense.period_month, __props.generalExpense.period_year)), 1)
                        ]),
                        createVNode("div", null, [
                      ...
                      __props.generalExpense.notes ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("p", { class: "text-sm text-gray-900 bg-white border border-gray-200 px-3 py-2 rounded-lg" }, toDisplayString(__props.generalExpense.notes), 1)
                      ])) : createCommentVNode("", true)
                    ]),
                    createVNode("div", { class: "bg-white rounded-lg shadow-sm border border-sage-200 p-6" }, [
                      createVNode("h2", { class: "text-lg font-semibold text-sage-800 mb-4" }, "Expense Item Details"),
                      createVNode("div", { class: "space-y-4" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.generalExpense.items, (item, index) => {
                          return openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "grid grid-cols-1 gap-4" }, [
                              createVNode("div", null, [
                                createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-1" }, "Description"),
                                createVNode("p", { class: "text-sm text-sage-900" }, toDisplayString(item.description), 1)
                              ]),
                              item.notes ? (openBlock(), createBlock("div", { key: 0 }, [
                                createVNode("label", { class: "block text-sm font-medium text-sage-700 mb-1" }, "Item Notes"),
                        ...
                        !__props.generalExpense.items || __props.generalExpense.items.length === 0 ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("p", { class: "text-sm" }, "No expense items")
                        ])) : createCommentVNode("", true)
                      ]),
                      __props.generalExpense.items && __props.generalExpense.items.length > 0 ? (openBlock(), createBlock("div", {
                        key: 0,
                  ...
                  createVNode("div", { class: "space-y-6" }, [
                      ...
                      createVNode("div", { class: "space-y-4" }, [
                        ...
                        createVNode("div", { class: "border-t border-sage-200 pt-4" }, [
                          ...
                          createVNode("div", { class: "flex justify-between items-center text-sm mt-2" }, [
                            createVNode("span", { class: "text-sage-600" }, "Average per Item:"),
                    ...
                    createVNode("div", { class: "bg-white rounded-lg shadow-sm border border-sage-200 p-6" }, [
                      createVNode("h2", { class: "text-lg font-semibold text-sage-800 mb-4" }, "Actions"),
              ...
              showDeleteModal.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "bg-white rounded-lg p-6 max-w-md w-full mx-4" }, [
                  ...
                  createVNode("p", { class: "text-sm text-sage-600 mb-6" }, ' Are you sure you want to delete the expense in category "' + toDisplayString(__props.generalExpense.category) + '"? This action cannot be undone. ', 1),
              ...
              showApproveModal.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "bg-white rounded-lg p-6 max-w-md w-full mx-4" }, [
                  createVNode("h3", { class: "text-lg font-medium text-sage-900 mb-4" }, "Confirm Approval"),
                  createVNode("p", { class: "text-sm text-sage-600 mb-6" }, ' Are you sure you want to approve the expense in category "' + toDisplayString(__props.generalExpense.category) + '" with a total of ' + toDisplayString(formatCurrency(__props.generalExpense.total_amount)) + "? ", 1),
                  createVNode("div", { class: "flex justify-end space-x-3" }, [
                    createVNode("button", {
