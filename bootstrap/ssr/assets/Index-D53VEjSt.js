...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentPage = computed(() => {
      var _a2;
      return Number(((_a2 = props.customers) == null ? void 0 : _a2.current_page) || 1);
    });
    const lastPage = computed(() => {
      var _a2;
      return Number(((_a2 = props.customers) == null ? void 0 : _a2.last_page) || 1);
    });
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="py-6" data-v-c7f1818a${_scopeId}><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-c7f1818a${_scopeId}><div class="flex justify-between items-center mb-6" data-v-c7f1818a${_scopeId}><div data-v-c7f1818a${_scopeId}><h1 class="text-2xl font-bold text-gray-900" data-v-c7f1818a${_scopeId}>Customer Management</h1><p class="mt-1 text-sm text-gray-600" data-v-c7f1818a${_scopeId}>Manage customer records and contact information</p></div><div class="flex space-x-2" data-v-c7f1818a${_scopeId}><button class="inline-flex items-center px-4 py-2 bg-sage-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sage-900 focus:bg-sage-700 active:bg-sage-900 focus:outline-none focus:ring-2 focus:ring-sage-500 focus:ring-offset-2 transition ease-in-out duration-150" data-v-c7f1818a${_scopeId}>`);
            ...
            _push2(`</div></div><div class="bg-white shadow overflow-hidden sm:rounded-md mb-6" data-v-c7f1818a${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-c7f1818a${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900 mb-4" data-v-c7f1818a${_scopeId}>Filters</h3><div class="grid grid-cols-1 md:grid-cols-4 gap-4" data-v-c7f1818a${_scopeId}><div class="md:col-span-3" data-v-c7f1818a${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-c7f1818a${_scopeId}>Search</label><input${ssrRenderAttr("value", form.search)} type="text" placeholder="Search company name, contact, email, marketing..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sage-500 focus:border-sage-500" data-v-c7f1818a${_scopeId}></div><div class="flex items-end" data-v-c7f1818a${_scopeId}><button class="w-full px-4 py-2 bg-sage-600 text-white rounded-md hover:bg-sage-900 transition-colors" data-v-c7f1818a${_scopeId}> Search </button></div></div></div></div><div class="bg-white shadow overflow-hidden sm:rounded-md" data-v-c7f1818a${_scopeId}><div class="px-4 py-5 sm:p-6" data-v-c7f1818a${_scopeId}><div class="sm:flex sm:items-center sm:justify-between mb-4" data-v-c7f1818a${_scopeId}><div data-v-c7f1818a${_scopeId}><h3 class="text-lg leading-6 font-medium text-gray-900" data-v-c7f1818a${_scopeId}>Customer Data List</h3><p class="mt-1 text-sm text-gray-600" data-v-c7f1818a${_scopeId}>Total: ${ssrInterpolate(((_a2 = __props.customers) == null ? void 0 : _a2.total) || 0)} records</p></div></div><div class="overflow-x-auto" data-v-c7f1818a${_scopeId}><table class="min-w-full divide-y divide-gray-200" data-v-c7f1818a${_scopeId}><thead class="bg-gray-50" data-v-c7f1818a${_scopeId}><tr data-v-c7f1818a${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Customer Code </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Company Name </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Business Type </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Contact Name </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Contact Email </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Marketing </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" data-v-c7f1818a${_scopeId}> Handler </th><th scope="col" class="relative px-6 py-3" data-v-c7f1818a${_scopeId}><span class="sr-only" data-v-c7f1818a${_scopeId}>Delete</span></th></tr></thead><tbody class="bg-white divide-y divide-gray-200" data-v-c7f1818a${_scopeId}><!--[-->`);
            ssrRenderList(__props.customers.data, (customer) => {
              var _a3;
              _push2(`<tr class="hover:bg-gray-50 cursor-pointer" data-v-c7f1818a${_scopeId}><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.customer_code || "-")}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm font-medium text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.company_name)}</div><div class="text-sm text-gray-500" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.company_type)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.company_type)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.pic_name)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.pic_email)}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(customer.marketing_name || "-")}</div></td><td class="px-6 py-4 whitespace-nowrap" data-v-c7f1818a${_scopeId}><div class="text-sm text-gray-900" data-v-c7f1818a${_scopeId}>${ssrInterpolate(((_a3 = customer.handler) == null ? void 0 : _a3.name) || "-")}</div></td><td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" data-v-c7f1818a${_scopeId}><button class="text-red-600 hover:text-red-900 p-2 rounded-md hover:bg-red-50" title="Delete" data-v-c7f1818a${_scopeId}>`);
            ...
            if (!__props.customers.data || __props.customers.data.length === 0) {
              _push2(`<div class="text-center py-12" data-v-c7f1818a${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Users), { class: "mx-auto h-12 w-12 text-gray-400" }, null, _parent2, _scopeId));
              _push2(`<h3 class="mt-2 text-sm font-medium text-gray-900" data-v-c7f1818a${_scopeId}>No customer data yet</h3><p class="mt-1 text-sm text-gray-500" data-v-c7f1818a${_scopeId}>Start by adding your first customer</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.customers.links) {
              _push2(`<div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6 mt-6" data-v-c7f1818a${_scopeId}><div class="flex items-center justify-between" data-v-c7f1818a${_scopeId}><div class="text-sm text-gray-700" data-v-c7f1818a${_scopeId}> Showing ${ssrInterpolate(__props.customers.from || 0)} to ${ssrInterpolate(__props.customers.to || 0)} of ${ssrInterpolate(__props.customers.total || 0)} results </div><div class="flex items-center space-x-1" data-v-c7f1818a${_scopeId}><button${ssrIncludeBooleanAttr(currentPage.value <= 1) ? " disabled" : ""} class="${ssrRenderClass([
              ...
              ])}" data-v-c7f1818a${_scopeId}> « Previous </button><!--[-->`);
              ssrRenderList(paginationItems.value, (item) => {
                _push2(`<!--[-->`);
                if (item.type === "ellipsis") {
                  _push2(`<span class="px-3 py-2 text-sm text-gray-400" data-v-c7f1818a${_scopeId}> ... </span>`);
                } else {
                  ...
                  ])}" data-v-c7f1818a${_scopeId}>${ssrInterpolate(item.page)}</button>`);
                }
                _push2(`<!--]-->`);
              });
              ...
              ])}" data-v-c7f1818a${_scopeId}> Next » </button></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
                    ...
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      ...
                      __props.customers.links ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(__props.customers.from || 0) + " to " + toDisplayString(__props.customers.to || 0) + " of " + toDisplayString(__props.customers.total || 0) + " results ", 1),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c7f1818a"]]);
export {
  Index as default
};
