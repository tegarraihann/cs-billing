import { reactive, computed, withCtx, unref, createVNode, createTextVNode, withDirectives, withKeys, vModelText, createBlock, createCommentVNode, openBlock, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const currentIndexQuery = computed(() => {
      ...
      const currentPage = (_a2 = props.packageUnits) == null ? void 0 : _a2.current_page;
      ...
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_a2 = __props.packageUnits) == null ? void 0 : _a2.links) && __props.packageUnits.links.length > 3) {
              _push2(`<div class="mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div class="text-sm text-gray-700"${_scopeId}> Showing ${ssrInterpolate(((_b = __props.packageUnits) == null ? void 0 : _b.from) ?? 0)} to ${ssrInterpolate(((_c = __props.packageUnits) == null ? void 0 : _c.to) ?? 0)} of ${ssrInterpolate(((_d = __props.packageUnits) == null ? void 0 : _d.total) ?? 0)} package units </div><div class="flex space-x-1"${_scopeId}><!--[-->`);
              ssrRenderList(((_e = __props.packageUnits) == null ? void 0 : _e.links) || [], (link) => {
                _push2(`<!--[-->`);
                if (link.url) {
            ...
            _push2(ssrRenderComponent(AlertDialog, {
              ...
              message: `Are you sure you want to delete package unit '${(_f = deleteModal.unit) == null ? void 0 : _f.code}'?`,
              "confirm-text": "Delete",
              "cancel-text": "Cancel",
            ...
            return [
                ...
                createVNode("div", { class: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  ...
                  createVNode("div", { class: "bg-white shadow overflow-hidden sm:rounded-md" }, [
                    createVNode("div", { class: "px-4 py-5 sm:p-6" }, [
                      ...
                      ((_g = __props.packageUnits) == null ? void 0 : _g.links) && __props.packageUnits.links.length > 3 ? (openBlock(), createBlock("div", {
                        key: 1,
                        class: "mt-6 bg-white px-4 py-3 border-t border-gray-200 sm:px-6"
                      }, [
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          createVNode("div", { class: "text-sm text-gray-700" }, " Showing " + toDisplayString(((_h = __props.packageUnits) == null ? void 0 : _h.from) ?? 0) + " to " + toDisplayString(((_i = __props.packageUnits) == null ? void 0 : _i.to) ?? 0) + " of " + toDisplayString(((_j = __props.packageUnits) == null ? void 0 : _j.total) ?? 0) + " package units ", 1),
                          createVNode("div", { class: "flex space-x-1" }, [
                            (openBlock(true), createBlock(Fragment, null, renderList(((_k = __props.packageUnits) == null ? void 0 : _k.links) || [], (link) => {
              ...
              createVNode(AlertDialog, {
                show: deleteModal.show,
                title: "Delete Package Unit",
                message: `Are you sure you want to delete package unit '${(_l = deleteModal.unit) == null ? void 0 : _l.code}'?`,
                "confirm-text": "Delete",
                "cancel-text": "Cancel",
                onConfirm: deleteUnit,
                onCancel: ($event) => deleteModal.show = false
