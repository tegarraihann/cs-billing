import { reactive, mergeProps, withCtx, createVNode, createBlock, openBlock, withDirectives, vModelText, Fragment, renderList, toDisplayString, vModelSelect, createCommentVNode, useSSRContext } from "vue";
                ...
                createVNode("div", { class: "bg-white rounded-lg shadow-sm p-6 mb-6" }, [
                  createVNode("div", { class: "flex justify-between items-center mb-4" }, [
                    ...
                    createVNode("button", {
                      ...
                      createVNode("span", null, "Export PDF")
                    ])
                  ]),
