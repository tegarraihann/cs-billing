    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AdminKeuanganLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "All-in Salary Entry" }, null, _parent2, _scopeId));
            ...
            }, "mt-1 block w-full max-w-xs border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm"])}"${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).target_value) ? ssrLooseContain(unref(form).target_value, "") : ssrLooseEqual(unref(form).target_value, "")) ? " selected" : ""}${_scopeId}>Select Division</option><!--[-->`);
            ssrRenderList(__props.previewStats.divisions, (division, key) => {
              _push2(`<option${ssrRenderAttr("value", key)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).target_value) ? ssrLooseContain(unref(form).target_value, key) : ssrLooseEqual(unref(form).target_value, key)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(division.label)} (${ssrInterpolate(division.count)} employees) </option>`);
            });
            _push2(`<!--]--></select>`);
            ...
            _push2(`</div></div><div class="mt-6 p-4 bg-gray-50 rounded-lg"${_scopeId}><div class="flex justify-between items-center"${_scopeId}><span class="text-lg font-medium text-gray-900"${_scopeId}>Total Salary per Employee:</span><span class="text-2xl font-bold text-sage-600"${_scopeId}> IDR ${ssrInterpolate(formatCurrency(totalSalary.value))}</span></div></div></div><div class="mb-8"${_scopeId}><label for="notes" class="block text-sm font-medium text-gray-700 mb-2"${_scopeId}> Notes </label><textarea id="notes" rows="3" class="${ssrRenderClass([{ "border-red-300 focus:border-red-500 focus:ring-red-500": __props.errors.notes }, "mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-sage-500 focus:border-sage-500 sm:text-sm"])}" placeholder="Additional notes for this salary..."${_scopeId}>${ssrInterpolate(unref(form).notes)}</textarea>`);
            ...
            _push2(` ${ssrInterpolate(processing.value ? "Processing..." : "Save All-in Salary")}</button></div>`);
            if (unref(form).target_type) {
              ...
              _push2(`<div${_scopeId}><h4 class="text-sm font-medium text-blue-800 mb-1"${_scopeId}>Execution Preview</h4><p class="text-sm text-blue-700"${_scopeId}> The system will create individual salary records for <strong${_scopeId}>${ssrInterpolate(getTargetDescription())}</strong> with total salary <strong${_scopeId}>IDR ${ssrInterpolate(formatCurrency(totalSalary.value))}</strong> per employee. </p></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode(unref(Head), { title: "All-in Salary Entry" }),
              createVNode("div", { class: "py-6" }, [
                createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "mb-6" }, [
                    ...
                    createVNode("h1", { class: "text-2xl font-bold text-gray-900" }, "All-in Salary Entry"),
                    createVNode("p", { class: "mt-1 text-sm text-gray-600" }, "Enter salaries for all employees, a division, or a position at once.")
                  ]),
                    ...
                    createVNode("div", { class: "px-6 py-8" }, [
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "border-b border-gray-200 pb-6 mb-6" }, [
                          createVNode("h3", { class: "text-lg font-medium leading-6 text-gray-900 mb-4" }, "Select Target Employees"),
                          createVNode("div", { class: "space-y-4" }, [
                            createVNode("div", { class: "flex items-center" }, [
                              ...
                              createVNode("label", {
                                ...
                                createVNode("span", { class: "text-gray-500 ml-2" }, "(" + toDisplayString(__props.previewStats.total_staff || 0) + " employees)", 1)
                              ])
                            ]),
                            createVNode("div", { class: "flex items-start" }, [
                              ...
                              createVNode("div", { class: "ml-3 flex-1" }, [
                                createVNode("label", {
                                  ...
                                  createVNode("span", { class: "font-semibold" }, "ALL DIVISIONS")
                                ]),
                                withDirectives(createVNode("select", {
                                  ...
                                  (openBlock(true), createBlock(Fragment, null, renderList(__props.previewStats.divisions, (division, key) => {
                                    return openBlock(), createBlock("option", {
                                      key,
                                      value: key
                                    }, toDisplayString(division.label) + " (" + toDisplayString(division.count) + " employees) ", 9, ["value"]);
                                  }), 128))
                            ...
                            createVNode("div", { class: "flex items-start" }, [
                              ...
                              createVNode("div", { class: "ml-3 flex-1" }, [
                                createVNode("label", {
                                  ...
                                  createVNode("span", { class: "font-semibold" }, "ALL POSITIONS")
                                ]),
                                withDirectives(createVNode("input", {
                                  "onUpdate:modelValue": ($event) => unref(form).target_value = $event,
                                ...
                                createVNode("div", { class: "mt-2 text-xs text-gray-500" }, [
                                  createVNode("strong", null, "Available positions:"),
                                  createVNode("div", { class: "mt-1" }, [
                                    (openBlock(true), createBlock(Fragment, null, renderList(__props.previewStats.positions, (count, position) => {
                                      ...
                                      }, toDisplayString(position) + " (" + toDisplayString(count) + " employees) ", 1);
                                    }), 128))
                                  ])
                                ])
                              ])
                        ...
                        createVNode("div", { class: "border-b border-gray-200 pb-6 mb-6" }, [
                          createVNode("h3", { class: "text-lg font-medium leading-6 text-gray-900 mb-4" }, "Uniform Salary Details"),
                          ...
                          createVNode("div", { class: "mt-6 p-4 bg-gray-50 rounded-lg" }, [
                            createVNode("div", { class: "flex justify-between items-center" }, [
                              createVNode("span", { class: "text-lg font-medium text-gray-900" }, "Total Salary per Employee:"),
                              createVNode("span", { class: "text-2xl font-bold text-sage-600" }, " IDR " + toDisplayString(formatCurrency(totalSalary.value)), 1)
                            ])
                          ])
                        ]),
                        ...
                        createVNode("div", { class: "flex items-center justify-end space-x-3" }, [
                          ...
                          createVNode("button", {
                            ...
                            createTextVNode(" " + toDisplayString(processing.value ? "Processing..." : "Save All-in Salary"), 1)
                          ], 8, ["disabled"])
                        ]),
                        unref(form).target_type ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "flex" }, [
                            ...
                            createVNode("div", null, [
                              createVNode("h4", { class: "text-sm font-medium text-blue-800 mb-1" }, "Execution Preview"),
                              createVNode("p", { class: "text-sm text-blue-700" }, [
                                createTextVNode(" The system will create individual salary records for "),
                                createVNode("strong", null, toDisplayString(getTargetDescription()), 1),
                                createTextVNode(" with total salary "),
                                createVNode("strong", null, "IDR " + toDisplayString(formatCurrency(totalSalary.value)), 1),
                                createTextVNode(" per employee. ")
                              ])
                            ])
                          ])
                        ])) : createCommentVNode("", true)
